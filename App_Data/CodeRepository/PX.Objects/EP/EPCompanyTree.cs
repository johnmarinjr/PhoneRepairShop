	...
	public class ImportCompanyTreeMaint : PXGraph<ImportCompanyTreeMaint>
	{
			...
			int? WorkGroupID)
		{
				...
				Where<EPCompanyTreeMember.workGroupID, Equal<Required<EPCompanyTreeMember.workGroupID>>>>.Select(this, WorkGroupID))
			{
				...
				{
					Members.Cache.RaiseExceptionHandling<EPCompanyTreeMember.contactID>(member, null, new PXSetPropertyException(PX.Objects.EP.Messages.UserWithoutEmployee, PXErrorLevel.RowWarning, user.Username));
				}
