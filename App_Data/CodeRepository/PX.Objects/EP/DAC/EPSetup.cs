...
namespace PX.Objects.EP
{
	...
	public partial class EPSetup : PX.Data.IBqlTable, IAssignedMap
	{
        ...
        [PM.AccountGroup(DisplayName="Off-Balance Account Group")]
		...
		#region LastCustomWeekID

		public abstract class lastCustomWeekID : PX.Data.BQL.BqlInt.Field<lastCustomWeekID> { }
		[PXInt]
		[PXUIField(DisplayName = "Last Custom Week ID")]
		[PXDBScalar(typeof(SelectFrom<EPCustomWeek>.OrderBy<Desc<EPCustomWeek.weekID>>.SearchFor<EPCustomWeek.weekID>))]
	...
	public class EPPostOptions
	{
		...
		public class overridePMInPayroll : PX.Data.BQL.BqlString.Constant<overridePMInPayroll>
		{
			public overridePMInPayroll() : base(OverridePMInPayroll) { }
		}

		// Post, DoNotPost, and PostToOffBalance settings are used in Time & Expenses Preferences
		// DoNotPost, PostToOffBalance, OverridePMInPayroll, OverridePMAndGLInPayroll, PostPMAndGLFromPayroll settings are used in Payroll Preferences

		public const string Post = "P";						// Post PM and GL transactions in the Time module. Setting is not used in (and does not affect) the Payroll module.
		public const string DoNotPost = "N";                // Do not post
		public const string PostToOffBalance = "O";         // Post PM transaction in the Time module. Do not post in the Payroll Module.
		public const string OverridePMInPayroll = "M";      // Post PM transaction in the Time module, then revert this PM transaction in the Payroll module and post PM and GL transactions in the Payroll module.
		public const string OverridePMAndGLInPayroll = "G"; // Post PM and GL transactions in the Time module, then revert these PM and GL transactions in the Payroll module and post PM and GL transactions in the Payroll module.
		public const string PostPMAndGLFromPayroll = "A";   // Post PM and GL transactions in the Payroll module only. Do not post in the Time module.
	}
