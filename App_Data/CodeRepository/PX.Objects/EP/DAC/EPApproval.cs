...
namespace PX.Objects.EP
{
	...
	public partial class EPApproval : IBqlTable
	{
		...
		[Owner(DisplayName = "Assigned Approver ID", Visibility = PXUIVisibility.SelectorVisible)]
		...
		[Owner(Visibility = PXUIVisibility.SelectorVisible)]
		...
		[Owner(DisplayName = "Approver ID", Visibility = PXUIVisibility.Visible, Enabled = false)]
