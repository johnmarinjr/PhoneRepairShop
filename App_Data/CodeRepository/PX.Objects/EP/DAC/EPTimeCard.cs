...
namespace PX.Objects.EP
{
	...
	public partial class EPTimeCard : IBqlTable, IAssign
	{
		...
		#region WeekEndDate
		public abstract class weekEndDate : PX.Data.BQL.BqlDateTime.Field<weekEndDate> { }
		
		[PXDate]
		[PXDependsOnFields(typeof(weekStartDate))]
		public virtual DateTime? WeekEndDate
		{
			get { return _WeekStartDate?.AddDays(6); }
			set {  }
		}
		#endregion
	...
	public partial class TimecardWithTotals : IBqlTable
	{
		...
		public abstract class noteID : PX.Data.BQL.BqlGuid.Field<noteID> { }
		protected Guid? _NoteID;
		[PXNote(BqlField = typeof(EPTimeCard.noteID),
			DescriptionField = typeof(EPTimeCard.timeCardCD),
			Selector = typeof(EPTimeCard.timeCardCD)
			)]
		public virtual Guid? NoteID
