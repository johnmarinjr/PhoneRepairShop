...
namespace PX.Objects.EP
{
	...
	public partial class EPSummaryApprove : IBqlTable
	{
		...
		{
			public static EPSummaryApprove Find(PXGraph graph, string timeCardCD, int? lineNbr) => FindBy(graph, timeCardCD, lineNbr);
		}
		...
		public static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<EPSummaryApprove>.By<projectTaskID> { }
