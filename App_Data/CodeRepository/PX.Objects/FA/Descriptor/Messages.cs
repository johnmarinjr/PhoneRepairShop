...
namespace PX.Objects.FA
{
	...
	public static class Messages
	{
		...
		public const string AssetBaseCurrencyDiffersFromDestinationBranch = "The {1} fixed asset cannot be transferred to the {3} branch because the fixed asset's currency ({0}) differs from the {2} base currency of the {3} destination branch.";
