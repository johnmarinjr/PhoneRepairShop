...
namespace PX.Objects.FA
{
   ...
   public class FixedAssetStatus
   {
	...
	public partial class FixedAsset : IBqlTable
	{
		...
		///</list>
		/// </value>
		[PXDefault(FARecordType.AssetType)]
		...
		/// <summary>
		/// The base <see cref="Currency"/> of the Fixed Asset, corresponds to the Base Currency of the Branch of Fixed Asset.
		/// </summary>
		[PXDefault(typeof(AccessInfo.baseCuryID), PersistingCheck = PXPersistingCheck.NullOrBlank)]
