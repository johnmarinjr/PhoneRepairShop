...
namespace PX.Objects.DR
{
	public class DraftScheduleMaintASC606 : PXGraphExtension<DraftScheduleMaint>
	{
		...
		private void VerifySchedule(DRSchedule schedule)
		{
			...
			CurrencyInfo currencyInfo = CurrencyInfoAttribute.GetCurrencyInfo<DRSchedule.curyInfoID>(Base.Schedule.Cache, schedule);
		...
		private void SetVisibileAndEnable(Events.RowSelected<DRSchedule> e)
		{
			...
			bool isCustomerDiscountsFeatureEnabled = PXAccess.FeatureInstalled<FeaturesSet.customerDiscounts>();
			...
			PXUIFieldAttribute.SetVisible<DRScheduleDetail.discountPercent>(Base.Components.Cache, null, isCustomerDiscountsFeatureEnabled);
