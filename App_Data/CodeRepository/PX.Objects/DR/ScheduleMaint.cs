	...
	public class ScheduleMaint : PXGraph<ScheduleMaint>
	{
		...
		public virtual void ReleaseCustomSchedule(DRSchedule schedule)
		{
			using (var ts = new PXTransactionScope())
			{
				...
				PerformReleaseCustomScheduleValidations(schedule, details);
		...
		public virtual void PerformReleaseCustomScheduleValidations(DRSchedule schedule, IEnumerable<DRScheduleDetail> details)
		{
		}
