...
namespace PX.Objects.DR
{
	...
	public static class Messages
	{
		...
		public const string TermCantBeNegative = "Term End Date ({0:d}) cannot be earlier than Term Start Date ({1:d}).";
		...
		public const string DefaultTermMustBeTheSameForAllComponents = "The default term must be the same for all components with flexible deferral codes for which the Override Default Term check box is selected.";
		...
		public const string DRScheduleAllocationWeightIsLessOrEqualZero = "The total residual amount cannot be allocated between the residual components because the calculated allocation weight of the {0} component is less than or equal to zero. Thus, a deferral schedule cannot be created and the revenue will be posted to a suspense account.";
		public const string DRScheduleCuryTotalAmtIsLessOrEqualZeroSingleResidualComponent = "The total residual amount is less than or equal to zero and cannot be allocated between the residual components. Thus, a deferral schedule cannot be created and the revenue will be posted to a suspense account.";
		public const string DRSetupSuspenseAccountIsEmpty = "The document cannot be released because the suspense account is not specified. To proceed, specify the account on the Deferred Revenue Preferences (DR101000) form.";
		public const string DRSetupSuspenseSubAccountIsEmpty = "The document cannot be released because the suspense subaccount is not specified. To proceed, specify the subaccount on the Deferred Revenue Preferences (DR101000) form.";
		...
		public const string CurrencyIsNotBaseCurrency = "The currency cannot be selected as a schedule currency, because there is no branch with the same base currency in the system.";
		public const string ComponentBranchBaseCurrencyDifferentFromScheduleBranch = "The deferral schedule currency differs from the base currency of the {0} branch.";
		public const string ScheduleCurrencyDifferentFromComponentBranchBaseCurrency = "The document cannot be released because the deferral schedule currency differs from the base currency of the {0} component branch.";
		public const string ScheduleCurrencyDifferentFromRestrictVisibilityTo = "The document cannot be released because the deferral schedule currency differs from the base currency of the {0} entity associated with the {1} account. ";
