...
namespace PX.Objects.PM
{
	public class AllocationMaint : PXGraph<AllocationMaint, PMAllocation>
	{
		...
		protected virtual void _(Events.FieldUpdated<PMAllocationDetail, PMAllocationDetail.branchOrigin> e)
		{
			if (e.Row != null && e.Row.BranchOrigin != null && e.Row.BranchOrigin == PMOrigin.Source)
				e.Cache.SetDefaultExt<PMAllocationDetail.sourceBranchID>(e.Row);
		}
