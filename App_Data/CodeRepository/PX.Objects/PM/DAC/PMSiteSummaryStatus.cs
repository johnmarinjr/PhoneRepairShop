...
{
	[Serializable]
	[PXCacheName(Messages.PMSiteSummaryStatus)]
	public class PMSiteSummaryStatus : PX.Data.IBqlTable, IStatus
	{
		#region Keys
		public class PK : PrimaryKeyOf<PMSiteSummaryStatus>.By<inventoryID, subItemID, siteID, projectID>
		{
			public static PMSiteSummaryStatus Find(PXGraph graph, int? inventoryID, int? subItemID, int? siteID, int? projectID)
				=> FindBy(graph, inventoryID, subItemID, siteID, projectID);
		}
		public static class FK
		{
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<PMSiteSummaryStatus>.By<inventoryID> { }
			public class SubItem : INSubItem.PK.ForeignKeyOf<PMSiteSummaryStatus>.By<subItemID> { }
			public class Site : INSite.PK.ForeignKeyOf<PMSiteSummaryStatus>.By<siteID> { }
			public class ItemSite : INItemSite.PK.ForeignKeyOf<PMSiteSummaryStatus>.By<inventoryID, siteID> { }
			public class Project : PMProject.PK.ForeignKeyOf<PMSiteSummaryStatus>.By<projectID> { }
		}
		#endregion
		#region Selected
