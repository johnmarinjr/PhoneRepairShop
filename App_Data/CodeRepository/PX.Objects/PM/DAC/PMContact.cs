...
{
	/// <summary>
	/// Represents a contact that is specified in the <see cref="PMProject">project</see> and
	/// in the <see cref="PMProforma">pro forma invoice</see>.
	/// A <see cref="PMContact"/> record is a copy of customer location's
	...
	/// (which corresponds to the <see cref="ProjectEntry"/> graph) and on the
	/// Pro Forma Invoices (PM307000) form (which corresponds to the <see cref="ProformaEntry"/> graph).
	/// </summary>
	[Serializable()]
	...
	[Serializable]
	[PXCacheName(Messages.PMContact)]
	public partial class PMShippingContact : PMContact
	{
