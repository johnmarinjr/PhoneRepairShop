...
{
	[PMLotSerialStatusAccumAccumulator]
    [Serializable]
    [PXHidden]
    public partial class PMLotSerialStatusAccum : PMLotSerialStatus, IQtyAllocated
    {
        #region Keys
        public class PK : PrimaryKeyOf<PMLotSerialStatusAccum>.By<inventoryID, subItemID, siteID, locationID, lotSerialNbr, projectID, taskID>
        {
            public static PMLotSerialStatusAccum Find(PXGraph graph, int? inventoryID, int? subItemID, int? siteID, int? locationID, string lotSerialNbr, int? projectID, int? taskID)
                => FindBy(graph, inventoryID, subItemID, siteID, locationID, lotSerialNbr, projectID, taskID);
        }
        public static class FK
        {
            public class Location : INLocation.PK.ForeignKeyOf<PMLotSerialStatusAccum>.By<locationID> { }
            public class LocationStatus : INLocationStatus.PK.ForeignKeyOf<PMLotSerialStatusAccum>.By<inventoryID, subItemID, siteID, locationID> { }

            public class ProjectLocationStatus : PMLocationStatus.PK.ForeignKeyOf<PMLotSerialStatusAccum>.By<inventoryID, subItemID, siteID, locationID, projectID, taskID> { }

            public class SubItem : INSubItem.PK.ForeignKeyOf<PMLotSerialStatusAccum>.By<subItemID> { }
            public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<PMLotSerialStatusAccum>.By<inventoryID> { }
            public class ItemLotSerial : INItemLotSerial.PK.ForeignKeyOf<PMLotSerialStatusAccum>.By<inventoryID, lotSerialNbr> { }

            public class Site : INSite.PK.ForeignKeyOf<PMLotSerialStatusAccum>.By<siteID> { }
            public class Project : PMProject.PK.ForeignKeyOf<PMLotSerialStatusAccum>.By<projectID> { }
            public class Task : PMTask.PK.ForeignKeyOf<PMLotSerialStatusAccum>.By<taskID> { }
        }
        #endregion
        #region InventoryID
        ...
        [PXDefault(typeof(Select<InventoryItem, Where<InventoryItem.inventoryID, Equal<Current<PMLotSerialStatusAccum.inventoryID>>>>),
        ...
        [PXDefault(typeof(Select<INLotSerClass,
            Where<INLotSerClass.lotSerClassID, Equal<Current<PMLotSerialStatusAccum.lotSerClassID>>>>),
        ...
        [PXString(10, IsUnicode = true)]
        [PXDefault(typeof(Select<INItemClass, Where<INItemClass.itemClassID, Equal<Current<PMLotSerialStatusAccum.itemClassID>>>>),
        ...
        [PXBool()]
        [PXDefault(typeof(Select<INAvailabilityScheme, Where<INAvailabilityScheme.availabilitySchemeID, Equal<Current<PMLotSerialStatusAccum.availabilitySchemeID>>>>),
