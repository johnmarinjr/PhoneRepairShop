...
{
	/// <summary>Represents a commitment line of a <see cref="PMChangeOrder">change order</see>. The records of this type are created and edited through the <strong>Commitments</strong> tab of the
