...
namespace PX.Objects.PM
{
	...
	public class PMSiteStatus : PX.Data.IBqlTable, IStatus
	{
		#region Keys
		public class PK : PrimaryKeyOf<PMSiteStatus>.By<inventoryID, subItemID, siteID, projectID, taskID>
		{
			public static PMSiteStatus Find(PXGraph graph, int? inventoryID, int? subItemID, int? siteID, int? projectID, int? taskID)
				=> FindBy(graph, inventoryID, subItemID, siteID, projectID, taskID);
		}
		public static class FK
		{
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<PMSiteStatus>.By<inventoryID> { }
			public class SubItem : INSubItem.PK.ForeignKeyOf<PMSiteStatus>.By<subItemID> { }
			public class Site : INSite.PK.ForeignKeyOf<PMSiteStatus>.By<siteID> { }
			public class ItemSite : INItemSite.PK.ForeignKeyOf<PMSiteStatus>.By<inventoryID, siteID> { }
			public class Project : PMProject.PK.ForeignKeyOf<PMSiteStatus>.By<projectID> { }
			public class Task : PMTask.PK.ForeignKeyOf<PMSiteStatus>.By<taskID> { }
		}
		#endregion
		#region Selected
