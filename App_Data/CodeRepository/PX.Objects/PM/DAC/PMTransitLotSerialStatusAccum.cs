...
{
    [PMTransitLotSerialStatusAccumulator]
    [Serializable]
    [PXHidden]
    public partial class PMTransitLotSerialStatusAccum : PMLotSerialStatus, IQtyAllocated
    {
        #region Keys
        public class PK : PrimaryKeyOf<PMTransitLotSerialStatusAccum>.By<inventoryID, subItemID, siteID, locationID, lotSerialNbr, projectID, taskID>
        {
            public static PMTransitLotSerialStatusAccum Find(PXGraph graph, int? inventoryID, int? subItemID, int? siteID, int? locationID, string lotSerialNbr, int? projectID, int? taskID)
                => FindBy(graph, inventoryID, subItemID, siteID, locationID, lotSerialNbr, projectID, taskID);
        }
        public static class FK
        {
            public class Location : INLocation.PK.ForeignKeyOf<PMTransitLotSerialStatusAccum>.By<locationID> { }
            public class LocationStatus : INLocationStatus.PK.ForeignKeyOf<PMTransitLotSerialStatusAccum>.By<inventoryID, subItemID, siteID, locationID> { }

            public class ProjectLocationStatus : PMLocationStatus.PK.ForeignKeyOf<PMTransitLotSerialStatusAccum>.By<inventoryID, subItemID, siteID, locationID, projectID, taskID> { }

            public class SubItem : INSubItem.PK.ForeignKeyOf<PMTransitLotSerialStatusAccum>.By<subItemID> { }
            public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<PMTransitLotSerialStatusAccum>.By<inventoryID> { }
            public class ItemLotSerial : INItemLotSerial.PK.ForeignKeyOf<PMTransitLotSerialStatusAccum>.By<inventoryID, lotSerialNbr> { }

            public class Site : INSite.PK.ForeignKeyOf<PMTransitLotSerialStatusAccum>.By<siteID> { }
            public class Project : PMProject.PK.ForeignKeyOf<PMTransitLotSerialStatusAccum>.By<projectID> { }
            public class Task : PMTask.PK.ForeignKeyOf<PMTransitLotSerialStatusAccum>.By<taskID> { }
        }
        #endregion
        #region InventoryID
        ...
        [PXDefault(typeof(Select<INLotSerClass,
            Where<INLotSerClass.lotSerClassID, Equal<Current<lotSerClassID>>>>),
