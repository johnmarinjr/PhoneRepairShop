...
{
	/// <summary>
	/// Represents a project billing record.
	/// The records of this type are displayed on the <b>Invoices</b> tab of the Projects (PM301000) form
	/// (which corresponds to the <see cref="ProjectEntry"/> graph).
	/// </summary>
