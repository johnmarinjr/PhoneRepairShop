...
namespace PX.Objects.PM
{
	public class ProjectBalanceValidation : PXGraph<ProjectBalanceValidation>
	{
		...
		public PXAction<PMValidationFilter> initStock;
		[PXUIField(DisplayName = "Initialize Stock", FieldClass = nameof(FeaturesSet.MaterialManagement))]
		[PXProcessButton]
		public virtual IEnumerable InitStock(PXAdapter adapter)
		{
			Actions.PressSave();
		...
		protected virtual void InitStockProc()
		{
		}
	...
	public partial class PMValidationFilter : IBqlTable
	{
		...
		[PXDBBool()]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Recalculate Draft Invoice Amount")]
