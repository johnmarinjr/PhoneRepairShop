...
namespace PX.Objects.CS
{
	...
	public class FeaturesSet : IBqlTable
	{
		...
		[Feature(false, typeof(FeaturesSet.wMSFulfillment), typeof(Select<SO.SOPickingJob, Where<SO.SOPickingJob.status.IsNotEqual<SO.SOPickingJob.status.completed>>>),
		...
		[FeatureRestrictor(typeof(Select<PM.PMSiteStatus, Where<PM.PMSiteStatus.taskID, NotEqual<int0>>>))]
		...
		[Feature(false, typeof(FeaturesSet.commerceIntegration), DisplayName = "Shopify and Shopify POS Connector")]
		...
		[Feature(false, typeof(integrationModule), DisplayName = "Stripe Integration", Visible = false)]
		...
		[Feature(false, typeof(payrollModule), DisplayName = "US Payroll", Visible = false, SyncToParent = true)]
		...
		[Feature(false, typeof(payrollModule), DisplayName = "Canadian Payroll", Visible = false)]
		[FeatureRestrictor(typeof(SelectFrom<PR.Standalone.PRTaxCode>
		...
		[Feature(typeof(FeaturesSet.financialAdvanced), DisplayName = "GL Anomaly Detection")]
