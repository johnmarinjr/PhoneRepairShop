...
namespace PX.Objects.CS
{
	...
	public static class Messages
	{
		...
		public const string CustomerAccountsForBranch = "This branch is associated with at least one customer account. To delete the branch, clear the Default Branch box on the Customers (AR303000) form for the following customer accounts: {0}.";
		...
		public const string NeedToInstallLocalizationFeature = "To use this feature, you need to install the {0} localization using Acumatica Installation Wizard.";
		public const string OnlyOneLocalizationFeatureCanBeEnabled = "Only one localization feature can be enabled at the same time.";
		...
		public const string FeaturesDifferBaseCuryExist = "This feature cannot be disabled because there are companies with different base currencies in the system.";
		public const string ConsolidatedForAllCompanies = "The statements cannot be printed because it is not allowed to consolidate statements for all companies if the Multiple Base Currency feature is enabled. Select a different option in the Prepare Statements box on the Accounts Receivable Preferences (AR101000) form.";
		...
		public const string CompanyGroupBaseCurrencyDifferFromCompany = "The base currency of the {0} company does not match the {1} group currency.";
		...
		public const string BranchBaseCurrencyDifferFromEmployee = "The base currency of the selected branch differs from the base currency of the {0} employee.";
		public const string BranchBaseCurrencyDifferFromCustomer = "The base currency of the expense claim differs from the base currency of the entity associated with the {0} account.";
		public const string BranchBaseCurrencyDifferFromCustomerOnExpenseReceipt = "The base currency of the expense receipt differs from the base currency of the entity associated with the {0} account.";
		public const string ProjectMultiCurrencyConflictsWithMultiBaseCurrency = "This feature cannot be disabled if the Multiple Base Currencies feature is in use.";
		#endregion //Validation and Processing Messages

		public const string MBCFeatureIsInATestMode = "This feature is currently in Managed Availability and some scenarios may not be supported yet. We recommend testing it before enabling it on a production instance.";
		public const string GLAnomalyDetectionFeatureIsInTestMode = "This feature is currently in Managed Availability. The service works with limited use cases and predictions should be reviewed before making changes.";
	...
	#region Graph Names
		...
		public const string MultiCurrencyProjects = "Multicurrency Projects";
