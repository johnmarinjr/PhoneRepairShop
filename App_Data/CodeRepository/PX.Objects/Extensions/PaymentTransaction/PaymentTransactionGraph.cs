...
namespace PX.Objects.Extensions.PaymentTransaction
{
		...
		where TPrimary : class, IBqlTable, new()
	{
		...
		protected virtual void CheckProcCenterDisabled()
		{
			...
			if (disabledProcCenter)
			{
				throw new PXException(AR.Messages.StripeFeatureIsDisabled);
			}
		}

		protected virtual bool IsProcCenterDisabled(string procCenterType)
		{
			return procCenterType == AR.CCPaymentProcessing.Specific.StripeConstants.StripeType && !PXAccess.FeatureInstalled<CS.FeaturesSet.stripeIntegration>();
		}
