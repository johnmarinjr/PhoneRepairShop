...
namespace PX.Objects.IN
{
	...
	[PXProjection(typeof(Select2<INLotSerialStatus, InnerJoin<INItemLotSerial, On<INLotSerialStatus.FK.ItemLotSerial>>>), Persistent = false)]
	public partial class INLotSerialStatus : PX.Data.IBqlTable, IStatus, ILotSerial
    {
		#region Keys
		public class PK : PrimaryKeyOf<INLotSerialStatus>.By<inventoryID, subItemID, siteID, locationID, lotSerialNbr>
		{
			public static INLotSerialStatus Find(PXGraph graph, int? inventoryID, int? subItemID, int? siteID, int? locationID, string lotSerialNbr)
