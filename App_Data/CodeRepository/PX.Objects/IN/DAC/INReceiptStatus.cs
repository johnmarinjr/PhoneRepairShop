...
namespace PX.Objects.IN
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<INReceiptStatus>.By<docType, receiptNbr, inventoryID, costSubItemID, costSiteID, lotSerialNbr, accountID, subID>
		{
			public static INReceiptStatus Find(PXGraph graph, string docType, string receiptNbr, int? inventoryID, int? costSubItemID, int? costSiteID, string lotSerialNbr, int? accountID, int? subID)
				=> FindBy(graph, docType, receiptNbr, inventoryID, costSubItemID, costSiteID, lotSerialNbr, accountID, subID);
		}
