...
namespace PX.Objects.IN
{
	using SelectParentINItemClassRep = Select<INItemClassRep,
		...
		And<INItemClassRep.curyID, Equal<Current<INItemRep.curyID>>,
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<INItemRep>.By<inventoryID, curyID, replenishmentClassID>
		{
			public static INItemRep Find(PXGraph graph, int? inventoryID, string curyID, string replenishmentClassID) 
				=> FindBy(graph, inventoryID, curyID, replenishmentClassID);
		}
