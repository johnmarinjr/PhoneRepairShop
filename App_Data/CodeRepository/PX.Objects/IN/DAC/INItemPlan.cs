...
namespace PX.Objects.IN
{
	...
	public partial class INItemPlan : PX.Data.IBqlTable, IQtyPlanned
	{
		...
		public static implicit operator PM.PMSiteStatusAccum(INItemPlan item)
		{
			PM.PMSiteStatusAccum ret = new PM.PMSiteStatusAccum();
			ret.InventoryID = item.InventoryID;
			ret.SubItemID = item.SubItemID;
			ret.SiteID = item.SiteID;
			ret.ProjectID = item.ProjectID.GetValueOrDefault(PM.ProjectDefaultAttribute.NonProject().GetValueOrDefault());
			ret.TaskID = item.TaskID.GetValueOrDefault();

			return ret;
		}

		public static implicit operator PM.PMSiteSummaryStatusAccum(INItemPlan item)
		{
			PM.PMSiteSummaryStatusAccum ret = new PM.PMSiteSummaryStatusAccum();
			ret.InventoryID = item.InventoryID;
			ret.SubItemID = item.SubItemID;
			ret.SiteID = item.SiteID;
			ret.ProjectID = item.ProjectID.GetValueOrDefault(PM.ProjectDefaultAttribute.NonProject().GetValueOrDefault());
		...
		public static implicit operator PM.PMLocationStatusAccum(INItemPlan item)
		{
			PM.PMLocationStatusAccum ret = new PM.PMLocationStatusAccum();
			ret.InventoryID = item.InventoryID;
			ret.SubItemID = item.SubItemID;
			ret.SiteID = item.SiteID;
			ret.LocationID = item.LocationID;
		...
		public static implicit operator PM.PMLotSerialStatusAccum(INItemPlan item)
		{
			PM.PMLotSerialStatusAccum ret = new PM.PMLotSerialStatusAccum();
			ret.InventoryID = item.InventoryID;
			ret.SubItemID = item.SubItemID;
			ret.SiteID = item.SiteID; 
			ret.LocationID = item.LocationID;
