...
namespace PX.Objects.IN
{
	...
	public partial class INTranCost : PX.Data.IBqlTable
	{
		...
		[PXParent(typeof(Select<INTran, 
			...
			And<INTran.lineNbr, Equal<Current<INTranCost.lineNbr>>>>>>), LeaveChildren = true)]
		...
		#endregion
		#region IsVirtual
		[Obsolete("The field is obsoleted, use the CostType field instead.")]
		...
		public abstract class costType : PX.Data.BQL.BqlString.Field<costType>
		{
			...
			public class dropShipPPVorLC : PX.Data.BQL.BqlString.Constant<dropShipPPVorLC>
			{
				public dropShipPPVorLC() : base(DropShipPPVorLC) { }
			}

			public class transitTransfer : PX.Data.BQL.BqlString.Constant<transitTransfer>
			{
				public transitTransfer() : base(TransitTransfer) { }
			}
		}
		[PXDBString(1, IsUnicode = false, IsFixed = true)]
		[PXDefault(typeof(costType.normal))]
