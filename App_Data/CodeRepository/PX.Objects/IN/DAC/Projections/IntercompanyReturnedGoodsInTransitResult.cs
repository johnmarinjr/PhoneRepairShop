...
namespace PX.Objects.IN
{
	...
	[PXProjection(typeof(Select2<POReceiptLine,
		...
		InnerJoin<Branch2, On<Branch2.bAccountID, Equal<POReceipt.vendorID>>,
		LeftJoin<SOOrder,
			On<SOOrder.intercompanyPOReturnNbr.IsEqual<POReceipt.receiptNbr>>,
		...
		LeftJoin<SOShipment, On<SOShipLine.FK.Shipment>>>>>>>>>>), Persistent = false)]
	public class IntercompanyReturnedGoodsInTransitResult : IBqlTable
	{
		...
		[POReceiptType.RefNbr(typeof(Search<POReceipt.receiptNbr, Where<POReceipt.receiptType, Equal<POReceiptType.poreturn>>>), Filterable = true)]
		...
		[Branch(DisplayName = "Selling Company", Required = false, BqlField = typeof(Branch2.branchID))]
		...
		public abstract class origReceiptType : Data.BQL.BqlString.Field<origReceiptType> { }
		[PXDBString(2, IsFixed = true, BqlField = typeof(POReceiptLine.origReceiptType))]
		public virtual string OrigReceiptType
		{
			get;
			set;
		}
