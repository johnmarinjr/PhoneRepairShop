...
namespace PX.Objects.IN
{
	...
	[PXProjection(typeof(Select2<SOShipLine,
		...
		InnerJoin<Branch2, On<Branch2.bAccountID, Equal<SOOrder.customerID>>,
	...
	public class IntercompanyGoodsInTransitResult : IBqlTable
	{
		...
		[Branch(DisplayName = "Purchasing Company", Required = false, BqlField = typeof(Branch2.branchID))]
		...
		[PXDBString(2, IsKey = true, IsFixed = true, BqlField = typeof(POReceipt.receiptType))]
		[POReceiptType.List]
		...
		[POReceiptType.RefNbr(typeof(Search<POReceipt.receiptNbr, Where<POReceipt.receiptType.IsEqual<pOReceiptType.FromCurrent>>>), Filterable = true)]
