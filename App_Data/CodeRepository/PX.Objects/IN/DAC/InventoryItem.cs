...
namespace PX.Objects.IN
{
	...
	public class InventoryItem : IBqlTable, PX.SM.IIncludable
	{
		...
		public static class FK
		{
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.DefaultShipLocation instead.")]
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.PreferredVendor instead.")]
			public class PreferredVendor : AP.Vendor.PK.ForeignKeyOf<InventoryItem>.By<preferredVendorID> { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.PreferredVendorLocation instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.LastStdCost instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.PendingStdCost instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.PendingStdCostDate instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.StdCost instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.StdCostDate instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.BasePrice instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.PreferredVendorID instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.PreferredVendorLocationID instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.DfltSiteID instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.DfltShipLocationID instead.")]
		...
		[PXRestrictor(typeof(Where<INLocation.active.IsEqual<True>>), Messages.LocationIsNotActive)]
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.DfltReceiptLocationID instead.")]
		...
		[Obsolete("This field is obsolete and is going to be removed in 2022R1. Use InventoryItemCurySettings.RecPrice instead.")]
