...
namespace PX.Objects.IN
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<INItemClassRep>.By<itemClassID, curyID, replenishmentClassID>
		{
			public static INItemClassRep Find(PXGraph graph, int? itemClassID, string curyID, string replenishmentClassID)
				=> FindBy(graph, itemClassID, curyID, replenishmentClassID);
		}
