	...
	{		
		...
		public PXSelectJoin<INTranSplit,
                            ...
                            LeftJoin<POReceiptLine,
								On<POReceiptLine.receiptType, Equal<INTranSplit.pOReceiptType>,
								And<POReceiptLine.receiptNbr, Equal<INTranSplit.pOReceiptNbr>,
							...
							Where<Current<INLotSerFilter.lotSerialNbr>, IsNotNull,
							 And2<Where2<Not<FeatureInstalled<FeaturesSet.multipleBaseCurrencies>>,
								Or<INSite.branchID, InsideBranchesOf<Current<INLotSerFilter.orgBAccountID>>>>,
