...
namespace PX.Objects.IN
{
    ...
    public class InventoryTranDetEnq : PXGraph<InventoryTranDetEnq>
    {
		...
		protected virtual IEnumerable resultRecords()
        {
            ...
            {
                cmd.WhereAnd<Where<INSite.branchID, InsideBranchesOf<Current<InventoryTranDetEnqFilter.orgBAccountID>>>>();
                cmdBeginning.WhereAnd<Where<INSite.branchID, InsideBranchesOf<Current<InventoryTranDetEnqFilter.orgBAccountID>>>>();
            }
