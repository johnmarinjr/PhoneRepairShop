...
namespace PX.Objects.IN
{
	...
	public class INIntegrityCheck : PXGraph<INIntegrityCheck>
	{
		...
		/// <summary>
		/// Is needed because of a restriciton for <see cref="INSiteLotSerial.qtyActual"/> in <see cref="SiteStatusAccumulatorAttribute.PrepareInsert"/>
		/// </summary>
		protected virtual void _(Events.FieldDefaulting<SiteLotSerial, SiteLotSerial.negActualQty> e)
		{
			e.NewValue = true;
			e.Cancel = true;
		}
