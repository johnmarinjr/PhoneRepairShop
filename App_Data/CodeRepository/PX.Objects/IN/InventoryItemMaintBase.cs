...
namespace PX.Objects.IN
{
	public abstract class InventoryItemMaintBase : PXGraph<InventoryItemMaintBase, InventoryItem>
	{
		...
		protected virtual void SetDefaultSiteID(InventoryItem item)
		{
			...
			var itemClassCurySettingsRows = SelectFrom<INItemClassCurySettings>
				...
				.View.ReadOnly.Select(this, item.ParentItemClassID)
			...
			var itemCurySettingsRows = AllItemCurySettings.Select(item.InventoryID).RowCast<InventoryItemCurySettings>();
		...
		public static void VerifyOnlyOneResidualComponent(PXCache itemCache, InventoryItem item, IEnumerable<INComponent> components)
			=> VerifyOnlyOneResidualComponent(itemCache, components);
