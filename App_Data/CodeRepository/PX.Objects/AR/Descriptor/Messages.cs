...
namespace PX.Objects.AR
{
	...
	public static class Messages
	{
		...
		public const string ERR_VoidTranNotLinkedOrigTran = "Validation of the {0} transaction has failed. The {0} transaction cannot void the {1} transaction. To refund the original transaction, use the Refund Card Payment command on the More menu. To void the original transaction, delete the Customer Refund document and void the original payment.";
