...
namespace PX.Objects.AR
{
	...
	public partial class ARAdjust 
		: IBqlTable, IAdjustment, IDocumentAdjustment, IAdjustmentAmount, Common.GraphExtensions.Abstract.DAC.IFinAdjust, ICreatePaymentAdjust
	{
		#region Keys
		...
		[ARInvoiceType.AdjdLineNbrRestrictor(
			typeof(Where<ARInvoice.paymentsByLinesAllowed, Equal<True>,
					And<Where<ARTran.curyTranBal, NotEqual<decimal0>,
						Or<ARInvoice.retainageApply, Equal<True>, And<ARInvoice.retainageUnreleasedAmt, Equal<decimal0>, And<ARInvoice.retainageReleased, Equal<decimal0>>>>>>>),
			ErrorMessages.ElementDoesntExist, typeof(ARTran.lineNbr))]
		...
		[PXSelector(typeof(Search<SOOrder.orderNbr,
			Where<SOOrder.orderType, Equal<Optional<adjdOrderType>>>>), Filterable = true)]
		[PXParent(typeof(Select<SOAdjust, Where<SOAdjust.adjdOrderType, Equal<Current<adjdOrderType>>, And<SOAdjust.adjdOrderNbr, Equal<Current<adjdOrderNbr>>,
			And<SOAdjust.adjgDocType, Equal<Current<adjgDocType>>, And<SOAdjust.adjgRefNbr, Equal<Current<adjgRefNbr>>>>>>>), LeaveChildren = true)]
	...
	[PXDefault(typeof(ARPayment.adjCntr))]
		...
		#endregion
		#region InvoiceID
		public abstract class invoiceID : PX.Data.BQL.BqlGuid.Field<invoiceID> { }
		...
		#endregion
		#region PaymentID
		public abstract class paymentID : PX.Data.BQL.BqlGuid.Field<paymentID> { }

		[PXDBGuidAttribute()]
		public virtual Guid? PaymentID { get; set; }
		#endregion
		#region MemoID
		public abstract class memoID : PX.Data.BQL.BqlGuid.Field<memoID> { }
		...
		public abstract class displayBranchID : PX.Data.BQL.BqlInt.Field<displayBranchID> { }
		[PXInt]
		...
		public abstract class displayCustomerID : PX.Data.BQL.BqlInt.Field<displayCustomerID> { }
		[PXInt]
		...
		#region AdjAmt
		public abstract class displayAdjAmt : PX.Data.BQL.BqlDecimal.Field<displayAdjAmt> { }
		[PXDecimal(4)]
		[PXUnboundDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? DisplayAdjAmt
		{
			get;
			set;
		}
		...
		#region DisplayProcStatus
		public abstract class displayProcStatus : Data.BQL.BqlString.Field<displayProcStatus> { }
		[PXString(3, IsFixed = true)]
	...
	[PXCacheName(Messages.ARAdjust)]
	[PXBreakInheritance()]
	[DebuggerDisplay(nameof(ARAdjust2) + ": Invoice (Type {" + nameof(AdjdDocType) + "}, Number {" + nameof(AdjdRefNbr) + "}), Payment (Type {" + nameof(AdjgDocType) + "}, Number {" + nameof(AdjgRefNbr) + "}), tstamp = {PX.Data.PXDBTimestampAttribute.ToString(tstamp)}")]
	public partial class ARAdjust2 : PX.Objects.AR.ARAdjust, ICreatePaymentAdjust
	{
		...
		[ARPaymentType.AdjgRefNbr(typeof(Search<ARPayment.refNbr, 
			Where<ARPayment.docType, Equal<Optional<ARAdjust2.adjgDocType>>>>), Filterable = true)]
		...
		[PXParent(typeof(Select<AR.ARInvoice,
			Where<AR.ARInvoice.docType, Equal<Current<ARAdjust2.adjdDocType>>,
				...
				And<AR.ARInvoice.docType, NotEqual<ARDocType.creditMemo>>>>>))]
		[PXUnboundFormula(
		...
		#endregion
		#region AdjdOrderType
		public new abstract class adjdOrderType : Data.BQL.BqlString.Field<adjdOrderType> { }
		[PXDBString(2, IsFixed = true)]
		[PXUIField(DisplayName = "Order Type")]
		[PXSelector(typeof(Search<SOOrderType.orderType>))]
		...
		#endregion
		#region AdjdOrderNbr
		public new abstract class adjdOrderNbr : Data.BQL.BqlString.Field<adjdOrderNbr> { }
		[PXDBString(15, IsUnicode = true, InputMask = ">CCCCCCCCCCCCCCC")]
		[PXUIField(DisplayName = "Order Nbr.", Enabled = false)]
		[PXSelector(typeof(Search<SOOrder.orderNbr,
			Where<SOOrder.orderType, Equal<Optional<adjdOrderType>>>>), Filterable = true)]
        ...
        #endregion
        #region InvoiceID
        public new abstract class invoiceID : PX.Data.BQL.BqlGuid.Field<invoiceID> { }
        ...
        #endregion
        #region PaymentID
        public new abstract class paymentID : PX.Data.BQL.BqlGuid.Field<paymentID> { }

        [PXDBGuidAttribute()]
        public override Guid? PaymentID { get; set; }
        #endregion
        #region MemoID
        public new abstract class memoID : PX.Data.BQL.BqlGuid.Field<memoID> { }
