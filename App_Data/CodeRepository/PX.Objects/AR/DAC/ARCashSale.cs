...
namespace PX.Objects.AR.Standalone
{
	...
	public class ARCashSale : ARRegister, ICCPayment, IApprovable, IApprovalDescription
	{
		...
		[LocationActive(typeof(Where<Location.bAccountID, Equal<Current<ARCashSale.customerID>>,
		...
		[PXFormula(typeof(Switch<
								Case<Where<PendingValue<ARCashSale.branchID>, IsPending>, Null,
								Case<Where<ARCashSale.customerLocationID, IsNotNull,
	...
	public class ARCashSaleType : ARDocType
	{
		...
		public class NumberingAttribute : AutoNumberAttribute
		{
			...
			{
				get => new string[] { CashSale, CashReturn };
			}

			private static Type[] _SetupFields
			{
				get => new Type[] { typeof(ARSetup.invoiceNumberingID), typeof(ARSetup.invoiceNumberingID) };
			}
