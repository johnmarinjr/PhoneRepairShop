...
namespace PX.Objects.AR
{
	...
	public partial class ARSetup : PX.Data.IBqlTable
	{
		...
		#endregion
		#region PrepareStatements
		public abstract class prepareStatements : PX.Data.BQL.BqlShort.Field<prepareStatements>
		{
			public class ListAttribute : PXStringListAttribute
			{
				public ListAttribute() : base(
					new string[] { ForEachBranch, ConsolidatedForCompany, ConsolidatedForAllCompanies },
					new string[] { Messages.ForEachBranch, Messages.ConsolidatedForCompany, Messages.ConsolidatedForAllCompanies })	{ }
				...
				public override void CacheAttached(PXCache sender)
				{
					...
					{
						typesValues.Add(ForEachBranch);
						typesLabels.Add(Messages.ForEachBranch);
					}

					typesValues.Add(ConsolidatedForCompany);
					typesLabels.Add(Messages.ConsolidatedForCompany);

					if (PXAccess.FeatureInstalled<FeaturesSet.multiCompany>())
					{
						typesValues.Add(ConsolidatedForAllCompanies);
						typesLabels.Add(Messages.ConsolidatedForAllCompanies);
					}
		...
		[PXDBString(1, IsFixed = true)]
		[PXDefault(prepareStatements.ConsolidatedForCompany)]
		[PXUIField(DisplayName = "Prepare Statements")]
		[prepareStatements.List]
		...
		[GL.Branch(DisplayName="Statement from Branch", PersistingCheck = PXPersistingCheck.Nothing, FieldClass = "COMPANYBRANCH")]
		...
		[PXDBBool()]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Consolidate Dunning Letters for all Branches", FieldClass = "COMPANYBRANCH")]
		...
		[GL.Branch(DisplayName ="Dunning Letter from Branch", PersistingCheck = PXPersistingCheck.Nothing, FieldClass = "COMPANYBRANCH")]
		...
		public abstract class autoLoadMaxDocs : PX.Data.BQL.BqlShort.Field<autoLoadMaxDocs> { }
		[PXDBShort()]
		[PXDefault((short)100)]
