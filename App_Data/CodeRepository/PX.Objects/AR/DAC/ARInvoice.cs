	...
	public class ARInvoiceType : ARDocType
	{
		...
		public class AppListAttribute : PO.PXStringListExtAttribute
		{
			public AppListAttribute()
				: base(
					new string[] {CreditMemo, Payment, Prepayment},
					new string[] {Messages.CreditMemo, Messages.Payment, Messages.Prepayment},
					ARDocType.Values,
					ARDocType.Labels
				)
			{
		...
		public class AdjListAttribute : PO.PXStringListExtAttribute
		{
			public AdjListAttribute()
				: base(
					new string[] {Invoice, DebitMemo, FinCharge, Refund},
					new string[] {Messages.Invoice, Messages.DebitMemo, Messages.FinCharge, Messages.Refund},
					ARDocType.Values,
					ARDocType.Labels
				)
			{
