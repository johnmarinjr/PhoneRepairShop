...
namespace PX.Objects.AR
{
	...
	public partial class ARTran : IBqlTable, IHasMinGrossProfit, DR.Descriptor.IDocumentLine, ISortOrder, ILSPrimary, IAccountable, IN.RelatedItems.ISubstitutableLine
	{
		#region Keys
		...
		[SO.GraphExtensions.SOInvoiceEntryExt.SOInvoiceLineSplittingExtension.ARLotSerialNbr(typeof(ARTran.inventoryID), typeof(ARTran.subItemID), typeof(ARTran.locationID), PersistingCheck = PXPersistingCheck.Nothing, FieldClass = "LotSerial")]
		...
		[SO.GraphExtensions.SOInvoiceEntryExt.SOInvoiceLineSplittingExtension.ARExpireDate(typeof(ARTran.inventoryID), PersistingCheck = PXPersistingCheck.Nothing, FieldClass = "LotSerial")]
