...
namespace PX.Objects.AR
{
	...
	public partial class CustomerPaymentMethod : PX.Data.IBqlTable, ICCPaymentProfile
	{
		...
		[PXFormula(typeof(Switch<
			Case<Where<cardType, IsNull>, Null,
			Case<Where<cardType, Equal<CardType.other>, And<procCenterCardTypeCode, IsNotNull>>,
				ListLabelOf<cardType>.Concat<Colon>.Concat<procCenterCardTypeCode>>>,
			ListLabelOf<cardType>>))]
		public virtual string DisplayCardType
		{
			get;
			set;
		}
