...
namespace PX.Objects.CR
{
    ...
    public partial class CRShippingContact : CRContact
    {
        ...
        public new abstract class isDefaultContact : BqlBool.Field<isDefaultContact> { }
    ...
    [Serializable]
    [PXCacheName(Messages.BillToContact)]
    public partial class CRBillingContact : CRContact
    {
        #region Keys
        public class PK : PrimaryKeyOf<CRBillingContact>.By<contactID>
        {
            public static CRBillingContact Find(PXGraph graph, int? contactID) => FindBy(graph, contactID);
        }
        public new static class FK
        {
            public class BusinessAccount : CR.BAccount.PK.ForeignKeyOf<CRBillingContact>.By<bAccountID> { }
            public class Contact : CR.Contact.PK.ForeignKeyOf<CRBillingContact>.By<bAccountContactID> { }
            public class Location : CR.Location.PK.ForeignKeyOf<CRBillingContact>.By<bAccountID, bAccountLocationID> { }
        }
        #endregion
		...
		#endregion
		#region BAccountContactID
		public new abstract class bAccountContactID : BqlInt.Field<bAccountContactID> { }
        #endregion
        #region BAccountLocationID
        public new abstract class bAccountLocationID : BqlInt.Field<bAccountLocationID> { }
        #endregion
        #region RevisionID
        public new abstract class revisionID : BqlInt.Field<revisionID> { }
        #endregion
        ...
        #endregion
        #region OverrideContact
        public new abstract class overrideContact : BqlBool.Field<overrideContact> { }
        [PXBool]
        [PXUIField(DisplayName = "Override", Visibility = PXUIVisibility.Visible)]
        public override Boolean? OverrideContact
        {
