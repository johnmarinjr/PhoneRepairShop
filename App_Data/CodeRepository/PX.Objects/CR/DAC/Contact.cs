...
namespace PX.Objects.CR
{
	...
	public partial class Contact : IBqlTable, IContactBase, IPersonalContact, IAssign, IPXSelectable, CRDefaultMailToAttribute.IEmailMessageTarget, IConsentable, INotable
	{
		...
		/// <summary>
		/// Specifies (if set to <see langword="true" />) that the <see cref="Contact">contact</see>,
		/// which the current <see cref="ContactAccount"/> represents, is primary for the <see cref="BAccount">business account</see>,
		/// which the current <see cref="ContactAccount"/> also represents.
		/// </summary>
		/// <remarks>
		...
		/// Corresponds to the value of the <see cref="CR.BAccount.BAccountID"/> field.
		/// </value>
		[ParentBAccount(typeof(Contact.bAccountID))]
		[PXMassUpdatableField]
		...
		/// </value>
		[PXDBCalced(typeof(
			Switch<Case<Where<contactType, Equal<ContactTypesAttribute.bAccountProperty>>, ContactTypesAttribute.Priority.bAccountPriority,
				   Case<Where<Where<contactType, Equal<ContactTypesAttribute.salesPerson>>>, ContactTypesAttribute.Priority.salesPersonPriority,
				   Case<Where<Where<contactType, Equal<ContactTypesAttribute.employee>>>, ContactTypesAttribute.Priority.employeePriority,
				   Case<Where<Where<contactType, Equal<ContactTypesAttribute.person>>>, ContactTypesAttribute.Priority.personPriority,
				   Case<Where<Where<contactType, Equal<ContactTypesAttribute.lead>>>, ContactTypesAttribute.Priority.leadPriority>>>>>>
			), typeof(int))]
        ...
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
        [PXUIField(DisplayName = "Ext Ref Nbr", Visibility = PXUIVisibility.Visible, Visible = true)]
        [PXMassMergableField]
	...
	public class ContactAccount : Contact
	{
		...
		/// <inheritdoc cref="BAccount.PrimaryContactID"/>
		...
		#endregion
		#region IsPrimary
		public new abstract class isPrimary : BqlBool.Field<isPrimary> { }
		...
		/// </summary>
		/// <value>
		/// The value is <see langword="true"/> when <see cref="PrimaryContactID"/>
		/// is equal to <see cref="Contact.ContactID"/>.
		/// </value>
		[PXBool]
		[PXUIField(DisplayName = "Primary", Enabled = false)]
		[PXDependsOnFields(typeof(contactID), typeof(primaryContactID))]
		public override bool? IsPrimary
		{
			get => ContactID == PrimaryContactID;
			set { }
		}
	...
	{
		#region other fields
		public new abstract class accountStatus : BqlString.Field<accountStatus> { }
		public new abstract class status : BqlString.Field<status> { }
		public new abstract class type : BqlString.Field<type> { }
		#endregion
		...
		public new abstract class leadStatus : BqlString.Field<leadStatus> { }
		#endregion
		#region RawContactStatus
		[PXString]
		[PXDBCalced(typeof(Contact.status.When<Contact.contactType.IsEqual<ContactTypesAttribute.person>>.ElseNull), typeof(string))]
		[ContactTypes(BqlField = typeof(Contact.status))]
		public virtual string RawContactStatus { get; set; }
		public new abstract class rawContactStatus : BqlString.Field<rawContactStatus> { }
		#endregion
		#region AggregatedStatus
		[PXString]
		[PXUIField(DisplayName = "Status")]
		[CoalesceCombinedDBStringLists(typeof(ContactAccountLead), typeof(leadStatus), typeof(status), typeof(accountStatus))]
		public virtual string AggregatedStatus { get; set; }
		public abstract class aggregatedStatus : BqlString.Field<aggregatedStatus> { }
		#endregion
		#region RawLeadType
		[PXDBString(2, IsFixed = true, BqlField = typeof(CRLead.contactType), BqlTable = typeof(CRLead))]
		[PXStringList(new[] { ContactTypesAttribute.Lead }, new[] { Messages.Lead })]
		public virtual string RawLeadType { get; set; }
		public new abstract class rawLeadType : BqlString.Field<rawLeadType> { }
		#endregion
		#region RawContactType
		[PXString]
		[PXDBCalced(typeof(Contact.contactType.When<Contact.contactType.IsEqual<ContactTypesAttribute.person>>.ElseNull), typeof(string))]
		[PXStringList(new[] { ContactTypesAttribute.Person }, new[] { Messages.Person })]
		public virtual string RawContactType { get; set; }
		public new abstract class rawContactType : BqlString.Field<rawContactType> { }
		#endregion
		#region AggregatedType
		[PXString]
		[PXUIField(DisplayName = "Type")]
		[CoalesceCombinedDBStringLists(typeof(ContactAccountLead), typeof(rawLeadType), typeof(rawContactType), typeof(type))]
		public virtual string AggregatedType { get; set; }
		public abstract class aggregatedType : BqlString.Field<aggregatedType> { }
		#endregion
	}
