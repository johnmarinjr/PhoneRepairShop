...
namespace PX.Objects.CR
{
	...
	public partial class EPActivity : IAssign, IBqlTable
	{
		...
		[PXDBString(998, InputMask = "", IsUnicode = true, BqlField = typeof(SMEmail.subject))]
		[PXDefault]
		[PXUIField(DisplayName = "Summary", Visibility = PXUIVisibility.SelectorVisible)]
		[PXNavigateSelector(typeof(subject))]
		...
		[PXDBString(3000, IsUnicode = true, BqlField = typeof(SMEmail.mailTo))]
		...
		[PXDBString(3000, IsUnicode = true, BqlField = typeof(SMEmail.mailCc))]
		...
		[PXDBString(3000, IsUnicode = true, BqlField = typeof(SMEmail.mailBcc))]
		...
		[TimeActivityShiftCodeSelector(typeof(owner), typeof(date))]
