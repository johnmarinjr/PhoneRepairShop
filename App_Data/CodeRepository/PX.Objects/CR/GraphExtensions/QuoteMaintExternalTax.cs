...
namespace PX.Objects.CR
{
	public class QuoteMaintExternalTax : ExternalTaxBase<QuoteMaint, CRQuote>
	{
		...
		protected virtual void ApplyTax(CRQuote quote, GetTaxResult result)
		{
			...
			CalcCuryProductsAmount(quote, ref CuryProductsAmount);

			Base.Quote.SetValueExt<CRQuote.curyProductsAmount>(quote, CuryProductsAmount ?? 0m);
		}

		protected IAddressLocation GetFromAddress(CRQuote quote)
		{
		...
		protected IAddressLocation GetToAddress(CRQuote quote)
		{
