		...
		where TGraph : PXGraph
	{
		...
		protected virtual void _(Events.FieldUpdated<Document, Document.refContactID> e)
		{
			if (e.Row == null
				...
				|| Base.IsImport && Documents.View.Answer == WebDialogResult.None
			...
			Documents.View.Answer = MapDocumentDialogAnswers();
		...
		protected virtual WebDialogResult MapDocumentDialogAnswers()
		{
			switch (Documents.View.Answer)
			{
				...
				case WebDialogResult.Retry:
					return WebDialogResult.Retry;
				case WebDialogResult.Cancel:
				case WebDialogResult.Ignore:
					return WebDialogResult.Ignore;
				default:
					return Documents.View.Answer;
			}
		}
