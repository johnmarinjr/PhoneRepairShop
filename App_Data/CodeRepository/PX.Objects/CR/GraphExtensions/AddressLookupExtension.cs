...
namespace PX.Objects.CR.Extensions
{
		...
		where TAddress : class, IBqlTable, IAddressLocation, new()
	{
		...
		protected void AddAction(string name, string displayName, PXButtonDelegate handler, bool visible, bool? visibleOnDataSource = null)
		{
			...
			if (visibleOnDataSource.HasValue)
			{
				buttAttr.DisplayOnMainToolbar = visibleOnDataSource.Value;
			};
