...
namespace PX.Objects.CR
{
	...
	public static class Messages
	{
		...
		public const string NonBranchRequired = "You cannot select the {0} branch because the {1} case class does not allow selecting branches and employees for cases of the class.";
		public const string NonEmployeeRequired = "You cannot select the {0} employee because the {1} case class does not allow selecting an employee as a contact for cases of the class.";
		public const string EmployeeCaseClassMismatch = "The {0} case class cannot be changed because this case class is associated with at least one case.";
		public const string CaseClassOfEmployeeCase = "The {0} case class cannot be changed because this case class is associated with at least one case.";
        ...
        public const string ContractBAccountDiffer = "The {0} contact is not associated with the {1} business account.";
        public const string ContactBAccountDifferForEmployee = "The {0} employee is not assigned to the {1} branch.";
        public const string EmployeeNotAllowedForCaseClass = "You cannot select the {0} employee because the {0} case class does not allow selecting an employee as a contact for cases of the class.";
		...
		public const string ContactAssocRecordDiff = "The duplicate records cannot be merged because they are associated with different records.";
		public const string CannotMergeTwoCustomers = "The duplicate business accounts cannot be merged because they have the Customer type.";
	    ...
	    public const string ReplaceContactDetails = "Would you like the overridden settings on the Contact tab to be replaced with the settings from the newly selected entity?";
	    public const string ReplaceContactDetails_PM = "Would you like the overridden settings on the Billing Info tab to be replaced with the settings from the newly selected entity?";
		public const string ReplaceBillingAndShippingInfo = "Would you like the overridden settings on the Financial and Shipping tabs to be replaced with the settings from the newly selected entity?";
		public const string ReplaceContactDetailsAndBillingAndShippingInfo = "Would you like the overridden settings on the Contact, Financial, and Shipping tabs to be replaced with the settings from the newly selected entity?";
	    public const string ReplaceContactDetailsAndShippingInfo = "Would you like the overridden settings on the Contact and Shipping tabs to be replaced with the settings from the newly selected entity?";
	    public const string ReplaceContactDetailsAndShippingInfo_PM = "Would you like the overridden settings on the Billing Info and Shipping Info tabs to be replaced with the settings from the newly selected entity?";
	    public const string ReplaceBillingInfo = "Would you like the overridden settings on the Financial tab to be replaced with the settings from the newly selected entity?";
	    public const string ReplaceShippingInfo_PM = "Would you like the overridden settings on the Shipping Info tab to be replaced with the settings from the newly selected entity?";
	    public const string ReplaceShippingInfo = "Would you like the overridden settings on the Shipping tab to be replaced with the settings from the newly selected entity?";
		...
		public const string QuoteSubmittedReadonly = "One or more settings in the opportunity cannot be modified, because the primary quote status is other than Draft.";
		...
		public const string ValidationFailedError = "Validation failed.";
		public const string FillReqiredUDFAttributes = "Values must be specified for all required user-defined fields.";
		public const string LastNameOrFullNameReqired = "Last Name or Account Name (or both) should be filled in.";
		...
		public const string CompanyName = "Account Name";
		...
		public const string ConvertToSalesOrder = "Convert to Order";
	    public const string CreateQuote = "Create Quote";
	    public const string MarkAsPrimary = "Set As Primary";
		...
		public const string MarkAsDeclined = "Mark as Declined";
		public const string MarkAsConverted = "Mark as Converted";
		public const string Approve = "Approve";
		public const string Reject = "Reject";
		public const string RequestApproval = "Request Approval";
		public const string Edit = "Edit";
		public const string MarkAsAccepted = "Mark as Accepted";
		public const string SendQuote = "Send";
		...
		public const string ErrorSavingWithDuplicates = "The {0} cannot be saved because at least one duplicate has been found for this record.";
		public const string SureToSaveWithDuplicates = "At least one duplicate has been found. Do you want to save the record?";

		public const string EmailStatusUpdatedBeforeDeleting = "Mail Status set to Deleted";
		#endregion
		...
		public const string AccountLocationEmail = "Account Location Email";
		[Obsolete]
		public const string AccountShipToEmail1 = "Account Ship-To Email";
		...
		public const string ContactFullName = "Account Name";
		...
		public const string SalesQuote = "Quote";
        ...
        public const string BillToContact = "Bill-To Contact";
        public const string BillToAddress = "Bill-To Address";
		...
		//CRValidationRules
		public const string LeadToLeadValidation = "Lead to Lead";
		public const string LeadToContactValidation = "Lead to Contact";
		public const string ContactToContactValidation = "Contact to Contact";
		public const string ContactLeadValidation = "Contact to Lead";
		public const string LeadToAccountValidation = "Lead to Account";
		public const string ContactToAccountValidation = "Contact to Account";
		public const string AccountToAccountValidation = "Account to Account";
		...
		// Remind at
		public const string AtTheTimeOfEvent = "At the time of the event";
		public const string Before5minutes = "5 minutes before";
		public const string Before15minutes = "15 minutes before";
		public const string Before30minutes = "30 minutes before";
		public const string Before1hour = "1 hour before";
		public const string Before2hours = "2 hours before";
		public const string Before1day = "1 day before";
		public const string Before3days = "3 days before";
		public const string Before1week = "1 week before";
		#endregion
		...
		public const string CreateNewOpportunity = "Create Opportunity";
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		...
		public const string NoGramsDuringTurningOnDuplicateValidationFeature = "Validation scores have not been calculated for the existing leads, contacts, or business accounts. Before you start validating records for duplicates, calculate validation scores on the Calculate Grams (CR503400) form.";

		public const string AddNewCase = "Add Case";
		public const string CreateNewCase = "Create Case";
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		...
		public const string CreateActivity = "Create Activity";
		...
		public const string CreateTypedActivityFormat = "Create {0}";
		...
		public const string ConvertToInvoice = "Convert to Invoice";
