...
namespace PX.Objects.CM
{
								...
								PXSelectJoin<APHistoryByPeriod, 
									...
									InnerJoin<Branch,
										On<Branch.branchID, Equal<APHistoryByPeriod.branchID>,
											...
											Or<Current2<RevalueFilter.orgBAccountID>, IsNull, And<Not<FeatureInstalled<FeaturesSet.multipleBaseCurrencies>>>>>>>,
									InnerJoin<FinPeriod,
									...
									Where<APHistoryByPeriod.curyID, Equal<Current<RevalueFilter.curyID>>, 
										And2<Where2<Where<FinPeriod.masterFinPeriodID, Equal<Current<RevalueFilter.finPeriodID>>,
													And<Current2<RevalueFilter.orgBAccountID>, IsNull>>,
											Or<Where<FinPeriod.finPeriodID, Equal<Current<RevalueFilter.finPeriodID>>,
													And<Current2<RevalueFilter.orgBAccountID>, IsNotNull>>>>,
										And<Where<RevaluedAPHistory.curyFinYtdBalance, NotEqual<decimal0>, 
													Or<RevaluedAPHistory.finYtdBalance, NotEqual<decimal0>,
	...
	public partial class RevalueFilter : PX.Data.IBqlTable
	{
		...
		[PXFormula(typeof(GetOrganizationBaseCuryID<orgBAccountID>))]
		...
		[PXSelector(typeof(Search<Currency.curyID,
			Where<Currency.curyID, NotEqual<Current<organizationBaseCuryID>>,
				Or<Where<Current<organizationBaseCuryID>, IsNull,
					And<Not<Currency.curyID, EqualBaseCuryID<Current<AccessInfo.branchID>>>>>>>>))]
		...
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXDBBaseCury(curyID: typeof(organizationBaseCuryID))]
