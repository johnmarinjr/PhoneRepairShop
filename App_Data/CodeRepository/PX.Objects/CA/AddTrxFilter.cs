...
namespace PX.Objects.CA
{
	...
	public partial class AddTrxFilter : IBqlTable
	{
		...
		[LocationActive(typeof(Where<Location.bAccountID, Equal<Current<AddTrxFilter.referenceID>>>), DescriptionField = typeof(Location.descr))]
		...
		private static CATran CreateCATransaction(PXGraph graph, AddTrxFilter parameters, PXSelectBase<CurrencyInfo> currencyinfo, bool releaseTransaction)
		{
			...
			CM.Extensions.CurrencyInfo info = null;
			CurrencyInfo filterInfo = currencyinfo.Search<CurrencyInfo.curyInfoID>(parameters.CuryInfoID);
			if (filterInfo != null)
			{
				info = teMultiCurrency.currencyinfo.Insert(CM.Extensions.CurrencyInfo.GetEX(filterInfo));
			}
