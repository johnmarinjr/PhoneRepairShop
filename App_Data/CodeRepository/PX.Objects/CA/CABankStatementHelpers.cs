...
namespace PX.Objects.CA.BankStatementHelpers
{
	...
	public partial class CATranExt : CATran, IBankMatchRelevance
	{
		...
		#endregion
		#region CuryTranAmtCalc
		public abstract class curyTranAmtCalc : PX.Data.BQL.BqlDecimal.Field<curyTranAmtCalc> { }
		[PXCurrency(typeof(CATran.curyInfoID), typeof(CATranExt.tranAmtCalc))]
		[PXUIField(DisplayName = "Amount", Visibility = PXUIVisibility.Visible)]
		public virtual decimal? CuryTranAmtCalc
		{
			get;
			set;
		}
		#endregion
		#region TranAmtCalc
		public abstract class tranAmtCalc : PX.Data.BQL.BqlDecimal.Field<tranAmtCalc> { }
		[PXDecimal(4)]
		[PXUIField(DisplayName = "Tran. Amount")]
		public virtual decimal? TranAmtCalc
		{
			get;
			set;
		}
		...
		#endregion
		#region ReferenceID
		public abstract new class referenceID : PX.Data.BQL.BqlInt.Field<referenceID> { }
		#endregion
	}
