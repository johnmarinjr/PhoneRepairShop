...
namespace PX.Objects.CA
{
	...
	public partial class CABankTranAdjustment : IBqlTable, ICADocAdjust, IAdjustment
	{
		...
		[FinPeriodID(
			...
			AutoCalculateMasterPeriod = false)]
		...
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXUIField(DisplayName = "Invoice Amount", Visibility = PXUIVisibility.Visible, Visible = false, Enabled = false)]
		...
		[PXCurrency(typeof(adjdCuryInfoID), typeof(whTaxBal))]
		[PXUnboundDefault]
		...
		[PXCurrency(typeof(adjdCuryInfoID), typeof(adjgWOAmt))]
		...
		#endregion
		#region AdjgWOAmt
		public abstract class adjgWOAmt : PX.Data.BQL.BqlDecimal.Field<adjgWOAmt> { }

		[PXDecimal(4)]
		public virtual decimal? AdjgWOAmt
		{
			get;
			set;
		}
