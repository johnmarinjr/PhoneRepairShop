...
namespace PX.Objects.CA
{
	...
	[Serializable]
	[PXProjection(typeof(Select2<CATransfer,
		InnerJoin<CashAccount, On<CATransfer.outAccountID, Equal<CashAccount.cashAccountID>>,
		InnerJoin<Alias.CashAccountAlias, On<CATransfer.inAccountID, Equal<Alias.CashAccountAlias.cashAccountID>>>>>), Persistent = true)]
