...
namespace PX.Objects.CA
{
    [Serializable]
	[PXBreakInheritance]
	[PXCacheName(Messages.CABankTaxTran)]
	public partial class CABankTaxTran : TaxDetail, IBqlTable
	{
		#region Keys
		...
		[PXDBInt]
		[PXDefault(typeof(Search<Tax.taxVendorID, Where<Tax.taxID, Equal<Current<CABankTaxTran.taxID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		[FinPeriodID(branchSourceType: typeof(CABankTaxTran.branchID),
		...
		[PXDBDefaultBankTaxZone(typeof(CABankTran.taxZoneID))]
		...
		[PXDefault(typeof(Search<TaxRev.taxBucketID,
			Where<TaxRev.taxID, Equal<Current<CABankTaxTran.taxID>>,
				And<Current<CABankTaxTran.tranDate>, Between<TaxRev.startDate, TaxRev.endDate>,
				And2<Where<TaxRev.taxType, Equal<Current<CABankTaxTran.taxType>>,
						Or<TaxRev.taxType, Equal<TaxType.sales>,
					And<Current<CABankTaxTran.taxType>, Equal<TaxType.pendingSales>,
						Or<TaxRev.taxType, Equal<TaxType.purchase>,
						And<Current<CABankTaxTran.taxType>, Equal<TaxType.pendingPurchase>>>>>>,
