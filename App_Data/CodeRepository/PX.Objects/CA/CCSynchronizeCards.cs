...
namespace PX.Objects.CA
{
	public class CCSynchronizeCards : PXGraph<CCSynchronizeCards>
	{
		...
		public void CreateCustomerPaymentMethodRecord(CCSynchronizeCard item)
		{
			...
			customerPaymentMethodCache.SetValueExt<CustomerPaymentMethod.descr>(customerPM, item.CardNumber);
		...
		{
			syncCard.CardNumber = CCProcessingHelper.FormatMaskedCardNumber(cardNumber, CardType.GetDisplayName(syncCard.CardType));
		}
