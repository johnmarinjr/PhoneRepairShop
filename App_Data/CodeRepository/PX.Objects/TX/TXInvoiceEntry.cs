...
namespace PX.Objects.TX
{
	public class TXInvoiceEntry : APInvoiceEntry
	{
		...
		public TXInvoiceEntry()
		{
			...
			CN.ProjectAccounting.AP.GraphExtensions.APInvoiceEntryReclassifyingExt projectReclassifyingExtension = this.GetExtension<CN.ProjectAccounting.AP.GraphExtensions.APInvoiceEntryReclassifyingExt>();
			projectReclassifyingExtension?.reclassify.SetVisible(false);
			projectReclassifyingExtension?.reclassify.SetEnabled(false);
		}
		...
		where ToCuryInfoID : IBqlOperand 
	{
		public override object Evaluate(PXCache cache, object item, Dictionary<Type, object> pars)
		{
			...
			decimal val = orig_info.CuryConvBase(curyAmount.Value);
			return info.CuryConvCury(val);
		}
	}
