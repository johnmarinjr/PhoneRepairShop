...
namespace PX.Objects.TX
{
	public class RoundingManager
	{
		...
		public RoundingManager(PXGraph graph, int? vendorId, int taxReportRevisionID)
		{
			...
			_taxReportRevisionID = taxReportRevisionID;
		}

		public RoundingManager(Vendor vendor, int taxReportRevisionID)
		{
			this.vendor = vendor;
			_taxReportRevisionID = taxReportRevisionID;
		}
		...
		public int CurrentTaxReportRevisionID
		{
			get { return _taxReportRevisionID; }
		}
	...
	public partial class TaxPeriodFilter : IBqlTable
	{
		...
		[PXInt]
		[PXUnboundDefault]
		[PXSelector(typeof(Search4<TaxReport.revisionID, Where<TaxReport.vendorID, Equal<Current<TaxPeriodFilter.vendorID>>,
			And<TaxReport.validFrom, LessEqual<Current<TaxPeriodFilter.endDate>>>>, Aggregate<Max<TaxReport.validFrom>>, OrderBy<Desc<TaxReport.validFrom>>>))]
		public virtual Int32? TaxReportRevisionID { get; set; }
		#endregion
		#region RevisionID
		...
		[PXSelector(typeof(Search5<TaxHistory.revisionID,
											InnerJoin<Branch,
											 ...
											 Where<Branch.organizationID, Equal<Current2<TaxPeriodFilter.organizationID>>,
													...
													And<TaxHistory.taxReportRevisionID, Equal<Current2<TaxPeriodFilter.taxReportRevisionID>>,
	...
	[PXProjection(typeof(Select2<TaxTran,
			InnerJoin<TaxRev,
				On<
					TaxTran.taxID, Equal<TaxRev.taxID>,
					And<TaxRev.outdated, Equal<boolFalse>,
					And<TaxTran.taxType, Equal<TaxRev.taxType>,
					...
					And2<
						Where<CurrentValue<Vendor.taxReportFinPeriod>, Equal<boolTrue>, Or<TaxTran.tranDate, Less<CurrentValue<TaxPeriod.endDate>>>>,
						And<Where<CurrentValue<Vendor.taxReportFinPeriod>, Equal<boolFalse>, Or<TaxTran.finDate, Less<CurrentValue<TaxPeriod.endDate>>>>
			>>>>>>>>>>>>>>))]
	[PXHidden]
	public partial class TaxTranRevReport : PX.Data.IBqlTable
	{
		#region BranchID
		public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
		...
		public virtual Int32? TaxBucketID { get; set; }
		#endregion
		#region TaxZoneID
		...
		#endregion
		#region ExemptedAmt
		public abstract class exemptedAmt : PX.Data.BQL.BqlDecimal.Field<exemptedAmt> { }
		[PXDBDecimal(4, BqlField = typeof(TaxTran.exemptedAmt))]
		public virtual Decimal? ExemptedAmt { get; set; }
		#endregion
		#region CuryExemptedAmt
		public abstract class curyExemptedAmt : PX.Data.BQL.BqlDecimal.Field<exemptedAmt> { }
		...
		#region TaxPeriodID
		public abstract class taxPeriodID : PX.Data.BQL.BqlString.Field<taxPeriodID> { }
		[GL.FinPeriodID(BqlField = typeof(TaxTran.taxPeriodID))]
		public virtual String TaxPeriodID { get; set; }
		#endregion
		...
		#region TaxRevTaxVendorID
		public abstract class taxRevTaxVendorID : PX.Data.BQL.BqlInt.Field<taxRevTaxVendorID> { }
		[PXDBInt(BqlField = typeof(TaxRev.taxVendorID))]
		public virtual Int32? TaxRevTaxVendorID { get; set; }
		#endregion

		#region TaxRevTaxBucketID
		public abstract class taxRevTaxBucketID : PX.Data.BQL.BqlInt.Field<taxRevTaxBucketID> { }
		[PXDBInt(BqlField = typeof(TaxRev.taxBucketID))]
		public virtual Int32? TaxRevTaxBucketID { get; set; }
		#endregion
	}

	[PXProjection(typeof(Select2<TaxPeriodForReportShowing,
		InnerJoin<TaxReport,
			On<TaxReport.vendorID, Equal<TaxPeriodForReportShowing.vendorID>,
			And<Add<TaxPeriodForReportShowing.endDate, int_1>, Between<TaxReport.validFrom, TaxReport.validTo>>>,
		InnerJoin<TaxReportLine,
			On<TaxReportLine.vendorID, Equal<TaxPeriodForReportShowing.vendorID>,
			And<TaxReportLine.taxReportRevisionID, Equal<TaxReport.revisionID>>>,
	...
	[PXProjection(typeof(Select2<TaxPeriodForReportShowing,
							InnerJoin<TaxReport, On<TaxReport.vendorID, Equal<TaxPeriodForReportShowing.vendorID>,
								And<Add<TaxPeriodForReportShowing.endDate, int_1>, Between<TaxReport.validFrom, TaxReport.validTo>>>,
							InnerJoin<TaxReportLine,
								On<TaxReportLine.vendorID, Equal<TaxPeriodForReportShowing.vendorID>,
								And<TaxReportLine.taxReportRevisionID, Equal<TaxReport.revisionID>,
							...
							LeftJoin<TaxHistorySum,
								...
								And<TaxHistorySum.taxReportRevisionID, Equal<TaxReport.revisionID>,
	...
	[PXProjection(typeof(Select2<TaxPeriodEffective,
	 ...
	 InnerJoin<TaxBucketLine, On<TaxBucketLine.vendorID, Equal<TaxReportLine.vendorID>, 
		And<TaxBucketLine.taxReportRevisionID, Equal<TaxReportLine.taxReportRevisionID>, 
		And<TaxBucketLine.lineNbr, Equal<TaxReportLine.lineNbr>>>>,
	 CrossJoin<Company,
	 InnerJoin<Vendor,
	 ...
	 LeftJoin<CM.CurrencyRateByDate,
			 On<CM.CurrencyRateByDate.fromCuryID, Equal<CurrencyInfo.curyID>,
			 And<CM.CurrencyRateByDate.toCuryID, Equal<Vendor.curyID>,
			 And<CM.CurrencyRateByDate.curyRateType, Equal<Vendor.curyRateTypeID>,
			 And<CM.CurrencyRateByDate.curyEffDate, LessEqual<TaxTran.tranDate>,
					 And<Where<CM.CurrencyRateByDate.nextEffDate, Greater<TaxTran.tranDate>,
									 Or<CM.CurrencyRateByDate.nextEffDate, IsNull>>>
>>>>>>>>>>>>))]
	...
	public partial class TaxDetailReportCurrency : PX.Data.IBqlTable
	{
		...
		[PXDBDecimal(6, BqlField = typeof(CM.CurrencyRateByDate.curyRate))]
		...
		[PXDBString(1, BqlField = typeof(CM.CurrencyRateByDate.curyMultDiv))]
	...
	public class ReportTaxDetail : PXGraph<ReportTaxDetail>
	{
		...
		public PXSelect<TaxReportLine,
			Where<TaxReportLine.vendorID, Equal<Current<TaxHistoryMaster.vendorID>>,
				And<TaxReportLine.taxReportRevisionID, Equal<Current<TaxHistoryMaster.taxReportRevisionID>>,
		...
		public PXSelectJoin<TaxReportLine,
		  ...
		  InnerJoin<TaxTranReport,
			...
			Where<TaxReportLine.vendorID, Equal<Current<TaxHistoryMaster.vendorID>>,
				And2<Where<TaxReportLine.lineNbr, Equal<Current<TaxHistoryMaster.lineNbr>>,
						Or<TaxReportLine.tempLineNbr, Equal<Current<TaxHistoryMaster.lineNbr>>>>,
		...
		public virtual IEnumerable history_Detail()
		{
			...
			using (new PXReadBranchRestrictedScope(filterRow.OrganizationID.SingleToArray(), filterRow.BranchID.SingleToArrayOrNull()))
			{
				...
				var historyDetailsExpanded = History_Detail_Expanded.Select(filterRow.OrganizationID, filterRow.BranchID)
					.Where(row => ((TaxReportLine)row).TaxReportRevisionID == filterRow.TaxReportRevisionID);
		...
		protected virtual void TaxHistoryMaster_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			if (History_Header.Current != null && History_Header.Current.VendorID != null && string.IsNullOrEmpty(History_Header.Current.TaxPeriodID) == false)
			{
				...
				History_Header.Current.TaxReportRevisionID = (History_Header.Current.EndDate == null) ?
					null :
					TaxReportMaint.GetTaxReportVersionByDate(this, History_Header.Current.VendorID, History_Header.Current.EndDate.Value.AddDays(-1))?.RevisionID;
			}
			...
			if (History_Header.Current != null && History_Header.Current.VendorID != null)
			{
				...
				var taxReportLines =
					...
					.Select(this, History_Header.Current.TaxReportRevisionID);
	...
	public class ReportTaxReview : PXGraph<ReportTax>
	{
		...
		public PXSelectJoin<TaxReportLine,
					LeftJoin<TaxHistory,
						...
						And<TaxReportLine.taxReportRevisionID, Equal<TaxHistory.taxReportRevisionID>,
		...
		public PXSelectJoinGroupBy<TaxReportLine,
			...
			Aggregate<
				GroupBy<TaxReportLine.taxReportRevisionID,
		...
		protected virtual void TaxPeriodFilter_RowUpdated(PXCache sender, PXRowUpdatedEventArgs e)
		{
			...
			{
				TaxPeriod taxper = TaxYearMaint.FindTaxPeriodByKey(this, filter.OrganizationID, filter.VendorID, filter.TaxPeriodID);
				sender.SetValue<TaxPeriodFilter.taxReportRevisionID>(e.Row,
					(taxper == null) ? null :
					TaxReportMaint.GetTaxReportVersionByDate(this, filter.VendorID, (((DateTime)taxper.EndDate).AddDays(-1)))?.RevisionID);
			}
		}
...
#pragma warning disable PX1015
				// The two extra arguments passed to the BQL Select are required to avoid platfrom bug. 
				// Query cache doesn't take into consideration PXReadBranchRestrictedScope. See AC-57858 for more details
				return Period_Details_Expanded.Select(filter.OrganizationID, filter.BranchID).Where(row => ((TaxReportLine)row).TaxReportRevisionID == filter.TaxReportRevisionID)
	...
	public class ReportTax : PXGraph<ReportTax>
	{
		...
		public PXSelectReadonly2<TaxReportLine,
			LeftJoin<TaxBucketLine,
				...
				And<TaxBucketLine.taxReportRevisionID, Equal<TaxReportLine.taxReportRevisionID>,
				And<TaxBucketLine.lineNbr, Equal<TaxReportLine.lineNbr>>>>,
			LeftJoin<Currency, On<Currency.curyID, Equal<Current<Vendor.curyID>>>,
			LeftJoin<TaxTranRevReport,
				On<TaxTranRevReport.taxRevTaxVendorID, Equal<TaxBucketLine.vendorID>,
				And<TaxTranRevReport.taxRevTaxBucketID, Equal<TaxBucketLine.bucketID>,
				And<Where<TaxReportLine.taxZoneID, IsNull,	And<TaxReportLine.tempLine, Equal<boolFalse>, Or<TaxReportLine.taxZoneID, Equal<TaxTranRevReport.taxZoneID>>>>>>
			>>>>,
			Where<TaxReportLine.vendorID, Equal<Current<TaxPeriodFilter.vendorID>>>,
			OrderBy<
		...
		protected virtual void TaxPeriodFilter_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			if (allowProcess && filter.TaxReportRevisionID == null)
			{
				sender.RaiseExceptionHandling<TaxPeriodFilter.taxPeriodID>(filter, taxPeriodIDForMessage,
						new PXSetPropertyException(Messages.TaxReportVersionIsNotFound,
		...
		protected virtual IEnumerable period_Details()
		{
			...
			using (new PXFieldScope(Period_Details_Expanded.View,
					...
					typeof(TaxTranRevReport.taxAmt), typeof(TaxTranRevReport.curyTaxAmt),
					typeof(TaxTranRevReport.taxableAmt), typeof(TaxTranRevReport.curyTaxableAmt),
					typeof(TaxTranRevReport.exemptedAmt), typeof(TaxTranRevReport.curyExemptedAmt),
			...
			using (new PXReadBranchRestrictedScope(filter.OrganizationID.SingleToArray(), filter.BranchID.SingleToArrayOrNull()))
			{
				var results = Period_Details_Expanded
				  .Select().AsEnumerable().Where(row => ((TaxReportLine)row).TaxReportRevisionID == filter.TaxReportRevisionID)
				  .Where(line => ShowTaxReportLine(line.GetItem<TaxReportLine>(), Period_Header.Current.TaxPeriodID));

				var trans = results.RowCast<TaxTranRevReport>();
				...
				foreach (PXResult<TaxReportLine, TaxBucketLine, Currency, TaxTranRevReport> res in results)
				{
					TaxReportLine line = res;
					TaxTranRevReport tran = res;
					Currency cury = res;
					CM.CurrencyRate rate = tran.TranDate != null && provideRates == true ? ratesProvider.GetRate(tran.CuryID, tran.TranDate.Value) : null;

					if ((prev_line?.VendorID == line?.VendorID && prev_line?.LineNbr == line?.LineNbr && prev_line?.TaxReportRevisionID == line?.TaxReportRevisionID) == false || hist == null)
					{
						if (hist != null)
						{
						...
						hist = new TaxHistory
						{
							...
							TaxPeriodID = filter.TaxPeriodID,
							UnfiledAmt = 0m,
							ReportUnfiledAmt = 0m,
						...
						tran.TaxType != TaxType.PendingPurchase)
					{
						...
						GetReportTranAmt(line, tran, out decimal tranAmt, out decimal curyTranAmt);
						...
						hist.UnfiledAmt += HistMult * tranAmt;
							...
							(cury.CuryID == tran.CuryID
								...
								: cury.CuryID == company.Current.BaseCuryID || cury.CuryID == null || rate == null
									? tranAmt
									: TaxHistorySumManager.RecalcCurrency(cury.DecimalPlaces, rate, curyTranAmt));
						}
			...
			ret = (vendor != null && vendor.TaxUseVendorCurPrecision != true) ?
				TaxHistorySumManager.GetPreviewReport(this, vendor, (int) filter.TaxReportRevisionID, ret, (line) => ShowTaxReportLine(line, filter.TaxPeriodID)) : ret;
		...
		public virtual IEnumerable FileTax(PXAdapter adapter)
		{
			...
			TaxReportMaint.TaxBucketAnalizer.CheckTaxAgencySettings(this, p.VendorID == null ? 0 : (int)p.VendorID, (int) p.TaxReportRevisionID);
		...
		public static void FileTaxProc(TaxPeriodFilter p)
		{
			...
			docgraph.Period_Header.Current.TaxReportRevisionID = p.TaxReportRevisionID;
	...
	public class ReportTaxProcess : PXGraph<ReportTaxProcess>
	{
		...
		private void SegregateBatch(JournalEntry je, int? BranchID, string CuryID, DateTime? DocDate, string FinPeriodID, string description)
		{
				...
				!object.Equals(apbatch.FinPeriodID, FinPeriodID))
			{
				...
				je.BatchModule.Insert(new Batch
				{
					BranchID = BranchID,
					Module = "GL",
					Status = "U",
				...
				CM.CurrencyInfo b_info = PXSelect<CM.CurrencyInfo, Where<CurrencyInfo.curyInfoID, Equal<Current<Batch.curyInfoID>>>>.Select(je, null);
		...
		private void UpdateHistory(TaxTran tran, TaxReportLine line)
		{
			...
			if (hist == null)
			{
				...
				hist.TaxReportRevisionID = line.TaxReportRevisionID;
			...
			using (new PXConnectionScope())
			{
				using (PXTransactionScope ts = new PXTransactionScope())
				{
					RoundingManager rmanager = new RoundingManager(this, doc.VendorID,
						(TaxHistory_Current.Current?.TaxReportRevisionID == null) ? 0 : (int)TaxHistory_Current.Current.TaxReportRevisionID.Value);
				...
				using (new PXReadBranchRestrictedScope(p.OrganizationID.SingleToArray(), _branches, requireAccessForAllSpecified:true))
				{
					taxHistories = PXSelectJoinGroupBy<TaxHistory,
						...
						Where<TaxHistory.vendorID, Equal<Required<TaxHistory.vendorID>>,
							And<TaxHistory.taxPeriodID, Equal<Required<TaxHistory.taxPeriodID>>,
							And<TaxHistory.revisionID, Equal<Required<TaxHistory.revisionID>>,
							And<TaxHistory.taxReportRevisionID, Equal<Required<TaxHistory.taxReportRevisionID>>>>>>,
						Aggregate<GroupBy<TaxHistory.vendorID,
							...
							GroupBy<TaxReportLine.netTax,
											Sum<TaxHistory.filedAmt>>>>>>>>>>
										.Select(docgraph, p.VendorID, p.TaxPeriodID, p.RevisionId, p.TaxReportRevisionID).AsEnumerable()
				...
				foreach (PXResult<TaxHistory, TaxReportLine> res in taxHistories)
				{
						...
						&& vendor.AutoGenerateTaxBill == true)
					{
						...
						APTran new_aptran = new APTran
						{
							...
							SubID = hist.SubID,
							LineAmt = hist.FiledAmt,
							CuryLineAmt = hist.ReportFiledAmt,
							TranAmt = hist.FiledAmt,
							CuryTranAmt = hist.ReportFiledAmt,
							TranDesc = string.IsNullOrEmpty(line.TaxZoneID)
				...
				if (tranlist.Count > 0)
				{
					foreach (KeyValuePair<int?, KeyValuePair<APInvoice, List<APTran>>> pair in tranlist)
					{
						...
						if (PXAccess.FeatureInstalled<FeaturesSet.multicurrency>())
						{
							...
							{
								new_info.BaseCuryID = PXOrgAccess.GetBaseCuryID(p.OrgBAccountID);
								new_info.BaseCalc = object.Equals(new_info.CuryID, new_info.BaseCuryID);
							}
							else
							{
		...
		public virtual string FileTaxProc(TaxPeriodFilter filter)
		{
			...
			using (new PXConnectionScope())
			{
				using (PXTransactionScope ts = new PXTransactionScope())
				{
					...
					RoundingManager rmanager = new RoundingManager(this, taxPeriod.VendorID, (int) filter.TaxReportRevisionID);
					...
					using (new PXReadBranchRestrictedScope(filter.OrganizationID.SingleToArray(), _branches, requireAccessForAllSpecified: true))
					{
						foreach (PXResult<TaxReportLine, TaxBucketLine, TaxTranReport> res
								in Period_Details_Expanded.Select(revisionId, taxPeriod.TaxPeriodID, taxPeriod.VendorID, filter.TaxReportRevisionID).AsEnumerable()
			...
			using (new PXReadBranchRestrictedScope(organizationID.SingleToArray(), branchIDs, requireAccessForAllSpecified: true))
			{
				...
				if (tax != null)
				{
					ARInvoice doc = PXSelectJoin<
						...
						InnerJoin<ARTaxTran,
							On<ARTaxTran.refNbr, Equal<ARInvoice.refNbr>,
							And<ARTaxTran.tranType, Equal<ARInvoice.docType>>>>>,
						...
						.SelectSingleBound(graph, null, endDate, tax.TaxID);
			...
			using (new PXReadBranchRestrictedScope(organizationID.SingleToArray(), branchIDs, requireAccessForAllSpecified: true))
			{
				...
				if (tax != null)
				{
					APInvoice doc = PXSelectJoin<
						...
						InnerJoin<APTaxTran,
							On<APTaxTran.refNbr, Equal<APInvoice.refNbr>,
