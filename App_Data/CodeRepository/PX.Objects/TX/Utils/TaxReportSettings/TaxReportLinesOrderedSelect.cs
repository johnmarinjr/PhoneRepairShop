...
namespace PX.Objects.TX
{
	...
	public class TaxReportLinesOrderedSelect :
		PXOrderedSelect<TaxReport, TaxReportLine,
				...
				Asc<TaxReportLine.taxZoneID>>>>
	{
		...
		{
			TaxReport vendorMaster = taxReportGraph.Report.Current;
			...
			var detailLinesGroupedByMainLines =
				...
				.Select(taxReportGraph, vendorMaster.VendorID, mainLines.Keys.ToArray())
