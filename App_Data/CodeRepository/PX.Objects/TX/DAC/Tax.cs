...
namespace PX.Objects.TX
{
	...
	#region Two
	public sealed class Two : Constant<int>
	{
		public Two() : base(2) { }
	}
	#endregion
	...
	public partial class Tax : PX.Data.IBqlTable
	{
		...
		{
			/// <summary>
			/// define tax description maximum length.
			/// </summary>
		...
		/// </summary>
		[PXDBLocalizableString(descr.MaxLength, IsUnicode = true)]
		...
		[PXFormula(typeof(Substring<taxCalcRule, Two, One>))]
