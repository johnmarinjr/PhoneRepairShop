...
namespace PX.Objects.TX
{
	...
	public static class Messages
	{
		...
		public const string TaxReportVersionIsNotFound = "A tax report cannot be prepared for the selected company and tax agency because the report version for the {0} tax period has not been found in the system.";
		...
		public const string TheTaxReportSettingsCannotBeModified = "The report version cannot be modified because there is a prepared tax report in the system for the selected tax agency. You need to release or void the prepared tax report before modifying the settings.";
		...
		public const string NoLinesByTaxZone = "Tax zones cannot be updated. The report version does not have report lines with the Detail by Tax Zones check box selected.";
		...
		public const string TaxSetttigModeOnlyWhenNetGrossIsOff = "The Tax Calculation Mode field can have only the Tax Settings (T) value because the Net/Gross Entry Mode feature is disabled.";
		public const string InvalidTaxCalculationMode = "The Tax Calculation Mode field can have only the Tax Settings (T), Net (N), and Gross (G) values.";

		public const string ValidDateIntersectHistory = "A report version with the specified date cannot be created. There is a prepared report for the {0} tax period for the {1} tax agency.";
		public const string ValidDateIntersectOtherReportVersion = "The {0} report version already exists for the specified date for the {1} tax agency.";
		public const string ValidDateBeforeExistingReportVersion = "The {0} report version is already valid from {1}. You cannot add a new report version with a date earlier than the date of the {0} version.";
		public const string ReportVerionHasHistory = "The report version has history and cannot be deleted.";
		#endregion
		...
		public const string DeleteReportVerionAsk = "The current report version will be deleted.";
		public const string DeleteNotificationHeader = "Delete Notification";
		public const string RedirectUnsavedDataNotification = "You will be redirected to another page, all unsaved data will be lost. Continue?";
		...
		public const string CreateReportVerion = "Add New Version";
		public const string CopyReportVerion = "Copy Version";
		public const string DeleteReportVerion = "Delete Version";
		#endregion
		...
		public const string ExternalTaxProviderCannotBeSelectedOnLine = "The external tax provider cannot be manually selected on the blanket sales order line. To calculate taxes via an external tax provider, select a tax zone in the Customer Tax Zone box on the Financial tab.";
