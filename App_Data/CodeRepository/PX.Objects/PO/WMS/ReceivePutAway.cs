...
namespace PX.Objects.PO.WMS
{
	...
	public partial class ReceivePutAway : WMSBase
	{
		...
		public
			...
			Where<
				POReceiptLineSplit.receiptType.IsEqual<RPAScanHeader.receiptType.FromCurrent>.
				And<POReceiptLineSplit.receiptNbr.IsEqual<WMSScanHeader.refNbr.FromCurrent>>>.
			OrderBy<
