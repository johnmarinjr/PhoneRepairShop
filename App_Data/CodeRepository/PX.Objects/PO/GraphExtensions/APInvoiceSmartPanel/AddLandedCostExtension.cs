		...
		protected virtual IEnumerable landedCostDetailsAdd()
		{
			PXSelectBase<POLandedCostDetailS> cmd = new PXSelectJoinGroupBy<POLandedCostDetailS,
				InnerJoin<POLandedCostDoc, On<POLandedCostDetailS.docType, Equal<POLandedCostDoc.docType>, And<POLandedCostDetailS.refNbr, Equal<POLandedCostDoc.refNbr>>>,
						...
						LeftJoin<POReceiptLine, On<POLandedCostReceiptLine.FK.ReceiptLine>>>>,
				...
				And<POLandedCostDoc.curyID, Equal<Current<APRegister.curyID>>,
					...
					And2<Where<Current<POLandedCostDetailFilter.receiptType>, IsNull,
						Or<Current<POLandedCostDetailFilter.receiptType>, Equal<POReceiptType.all>,
						Or<Current<POLandedCostDetailFilter.receiptType>, Equal<POLandedCostReceiptLine.pOReceiptType>>>>,
					And2<Where<Current<POLandedCostDetailFilter.receiptNbr>, IsNull,
						Or<Current<POLandedCostDetailFilter.receiptNbr>, Equal<POLandedCostReceiptLine.pOReceiptNbr>>>,
