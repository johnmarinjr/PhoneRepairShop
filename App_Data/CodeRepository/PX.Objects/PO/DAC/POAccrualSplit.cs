...
namespace PX.Objects.PO
{
	...
	public class POAccrualSplit : IBqlTable
	{
		...
		{
			public static POAccrualSplit Find(PXGraph graph, string aPDocType, string aPRefNbr, int? aPLineNbr, string pOReceiptType, string pOReceiptNbr, int? pOReceiptLineNbr)
				=> FindBy(graph, aPDocType, aPRefNbr, aPLineNbr, pOReceiptType, pOReceiptNbr, pOReceiptLineNbr);
		}
