...
namespace PX.Objects.PO
{
	...
	public partial class POOrderReceipt : PX.Data.IBqlTable
	{
		...
		{
			public static POOrderReceipt Find(PXGraph graph, string receiptType, string receiptNbr, string pOType, string pONbr) => FindBy(graph, receiptType, receiptNbr, pOType, pONbr);
		}
	...
	public partial class POOrderReceiptLink : POOrderReceipt
	{
		...
		{
			public static POOrderReceiptLink Find(PXGraph graph, string receiptType, string receiptNbr, string pOType, string pONbr) => FindBy(graph, receiptType, receiptNbr, pOType, pONbr);
		}
