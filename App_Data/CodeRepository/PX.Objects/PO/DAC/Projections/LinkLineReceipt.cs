	...
	[PXProjection(typeof(
		Select2<POReceiptLine,
			...
			LeftJoin<POOrderReceiptLink,
				On<POOrderReceiptLink.receiptType, Equal<POReceiptLine.receiptType>,
				And<POOrderReceiptLink.receiptNbr, Equal<POReceiptLine.receiptNbr>,
				And<POOrderReceiptLink.pOType, Equal<POReceiptLine.pOType>,
				And<POOrderReceiptLink.pONbr, Equal<POReceiptLine.pONbr>>>>>,
			...
			Where2<
				Where<POReceiptLine.pOType, In3<POOrderType.regularOrder, POOrderType.dropShip, POOrderType.projectDropShip>, Or<POReceiptLine.pOType, IsNull>>,
