...
namespace PX.Objects.PO
{
	...
	public partial class POOrderPOReceipt : IBqlTable
	{
		...
		{
			public static POOrderPOReceipt Find(PXGraph graph, string receiptType, string receiptNbr, string pOType, string pONbr) => FindBy(graph, receiptType, receiptNbr, pOType, pONbr);
		}
