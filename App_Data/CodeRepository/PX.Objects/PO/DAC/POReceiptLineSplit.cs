...
namespace PX.Objects.PO
{
	...
	public partial class POReceiptLineSplit : PX.Data.IBqlTable, ILSDetail
	{
		...
		{
			public static POReceiptLineSplit Find(PXGraph graph, string receiptType, string receiptNbr, int? lineNbr, int? splitLineNbr)
				=> FindBy(graph, receiptType, receiptNbr, lineNbr, splitLineNbr);
		}
