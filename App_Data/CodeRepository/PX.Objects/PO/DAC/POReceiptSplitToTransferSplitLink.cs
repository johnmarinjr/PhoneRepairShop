	...
	public class POReceiptSplitToTransferSplitLink : IBqlTable
	{
		...
		public class PK : PrimaryKeyOf<POReceiptSplitToTransferSplitLink>.By<receiptType, receiptNbr, receiptLineNbr, receiptSplitLineNbr, transferDocType, transferRefNbr, transferLineNbr, transferSplitLineNbr>
		{
			public static POReceiptSplitToTransferSplitLink Find(PXGraph graph, 
				string receiptType, string receiptNbr, int? receiptLineNbr, int? receiptSplitLineNbr, 
				string transferDocType, string transferRefNbr, int? transferLineNbr, int? transferSplitLineNbr)
				=> FindBy(graph, receiptType, receiptNbr, receiptLineNbr, receiptSplitLineNbr, transferDocType, transferRefNbr, transferLineNbr, transferSplitLineNbr);
		}
