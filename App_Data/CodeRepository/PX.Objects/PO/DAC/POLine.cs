...
namespace PX.Objects.PO
{
	...
	public partial class POLine : PX.Data.IBqlTable, IItemPlanMaster, ISortOrder, ITaxableDetail, IMatrixItemLine, ICommitmentSource
	{
		...
		[PXDBString(1)]
		[PXDefault(typeof(POOrder.dropshipReceiptProcessing), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		[PXDBString(1)]
		[PXDefault(typeof(POOrder.dropshipExpenseRecording), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		/// </summary>
		[PXDBBool()]
		[PXDefault(typeof(Switch<Case<Where<POLine.orderType, Equal<POOrderType.projectDropShip>>, False>, IsNull<Selector<POLine.inventoryID, InventoryItem.accrueCost>, False>>))]
		...
		[POSiteAvail(typeof(POLine.inventoryID), typeof(POLine.subItemID), DocumentBranchType = typeof(POOrder.branchID))]
		[PXDefault(typeof(Coalesce<
				...
				Search<InventoryItemCurySettings.dfltSiteID,
					Where<InventoryItemCurySettings.inventoryID, Equal<Current<POLine.inventoryID>>,
		...
		[PXDefault(typeof(Search<INItemCost.lastCost,
			Where<INItemCost.inventoryID, Equal<Current<POLine.inventoryID>>,
				And<INItemCost.curyID, EqualBaseCuryID<Current2<POLine.branchID>>>>>))]
		...
		[PXDBPriceCostCalced(typeof(Switch<Case<Where<POLine.discPct, NotEqual<decimal0>>, Mult<POLine.curyUnitCost, Sub<decimal1, Div<discPct, decimal100>>>,
										   ...
										   Div<Sub<POLine.curyLineAmt, POLine.curyDiscAmt>, POLine.orderQty>>),
		...
		[PXPriceCost]
		[PXDBPriceCostCalced(typeof(Switch<Case<Where<POLine.orderQty, Equal<decimal0>>, decimal0>, Div<POLine.lineAmt, POLine.orderQty>>),
			typeof(Decimal), CastToScale = 9, CastToPrecision = 25)]
	...
	public static class POLineType
	{
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute() : base(
				new[]
				{
					...
					Pair(GoodsForProject, Messages.GoodsForProject),
					Pair(NonStockForProject, Messages.NonStockForProject),
		...
		public class goodsForProject : PX.Data.BQL.BqlString.Constant<goodsForProject>
		{
			public goodsForProject() : base(GoodsForProject) {; }
		}

		public class nonStockForProject : PX.Data.BQL.BqlString.Constant<nonStockForProject>
		{
			public nonStockForProject() : base(NonStockForProject) {; }
		}
		...
		{
			return lineType == POLineType.Service;
		}
		...
		public static bool IsProjectDropShip(string lineType) 
		{
			return lineType == POLineType.GoodsForProject ||
				lineType == POLineType.NonStockForProject;
		}
