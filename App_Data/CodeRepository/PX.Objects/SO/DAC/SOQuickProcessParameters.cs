...
{
	using OrderTypeRequiresShipping = Where<SOOrderType.behavior.FromCurrent.IsIn<SOBehavior.sO, SOBehavior.tR>>;
	using OrderTypeRequiresInvoicing = Where<SOOrderType.behavior.FromCurrent.IsIn<SOBehavior.sO, SOBehavior.iN, SOBehavior.cM>.
	...
	public class SOQuickProcessParameters : IBqlTable
	{
		...
		[PXQuickProcess.Step.IsStartPoint(typeof(Where<Current<SOOrderType.behavior>, In3<SOBehavior.iN, SOBehavior.cM>>))]
