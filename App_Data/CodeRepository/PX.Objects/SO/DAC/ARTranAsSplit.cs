...
namespace PX.Objects.SO
{
	...
	public class ARTranAsSplit : IBqlTable, IN.ILSDetail
	{
		...
		[IN.SiteAvail(typeof(ARTranAsSplit.inventoryID), typeof(ARTranAsSplit.subItemID), BqlField = typeof(AR.ARTran.siteID), DocumentBranchType = typeof(AR.ARInvoice.branchID))]
