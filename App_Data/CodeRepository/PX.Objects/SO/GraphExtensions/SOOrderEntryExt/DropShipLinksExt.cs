...
namespace PX.Objects.SO.GraphExtensions.SOOrderEntryExt
{
	public class DropShipLinksExt : PXGraphExtension<PurchaseSupplyBaseExt, SOOrderEntry>
	{
		...
		public virtual void _(Events.RowUpdated<SOLine> e)
		{
			...
			{
				DropShipLink link = Base1.GetDropShipLink(e.OldRow);
				if (link != null)
				{
		...
		public virtual void _(Events.RowSelected<SOOrder> e)
		{
			...
			Base.Transactions.Cache.Adjust<PXUIFieldAttribute>()
				.For<SOLine.pOOrderStatus>(fa => fa.Visible = Base.soordertype.Current.RequireShipping ?? false)
				.SameFor<SOLine.pOOrderType>()
				.SameFor<SOLine.pOOrderNbr>()
				.SameFor<SOLine.pOLineNbr>()
				.SameFor<SOLine.pOLinkActive>();
		}
