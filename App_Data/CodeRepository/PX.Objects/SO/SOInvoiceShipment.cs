...
namespace PX.Objects.SO
{
	...
	public class SOInvoiceShipment : PXGraph<SOInvoiceShipment>
	{
		...
		public virtual void SOShipmentFilter_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			PXUIFieldAttribute.SetVisible<SOShipmentFilter.showPrinted>(sender, filter, filter.Action.IsIn(PrintShipmentConfirmation, PrintLabels, PrintPickList));
				...
				case CreateDropshipInvoice:
				{
					cmd = new
						...
						Where<
							...
							And<POReceipt.receiptType.IsEqual<
								Use<Switch<Case<Where<SOOrderShipment.operation.IsEqual<SOOperation.receipt>>, POReceiptType.poreturn>, POReceiptType.poreceipt>>.AsString>>.
							//And<
