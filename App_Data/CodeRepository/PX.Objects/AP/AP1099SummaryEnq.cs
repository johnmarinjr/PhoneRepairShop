...
namespace PX.Objects.AP
{
	...
	public class AP1099SummaryEnq : PXGraph<AP1099SummaryEnq>
	{
		...
		protected virtual void AP1099Year_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			reopen1099Year.SetEnabled(!string.IsNullOrEmpty(year1099.FinYear) 
				&& year1099.Status == AP1099Year.status.Closed
		...
		[PXProcessButton(Category = ActionCategories.Processing, DisplayOnMainToolbar = true)]
