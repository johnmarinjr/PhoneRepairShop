        ...
        private bool VerifyItem(int? inventoryID)
        {
            ...
            if (Sequence.Current.IsPromotion == true)
            {
                ...
                existing = PXSelectReadonly2<DiscountItem,
                                        InnerJoin<VendorDiscountSequence, On<DiscountItem.discountID, Equal<VendorDiscountSequence.discountID>,
                                            And<DiscountItem.discountSequenceID, Equal<VendorDiscountSequence.discountSequenceID>,
                                            And<VendorDiscountSequence.discountSequenceID, NotEqual<Current<VendorDiscountSequence.discountSequenceID>>>>>>,
                                        Where<DiscountItem.discountID, Equal<Current<VendorDiscountSequence.discountID>>,
        ...
        private bool VerifyInventoryPriceClass(string priceClassID)
        {
            ...
            if (Sequence.Current.IsPromotion == true)
            {
                ...
                existing = PXSelectReadonly2<DiscountInventoryPriceClass,
                                        InnerJoin<VendorDiscountSequence, On<DiscountInventoryPriceClass.discountID, Equal<VendorDiscountSequence.discountID>,
                                            And<DiscountInventoryPriceClass.discountSequenceID, Equal<VendorDiscountSequence.discountSequenceID>,
                                            And<VendorDiscountSequence.discountSequenceID, NotEqual<Current<VendorDiscountSequence.discountSequenceID>>>>>>,
                                        Where<DiscountInventoryPriceClass.discountID, Equal<Current<VendorDiscountSequence.discountID>>,
        ...
        private bool VerifyLocation(int? locationID)
        {
            ...
            if (Sequence.Current.IsPromotion == true)
            {
                ...
                existing = PXSelectReadonly2<APDiscountLocation,
                                        InnerJoin<VendorDiscountSequence, On<APDiscountLocation.discountID, Equal<VendorDiscountSequence.discountID>,
                                            And<APDiscountLocation.discountSequenceID, Equal<VendorDiscountSequence.discountSequenceID>,
                                            And<VendorDiscountSequence.discountSequenceID, NotEqual<Current<VendorDiscountSequence.discountSequenceID>>>>>>,
