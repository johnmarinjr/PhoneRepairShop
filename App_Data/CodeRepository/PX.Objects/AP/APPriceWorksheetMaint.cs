...
namespace PX.Objects.AP
{
       ...
       protected virtual decimal AdjustByUOM(InventoryItem inventoryItem, APPriceWorksheetDetail worksheetDetail, decimal correctedAmtInBaseUnit)
		...
		private decimal GetItemPrice(int? inventoryID, string toCuryID, DateTime? curyEffectiveDate)
        {
            ...
            return itemPrice == null
                ? 0m
                : ConvertSalesPrice(this, new CMSetupSelect(this).Current.APRateTypeDflt, Accessinfo.BaseCuryID,
        ...
        {
            var itemCurySettings = InventoryItemCurySettings.PK.Find(this, inventoryItem.InventoryID, Accessinfo.BaseCuryID);
            return itemCurySettings?.BasePrice;
        }
		...
		public virtual bool PrepareImportRow(string viewName, IDictionary keys, IDictionary values)
		{
			if (viewName.Equals(Details.View.Name, StringComparison.InvariantCultureIgnoreCase) && !DontUpdateExistRecords)
			{
				...
				APPriceWorksheetDetail duplicate = null;

				try
				{
					duplicate = DuplicateFinder.Find(values);
				}
	...
	//TODO: Rename this class in one of the major updates to APAddItemSelected to eliminate confusion with the AR.ARAddItemSelected class
