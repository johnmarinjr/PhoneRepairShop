		...
		void I1099Record.WriteToFile(StreamWriter writer, YearFormat yearFormat)
		{
			...
			if (yearFormat == YearFormat.F2020)
			{
				dataRow
					...
					.Append(string.Empty, startPosition: 304, fieldLength: 196)
					.Append(RecordSequenceNumber, startPosition: 500, fieldLength: 8, paddingStyle: PaddingEnum.Left, paddingChar: '0')
					.Append(string.Empty, startPosition: 508, fieldLength: 199)
					.Append(StateIncomeTaxWithheldTotal, startPosition: 707, fieldLength: 18, paddingStyle: PaddingEnum.Left, paddingChar: '0')
					.Append(LocalIncomeTaxWithheldTotal, startPosition: 725, fieldLength: 18, paddingStyle: PaddingEnum.Left, paddingChar: '0')
					.Append(string.Empty, startPosition: 743, fieldLength: 4)
					.Append(CombinedFederalOrStateCode, startPosition: 747, fieldLength: 2)
			...
			else
			{
				dataRow
					...
					.Append(string.Empty, startPosition: 340, fieldLength: 160)
					.Append(RecordSequenceNumber, startPosition: 500, fieldLength: 8, paddingStyle: PaddingEnum.Left, paddingChar: '0')
					.Append(string.Empty, startPosition: 508, fieldLength: 199)
					.Append(StateIncomeTaxWithheldTotal, startPosition: 707, fieldLength: 18, paddingStyle: PaddingEnum.Left, paddingChar: '0')
					.Append(LocalIncomeTaxWithheldTotal, startPosition: 725, fieldLength: 18, paddingStyle: PaddingEnum.Left, paddingChar: '0')
