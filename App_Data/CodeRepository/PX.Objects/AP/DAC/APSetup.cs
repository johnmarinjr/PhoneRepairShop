...
namespace PX.Objects.AP
{
	...
	public partial class APSetup : IBqlTable
	{
		...
		#region PrintDirectSalesOn
		public abstract class printDirectSalesOn : PX.Data.BQL.BqlShort.Field<printDirectSalesOn>
		{
			public class ListAttribute : PXStringListAttribute
			{
				public ListAttribute() : base(
					new string[] { MISC_Always, NEC_Always, MISC_if_Filed, NEC_if_Filed },
					new string[] { "Form 1099-MISC Always", "Form 1099-NEC Always", "Form 1099-MISC if Filed for Payee", "Form 1099-NEC if Filed for Payee" }
					)
				{ }
			}
		...
		[printDirectSalesOn.List]
		[PXDefault(printDirectSalesOn.MISC_Always)]
