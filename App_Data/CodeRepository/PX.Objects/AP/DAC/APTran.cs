...
namespace PX.Objects.AP
{
	...
	public partial class APTran : IBqlTable, DR.Descriptor.IDocumentLine, ISortOrder, ITaxableDetail, IAccountable
	{
		...
		public static class FK
		{
			...
			public class POReceipt : PO.POReceipt.PK.ForeignKeyOf<APTran>.By<receiptType, receiptNbr> { }
			public class POReceiptLine : PO.POReceiptLine.PK.ForeignKeyOf<APTran>.By<receiptType, receiptNbr, receiptLineNbr> { }
		...
		[PXSelector(typeof(Search<POReceipt.receiptNbr, Where<POReceipt.receiptType.IsEqual<receiptType.FromCurrent>>>))]
		...
		[PXDefault(typeof(Search<INItemCost.lastCost,
			Where<INItemCost.inventoryID, Equal<Current<APTran.inventoryID>>,
				And<INItemCost.curyID, EqualBaseCuryID<Current2<APRegister.branchID>>>>>))]
