namespace PX.Objects.AP
{
	...
	[PXHidden]
	[Serializable]
	public partial class APHistoryAlias : APHistory
	{
		#region Keys
		public new class PK : PrimaryKeyOf<APHistoryAlias>.By<branchID, accountID, subID, vendorID, finPeriodID>
		{
			public static APHistoryAlias Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? vendorID, String finPeriodID) => FindBy(graph, branchID, accountID, subID, vendorID, finPeriodID);
		}
		public new static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<APHistoryAlias>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<APHistoryAlias>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<APHistoryAlias>.By<subID> { }
			public class Vendor : AR.Customer.PK.ForeignKeyOf<APHistoryAlias>.By<vendorID> { }
		}
		#endregion
