...
namespace PX.Objects.AP
{
	...
	public class APPayment : APRegister, CM.IInvoice, IPrintCheckControlable, IAssign, IApprovable, IApprovalDescription, IReserved
	{
		#region Keys
		...
		[APContact(typeof(Select2<Location,
							...
							InnerJoin<
									Contact, On<Contact.contactID, Equal<Location.vRemitContactID>,
								    And<
		...
		public abstract class batchPaymentRefNbr : IBqlField { }
