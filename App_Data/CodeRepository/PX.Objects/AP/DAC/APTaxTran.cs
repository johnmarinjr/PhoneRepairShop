...
namespace PX.Objects.AP
{
	...
	/// </summary>
	[Serializable]
	[PXProjection(typeof(SelectFrom<APTax>
		.InnerJoin<Tax>
		.On<APTax.taxID.IsEqual<Tax.taxID>>
		.AggregateTo<
			GroupBy<APTax.tranType>,
			GroupBy<APTax.refNbr>,
			GroupBy<APTax.lineNbr>,
			GroupBy<Tax.taxType>,
			Sum<APTax.taxAmt>
			>))]
	[PXCacheName(Messages.APLineTax)]
	public class APLineTax : IBqlTable
	{
		#region TranType
		...
		[PXDBString(1, IsFixed = true, BqlField = typeof(Tax.taxType))]
