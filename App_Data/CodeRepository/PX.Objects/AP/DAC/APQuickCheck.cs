...
namespace PX.Objects.AP.Standalone
{
	...
	public class APQuickCheck : APRegister, IPrintCheckControlable, IAssign, IApprovable, IApprovalDescription
	{
		...
		[APAddress(typeof(Select2<Location,
			...
			InnerJoin<Address, On<Address.addressID, Equal<Location.vRemitAddressID>, And<Where<Address.bAccountID, Equal<Location.bAccountID>, Or<Address.bAccountID, Equal<BAccountR.parentBAccountID>>>>>,
		...
		[APContact(typeof(Select2<Location,
			InnerJoin<BAccountR, On<BAccountR.bAccountID, Equal<Location.bAccountID>>,
			InnerJoin<Contact, On<Contact.contactID, Equal<Location.vRemitContactID>, And<Where<Contact.bAccountID, Equal<Location.bAccountID>, Or<Contact.bAccountID, Equal<BAccountR.parentBAccountID>>>>>,
		...
		[PXFormula(typeof(Switch<
			Case<Where<PendingValue<APQuickCheck.branchID>, IsNotNull>, Null,
	...
	public class APQuickCheckType : APDocType
	{
		...
		public class NumberingAttribute : AutoNumberAttribute
		{
			...
			{
				get => new string[] { QuickCheck, VoidQuickCheck };
			}

			private static Type[] _SetupFields
			{
				get =>  new Type[] { typeof(APSetup.checkNumberingID), null };
			}
