...
namespace PX.Objects.AP
{
	...
	public static class Messages
	{
		...
		public const string SkippedAlreadyRecognized = "The document is already recognized.";
		...
		public const string TryResubmitDocument = "The document has not been recognized. Try resubmitting the document.";
		public const string RecognizedVendor = "Recognized Vendor";
		public const string BatchRecognitionError = "Failed to recognize the previous record.";
