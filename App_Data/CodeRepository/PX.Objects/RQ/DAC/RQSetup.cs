namespace PX.Objects.RQ
{
    ...
    public partial class RQSetup : PX.Data.IBqlTable
	{
		...
		[PXDefault()]
		[PXSelector(typeof(Search<SOOrderType.orderType, Where<SOOrderType.behavior, Equal<SOBehavior.iN>,
			Or<Where<SOOrderType.behavior, Equal<SOBehavior.sO>, And<FeatureInstalled<FeaturesSet.inventory>>>>>>), DescriptionField = typeof(SOOrderType.descr))]
		[PXRestrictor(typeof(Where<SOOrderType.active, Equal<True>>), null)]
		[PXUIField(DisplayName = "Default Type of Requisition Sales", Visibility = PXUIVisibility.SelectorVisible)]
		...
		#endregion
		#region QTOrderType
		public abstract class qtOrderType : PX.Data.BQL.BqlString.Field<qtOrderType> { }
		[PXDBString(2, IsFixed = true, InputMask = ">aa")]
		[PXDefault()]
		[PXSelector(typeof(Search<SOOrderType.orderType, Where<SOOrderType.behavior, Equal<SOBehavior.qT>>>), DescriptionField = typeof(SOOrderType.descr))]
		[PXRestrictor(typeof(Where<SOOrderType.active, Equal<True>>), null)]
		[PXUIField(DisplayName = "Default Type of Requisition Quote", Visibility = PXUIVisibility.SelectorVisible)]
		public virtual String QTOrderType
		{
			get;
			set;
		}
