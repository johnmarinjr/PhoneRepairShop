...
using PX.Objects.EP;
	...
	public partial class RQRequestLine : PX.Data.IBqlTable
	{
			...
			Search2<Vendor.bAccountID,
				LeftJoin<InventoryItemCurySettings,
					  On<InventoryItemCurySettings.preferredVendorID, Equal<Vendor.bAccountID>,
						...
						And<InventoryItemCurySettings.curyID, EqualBaseCuryID<Current<RQRequest.branchID>>>>>>,
			Where2<
		...
		[PXFormula(null, typeof(SumCalc<RQRequest.openOrderQty>))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		[PXDBPriceCost]
		[PXDefault(TypeCode.Decimal, "0.0", typeof(Search<INItemCost.lastCost,
			Where<INItemCost.inventoryID, Equal<Current<RQRequestLine.inventoryID>>,
				And<INItemCost.curyID, EqualBaseCuryID<Current2<RQRequest.branchID>>>>>))]
