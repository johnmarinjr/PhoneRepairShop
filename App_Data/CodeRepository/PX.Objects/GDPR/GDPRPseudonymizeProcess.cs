...
namespace PX.Objects.GDPR
{
	...
	{
		protected virtual void PseudonymizeChilds(PXGraph processingGraph, Type childTable, IEnumerable<PXPersonalDataFieldAttribute> fields, IEnumerable<object> childs)
		{
		...
		protected virtual List<PXDataFieldParam> InterruptPseudonimyzationHandler(PXCache cache, List<PXDataFieldParam> restricts)
		{
		...
		protected virtual void WipeAudit(PXGraph processingGraph, Type childTable, IEnumerable<PXPersonalDataFieldAttribute> fields, IEnumerable<object> childs)
		{
			foreach (object child in childs)
			{
