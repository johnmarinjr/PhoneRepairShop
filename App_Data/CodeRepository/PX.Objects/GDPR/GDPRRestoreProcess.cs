...
namespace PX.Objects.GDPR
{
	...
	{
		protected virtual void RestoreObfuscatedEntries(PXGraph processingGraph, Type childTable, IEnumerable<PXPersonalDataFieldAttribute> fields, IEnumerable<object> childs)
		{
		...
		protected virtual List<PXDataFieldParam> InterruptRestorationHandler(PXCache cache, List<PXDataFieldParam> restricts)
		{
