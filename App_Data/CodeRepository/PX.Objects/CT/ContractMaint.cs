...
namespace PX.Objects.CT
{
	...
	{
		public class SingleCurrency : Extensions.MultiCurrency.SingleCurrencyGraph<ContractMaint, Contract>
		{
	   ...
	   [PXCopyPasteHiddenView]
		...
		[PXDefault]
		[PXRestrictor(typeof(Where<BAccount.type, NotEqual<BAccountType.vendorType>>), AR.Messages.CustomerOrOrganization)]
					...
					if (item.IsBaseValid == true)
					{
						...
						if (inventory != null)
						{
							...
							DiscountEngine.SetLineDiscountOnly<ContractDetail>(sender, det,
								...
								ContractDetail.baseDiscountSeq, DiscountLineFields.discountsAppliedToLine, DiscountLineFields.manualDisc, DiscountLineFields.manualPrice, DiscountLineFields.lineType, DiscountLineFields.isFree, DiscountLineFields.calculateDiscountsOnImport, DiscountLineFields.automaticDiscountsDisabled>(sender, det), contract.DiscountID,
					...
					if (item.IsFixedRecurringValid == true || item.IsUsageValid == true)
					{
						...
						if (inventory != null)
						{
							DiscountEngine.SetLineDiscountOnly<ContractDetail>(sender, det,
								...
								ContractDetail.recurringDiscountSeq, DiscountLineFields.discountsAppliedToLine, DiscountLineFields.manualDisc, DiscountLineFields.manualPrice, DiscountLineFields.lineType, DiscountLineFields.isFree, DiscountLineFields.calculateDiscountsOnImport, DiscountLineFields.automaticDiscountsDisabled>(sender, det), contract.DiscountID,
					...
					if (item.IsRenewalValid == true)
					{
						...
						if (inventory != null)
						{
							DiscountEngine.SetLineDiscountOnly<ContractDetail>(sender, det,
								...
								ContractDetail.renewalDiscountSeq, DiscountLineFields.discountsAppliedToLine, DiscountLineFields.manualDisc, DiscountLineFields.manualPrice, DiscountLineFields.lineType, DiscountLineFields.isFree, DiscountLineFields.calculateDiscountsOnImport, DiscountLineFields.automaticDiscountsDisabled>(sender, det), contract.DiscountID,
