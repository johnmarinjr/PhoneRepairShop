...
{
	public class ARPaymentEntryExt : GLVoucherEntryBase<ARPaymentEntry,ARPayment.docType, ARPayment.refNbr, BatchModule.moduleAR>
	{
		...
		{
			base.RowInserted<ARPayment.noteID, ARPayment.docDesc, ARPayment.customerID, ARPayment.customerLocationID>(sender, e, bs);
		}
	...
	public class ARInvoiceEntryExt : GLVoucherEntryBase<ARInvoiceEntry, ARInvoice.docType, ARInvoice.refNbr, BatchModule.moduleAR>
	{
		public override void Initialize()
		{
			base.Initialize();
		...
		{
			base.RowInserted<ARInvoice.noteID, ARInvoice.docDesc, ARInvoice.customerID, ARInvoice.customerLocationID>(sender, e, bs);
			sender.Update(e.Row);
		}
	...
	public class ARCashSaleEntryExt : GLVoucherEntryBase<ARCashSaleEntry, Standalone.ARCashSale.docType, Standalone.ARCashSale.refNbr, BatchModule.moduleAR>
	{
		public override void Initialize()
		{
			base.Initialize();
		...
		{
			base.RowInserted<Standalone.ARCashSale.noteID, Standalone.ARCashSale.docDesc, Standalone.ARCashSale.customerID, Standalone.ARCashSale.customerLocationID>(sender, e, bs);
		}
