...
namespace PX.Objects.GL.Reclassification.UI
{
	public class ReclassificationHistoryInq : PXGraph<ReclassificationHistoryInq>
	{
		...
		public ReclassificationHistoryInq()
		{
            ...
            PXUIFieldAttribute.SetVisibility<GLTran.projectID>(TransView.Cache, null, projectIDVisibility ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
            PXUIFieldAttribute.SetVisible<GLTran.projectID>(TransView.Cache, null, projectIDVisibility);
        }
