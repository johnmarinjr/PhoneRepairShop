...
{
	public class APInvoiceEntryExt : GLVoucherEntryBase<APInvoiceEntry, APInvoice.docType, APInvoice.refNbr, BatchModule.moduleAP>
	{
		...
		{
			base.RowInserted<APInvoice.noteID, APInvoice.docDesc, APInvoice.vendorID, APInvoice.vendorLocationID>(sender, e, bs);
		}
	...
	public class APPaymentEntryExt : GLVoucherEntryBase<APPaymentEntry, APPayment.docType, APPayment.refNbr, BatchModule.moduleAP>
	{
		public override void Initialize()
		{
			base.Initialize();
		...
		{
			base.RowInserted<APPayment.noteID, APPayment.docDesc, APPayment.vendorID, APPayment.vendorLocationID>(sender, e, bs);
		}
	...
	public class APQuickCheckEntryExt : GLVoucherEntryBase<APQuickCheckEntry, Standalone.APQuickCheck.docType, Standalone.APQuickCheck.refNbr, BatchModule.moduleAP>
	{
		public override void Initialize()
		{
			base.Initialize();
		...
		{
			base.RowInserted<Standalone.APQuickCheck.noteID, Standalone.APQuickCheck.docDesc, Standalone.APQuickCheck.vendorID, Standalone.APQuickCheck.vendorLocationID>(sender, e, bs);
			if (Base.IsWithinContext)
			{
