...
namespace PX.Objects.GL
{
	...
	//	[PXDBDecimal(4)]
		...
		public abstract class tranClass : PX.Data.BQL.BqlString.Field<tranClass>
		{
			...
			public class charge : PX.Data.BQL.BqlString.Constant<charge>{ public charge() :base(Charge) { } }
			public const string Charge = "U";
			public class discount : PX.Data.BQL.BqlString.Constant<discount>{ public discount() :base(Discount) { } }
			...
			public class writeoff : PX.Data.BQL.BqlString.Constant<writeoff>{ public writeoff() :base(WriteOff) { } }
			public const string WriteOff = "B";
			public class tax : PX.Data.BQL.BqlString.Constant<tax>{ public tax() :base(Tax) { } }
			public const string Tax = "T";
			public class withholdingTax : PX.Data.BQL.BqlString.Constant<withholdingTax>{ public withholdingTax() :base(WithholdingTax) { } }
			public const string WithholdingTax = "W";
			public class consolidation : PX.Data.BQL.BqlString.Constant<consolidation>{ public consolidation() :base(Consolidation) { } }
			public const string Consolidation = "C";
			public class rgol : PX.Data.BQL.BqlString.Constant<rgol>{ public rgol() :base(RealizedAndRoundingGOL) { } }
			public const string RealizedAndRoundingGOL = "R";
			public class rounding : PX.Data.BQL.BqlString.Constant<rounding>{ public rounding() :base(Rounding) { } }
			public const string Rounding = "X";
			public class evaluation : PX.Data.BQL.BqlString.Constant<evaluation>{ public evaluation() :base(UnrealizedAndRevaluationGOL) { } }
			public const string UnrealizedAndRevaluationGOL = "G";
			public class retainageWithheld : PX.Data.BQL.BqlString.Constant<retainageWithheld>{ public retainageWithheld() :base(RetainageWithheld) { } }
			public const string RetainageWithheld = "E";
			public class retainageReleased : PX.Data.BQL.BqlString.Constant<retainageReleased>{ public retainageReleased() :base(RetainageReleased) { } }
			public const string RetainageReleased = "F";
			public class shippedNotInvoiced : PX.Data.BQL.BqlString.Constant<shippedNotInvoiced>{ public shippedNotInvoiced() :base(ShippedNotInvoiced) { } }
			public const string ShippedNotInvoiced = "S";
			public class @void : PX.Data.BQL.BqlString.Constant<@void>{ public @void() :base(Void) { } } 
	...
	[PXHidden]
	//[PXBreakInheritance]
	public partial class GLTranAlias : GLTran
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLTranAlias>.By<module, batchNbr, lineNbr>
		{
			public static GLTranAlias Find(PXGraph graph, String module, String batchNbr, Int32? lineNbr) => FindBy(graph, module, batchNbr, lineNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<GLTranAlias>.By<branchID> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<GLTranAlias>.By<ledgerID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<GLTranAlias>.By<curyInfoID> { }
			public class Batch : GL.Batch.PK.ForeignKeyOf<GLTranAlias>.By<module, batchNbr> { }
			public class Account : GL.Account.PK.ForeignKeyOf<GLTranAlias>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<GLTranAlias>.By<subID> { }
			public class OriginalTransaction : GL.GLTranAlias.PK.ForeignKeyOf<GLTranAlias>.By<origModule, origBatchNbr, origLineNbr> { }
			public class OriginalAccount : GL.Account.PK.ForeignKeyOf<GLTranAlias>.By<origAccountID> { }
			public class OriginalSubaccount : GL.Sub.PK.ForeignKeyOf<GLTranAlias>.By<origSubID> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<GLTranAlias>.By<inventoryID> { }
			public class CashAccountTransaction : CA.CATran.UK.ForeignKeyOf<GLTranAlias>.By<cATranID> { }
		}
		#endregion
		...
		#endregion
		#region IsNonPM
		public new abstract class isNonPM : PX.Data.BQL.BqlBool.Field<isNonPM> { }
		#endregion
		#region RefNbr
		...
		#endregion
		#region PostYear
		public new abstract class postYear : PX.Data.BQL.BqlString.Field<postYear> { }
		#endregion
		#region TranYear
		public new abstract class tranYear : PX.Data.BQL.BqlString.Field<tranYear> { }
		#endregion
		#region NextPostYear
		public new abstract class nextPostYear : PX.Data.BQL.BqlString.Field<nextPostYear> { }
		#endregion
		#region NextTranYear
		public new abstract class nextTranYear : PX.Data.BQL.BqlString.Field<nextTranYear> { }
		#endregion
		#region CATranID
		...
		#endregion
		#region OrigTranDate
		public new abstract class reclassOrigTranDate : PX.Data.BQL.BqlDateTime.Field<reclassOrigTranDate> { }
		#endregion
		#region ReclassSourceTranModule
		...
		#endregion
		#region ReclassTotalCount
		public new abstract class reclassTotalCount : PX.Data.BQL.BqlInt.Field<reclassTotalCount> { }
		#endregion
		#region ReclassReleasedCount
		public new abstract class reclassReleasedCount : PX.Data.BQL.BqlInt.Field<reclassReleasedCount> { }
		#endregion
	}
}
