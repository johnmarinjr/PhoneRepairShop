...
namespace PX.Objects.GL
{
	...
	/// <summary>
	/// The DAC is version of GLHistoryByPeriod <see cref="GLHistoryByPeriod"/> with restiction by GLHistory.FinPeriodID <see cref="GLHistory.finPeriodID"/> 
	...
	public partial class GLHistoryByCurrentPeriod : PX.Data.IBqlTable
	{
		...
		{
			public static GLHistoryByCurrentPeriod Find(PXGraph graph, Int32? ledgerID, Int32? branchID, Int32? accountID, Int32? subID, String finPeriodID) => FindBy(graph, ledgerID, branchID, accountID, subID, finPeriodID);
		}
		public static class FK
		{
