...
{
    public class SOUnassignedShipLineSplitForProjectPlanIDAttribute : SOUnassignedShipLineSplitPlanIDAttribute
	{
		public SOUnassignedShipLineSplitForProjectPlanIDAttribute(Type ParentNoteID, Type ParentHoldEntry, Type ParentOrderDate) :
