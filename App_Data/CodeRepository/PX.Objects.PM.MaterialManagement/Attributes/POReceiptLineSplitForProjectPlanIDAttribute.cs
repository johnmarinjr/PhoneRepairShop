...
{
    public class POReceiptLineSplitForProjectPlanIDAttribute : POReceiptLineSplitPlanIDAttribute
    {
		public POReceiptLineSplitForProjectPlanIDAttribute(Type ParentNoteID, Type ParentHoldEntry, Type ParentOrderDate)
