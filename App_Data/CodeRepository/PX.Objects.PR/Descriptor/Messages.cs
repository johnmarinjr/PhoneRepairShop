...
namespace PX.Objects.PR
{
	...
	public static class Messages
	{
		...
		public const string LocationIsInactive = "Work Location {0} is inactive.";
		...
		public const string NotEnoughLastYearCarryoverMoney = "There is not enough money left from the last year's carryover of PTO bank {0}.";
		...
		public const string NotEnoughPTOMoneyAvailable = "The balance cannot be negative. The amount associated with earning code {0} cannot exceed the available amount in PTO bank {1}.";
		...
		public const string ErrorOnOtherPayment = "An error in the calculation of the '{0}' payment is blocking the calculation of this payment.";
		...
		public const string PTOFieldWillBeOverridden = "The value of the {0} box for this PTO disbursement earning will be updated by the calculation process.";
		...
		public const string PRWorkCompensationMaximumInsurableWage = "Work Compensation Maximum Insurable Wage";
		...
		public const string EmployeeAlreadyAddedToAnotherPaycheck = "Another paycheck ({0}) with the same pay period has already been created for the employee. Would you like to view the existing paycheck or continue editing the current one?";
		public const string EmployeeAlreadyAddedToAnotherPaycheckError = "Another paycheck ({0}) with the same pay period has already been created for the employee.";
		...
		#region TimeCards
		public const string TimeActivitiesImportedToPaycheck = "The time activities have been imported to Payroll. If you want to update or delete the time card, delete the corresponding earning detail records of the {0} paycheck first.";
		public const string TimeActivitiesImportedToPaidOrReleasedPaycheck = "The time activities have been imported to Payroll. If you want to update or delete the time card, void the {0} paycheck first.";
		public const string TimeActivitiesImportedToPayrollBatch = "The time activities have been imported to Payroll. If you want to update or delete the time card, delete the corresponding earning detail records of the {0} payroll batch first.";
		#endregion
		...
		public const string SummaryPTODoesntMatch = "The accrual amount for {0} ({1}) does not match PTO details ({2}).";
		public const string SummaryPTOMissing = "PTO bank for {0} is missing.";
