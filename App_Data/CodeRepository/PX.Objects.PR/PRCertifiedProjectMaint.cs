...
namespace PX.Objects.PR
{
	public class PRCertifiedProjectMaint : PXGraph<PRCertifiedProjectMaint>
	{
		...
		public SelectFrom<PRDeductionAndBenefitProjectPackage>.
			InnerJoin<PRDeductCode>.On<PRDeductionAndBenefitProjectPackage.deductionAndBenefitCodeID.IsEqual<PRDeductCode.codeID>>.
			Where<PRDeductionAndBenefitProjectPackage.projectID.IsEqual<CertifiedProjectFilter.projectID.FromCurrent>>.View DeductionsAndBenefitsPackage;
		...
		public SelectFrom<PRProjectFringeBenefitRateReducingDeduct>
			...
			.Where<PRProjectFringeBenefitRateReducingDeduct.projectID.IsEqual<CertifiedProjectFilter.projectID.FromCurrent>
				.And<PRDeductCode.countryID.IsEqual<BQLLocationConstants.CountryUS>>>.View FringeBenefitRateReducingDeductions;
		#endregion Views
