...
namespace PX.Objects.PR
{
	...
	public class PRPaymentWCPremium : IBqlTable
	{
		...
		{
			public static PRPaymentWCPremium Find(PXGraph graph, string docType, string refNbr, string workCodeID, int? deductCodeID, int? branchID, string contribType) => 
				FindBy(graph, docType, refNbr, workCodeID, deductCodeID, branchID, contribType);
		}
