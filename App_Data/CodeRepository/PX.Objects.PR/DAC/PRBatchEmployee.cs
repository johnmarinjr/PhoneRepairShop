...
namespace PX.Objects.PR
{
	...
	[Serializable]
	public class PRBatchEmployee : IBqlTable, IEmployeeType
	{
		#region Keys
		...
		[PXString(2)]
		[PXUnboundDefault(typeof(SearchFor<PREmployee.countryID>.Where<PREmployee.bAccountID.IsEqual<employeeID.FromCurrent>>))]
