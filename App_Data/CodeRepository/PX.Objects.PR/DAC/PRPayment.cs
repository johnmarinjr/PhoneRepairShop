	...
	public class PRPayment : IBqlTable, IEmployeeType
	{
		...
		[GL.Branch(
			typeof(SelectFrom<Branch>
				...
				.SearchFor<Branch.branchID>),
			typeof(SearchFor<Branch.branchID>
				.Where<Branch.countryID.IsEqual<countryID.FromCurrent>>),
			IsDetail = false,
		...
		[PXFormula(typeof(Default<employeeID>))]
		[PXDefault(typeof(SearchFor<PREmployee.empType>.Where<PREmployee.bAccountID.IsEqual<employeeID.FromCurrent>>))]
		[EmployeeType.List]
