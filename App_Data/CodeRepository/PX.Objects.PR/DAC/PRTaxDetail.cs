...
namespace PX.Objects.PR
{
	...
	public class PRTaxDetail : IBqlTable, IPaycheckExpenseDetail<int?>
	{
		...
		{
			public static PRTaxDetail Find(PXGraph graph, int? branchID, string paymentDocType, string paymentRefNbr, int? taxID, int? projectID, int? projectTaskID, int? laborItemID, string earningTypeCD, int? costCodeID) =>
				FindBy(graph, branchID, paymentDocType, paymentRefNbr, taxID, projectID, projectTaskID, laborItemID, earningTypeCD, costCodeID);
		}
