...
namespace PX.Objects.PR
{
	...
	public class PREmployeeTax : IBqlTable
	{
		...
		[PXString]
		[PXUnboundDefault(typeof(SearchFor<PRTaxCode.countryID>.Where<PRTaxCode.taxID.IsEqual<taxID.FromCurrent>>))]
		[PXDBScalar(typeof(SearchFor<PRTaxCode.countryID>.Where<PRTaxCode.taxID.IsEqual<taxID>>))]
