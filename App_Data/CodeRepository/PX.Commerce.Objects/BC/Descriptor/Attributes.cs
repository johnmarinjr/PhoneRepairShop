...
namespace PX.Commerce.Objects
{
	...
	public class BCEncryptPersonalDataAttribute : PXRSACryptStringAttribute
	{
		...
		public override void CommandPreparing(PXCache sender, PXCommandPreparingEventArgs e)
		{
			...
			{
				bool? encryptionRequired = sender.GetValue(e.Row, _encryptionRequired.Name) as bool?;
		...
		public override void FieldSelecting(PXCache sender, PXFieldSelectingEventArgs e)
		{
			IsViewDecrypted = true;
			bool? encryptionRequired = sender.GetValue(e.Row, _encryptionRequired.Name) as bool?;
			if (e.Row != null && encryptionRequired == true && e.ReturnValue != null)
			{
		...
		{
			bool? isEncrypted = cache.GetValue(row, _encryptionRequired.Name) as bool?;
