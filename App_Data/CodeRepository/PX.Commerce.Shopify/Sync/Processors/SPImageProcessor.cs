...
namespace PX.Commerce.Shopify
{
	...
	public class SPImageProcessor : BCProcessorBulkBase<SPImageProcessor, SPImageEntityBucket, MappedStockItem>, IProcessor
	{
		...
		public override List<SPImageEntityBucket> GetBucketsImport(List<BCSyncStatus> ids)
		{
			throw new NotImplementedException();
		}
		#endregion
		...
		public override List<SPImageEntityBucket> GetBucketsExport(List<BCSyncStatus> ids)
		{
