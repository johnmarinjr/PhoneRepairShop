...
namespace PX.Commerce.Shopify.API.REST
{
	public class FulfillmentRestDataProvider : RestDataProviderBase, IChildRestDataProvider<FulfillmentData>
	{
		...
		public virtual FulfillmentData Create(FulfillmentData entity, string orderId)
		{
			var segments = MakeParentUrlSegments(orderId);
			return base.Create<FulfillmentData, FulfillmentResponse>(entity, segments);
		}

		public virtual FulfillmentData Update(FulfillmentData entity, string orderId, string fulfillmentId)
		{
			var segments = MakeUrlSegments(fulfillmentId, orderId);
			return Update<FulfillmentData, FulfillmentResponse>(entity, segments);
		}

		public virtual bool Delete(string orderId, string fulfillmentId)
		{
			var segments = MakeUrlSegments(fulfillmentId, orderId);
			return Delete(segments);
		}

		public virtual IEnumerable<FulfillmentData> GetAll(string orderId, IFilter filter = null)
		{
			var segments = MakeParentUrlSegments(orderId);
		...
		public virtual IEnumerable<FulfillmentData> GetAllWithoutParent(IFilter filter = null)
		{
			throw new NotImplementedException();
		}

		public virtual FulfillmentData CompleteFulfillment(string orderId, string fulfillmentId)
		{
		...
		public virtual FulfillmentData OpenFulfillment(string orderId, string fulfillmentId)
		{
