...
namespace PX.Commerce.Shopify.API.REST
{
	public class OrderRestDataProvider : RestDataProviderBase, IParentRestDataProvider<OrderData>
	{
		...
		public virtual List<OrderTransaction> GetOrderTransactions(string orderId)
		{
		...
		public virtual List<OrderRefund> GetOrderRefunds(string orderId)
		{
		...
		public virtual OrderRefund GetOrderSingleRefund(string orderId, string refundID)
		{
		...
		public virtual List<OrderRisk> GetOrderRisks(string orderId)
		{
