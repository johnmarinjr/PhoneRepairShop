...
namespace PX.Objects.FS
{
    ...
    public class FSPriceManagement : PXGraph<FSPriceManagement>
    {
            ...
            int? inventoryID)
        {
            ...
            {
                decimal curyval;
                PXDBCurrencyAttribute.CuryConvCury(cache, info, (decimal)contractSalesPrice, out curyval, IN.CommonSetupDecPl.PrcCst);
                return curyval;
            }
                                                         ...
                                                         string taxCalcMode)
        {
            ...
            bool alwaysFromBaseCury = salesPriceMaint.GetAlwaysFromBaseCurrencySetting(cache);
            ...
            try
            {
                priceItem = salesPriceMaint.FindSalesPrice(
                    ...
                    siteID,
                    currencyinfo.BaseCuryID,
                    alwaysFromBaseCury ? currencyinfo.BaseCuryID : currencyinfo.CuryID,
                    Math.Abs(quantity ?? 0m),
                    uom,
                    date,
                    taxCalcMode);
            ...
            price = salesPriceMaint.AdjustSalesPrice(cache, priceItem, inventoryID, currencyinfo, uom);
