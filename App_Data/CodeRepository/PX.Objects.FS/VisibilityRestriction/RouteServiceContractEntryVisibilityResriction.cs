...
{
	public class RouteServiceContractEntryVisibilityResriction : PXGraphExtension<RouteServiceContractEntry>
	{
		...
		public void CopyPasteGetScript(bool isImportSimple, List<Api.Models.Command> script, List<Api.Models.Container> containers, CopyPasteGetScriptDelegate baseMethod)
		{
			...
			string branchViewName = nameof(RouteServiceContractEntry.ServiceContractRecords) + ": 1";
			string customerViewName = nameof(RouteServiceContractEntry.ServiceContractRecords);
