...
namespace PX.Objects.FS
{
    ...
    {        
        ...
        public class StartLogActions : LogActions
        {
            public new readonly string[] ID_LIST = { START };
            public new readonly string[] TX_LIST = { TX.LogActions.START };
        }

        public class PCRLogActions : LogActions
        {
            public new readonly string[] ID_LIST = { PAUSE, RESUME, COMPLETE };
            public new readonly string[] TX_LIST = { TX.LogActions.PAUSE, TX.LogActions.RESUME, TX.LogActions.COMPLETE };
        }
        ...
        public class Contract_ExpirationType
        {
			...
			public readonly string[] ID_LIST = { ID.Contract_ExpirationType.EXPIRING, ID.Contract_ExpirationType.UNLIMITED, ID.Contract_ExpirationType.RENEWABLE };
			public readonly string[] TX_LIST = { TX.Contract_ExpirationType.EXPIRING, TX.Contract_ExpirationType.UNLIMITED, TX.Contract_ExpirationType.RENEWABLE };
        }
        ...
        public class Action_ContractAction
        {
			...
			public readonly string[] ID_LIST = { ID.Action_ContractAction.CREATE, ID.Action_ContractAction.ACTIVATE, ID.Action_ContractAction.SUSPEND, ID.Action_ContractAction.CANCEL, ID.Action_ContractAction.EXPIRE, ID.Action_ContractAction.INACTIVATE_SCHEDULE, ID.Action_ContractAction.DELETE_SCHEDULE, ID.Action_ContractAction.Copied, ID.Action_ContractAction.Renew };
            public readonly string[] TX_LIST = { TX.Action_ContractAction.CREATE, TX.Action_ContractAction.ACTIVATE, TX.Action_ContractAction.SUSPEND, TX.Action_ContractAction.CANCEL, TX.Action_ContractAction.EXPIRE, TX.Action_ContractAction.INACTIVATE_SCHEDULE, TX.Action_ContractAction.DELETE_SCHEDULE, TX.Action_ContractAction.Copied, TX.Action_ContractAction.Renew };
        }
        ...
        public class ActionType_ProcessServiceContracts
        {
			...
			public readonly string[] ID_LIST =
            {
				...
				ID.ActionType_ProcessServiceContracts.RENEW, ID.ActionType_ProcessServiceContracts.FORECAST,
				ID.ActionType_ProcessServiceContracts.EMAILQUOTE
			};

            public readonly string[] TX_LIST =
            {
                TX.ActionType_ProcessServiceContracts.STATUS, TX.ActionType_ProcessServiceContracts.PERIOD,
				TX.ActionType_ProcessServiceContracts.RENEW, TX.ActionType_ProcessServiceContracts.FORECAST,
				TX.ActionType_ProcessServiceContracts.EMAILQUOTE
			};
        }
		...
		public class ContactType_ContractMail : ContactType_ApptMail
		{
			public new readonly string[] ID_LIST =
			{
				NotificationContactType.Contact,  NotificationContactType.Billing,
				ID.ContactType_ApptMail.CUSTOMER, ID.ContactType_ApptMail.VENDOR,
				ID.ContactType_ApptMail.SALESPERSON, NotificationContactType.Employee
			};

			public new readonly string[] TX_LIST =
			{
				PX.Objects.EP.Messages.Contact, PX.Objects.AR.Messages.Billing,
				TX.ContactType_ApptMail.CUSTOMER, TX.ContactType_ApptMail.VENDOR,
				TX.ContactType_ApptMail.SALESPERSON, PX.Objects.EP.Messages.Employee
			};
		}
