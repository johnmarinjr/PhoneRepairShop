...
namespace PX.Objects.FS
{
    public static class TX
    {
        ...
        [PXLocalizable]
        public class ServiceContractBillingType
        {
            public const string PerformedBillings = "At Time of Service";
            public const string StandardizedBillings = "End-Period Plus";
            public const string FixedRateBillings = "Beginning-Period Fixed";
            public const string FixedRateAsPerformedBillings = "Beginning-Period Plus";
        }
        ...
        public static class TableName
        {
            ...
            public const string FSContractPeriodDet             = "Contract Period Detail";
        }
        ...
        public static class Error
        {
            ...
            public const string LOG_START_CANNOT_BE_PRIOR_APPOINTMENT_START                                    = "The log start date and time is earlier than the appointment actual start date and time specified on the Settings tab.";
            public const string LOG_END_CANNOT_BE_GREATER_APPOINTMENT_END                                      = "The log end date and time is later than the appointment actual end date and time specified on the Settings tab.";
            public const string APPOINTMENT_START_CANNOT_BE_GREATER_MIN_LOG_START                              = "The appointment actual start date and time is later than the earliest start date and time specified on the Log tab.";
            public const string APPOINTMENT_END_CANNOT_BE_PRIOR_MAX_LOG_END                                    = "The appointment actual end date and time is earlier than the latest start date and time on the Log tab.";
            ...
            public const string CannotUnselectMarkForPOBecauseItWasRequestedFromServiceOrder                   = "You cannot select the Mark for PO check box in this line because the line has been created on the Service Orders (FS300100) form.";
			...
			public const string CannotChangeCuryUnitCostInApptLine											   = "You cannot change the Unit Cost for this line because other appointments have lines that are associated with the service order line related to this line.";
            ...
            [Obsolete("Will be removed in Acumatica 2022R2")]
            ...
            public const string StartStaffLogActionNotAllowedWithCurrentStaffLine                              = "The {0} action is not available for a staff line associated with travel items.";
            public const string LogActionNotAllowedForTravelLine                                               = "The {0} action is not available for travel items.";
			public const string DocumentCannotBeInvoiced													   = "The document {0}-{1} cannot be billed because it does not contain any billable items.";
			public const string LogTimeDurationCannotBeGreaterThan24Hr										   = "Time duration cannot be greater than 24 hours once the log line is assigned the Completed status. Insert a new log line and assign it to the corresponding date.";
			public const string FieldCannotBeUpdatedFromAppointmentScreen									   = "The {0} cannot be changed for the appointment line because the corresponding service order line has been added to at least one more appointment. You can change the {0} for the service order line on the Service Order (FS300100) form";
			public const string FieldCannotBeUpdatedAppointmentBilledOrClosed								   = "The {0} cannot be changed because there is at least one billed or closed appointment that includes this service order line.";
			public const string FieldCannotBeUpdatedServiceOrderAllowInvoiceBilled							   = "The {0} cannot be changed because the service order of this appointment is billed or closed, or the Allow Billing command is selected for this service order.";
			public const string RecordIsReferencedAtLicense                                                    = "This license type is specified for at least one non-stock item on the Non-Stock Items (IN202000) form, or a license on the Licenses (FS201000) form.";
			public const string RecordIsReferencedAtEmployee												   = "This skill is specified for at least one non-stock item on the Non-Stock Items (IN202000) form, or an employee on the Employees (EP203000) form.";
            public const string DocumentDateLesserThanServiceContractDate									   = "The date is incorrect. The date must be the same as or later than the start date of the related contract.";
			public const string DocumentDateGreaterThanServiceContractEndDate								   = "The date is incorrect. The date must be earlier than or the same as the expiration date of the related contract.";
			public const string ServiceContractCannotBeExpired												   = "The document cannot be assigned the Expired status because at least one appointment or service order associated with the document has the status other than Completed or Closed.";
            public const string PROJECT_CANNOT_MODIFY_CREATED_FROM_APPOINTMENT                                 = "The project cannot be modified because the time activity has been created from an appointment with a specific project.";
			public const string OperationCannotPerformDueToContactDeactivated							       = "The contact {0} is deactivated. To perform the operation, select an active contact.";
        ...
        public static class Warning
        {
            ...
            public const string DOCUMENTS_WITHOUT_BILLING_INFO                                            = "Some documents are not displayed because they do not have all the required billing settings specified.";
			public const string USE_FIX_SERVICE_ORDERS_BUTTON											  = "To specify the missing billing settings, use the Fix Service Orders Without Billing Settings button.";
			public const string DOCUMENTS_WITHOUT_BILLING_INFO_USE_FIX_SERVICE_ORDERS_BUTTON			  = "Some documents are not displayed because they do not have all the required billing settings specified. To specify the missing billing settings, use the Fix Service Orders Without Billing Settings button.";
            ...
            public const string OpportunityLinkedToFSDocument                                             = "The document is associated with a field service document. Do you want to delete this document?";
			public const string NOTE_LEGAL_ASPECTS_OF_LOCATION_TRACKING									  = "The legal aspects of the data privacy of your company must be taken into careful consideration before you activate tracking.";
            public const string DocumentEndDateLaterThanServiceContractExpirationDate					  = "The date is later than the related service contract expiration date.";
		}
        ...
        public static class Messages
        {
            ...
            public const string EQUIPMENT_OF_OWNER								   = "The owner is {0}.";
            ...
            public const string CONTRACT_WITH_FIXED_RATE_BILLING                   = "Fixed Rate Contract: {0} {1}";
            ...
            public const string ContractDesctInvoicePrefix                         = "{0} Contract: {1} {2}";
        }
        ...
        public static class ActionType_ProcessServiceContracts
        {
			...
			public const string EMAILQUOTE = "Email Quote";
		}
		...
		[PXLocalizable]
		public static class SC_Duration_Type
		{
			public const string MONTH = "Month";
			public const string QUARTER = "Quarter";
			public const string YEAR = "Year";
		...
		[PXLocalizable]
		public class ForecastDet_Type
		{
			public const string Schedule		= "Schedule";
			public const string ContractPeriod	= "Contract Period";
        }

        [PXLocalizable]
		public class FSAppointmentLogColumns
		{
			public const string DetLineRef = "Detail Ref. Nbr.";
		}
	}
}
