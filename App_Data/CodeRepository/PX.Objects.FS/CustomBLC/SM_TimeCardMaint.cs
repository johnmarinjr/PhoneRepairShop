...
namespace PX.Objects.FS
{
    public class SM_TimeCardMaint : PXGraphExtension<TimeCardMaint>
    {
        ...
        protected virtual void _(Events.RowInserting<TimeCardMaint.EPTimecardDetail> e)
        {
            ...
            PMTimeActivity pmTimeActivityRow = (PMTimeActivity)e.Row;

            if (pmTimeActivityRow.OrigNoteID != null) 
            { 
                ...
                fsxPMTimeActivityRow.AppointmentCustomerID = null;
                fsxPMTimeActivityRow.AppointmentID = null;
                fsxPMTimeActivityRow.LogLineNbr = null;
                fsxPMTimeActivityRow.SOID = null;
            }
        }
