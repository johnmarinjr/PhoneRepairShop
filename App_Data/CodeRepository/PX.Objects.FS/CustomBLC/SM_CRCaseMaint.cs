...
namespace PX.Objects.FS
{
    public class SM_CRCaseMaint : PXGraphExtension<CRCaseMaint>
    {
        ...
        public override void Configure(PXScreenConfiguration configuration)
        {
            ...
            var categoryServices = context.Categories.CreateNew(PX.Objects.CR.Workflows.CaseWorkflow.CategoryNames.Services,
                c => c.DisplayName(PX.Objects.CR.Workflows.CaseWorkflow.CategoryDisplayNames.Services));

            var actionCreateServiceOrder = context.ActionDefinitions.CreateExisting<SM_CRCaseMaint>(e => e.CreateServiceOrder,
                a => a.WithCategory(categoryServices));
            var actionViewServiceOrder = context.ActionDefinitions.CreateExisting<SM_CRCaseMaint>(e => e.ViewServiceOrder,
                a => a.WithCategory(categoryServices));
            var actionOpenAppointmentBoard = context.ActionDefinitions.CreateExisting<SM_CRCaseMaint>(e => e.OpenAppointmentBoard,
                a => a.WithCategory(categoryServices));
                                                 ...
                                                 FSSrvOrdType fsSrvOrdTypeRow)
        {
            ...
            bool isInserted = Base.Case.Cache.GetStatus(crCaseRow) == PXEntryStatus.Inserted;

            CreateServiceOrder.SetEnabled(isSMSetup && crCaseRow != null && !isInserted && fsServiceOrderRow == null);
            ViewServiceOrder.SetEnabled(isSMSetup && crCaseRow != null && !isInserted && fsServiceOrderRow != null);
                                                    ...
                                                    bool updatingExistingSO)
        {
            ...
            UDFHelper.CopyAttributes(cache, crCaseRow, graphServiceOrderEntry.ServiceOrderRecords.Cache, fsServiceOrderRow, null);
