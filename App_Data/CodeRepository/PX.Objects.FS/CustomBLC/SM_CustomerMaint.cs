...
namespace PX.Objects.FS
{
    ...
    public class SM_CustomerMaint : PXGraphExtension<CustomerMaint>
    {
        ...
        public class WorkflowChanges : PXGraphExtension<CustomerMaint_Workflow, CustomerMaint>
        {
            ...
            protected virtual void Configure(WorkflowContext<CustomerMaint, Customer> context)
            {
        ...
        public virtual void SetSingleBillingSettings(PXCache cache, Customer customerRow)
        {
            ...
            {
				cache.SetValueExt<FSxCustomer.billingCycleID>(customerRow, fsxCustomerClassRow.DfltBillingCycleID);
            }
        ...
        {
            if (cache.GetStatus(currentRow) == PXEntryStatus.Deleted)
            {
                return false;
            }
