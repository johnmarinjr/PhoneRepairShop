...
namespace PX.Objects.FS
{
    public class SM_AccessUsers : PXGraphExtension<AccessUsers>
    {
        ...
        protected virtual void _(Events.RowSelected<UserPreferences> e)
        {
            ...
            if (PXAccess.FeatureInstalled<FeaturesSet.gDPRCompliance>() == true)
            {
                var exception = fsxUserPreferencesRow.TrackLocation == true ? new PXSetPropertyException(TX.Warning.NOTE_LEGAL_ASPECTS_OF_LOCATION_TRACKING, PXErrorLevel.Warning) : null;
                cache.RaiseExceptionHandling<FSxUserPreferences.trackLocation>(e.Row, fsxUserPreferencesRow.TrackLocation, exception);
            }
        }
