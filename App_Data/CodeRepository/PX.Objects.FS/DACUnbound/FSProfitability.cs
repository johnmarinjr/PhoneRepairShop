...
namespace PX.Objects.FS
{
    ...
    public class FSProfitability : IBqlTable
    {
        ...
        public FSProfitability(FSSODet fsSODet, string billingBy)
        {
            ...
            this.ActualDuration = this.LineType == ID.LineType_Profitability.INVENTORY_ITEM ? 0 : fsSODet.ApptDuration;
            this.ActualQty = billingBy == ID.Billing_By.APPOINTMENT ? fsSODet.ApptQty : fsSODet.EstimatedQty;
            this.CuryActualAmount = billingBy == ID.Billing_By.APPOINTMENT ? fsSODet.CuryApptTranAmt: fsSODet.CuryEstimatedTranAmt;
            this.BillableQty = billingBy == ID.Billing_By.APPOINTMENT ? fsSODet.ApptQty : fsSODet.BillableQty;
            this.CuryBillableAmount = billingBy == ID.Billing_By.APPOINTMENT ? fsSODet.CuryApptTranAmt : fsSODet.CuryBillableTranAmt;
            this.CuryUnitCost = fsSODet.CuryUnitCost;
            this.CuryEstimatedCost = this.EstimatedQty * this.CuryUnitCost;
            this.CuryExtCost = fsSODet.IsLinkedItem == true || billingBy == ID.Billing_By.SERVICE_ORDER ? fsSODet.CuryExtCost : this.ActualQty * this.CuryUnitCost;
