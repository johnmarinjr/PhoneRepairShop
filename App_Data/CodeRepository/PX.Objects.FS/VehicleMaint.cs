...
namespace PX.Objects.FS
{
    public class VehicleMaint : PXGraph<VehicleMaint, EPEquipment>
    {
		...
		#endregion
		#region EPEquipment_VehicleDescr
		[PXMergeAttributes(Method = MergeMethod.Merge)]
		[PXUnboundDefault(typeof(Search<FSEquipment.descr,
									Where<FSEquipment.sourceID, Equal<Current<EPEquipment.equipmentID>>,
									And<FSEquipment.sourceType, Equal<FSVehicle.sourceType.Vehicle>>>>))]
