...
namespace PX.Objects.FS
{
    public class SvrOrdTypeMaint : PXGraph<SvrOrdTypeMaint, FSSrvOrdType>
    {
        ...
        public virtual void SetPostingSettingVisibility(PXCache cache, FSSrvOrdType fsSrvOrdTypeRow, bool isVisible)
        {
            ...
            PXUIFieldAttribute.SetVisible<FSSrvOrdType.copyNotesToInvoice>(cache, fsSrvOrdTypeRow, isVisible && fsSrvOrdTypeRow.PostTo != ID.SrvOrdType_PostTo.PROJECTS);
            PXUIFieldAttribute.SetVisible<FSSrvOrdType.copyAttachmentsToInvoice>(cache, fsSrvOrdTypeRow, isVisible && fsSrvOrdTypeRow.PostTo != ID.SrvOrdType_PostTo.PROJECTS);
		...
		protected virtual void _(Events.FieldUpdated<FSSrvOrdType, FSSrvOrdType.completeSrvOrdWhenSrvDone> e)
		{
			if (e.Row == null)
			{
				return;
			...
			if (fsSrvOrdTypeRow.CloseSrvOrdWhenSrvDone == true && fsSrvOrdTypeRow.CompleteSrvOrdWhenSrvDone == false)
			{
				e.Cache.SetValueExt<FSSrvOrdType.closeSrvOrdWhenSrvDone>(e.Row, false);
			}
		}
