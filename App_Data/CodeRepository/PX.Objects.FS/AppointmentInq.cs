...
namespace PX.Objects.FS
{
    ...
    public class AppointmentInq : PXGraph<AppointmentInq>
    {
        ...
        public class AppointmentInqFilter : IBqlTable
        {
            ...
            [LocationActive(typeof(Where<Location.bAccountID, Equal<Current<AppointmentInqFilter.customerID>>>),
        ...
        #endregion
        #region FSAppointment_ScheduledDateTimeEnd
        [PXMergeAttributes(Method = MergeMethod.Merge)]
        [PXUIField(DisplayName = "Scheduled End Date", Visible = false)]
        protected virtual void FSAppointmentFSServiceOrder_ScheduledDateTimeEnd_CacheAttached(PXCache sender) { }
        #endregion
