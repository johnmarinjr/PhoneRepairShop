...
namespace PX.Objects.FS
{
    ...
    {
        private RouteDocumentMaint routeDocumentMaint = null;
        ...
        public virtual void UpdateRoute(FSRouteDocument fsRouteDocumentRow)
        {
            ...
            FSRouteDocument fsRouteDocumentRow_New = routeDocumentMaint.RouteRecords.Current = routeDocumentMaint.RouteRecords.Search<FSRouteDocument.routeDocumentID>(fsRouteDocumentRow.RouteDocumentID);

            if (fsRouteDocumentRow_New.RouteDocumentID != fsRouteDocumentRow.RouteDocumentID)
            {
                throw new PXException(TX.Error.RECORD_X_NOT_FOUND, DACHelper.GetDisplayName(typeof(FSRouteDocument)));
            }
