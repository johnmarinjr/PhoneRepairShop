    ...
    public class AppointmentEntry : ServiceOrderBase<AppointmentEntry, FSAppointment>, IGraphWithInitialization
    {
        ...
        public IEnumerable InvoiceAppointment(PXAdapter adapter)
        {
			...
			foreach (FSAppointment fsAppointmentRow in list)
            {
                ...
                delegate ()
                {
					...
					{
						// Here will be the code to propagate the error on the Appointment Lines
						throw e;
					}
                });
            }
        ...
        public PXSetup<FSContractPeriod>.Where<
               Where<
                   ...
                   And<Current<FSBillingCycle.billingBy>, Equal<FSBillingCycle.billingBy.Appointment>>>>> BillServiceContractPeriod;
		...
		protected virtual void _(Events.FieldUpdating<FSAppointmentDet, FSAppointmentDet.curyUnitCost> e)
		{
			if (e.Row == null)
			{
				return;
			...
			FSSODet soDetRow = FSSODet.UK.Find(this, e.Row.SODetID);

			if (e.Row.EnablePO == true && soDetRow?.ApptCntr > 1)
			{
				throw new PXSetPropertyException(TX.Error.CannotChangeCuryUnitCostInApptLine);
			}
		}
        ...
        protected virtual void _(Events.RowPersisted<FSAppointmentDet> e)
        {
            ...
            if (Accessinfo.ScreenID != SharedFunctions.SetScreenIDToDotFormat(ID.ScreenID.ExpenseReceipt)
				&& Accessinfo.ScreenID != SharedFunctions.SetScreenIDToDotFormat(ID.ScreenID.ExpenseReceipt)
        ...
        public class SalesTax : TaxGraph<AppointmentEntry, FSAppointment>
        {
            ...
            protected virtual void _(Events.FieldDefaulting<FSAppointment, FSAppointment.taxZoneID> e)
            {
				...
				e.NewValue = ((AppointmentEntry)e.Cache.Graph).GetDefaultTaxZone(row);
			}
            #endregion
        }
        #endregion
