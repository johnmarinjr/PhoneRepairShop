...
namespace PX.Objects.FS
{
    ...
    public class FSServiceOrder : PX.Data.IBqlTable
	{
        ...
        [PXUIRequired(typeof(Where<Current<FSSrvOrdType.behavior>, NotEqual<FSSrvOrdType.behavior.Values.internalAppointment>,
                               And<Current<FSSrvOrdType.behavior>, NotEqual<FSSrvOrdType.behavior.Values.quote>,
                               And<copied, Equal<False>>>>))]
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        [PXDecimal]
        [PXUIField(DisplayName = "Base Appointment Total", Enabled = false)]
        ...
        [PXFormula(typeof(
            Switch<
                Case<Where<billingBy, Equal<billingBy.Values.ServiceOrder>>, curyBillableOrderTotal>,
                Null>))]
        ...
        [PXFormula(typeof(
            Switch<
                Case<Where<billingBy, Equal<billingBy.Values.ServiceOrder>>, curyTaxTotal>,
                Null>))]
        ...
        [PXFormula(typeof(
            Switch<
                Case<Where<billingBy, Equal<billingBy.Values.ServiceOrder>>, curyDocTotal>,
                Null>))]
        ...
        [PXFormula(typeof(
            Switch<
                Case<Where<billingBy, Equal<billingBy.Values.ServiceOrder>>, curyCostTotal>,
                Null>))]
        ...
        [PXFormula(typeof(
            Switch<
                Case<Where<curyEffectiveCostTotal, Equal<decimal0>, 
                        Or<curyEffectiveCostTotal, IsNull>>, Null>,
                Mult<
                    Div<
                        Sub<curyEffectiveBillableLineTotal, curyEffectiveCostTotal>,
                        curyEffectiveCostTotal>,
                    decimal100>>))]
