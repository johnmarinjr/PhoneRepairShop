...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentDet : IBqlTable, IFSSODetBase, IDocLine, ISortOrder, ILSPrimary
    {
		...
		[PXUnboundFormula(typeof(Switch<
									Case<Where<
											status, Equal<ListField_Status_AppointmentDet.waitingForPO>,
											And<pOSource, Equal<pOSource.Values.purchaseToAppointment>>>,
										int1>,
									int0>),
							typeof(SumCalc<FSAppointment.pendingApptPOLineCntr>))]
        ...
        // TODO: rename it to Performable and make it a bound field
        ...
        [PXUnboundDefault(typeof(Switch<
                            ...
                            Case<Where<
                                    ...
                                    And<status, NotEqual<status.NotStarted>>>,
                                True,
                            Case<Where<
                                    Current<FSAppointment.areActualFieldsActive>, Equal<True>>,
                                True,
							Case<Where<
									Current<FSAppointment.closed>, Equal<True>>,
								True,
							Case<Where<
									Current<FSAppointment.closeActionRunning>, Equal<True>>,
								True>>>>>,
                            False>))]
        ...
        [PXDefault(typeof(Switch<
                            ...
                            Case<Where<areActualFieldsActive, Equal<True>,
                                ...
                                estimatedQty>>>,
                            decimal0>))]
        [PXFormula(typeof(Default<lineType, billingRule, areActualFieldsActive, linkedEntityType>))]
        ...
        {
			[PXDependsOnFields(typeof(effTranQty))]
            get
            {
                return this._EffTranQty;
            }
        ...
        [PXUIEnabled(typeof(Where<status, NotEqual<status.NotPerformed>>))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXDBCurrencyPriceCost(typeof(curyInfoID), typeof(discAmt))]
        ...
        #region INOpenQty
        public abstract class inOpenQty : PX.Data.BQL.BqlDecimal.Field<inOpenQty> { }

        [PXDecimal]
        [PXDefault(typeof(actualQty), PersistingCheck = PXPersistingCheck.Nothing)]
