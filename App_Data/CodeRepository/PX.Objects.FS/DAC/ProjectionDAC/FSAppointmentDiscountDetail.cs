...
namespace PX.Objects.FS
{
    [PXProjection(typeof(Select<FSDiscountDetail,
                            Where<FSDiscountDetail.entityType, Equal<FSDiscountDetail.entityType.Appointment>>>),
                    Persistent = true)]
    [Serializable]
    [PXBreakInheritance]
    public partial class FSAppointmentDiscountDetail : FSDiscountDetail, IDiscountDetail
    {
        #region Keys
        public new class PK : PrimaryKeyOf<FSAppointmentDiscountDetail>.By<srvOrdType, refNbr, recordID>
        {
            public static FSAppointmentDiscountDetail Find(PXGraph graph, string srvOrdType, string refNbr, int? recordID)
                => FindBy(graph, srvOrdType, refNbr, recordID);
        }
        public new static class FK
        {
            public class FreeItem : InventoryItem.PK.ForeignKeyOf<FSAppointmentDiscountDetail>.By<freeItemID> { }
        }
        #endregion
        ...
        [PXParent(typeof(Select<FSAppointment, Where<FSAppointment.srvOrdType, Equal<Current<srvOrdType>>, And<FSAppointment.refNbr, Equal<Current<refNbr>>>>>))]
