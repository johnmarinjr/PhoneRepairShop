...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentLog : FSLog
    {
		...
		[PXString(2)]
		[PXUnboundDefault(typeof(Search<EP.EPActivityApprove.approvalStatus,
				Where<FSxPMTimeActivity.appointmentID, Equal<Current<docID>>
					,And<FSxPMTimeActivity.logLineNbr, Equal<Current<lineNbr>>>>>))]
