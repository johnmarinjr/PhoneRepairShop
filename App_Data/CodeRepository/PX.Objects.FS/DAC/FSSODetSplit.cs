...
namespace PX.Objects.FS
{
    ...
    public class FSSODetSplit : PX.Data.IBqlTable, ILSDetail
    {
        ...
        public static class FK
        {
            ...
            public class POReceipt : Objects.PO.POReceipt.PK.ForeignKeyOf<FSSODetSplit>.By<pOReceiptType, pOReceiptNbr> { }
        ...
        [INExpireDate(typeof(FSSODetSplit.inventoryID), PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        [PXFormula(typeof(Mult<curyUnitCost, qty>))]
