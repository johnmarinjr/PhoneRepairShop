...
namespace PX.Objects.FS
{
    ...
    public abstract class ListField_LogActions : IBqlField
    {
        ...
        public class StartListAttribute : PXStringListAttribute
        {
            public StartListAttribute()
                : base(
                    new ID.StartLogActions().ID_LIST,
                    new ID.StartLogActions().TX_LIST)
            {
            }
        }
        ...
        public class PCRListAttribute : PXStringListAttribute
        {
            public PCRListAttribute()
                : base(
                    new ID.PCRLogActions().ID_LIST,
                    new ID.PCRLogActions().TX_LIST)
            {
            }
        }
    ...
    public abstract class ListField_Contract_ExpirationType : PX.Data.IBqlField
    {
		...
		{
			public Renewable() : base(ID.Contract_ExpirationType.RENEWABLE)
			{
			}
		}
	}
	...
	public class ContractContactType : NotificationContactType
	{
		/// <summary>
		/// Defines a list of the possible ContactType for the AR Customer <br/>
		/// Namely: Primary, Billing, Employee, Customer, Employee Staff, Vendor Staff <br/>
		...
		public class ClassListAttribute : PXStringListAttribute
		{
			public ClassListAttribute()
				: base(
						new ID.ContactType_ContractMail().ID_LIST,
						new ID.ContactType_ContractMail().TX_LIST)
			{
			}
		}
	...
	#region Renewal_Duration_Type

	public abstract class SC_Duration_Type : PX.Data.IBqlField
	{
		public class ListAtrribute : PXStringListAttribute
		{
			public ListAtrribute()
				: base(
					Pair(MONTH, TX.SC_Duration_Type.MONTH),
					Pair(QUARTER, TX.SC_Duration_Type.QUARTER),
					Pair(YEAR, TX.SC_Duration_Type.YEAR),
					Pair(CUSTOM, TX.SC_Duration_Type.CUSTOM))
			{
			}
		}
		...
		public class month : PX.Data.BQL.BqlString.Constant<month> { public month() : base(MONTH) { } }

		public const string QUARTER = "Q";
		public class quarter : PX.Data.BQL.BqlString.Constant<quarter> { public quarter() : base(QUARTER) { } }

		public const string YEAR = "Y";
		public class year : PX.Data.BQL.BqlString.Constant<year> { public year() : base(YEAR) { } }

		public const string CUSTOM = "C";
		public class custom : PX.Data.BQL.BqlString.Constant<custom> { public custom() : base(CUSTOM) { } }
    ...
    public abstract class ListField
    {
        ...
        #region Service Order Type Behavior
        [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
        ...
        #region Service Contract Billing Type
        [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
        public abstract class ServiceContractBillingType : PX.Data.IBqlField
        {
            public class ListAttribute : PXStringListAttribute
            {
                public ListAttribute()
                    : base(
                        Pair(PerformedBillings, TX.ServiceContractBillingType.PerformedBillings),
                        Pair(StandardizedBillings, TX.ServiceContractBillingType.StandardizedBillings),
                        Pair(FixedRateBillings, TX.ServiceContractBillingType.FixedRateBillings),
                        Pair(FixedRateAsPerformedBillings, TX.ServiceContractBillingType.FixedRateAsPerformedBillings))
                {
                }
            }

            public const string PerformedBillings = "APFB";
            public class performedBillings : PX.Data.BQL.BqlString.Constant<performedBillings> { public performedBillings() : base(PerformedBillings) { } }


            public const string StandardizedBillings = "STDB";
            public class standardizedBillings : PX.Data.BQL.BqlString.Constant<standardizedBillings> { public standardizedBillings() : base(StandardizedBillings) { } }


            public const string FixedRateBillings = "FIRB";
            public class fixedRateBillings : PX.Data.BQL.BqlString.Constant<fixedRateBillings> { public fixedRateBillings() : base(FixedRateBillings) { } }

            public const string FixedRateAsPerformedBillings = "FRPB";
            public class fixedRateAsPerformedBillings : PX.Data.BQL.BqlString.Constant<fixedRateBillings> { public fixedRateAsPerformedBillings() : base(FixedRateAsPerformedBillings) { } }
	...
	public abstract class ListField_ForecastDet_Type
	{
		public class ListAttribute : PXStringListAttribute
		{
			public static List<Tuple<string, string>> FullList = new List<Tuple<string, string>>
			{
				new Tuple<string, string>(Schedule, TX.ForecastDet_Type.Schedule),
				new Tuple<string, string>(ContractPeriod, TX.ForecastDet_Type.ContractPeriod)
			};
		...
		public class schedule : PX.Data.BQL.BqlString.Constant<schedule>
		{
		...
		public class contractPeriod : PX.Data.BQL.BqlString.Constant<contractPeriod>
		{
			public contractPeriod() : base(ContractPeriod)
			{
			}
		}
	}
