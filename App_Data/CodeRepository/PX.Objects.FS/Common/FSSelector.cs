				  ...
				  BqlTemplate.OfCommand<
					Search2<Contact.contactID,
					   InnerJoin<BAccount,
						   ...
						   LeftJoin<CRLead,
							   On<Contact.contactID, Equal<CRLead.contactID>>>>,
					   Where<
						   Contact.contactType, NotEqual<ContactTypesAttribute.bAccountProperty>,
						   And<CRLead.contactID, IsNull,
					  ...
					  typeof(And<
								...
								And<
									Where2<
										...
										Or<FSServiceContract.isFixedRateContract, Equal<True>>>>>>),
		...
		public FSSelectorAppointmentSODetIDAttribute()
			: base(
				typeof(Search2<
							...
							LeftJoin<
								InventoryItem, On<InventoryItem.inventoryID, Equal<FSAppointmentDet.inventoryID>>>,
					   Where<
		...
		public FSSelectorAppointmentSODetIDAttribute(Type whereType)
			: base(
				BqlCommand.Compose(
									typeof(Search2<,,>),
									typeof(FSAppointmentDet.lineRef),
									typeof(LeftJoin<InventoryItem, On<InventoryItem.inventoryID, Equal<FSAppointmentDet.inventoryID>>>),
									typeof(Where2<,>),
									typeof(Where<
												FSAppointmentDet.appointmentID, Equal<Current<FSAppointment.appointmentID>>,
												...
												typeof(FSEquipment.locationType), typeof(Equal<ListField_LocationType.Customer>),
													typeof(And2<,>),
														...
														typeof(And<>),
															typeof(Where2<,>),
																typeof(Where<,,>),
																	//In case OwnerType: Customer -> Check if billCustomer is the Owner.
