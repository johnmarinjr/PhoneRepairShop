...
namespace PX.Objects.AM.GraphExtensions
{
        ...
        where TPrimary : class, IBqlTable, new()
    {
        ...
        /// <returns></returns>
        public virtual bool CurrentEstimatesValidForSalesDetails(out PXException exception)
        {
            exception = null;
        ...
        public virtual void AddEstimatesToSalesOrder(SOOrderEntry soOrderEntry)
        {
        ...
        protected virtual int? ConvertQuoteStatusToEstimateStatus(string quoteStatus, int? currentEstimateStatus)
        {
            ...
            switch (quoteStatus)
            {
                ...
                case CRQuoteStatusAttribute.Accepted:
                ...
                case CRQuoteStatusAttribute.Converted:
                case CRQuoteStatusAttribute.QuoteApproved:
                case CRQuoteStatusAttribute.Declined:
