...
namespace PX.Objects.AM.GraphExtensions
{
            ...
            where TConfigWhere : IBqlWhere, new()
    {
		...
		// for performance on building of configurations on orders
		[PXRemoveBaseAttribute(typeof(PXSelectorAttribute))]
		protected virtual void _(Events.CacheAttached<AMConfigResultsAttribute.attributeID> e) { }

		[PXMergeAttributes(Method = MergeMethod.Merge)]
		// for performance on building of configurations on orders
		[PXRemoveBaseAttribute(typeof(AMAttributeValueAttribute))]
		[PXRemoveBaseAttribute(typeof(CA.DynamicValueValidationAttribute))]
		protected virtual void _(Events.CacheAttached<AMConfigResultsAttribute.value> e) { }

		[PXMergeAttributes(Method = MergeMethod.Merge)]
		// for performance on building of configurations on orders
		[PXRemoveBaseAttribute(typeof(PXSelectorAttribute))]
		[PXRemoveBaseAttribute(typeof(AMEmptySelectorValueAttribute))]
		protected virtual void _(Events.CacheAttached<AMConfigurationAttribute.attributeID> e) { }

		[PXMergeAttributes(Method = MergeMethod.Merge)]
		// for performance on building of configurations on orders
		[PXRemoveBaseAttribute(typeof(AMAttributeValueAttribute))]
		[PXRemoveBaseAttribute(typeof(CA.DynamicValueValidationAttribute))]
		protected virtual void _(Events.CacheAttached<AMConfigurationAttribute.value> e) { }
        ...
        public abstract bool ContainsEstimates { get; }
