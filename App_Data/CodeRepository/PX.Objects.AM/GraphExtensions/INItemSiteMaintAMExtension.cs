...
namespace PX.Objects.AM.GraphExtensions
{
    public class INItemSiteMaintAMExtension : PXGraphExtension<INItemSiteMaint>
    {
		...
		protected virtual IEnumerable viewBOM(PXAdapter adapter)
		{
			...
			Base.itemsiterecord.Cache.RaiseExceptionHandling<InventoryItemExt.aMBOMID>(Base.itemsiterecord.Current, itemExtension.AMBOMID,
		...
		protected virtual IEnumerable viewPlanningBOM(PXAdapter adapter)
		{
			...
			Base.itemsiterecord.Cache.RaiseExceptionHandling<InventoryItemExt.aMPlanningBOMID>(Base.itemsiterecord.Current, itemExtension.AMPlanningBOMID,
