...
namespace PX.Objects.AM.GraphExtensions
{
    public class InventoryItemMaintAMExtension : PXGraphExtension<InventoryItemMaint>
    {
		...
		protected virtual void _(Events.CacheAttached<InventoryItemExt.aMReplenishmentSource> e) { }
		...
		protected virtual void _(Events.FieldUpdated<InventoryItem, InventoryItem.itemClassID> e, PXFieldUpdated baseMethod)
		{
			...
			if (Base.doResetDefaultsOnItemClassChange == true && IsConsolidateOrdersVisible == true)
			{
				...
				{
					e.Cache.SetDefaultExt<CacheExtensions.InventoryItemExt.aMGroupWindow>(e.Row);
				}
			}
		}
		...
		{
			var itemExtension = Base.Item.Current.GetExtension<InventoryItemExt>();
			BOMMaint.RedirectActive(itemExtension.AMBOMID);

			Base.Item.Cache.RaiseExceptionHandling<InventoryItemExt.aMBOMID>(Base.Item.Current, itemExtension.AMBOMID,
		...
		[PXButton]
		[PXUIField(DisplayName = "View Planning BOM")]
		public virtual IEnumerable viewPlanningBOM(PXAdapter adapter)
		{
			var itemExtension = Base.Item.Current.GetExtension<InventoryItemExt>();
			BOMMaint.RedirectActive(itemExtension.AMPlanningBOMID);

			Base.Item.Cache.RaiseExceptionHandling<InventoryItemExt.aMPlanningBOMID>(Base.Item.Current, itemExtension.AMPlanningBOMID,
