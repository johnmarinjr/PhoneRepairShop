...
namespace PX.Objects.AM
{
    ...
    public static class ExtensionMethods
    {
		...
		/// <summary>
		/// Returns the string of <see cref="DayOfWeek"/> using first 3 characters.
		/// </summary>
		/// <example>Monday is "Mon", Thursday is "Thu"</example>
		/// <param name="dow">Day of week</param>
		public static string ToShortString(this DayOfWeek dow)
		{
			var dowString = Enum.GetName(typeof(DayOfWeek), dow);
			return string.IsNullOrEmpty(dowString) ? string.Empty : dowString.Substring(0, 3);
		}

		public static string To24HourString(this DateTime? date)
		{
			return date == null ? string.Empty : To24HourString(date.GetValueOrDefault());
		}
		...
		public static DayOfWeek NextDay(this DayOfWeek dow)
		{
			return (dow == DayOfWeek.Saturday) ? DayOfWeek.Sunday : (dow + 1);
		}
    }
}
