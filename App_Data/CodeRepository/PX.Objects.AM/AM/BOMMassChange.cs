...
namespace PX.Objects.AM
{
    ...
    public class BOMMassChange : PXGraph<BOMMassChange>
    {
        ...
        [PXDefault]
		protected virtual void _(Events.CacheAttached<AMBomMatl.inventoryID> e) { }
        ...
        [PXDefault]
		protected virtual void _(Events.CacheAttached<AMBomItem.inventoryID> e) { }

        [PXDBDate]
        [PXUIField(DisplayName = "Revision Start Date", Visible = false)]
		protected virtual void _(Events.CacheAttached<AMBomItem.effStartDate> e) { }

        [PXDBDate]
        [PXUIField(DisplayName = "Revision End Date", Visible = false)]
		protected virtual void _(Events.CacheAttached<AMBomItem.effEndDate> e) { }
