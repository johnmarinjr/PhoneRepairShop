...
namespace PX.Objects.AM
{
    ...
    public static class Messages
    {
        ...
        public const string EcrMatlDupItems = "A duplicate inventory item was found in Operation {0} of ECR {1}.";
        public const string EcoMatlDupItems = "A duplicate inventory item was found in Operation {0} of ECO {1}.";
		...
		public const string ProductionOrderUnreleasedTransactions = "The status of the {0} {1} production order cannot be changed because it has related transactions that are not released.";
        ...
        public const string DisassemblyRefLineNbrInvalid = "The {0} reference line number of the disassembly is invalid.";
        public const string UnableToReleaseRelatedTransactions = "The transactions related to the {0} batch {1} cannot be released: {2}.";
        public const string JournalEntryIsReleased = "The {0} journal entry is released.";
        ...
        public const string DuplicateSerialNumberInDocument = "The {0} inventory item has the duplicate {1} serial number in the {2} {3} production order.";
        ...
        public const string DateToMustBeGreaterThanDateFrom = "Date To must be greater then or equal to Date From";
		...
		public const string ProductionOrderUnreleasedVendorShipments = "The status of the {0} {1} production order cannot be changed because it has related vendor shipments that are not released.";
		public const string ProductionOrderUnreleasedClockEntries = "The status of the {0} {1} production order cannot be changed because it has related clock entries that are not released.";
        public const string BackflushMaterialNotAllowedWithPreassignLotSerial = "The material cannot be backflushed according to the current configuration of the preassigned lot or serial number settings for Production Order {0} {1}.";
        public const string PreassignedLotQuantityNotAssigned = "Production Order {0} {1} cannot be released. Make sure that the total quantity of items assigned to each lot number is equal to the quantity to produce specified in the production order.";
        public const string PreassignedSerialQuantityNotAssigned = "Production Order {0} {1} cannot be released. Make sure that each item in the order has a serial number assigned.";
        public const string MaterialAssignedToIncompleteParentLotSerial = "The parent item for the preassigned {0} lot or serial number assigned to a production material in Production Order {1} {2} is not available in inventory yet. Would you like to change the status to {2}?";
        public const string PreassignedLotSerialQuantityOutOfSync = "The total quantity {0} of the parent item for the preassigned lot or serial number does not match the quantity to produce {3} in Production Order {1} {2}.";
        public const string MaterialLotSerialNotAssigned = "Production Order {0} {1} contains materials to which parent lot or serial numbers have not been assigned.";
        public const string PreassignedLotSerialNumberDoesNotExist = "The transaction cannot be created for Production Order {0} {1} because the lot or serial number {2} has not been preassigned.";
        public const string ExceededPreassignedLotSerialQuantity = "The transaction cannot be created for Production Order {0} {1} because the item quantity exceeds the preassigned item quantity for lot/serial number {2}.";
        public const string ShiftCodeExistsInTime = "Shift code {0} already exists in Time & Expenses.";
        public const string ShiftCodeExistsInManufacturing = "Shift code {0} already exists in Manufacturing.";
        public const string LotSerialNbrAlreadyPreassigned = "The {0} lot or serial number cannot be assigned to the {1} item because it is already used in {2} {3}.";
		public const string ProductionOrderIsFirmNoSchedule = "Production order {0} {1} is firm and cannot be scheduled. Undo firm before scheduling.";
		public const string ProductionOrderIsUnscheduled = "The action cannot be performed because the Production Order {0} {1} has not been scheduled. Schedule the order first.";
        public const string ProductionOrderDoesNotAllowPreassign = "Preassigning lot or serial numbers is not allowed for Production Order {0} {1}.";
        public const string InvalidIntervalImport = "The '{0}' interval from the source file does not exist in the system.";
		public const string MoveControlPointQtyAvailable = "The total quantity must be less than or equal to the reported complete quantity of the previous control point for Operation {2} in Production Order {1} of Type {0}.";
		public const string MoveConstrolPointReversalQty = "The total reversing quantity of {0} must be less than or equal to the difference between the quantity {1} in the next control point Operation {2} and the completed quantity {3} in the current operation {4} for the order type {5} order number {6}.";
		public const string DuplicateOperationID = "The operation with the {0} identifier has already been added. Specify the unique operation ID.";
        ...
        public const string ProductionMatlLotSerial = "Production Material Lot/Serial Nbr.";
        ...
        // ColorCoding
        public const string ByOrderTypeColorCoding = "Order Type";
        public const string WorkCenterColorCoding = "Work Center";
        public const string StatusColorCoding = "Production Order Status";
        public const string DispatchPriorityColorCoding = "Dispatch Priority";
        public const string FirmScheduleColorCoding = "Firm Schedule";
        ...
        // Parent Lot/Serial Assignment
        public const string Never = "Never";
        public const string OnIssue = "On Issue";
        ...
        public const string MakeDefaultBom = "Set as Default BOM";
        public const string MakePlanningBom = "Set as Planning BOM";
        public const string BOMCostSummary = "Calculate BOM Cost";
        ...
        public const string CalculatePlanCost = "Update Planned Costs";
        ...
        public const string CopyFrom = "Create by Copying";
        public const string Add2Order = "Add to Sales Order";
        public const string CreateInventory = "Create Inventory Items";
        public const string AddHistory = "Add Comment";
        public const string NewRevision = "Create New Revision";
        ...
        public const string ReleaseMaterial = "Release Materials";
        public const string Attributes = "Attributes";
        public const string AutoCreateLinkedOrders = "Generate Orders for Subassemblies";
        ...
        public const string CreateMove = "Create Move Transaction";
        ...
        public const string CreateVendorShipment = "Create Vendor Shipment";
        public const string AddProductionOrders = "Add Production Orders";
		public const string ScheduleAndFirm = "Schedule and Firm";
		public const string UndoFirm = "Undo Firm";
