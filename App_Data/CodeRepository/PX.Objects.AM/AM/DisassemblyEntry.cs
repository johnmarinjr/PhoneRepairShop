...
namespace PX.Objects.AM
{
    ...
    /// </summary>
    public class DisassemblyEntry : PXGraph<DisassemblyEntry, AMDisassembleBatch>, ICaptionable
    {
        ...
        public AMDisassembleMaterialTranLineSplittingExtension MaterialLineSplittingExt
            => FindImplementation<AMDisassembleMaterialTranLineSplittingExtension>(); // former lsselect
        public AMDisassembleMasterTranLineSplittingExtension MasterLineSplittingExt
            => FindImplementation<AMDisassembleMasterTranLineSplittingExtension>(); // former lsselect2
        ...
        protected virtual void AMDisassembleBatch_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
        {
            ...
            sender.AllowUpdate = 
            sender.AllowDelete = 
            MaterialLineSplittingExt.lsselect.AllowInsert =
            MaterialLineSplittingExt.lsselect.AllowUpdate =
            MaterialLineSplittingExt.lsselect.AllowDelete =
            //MasterLineSplittingExt.lsselect.AllowInsert = (DO NOT SET MASTER LS TO ALLOW INSERT - CAUSES ISSUES ON AMDisassembleBatch INSERT button)
            MasterLineSplittingExt.lsselect.AllowUpdate =
            MasterLineSplittingExt.lsselect.AllowDelete =
