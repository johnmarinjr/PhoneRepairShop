    ...
    public class CTPProcess : PXGraph<CTPProcess>
    {
        ...
        protected virtual void RejectCTPProcess(SOOrderEntry orderEntry, ProdMaint prodGraph, CTPLine ctpLine)
        {
            ...
            var soLine = orderEntry.Transactions.Locate(new SOLine
            {
				...
				?? SOLine.PK.Find(this, ctpLine?.OrderType, ctpLine?.OrderNbr, ctpLine?.LineNbr);
        ...
        protected virtual AMProdItem CopyCTPtoRegularProdOrder(ProdMaint prodGraph, CTPLine ctpLine, CTPFilter filter)
        {
            ...
            if (ctpOrder != null)
            {
                ...
                newItem.ScheduleStatus = ctpOrder.ScheduleStatus;
        ...
        [PXUIField(DisplayName = "SO Type", Visible = true)]
		protected virtual void _(Events.CacheAttached<CTPLine.orderType> e) { }

        [PXMergeAttributes(Method = MergeMethod.Merge)]
        [PXUIField(DisplayName = "SO Nbr.", Visible = true)]
		protected virtual void _(Events.CacheAttached<CTPLine.orderNbr> e) { }
        ...
        public class CTPLine : SOLine
        {
			...
			// Required for cache attached to work correctly
            ...
            [ProductionOrderSelector(typeof(CTPLine.aMCTPOrderType), includeAll: true, ValidateValue = false)]
            ...
            [PXDBDateAndTime(UseTimeZone = true, BqlField = typeof(AMSchdItem.endDate))]
