...
namespace PX.Objects.AM
{
    public class CreateECOsProcess : PXGraph<CreateECOsProcess>
    {
		...
		protected virtual void _(Events.CacheAttached<AMECRItem.descr> e) { }
        ...
        {
			using (new DisableFormulaCalculationScope(ecoGraph.BomOperRecords.Cache, typeof(AMBomOper.queueTime), typeof(AMBomOper.finishTime), typeof(AMBomOper.moveTime)))
			{
