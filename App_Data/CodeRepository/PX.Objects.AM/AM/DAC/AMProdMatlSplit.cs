...
namespace PX.Objects.AM
{
    ...
    public class AMProdMatlSplit : IBqlTable, ILSDetail, IProdOper
    {
        ...
        public static class FK
        {
            ...
            public class ItemPlan : PX.Objects.IN.INItemPlan.PK.ForeignKeyOf<AMProdMatlSplit>.By<planID> { }
        }
        ...
        [PXDefault(typeof(AMProdMatl.operationID))]
        ...
        [PXDBInt(IsKey = true)]
        [PXLineNbr(typeof(AMProdMatl.splitLineCntr), ReuseGaps = false, DecrementOnDelete = false)]
