...
namespace PX.Objects.AM
{
	...
	public class AMEstimateClass : IBqlTable
	{
        ...
        public class PK : PrimaryKeyOf<AMEstimateClass>.By<estimateClassID>
        {
            public static AMEstimateClass Find(PXGraph graph, string estimateClassID)
                => FindBy(graph, estimateClassID);
        }

        public static class FK
        {
            public class TaxCategory: PX.Objects.TX.TaxCategory.PK.ForeignKeyOf<AMEstimateClass>.By<taxCategoryID> { }
            public class ItemClass : PX.Objects.IN.INItemClass.PK.ForeignKeyOf<AMEstimateClass>.By<itemClassID> { }
            public class Engineer : CR.Standalone.EPEmployee.PK.ForeignKeyOf<AMEstimateClass>.By<engineerID> { }
        }
