...
namespace PX.Objects.AM
{
    ...
    public class AMECOItem : IBqlTable, PX.Data.EP.IAssign, IECCItem
    {
        internal string DebuggerDisplay => $"ECOID = {ECOID}, BOMID = {BOMID}, RevisionID = {RevisionID}, InventoryID = {InventoryID}, SiteID = {SiteID}";

        #region Keys

        public class PK : PrimaryKeyOf<AMECOItem>.By<eCOID>
        {
            public static AMECOItem Find(PXGraph graph, string eCOID)
                => FindBy(graph, eCOID);
        }

        public static class FK
        {
            public class BOM : AMBomItem.PK.ForeignKeyOf<AMECOItem>.By<bOMID, bOMRevisionID> { }
            public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<AMECOItem>.By<inventoryID> { }
            public class Site : IN.INSite.PK.ForeignKeyOf<AMECOItem>.By<siteID> { }
            public class SubItem : INSubItem.PK.ForeignKeyOf<AMECOItem>.By<subItemID> { }
            public class Workgroup : PX.TM.EPCompanyTree.PK.ForeignKeyOf<AMECOItem>.By<workgroupID> { }
			public class Owner : CR.Standalone.EPEmployee.PK.ForeignKeyOf<AMECOItem>.By<ownerID> { }
        }
