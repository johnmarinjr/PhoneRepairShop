...
namespace PX.Objects.AM
{
    ...
    {
        #region Keys
        public class PK : PrimaryKeyOf<AMVendorShipLineSplit>.By<shipmentNbr, lineNbr, splitLineNbr>
        {
            public static AMVendorShipLineSplit Find(PXGraph graph, string shipmentNbr, int? lineNbr, int? splitLineNbr)
                => FindBy(graph, shipmentNbr, lineNbr, splitLineNbr);
        }

        public static class FK
        {
            public class Shipment : AMVendorShipment.PK.ForeignKeyOf<AMVendorShipLineSplit>.By<shipmentNbr> { }
            public class ShipTran  : AMVendorShipLine.PK.ForeignKeyOf<AMVendorShipLineSplit>.By<shipmentNbr, lineNbr> { }
            public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<AMVendorShipLineSplit>.By<inventoryID> { }
            public class Site : IN.INSite.PK.ForeignKeyOf<AMVendorShipLineSplit>.By<siteID> { }
        }
        #endregion

        #region ShipmentNbr (key)
        ...
        [INExpireDate(typeof(AMVendorShipLineSplit.inventoryID))]
