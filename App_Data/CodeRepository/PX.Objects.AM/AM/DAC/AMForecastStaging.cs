...
namespace PX.Objects.AM
{
    ...
    public class AMForecastStaging : IBqlTable
    {
        ...
        {
            public static AMForecastStaging Find(PXGraph graph, DateTime? beginDate, DateTime? endDate, int? inventoryID, int? subItemID, int? siteID, Guid? userID) 
                => FindBy(graph, beginDate, endDate, inventoryID, subItemID, siteID, userID);
        }
