...
namespace PX.Objects.AM
{
	...
	public class AMRPDetailFP : IBqlTable
	{
        ...
        public class PK : PrimaryKeyOf<AMRPDetailFP>.By<recordID>
        {
            public static AMRPDetailFP Find(PXGraph graph, int? recordID) => FindBy(graph, recordID);
        }

        public static class FK
        {
            public class BOM : AMBomItem.PK.ForeignKeyOf<AMRPDetailFP>.By<bOMID, bOMRevisionID> { }
            public class Vendor : AP.Vendor.PK.ForeignKeyOf<AMRPDetailFP>.By<vendorID> { }
            public class VendorLocation : CR.Location.PK.ForeignKeyOf<AMRPDetailFP>.By<vendorID, vendorLocationID> { }
            public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<AMRPDetailFP>.By<inventoryID> { }
            public class Site : IN.INSite.PK.ForeignKeyOf<AMRPDetailFP>.By<siteID> { }
            public class ItemPlan : IN.INItemPlan.PK.ForeignKeyOf<AMRPDetailFP>.By<planID> { }
            public class BAccount : CR.BAccount.PK.ForeignKeyOf<AMRPDetailFP>.By<bAccountID> { }
            public class SupplyItemPlan : INItemPlanSupply.PK.ForeignKeyOf<AMRPDetailFP>.By<supplyPlanID> { }
			public class DemandItemPlan : INItemPlanDemand.PK.ForeignKeyOf<AMRPDetailFP>.By<demandPlanID> { }
            public class ParentInventoryItem : IN.InventoryItem.PK.ForeignKeyOf<AMRPDetailFP>.By<parentInventoryID> { }
            public class ProductInventoryItem : IN.InventoryItem.PK.ForeignKeyOf<AMRPDetailFP>.By<productInventoryID> { }
        }
        ...
        [PXDBString(30, IsUnicode = true)]
        [PXUIField(DisplayName = "Parent Reference Nbr.")]
        ...
        [PXDBString(30, IsUnicode = true)]
        [PXUIField(DisplayName = "Product Reference Nbr.")]
        ...
        #endregion
		#region ConsolidatedRecordID
		public abstract class consolidatedRecordID : PX.Data.BQL.BqlInt.Field<consolidatedRecordID> { }
		[PXDBInt]
		[PXUIField(DisplayName = "Consolidated Record")]
		public virtual Int32? ConsolidatedRecordID { get; set; }
		#endregion
		#region ConsolidatedSafetyQty
		public abstract class consolidatedSafetyQty : PX.Data.BQL.BqlDecimal.Field<consolidatedSafetyQty> { }
		[PXDBDecimal]
		[PXUIField(DisplayName = "Consolidated Safety Qty.")]
		public virtual decimal? ConsolidatedSafetyQty { get; set; }
		#endregion
    }
    ...
    public class AMRPDetailFPSupply : IBqlTable
    {
		...
		protected int? _BranchID;
		[PXDBInt(BqlField = typeof(AMRPDetailFP.branchID))]
		public virtual int? BranchID
		{
			get
			{
