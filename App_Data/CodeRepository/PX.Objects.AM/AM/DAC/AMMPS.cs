...
namespace PX.Objects.AM
{
    ...
    public class AMMPS : IBqlTable, INotable
    {
        ...
        public class PK : PrimaryKeyOf<AMMPS>.By<mPSTypeID, mPSID>
        {
            public static AMMPS Find(PXGraph graph, string mPSTypeID, string mPSID) => FindBy(graph, mPSTypeID, mPSID);
        }

        public static class FK
        {
            public class InventoryItem : PX.Objects.IN.InventoryItem.PK.ForeignKeyOf<AMMPS>.By<inventoryID> { }
            public class Site : PX.Objects.IN.INSite.PK.ForeignKeyOf<AMMPS>.By<siteID> { }
        }
