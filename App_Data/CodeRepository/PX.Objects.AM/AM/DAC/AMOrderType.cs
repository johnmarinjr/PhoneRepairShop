...
namespace PX.Objects.AM
{
    ...
    public class AMOrderType : IBqlTable
    {
        ...
        [PXUIEnabled(typeof(Where<AMOrderType.function, Equal<OrderTypeFunction.regular>>))]
		[PXUIVisible(typeof(Where<AMOrderType.function, Equal<OrderTypeFunction.regular>>))]
		[PXFormula(typeof(Default<AMOrderType.function>))]
        ...
        /// </summary>
        [PXDBString(1)]
        [PXDefault(ParentLotSerialAssignment.Never)]
		...
		[PXUIVisible(typeof(Where<AMOrderType.function, Equal<OrderTypeFunction.regular>>))]
		[PXFormula(typeof(Default<AMOrderType.preassignLotSerial>))]
