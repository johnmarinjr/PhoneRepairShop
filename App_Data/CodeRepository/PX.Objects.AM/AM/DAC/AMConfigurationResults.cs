...
namespace PX.Objects.AM
{
    ...
    public class AMConfigurationResults : IBqlTable, IProductConfigResult
    {
        ...
        public class PK : PrimaryKeyOf<AMConfigurationResults>.By<configResultsID>
        {
            public static AMConfigurationResults Find(PXGraph graph, int? configResultsID) 
                => FindBy(graph, configResultsID);

            public static AMConfigurationResults FindDirty(PXGraph graph, int? configResultsID)
                => PXSelect<AMConfigurationResults,
                        Where<configResultsID, Equal<Required<configResultsID>>>>
                    .SelectWindowed(graph, 0, 1, configResultsID);
        }

        public static class FK
        {
            public class Configuraiton : AMConfiguration.PK.ForeignKeyOf<AMConfigurationResults>.By<configurationID, revision> { }
            public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<AMBomMatl>.By<inventoryID> { }
            public class Site : IN.INSite.PK.ForeignKeyOf<AMConfigurationResults>.By<siteID> { }
            public class Customer : AR.Customer.PK.ForeignKeyOf<AMConfigurationResults>.By<customerID> { }
            public class SalesOrder : SO.SOOrder.PK.ForeignKeyOf<AMConfigurationResults>.By<ordTypeRef, ordNbrRef> { }
            public class SalesLine : SO.SOLine.PK.ForeignKeyOf<AMConfigurationResults>.By<ordTypeRef, ordNbrRef, ordLineRef> { }
            //public class Opportunity : CR.CROpportunity.PK.ForeignKeyOf<AMConfigurationResults>.By<opportunityQuoteID> { }
        }
		...
		/// <summary>
		/// The code of the <see cref="CM.Currency"/> of the document.
		/// </summary>
		/// <value>
