...
namespace PX.Objects.AM
{
    ...
    {
        #region Keys
        public class PK : PrimaryKeyOf<AMWCSubstitute>.By<wcID, siteID>
        {
            public static AMWCSubstitute Find(PXGraph graph, string wcID, int? siteID) => FindBy(graph, wcID, siteID);
        }

        public static class FK
        {
            public class WorkCenter : AMWC.PK.ForeignKeyOf<AMWCSubstitute>.By<wcID> { }
            public class Site : IN.INSite.PK.ForeignKeyOf<AMWCSubstitute>.By<siteID> { }
        }
        #endregion
