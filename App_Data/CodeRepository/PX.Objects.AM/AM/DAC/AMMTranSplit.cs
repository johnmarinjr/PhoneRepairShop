...
namespace PX.Objects.AM
{
    ...
    public class AMMTranSplit : IBqlTable, ILSDetail, IAMBatch
    {
        ...
        {
            public static AMMTranSplit Find(PXGraph graph, string docType, string batNbr, int? lineNbr, int? splitLineNbr) =>
	...
	{ 
        ...
        [PXDBString(INLotSerialStatus.lotSerialNbr.LENGTH, IsUnicode = true, BqlField = typeof(AMMTranSplit.lotSerialNbr))]
