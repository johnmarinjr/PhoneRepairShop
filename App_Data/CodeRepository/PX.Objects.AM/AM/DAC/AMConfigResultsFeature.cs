...
namespace PX.Objects.AM
{
    ...
    public class AMConfigResultsFeature : IBqlTable, IRuleValid, IProductConfigResult
    {
        ...
        public class PK : PrimaryKeyOf<AMConfigResultsFeature>.By<configResultsID, featureLineNbr>
        {
            public static AMConfigResultsFeature Find(PXGraph graph, int? configResultsID ,int? featureLineNbr) 
                => FindBy(graph, configResultsID, featureLineNbr);

            public static AMConfigResultsFeature FindDirty(PXGraph graph, int? configResultsID ,int? featureLineNbr)
                => PXSelect<AMConfigResultsFeature,
                    ...
                    .SelectWindowed(graph, 0, 1, configResultsID, featureLineNbr);
        }

        public static class FK
        {
            public class ConfiguraitonResult : AMConfigurationResults.PK.ForeignKeyOf<AMConfigResultsFeature>.By<configResultsID> { }
            public class Configuraiton : AMConfiguration.PK.ForeignKeyOf<AMConfigResultsFeature>.By<configurationID, revision> { }
            public class ConfiguraitonFeature : AMConfigurationFeature.PK.ForeignKeyOf<AMConfigResultsFeature>.By<configurationID, revision, featureLineNbr> { }
        }
