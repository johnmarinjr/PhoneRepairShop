...
namespace PX.Objects.AM
{
    ...
    public class AMConfigResultsRule : IBqlTable, IRuleValid, IProductConfigResult
    {
        ...
        {
            public static AMConfigResultsRule Find(PXGraph graph, int? configResultsID, string ruleTarget, int? targetLineNbr, int? targetSubLineNbr, string ruleSource, int? ruleSourceLineNbr, int? ruleLineNbr) 
                => FindBy(graph, configResultsID, ruleTarget, targetLineNbr, targetSubLineNbr, ruleSource, ruleSourceLineNbr, ruleLineNbr);
