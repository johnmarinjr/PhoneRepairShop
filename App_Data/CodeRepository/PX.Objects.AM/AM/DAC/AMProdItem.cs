...
namespace PX.Objects.AM
{
    ...
    public class AMProdItem : IBqlTable, ILSPrimary, INotable, IProdOrder
    {
        ...
        public static class FK
        {
            ...
            public class BOM : AMBomItem.PK.ForeignKeyOf<AMProdItem>.By<bOMID, bOMRevisionID> { }
        }
        ...
        [PXDBString(1, IsFixed = true)]
        [PXDefault(ProductionScheduleStatus.Unscheduled)]
        [PXUIField(DisplayName = "Schedule Status", Enabled = false, FieldClass = Features.ADVANCEDPLANNINGFIELDCLASS)]
...
#pragma warning restore PX1030
		...
		[PXDBDateAndTime(DisplayNameDate = "Release Date", DisplayNameTime = "Release Time")]
		[PXUIField(Enabled = false, DisplayName = "Release Date")]
        ...
        /// </summary>
        [PXDBBool]
        [PXDefault(typeof(AMOrderType.preassignLotSerial))]
        [PXUIField(DisplayName = "Allow Preassigning Lot/Serial Numbers", FieldClass = "LotSerial")]
		[PXUIEnabled(typeof(Where<AMProdItem.function, Equal<OrderTypeFunction.regular>>))]
		[PXUIVisible(typeof(Where<AMProdItem.function, Equal<OrderTypeFunction.regular>>))]
        ...
        /// </summary>
        [PXDBString(1)]
        [PXDefault(typeof(AMOrderType.parentLotSerialRequired))]
        [PXUIField(DisplayName = "Require Parent Lot/Serial Number", FieldClass = "LotSerial")]
        [PXUIEnabled(typeof(Where<preassignLotSerial, Equal<True>>))]
		[PXUIVisible(typeof(Where<AMProdItem.function, Equal<OrderTypeFunction.regular>>))]
		[PXFormula(typeof(Default<AMProdItem.preassignLotSerial>))]
        ...
        [PXUIField(DisplayName = "Demand Plan ID", Visible = false, Enabled = false)]
        public virtual Int64? DemandPlanID { get; set; }
        #endregion
