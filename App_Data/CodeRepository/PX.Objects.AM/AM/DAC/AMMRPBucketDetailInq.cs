...
namespace PX.Objects.AM
{
    ...
    public class AMMRPBucketDetailInq : IBqlTable
    {
        ...
        {
            public static AMMRPBucketDetailInq Find(PXGraph graph, string bucketID, int? bucket, int? inventoryID, int? subItemID, int? siteID) 
                => FindBy(graph, bucketID, bucket, inventoryID, subItemID, siteID);
        }
