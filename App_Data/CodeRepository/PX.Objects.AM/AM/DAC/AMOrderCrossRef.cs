...
namespace PX.Objects.AM
{
    ...
    {
        #region Keys
        public class PK : PrimaryKeyOf<AMOrderCrossRef>.By<lineNbr, userID>
        {
            public static AMOrderCrossRef Find(PXGraph graph, int? lineNbr, Guid? userID) => FindBy(graph, lineNbr, userID);
        }
