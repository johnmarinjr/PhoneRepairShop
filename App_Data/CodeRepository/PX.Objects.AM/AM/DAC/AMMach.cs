...
{	
	...
	public class AMMach : IBqlTable, INotable
    {
        ...
        {
            public class MachineAccount : GL.Account.PK.ForeignKeyOf<AMMach>.By<machAcctID> { }
			public class MachineSubaccount : GL.Sub.PK.ForeignKeyOf<AMMach>.By<machSubID> { }
            public class MachineCalendar : CSCalendar.PK.ForeignKeyOf<AMMach>.By<calendarID> { }
        }        
