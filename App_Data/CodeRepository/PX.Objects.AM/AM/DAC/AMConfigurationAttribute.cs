...
namespace PX.Objects.AM
{
    ...
    public class AMConfigurationAttribute : IBqlTable, IProductConfiguration
    {
        ...
        public class PK : PrimaryKeyOf<AMConfigurationAttribute>.By<configurationID, revision, lineNbr>
        {
            public static AMConfigurationAttribute Find(PXGraph graph, string configurationID, string revision, int? lineNbr) 
                => FindBy(graph, configurationID, revision, lineNbr);
        }

        public static class FK
        {
            public class Attribute : PX.Objects.CS.CSAttribute.PK.ForeignKeyOf<AMConfigurationAttribute>.By<attributeID> { }
            public class Configuraiton : AMConfiguration.PK.ForeignKeyOf<AMConfigurationAttribute>.By<configurationID, revision> { }
        }
