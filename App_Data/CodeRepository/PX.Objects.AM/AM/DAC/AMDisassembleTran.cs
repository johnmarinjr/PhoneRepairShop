...
namespace PX.Objects.AM
{
    ...
    public class AMDisassembleTran : AMMTran
    {
        ...
        public new abstract class parentLotSerialNbr : PX.Data.BQL.BqlString.Field<parentLotSerialNbr> { }

        protected new String _ParentLotSerialNbr;

        [PXUIField(DisplayName = "Parent Lot/Serial Nbr.", FieldClass = "LotSerial")]
        public override String ParentLotSerialNbr
        {
            get
            {
