...
namespace PX.Objects.AM
{
    ...
    public class AMConfigurationRule : IBqlTable, IProductConfiguration
    {
        ...
        public class PK : PrimaryKeyOf<AMConfigurationRule>.By<configurationID, revision, ruleSource, sourceLineNbr, lineNbr>
        {
            public static AMConfigurationRule Find(PXGraph graph, string configurationID, string revision, string ruleSource, int? sourceLineNbr, int? lineNbr) 
                => FindBy(graph, configurationID, revision, ruleSource, sourceLineNbr, lineNbr);
        }

        public static class FK
        {
            public class Configuraiton : AMConfiguration.PK.ForeignKeyOf<AMConfigurationRule>.By<configurationID, revision> { }
            public class TargetFeature : AMConfigurationFeature.PK.ForeignKeyOf<AMConfigurationRule>.By<configurationID, revision, targetFeatureLineNbr> { }
            public class TargetOption : AMConfigurationOption.PK.ForeignKeyOf<AMConfigurationRule>.By<configurationID, revision, targetFeatureLineNbr, targetOptionLineNbr> { }
        }
