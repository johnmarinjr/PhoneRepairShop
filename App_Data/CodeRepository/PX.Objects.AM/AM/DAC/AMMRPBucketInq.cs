...
namespace PX.Objects.AM
{
    ...
    public class AMMRPBucketInq : IBqlTable
    {
        ...
        {
            public static AMMRPBucketInq Find(PXGraph graph, string bucketID, int? inventoryID, int? subItemID, int? siteID) 
                => FindBy(graph, bucketID, inventoryID, subItemID, siteID);
        }
