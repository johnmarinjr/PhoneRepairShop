...
namespace PX.Objects.AM
{
    ...
    public class AMConfigurationOption : IBqlTable, IConfigOption, IOperation, IProductConfiguration
	{
        ...
        public class PK : PrimaryKeyOf<AMConfigurationOption>.By<configurationID, revision, configFeatureLineNbr, lineNbr>
        {
            public static AMConfigurationOption Find(PXGraph graph, string configurationID, string revision, int? featureLineNbr, int? lineNbr) 
                => FindBy(graph, configurationID, revision, featureLineNbr, lineNbr);
        }

        public static class FK
        {
			public class Configuraiton : AMConfiguration.PK.ForeignKeyOf<AMConfigurationOption>.By<configurationID, revision> { }
			public class ConfigurationFeature : AMConfigurationFeature.PK.ForeignKeyOf<AMConfigurationOption>.By<configurationID, revision, configFeatureLineNbr> { }
			public class InventoryItem : PX.Objects.IN.InventoryItem.PK.ForeignKeyOf<AMConfigurationOption>.By<inventoryID> { }
            public class Site : PX.Objects.IN.INSite.PK.ForeignKeyOf<AMConfigurationOption>.By<siteID> { }
        }
