...
namespace PX.Objects.AM
{
    ...
    public class AMMTran : IBqlTable, ILSPrimary, IProdOper, IAMBatch, INotable, IProdCostTran
    {
        ...
        {
            public static AMMTran Find(PXGraph graph, string docType, string batNbr, int? lineNbr) =>
        ...
        public static class FK
        {
            ...
            public class WIPAccount : PX.Objects.GL.Account.PK.ForeignKeyOf<AMMTran>.By<wIPAcctID> { }
			public class WIPSubaccount : PX.Objects.GL.Sub.PK.ForeignKeyOf<AMMTran>.By<wIPSubID> { }
			public class Project : PX.Objects.PM.PMProject.PK.ForeignKeyOf<AMMTran>.By<projectID> { }
			public class Task : PX.Objects.PM.PMTask.PK.ForeignKeyOf<AMMTran>.By<taskID> { }
            public class OrigTran : AMMTran.PK.ForeignKeyOf<AMMTran>.By<origDocType, origBatNbr, origLineNbr> { }
            public class OrderType : AMOrderType.PK.ForeignKeyOf<AMMTran>.By<orderType> { }
            public class ProductionOrder : AMProdItem.PK.ForeignKeyOf<AMMTran>.By<orderType, prodOrdID> { }
            public class Operation : AMProdOper.PK.ForeignKeyOf<AMMTran>.By<orderType, prodOrdID, operationID> { }
            public class ProductionMaterial : AMProdMatl.PK.ForeignKeyOf<AMMTran>.By<orderType, prodOrdID, operationID, matlLineId> { }
            public class LaborCode : AMLaborCode.PK.ForeignKeyOf<AMMTran>.By<laborCodeID> { }
            public class Employee : PX.Objects.EP.EPEmployee.PK.ForeignKeyOf<AMMTran>.By<employeeID> { }
            public class Shift : PX.Objects.EP.EPShiftCode.UK.ForeignKeyOf<AMMTran>.By<shiftCD> { }
        }
        #endregion
        ...
        [PXDBInt(IsKey = true)]
        [PXDefault]
        [PXLineNbr(typeof(AMBatch.lineCntr), ReuseGaps = false, DecrementOnDelete = false)]
        ...
        [PXSelector(typeof(Search<AMProdOper.operationID,
			...
			DescriptionField = typeof(AMProdOper.descr))]
        ...
        [PXDefault(TypeCode.Decimal, "0.0", typeof(Coalesce<
            ...
            Search<INItemCost.tranUnitCost, Where<INItemCost.inventoryID, Equal<Current<AMMTran.inventoryID>>, And<INItemCost.curyID, Equal<Current<AccessInfo.baseCuryID>>>>>>))]
        ...
        protected Boolean? _IsLotSerialPreassigned;
        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Lot/Serial Nbr. Preassigned", Enabled = false, FieldClass = "LotSerial")]
        public virtual Boolean? IsLotSerialPreassigned
        {
            get
            {
                return _IsLotSerialPreassigned;
            }
            set
            {
                _IsLotSerialPreassigned = value;
            }
        }
        #endregion
    ...
    [PXCacheName("AM Transaction All Lot/Serial Nbr")]
    [Serializable]
    [PXProjection(typeof(Select<AMMTran>), Persistent = false)]
    public class AMMTranLotSerialNbrAll : IBqlTable
    {
        #region DocType
        ...
        protected String _ProdOrdID;
        [ProductionNbr(BqlField = typeof(AMMTran.prodOrdID))]
		[ProductionOrderSelector(typeof(AMMTranLotSerialNbrAll.orderType), true, ValidateValue = false)]
        public virtual String ProdOrdID
        {
            get
            {
        ...
        protected Int32? _InventoryID;
        [PXDBInt(BqlField = typeof(AMMTran.inventoryID))]
        ...
        protected String _LotSerialNbr;
        [PXDBString(INLotSerialStatus.lotSerialNbr.LENGTH, IsUnicode = true, InputMask = "",  BqlField = typeof(AMMTran.lotSerialNbr))]
	    [PXUIField(DisplayName = "Lot/Serial Nbr.", FieldClass = "LotSerial")]
        [PXSelector(typeof(Search<INItemLotSerial.lotSerialNbr, Where<INItemLotSerial.lotSerialNbr, NotEqual<StringEmpty>>>),
            typeof(INItemLotSerial.lotSerialNbr),
            typeof(INItemLotSerial.inventoryID),
            typeof(INItemLotSerial.qtyOnHand),
            typeof(INItemLotSerial.qtyAvail),
            typeof(INItemLotSerial.qtyHardAvail),
            typeof(INItemLotSerial.qtyOrig),
            DescriptionField = typeof(inventoryID),
            ValidateValue = false)]
        public virtual String LotSerialNbr
        {
            get
