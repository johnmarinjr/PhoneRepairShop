...
namespace PX.Objects.AM
{
    ...
    public class AMConfigResultsOption : IBqlTable, IRuleValid, IProductConfigResult
    {
        ...
        public class PK : PrimaryKeyOf<AMConfigResultsOption>.By<configResultsID, featureLineNbr, optionLineNbr>
        {
            public static AMConfigResultsOption Find(PXGraph graph, int? configResultsID ,int? featureLineNbr, int? optionLineNbr) 
                => FindBy(graph, configResultsID, featureLineNbr, optionLineNbr);

            public static AMConfigResultsOption FindDirty(PXGraph graph, int? configResultsID ,int? featureLineNbr, int? optionLineNbr)
                => PXSelect<AMConfigResultsOption,
                        Where<configResultsID, Equal<Required<configResultsID>>,
                            And<featureLineNbr, Equal<Required<featureLineNbr>>,
                                And<optionLineNbr, Equal<Required<optionLineNbr>>>>>>
                    .SelectWindowed(graph, 0, 1, configResultsID, featureLineNbr, optionLineNbr);
        }

        public static class FK
        {
            public class ConfiguraitonResult : AMConfigurationResults.PK.ForeignKeyOf<AMConfigResultsOption>.By<configResultsID> { }
            public class ConfiguraitonResultFeature : AMConfigResultsFeature.PK.ForeignKeyOf<AMConfigResultsOption>.By<configResultsID, featureLineNbr> { }
            public class Configuraiton : AMConfiguration.PK.ForeignKeyOf<AMConfigResultsOption>.By<configurationID, revision> { }
            public class ConfiguraitonFeature : AMConfigurationFeature.PK.ForeignKeyOf<AMConfigResultsOption>.By<configurationID, revision, featureLineNbr> { }
            public class ConfiguraitonOption : AMConfigurationOption.PK.ForeignKeyOf<AMConfigResultsOption>.By<configurationID, revision, featureLineNbr, optionLineNbr> { }
        }
		...
		[PXDefault(typeof(AMConfigResultsFeature.featureLineNbr))]
        ...
        [PXUnboundFormula(typeof(Switch<Case<Where<AMConfigResultsOption.included, 
                                            ...
                                            decimal0>),
                          typeof(SumCalc<AMConfigResultsFeature.totalQty>), SkipZeroUpdates = true)]
        ...
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXFormula(typeof(Default<qty, included>), SkipZeroUpdates = true)]
        ...
        [PXUnboundFormula(typeof(Switch<Case<Where<AMConfigResultsOption.materialType, NotEqual<AMMaterialType.supplemental>>,
                ...
                decimal0>),
            typeof(SumCalc<AMConfigurationResults.curyOptionPriceTotal>), SkipZeroUpdates = true)]
        ...
        [PXUnboundFormula(typeof(Switch<Case<Where<AMConfigResultsOption.materialType, Equal<AMMaterialType.supplemental>>,
                    ...
                    decimal0>),
                typeof(SumCalc<AMConfigurationResults.curySupplementalPriceTotal>), SkipZeroUpdates = true)]
        [PXDefault(TypeCode.Decimal, "0.0")]
