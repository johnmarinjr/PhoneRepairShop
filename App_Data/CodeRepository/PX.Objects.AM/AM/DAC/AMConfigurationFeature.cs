...
namespace PX.Objects.AM
{
    ...
    public class AMConfigurationFeature : IBqlTable, IProductConfiguration
	{
        ...
        public class PK : PrimaryKeyOf<AMConfigurationFeature>.By<configurationID, revision, lineNbr>
        {
            public static AMConfigurationFeature Find(PXGraph graph, string configurationID, string revision, int? lineNbr) 
                => FindBy(graph, configurationID, revision, lineNbr);
        }

        public static class FK
        {
			public class Configuraiton : AMConfiguration.PK.ForeignKeyOf<AMConfigurationFeature>.By<configurationID, revision> { }
			public class Feature : AMFeature.PK.ForeignKeyOf<AMConfigurationFeature>.By<featureID> { }
        }
