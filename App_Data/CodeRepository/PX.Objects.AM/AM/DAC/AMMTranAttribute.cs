...
namespace PX.Objects.AM
{
    ...
    public class AMMTranAttribute : IBqlTable, IAMBatch
    {
        ...
        {
            public static AMMTranAttribute Find(PXGraph graph, string docType, string batNbr, int? tranLineNbr, int? lineNbr, int? prodAttributeLineNbr) =>
                FindBy(graph, docType, batNbr, tranLineNbr, lineNbr, prodAttributeLineNbr);
        }
