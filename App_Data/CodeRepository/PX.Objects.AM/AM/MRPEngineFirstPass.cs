...
namespace PX.Objects.AM
{
    ...
    public class MRPEngineFirstPass
    {
		...
		public int PlanTypeForSafetyStock => MrpGraph.Setup.Current?.StockingMethod == AMRPSetup.MRPStockingMethod.SafetyStock ? MRPPlanningType.SafetyStock : MRPPlanningType.ReorderPoint;
        ...
        protected virtual void InsertConsolidatedAMRPDetailPlan(AMRPDetailPlan detailPlan)
        {
            ...
            InsertDetailFP(new AMRPDetailFP
            {
                ...
                RefNbr = RefNbrFieldAttribute.GetKeyString(MrpGraph, detailPlan.RefNoteID),
        ...
        [PXHidden]
        [Serializable]
		public class SimpleSalesLineSplit : IBqlTable
		{
			#region PlanID
