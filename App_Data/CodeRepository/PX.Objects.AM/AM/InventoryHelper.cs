...
namespace PX.Objects.AM
{
    ...
    public static class InventoryHelper
    {
		...
		[Obsolete(PX.Objects.Common.InternalMessages.MethodIsObsoleteAndWillBeRemoved2022R2)]
        public static AMProdItem IsLotSerialPreassigned(PXGraph graph, int? inventoryID, string lotSerial)
        {
		...
		public static bool IsLotSerialPreassigned(PXGraph graph, int? inventoryID, string lotSerial, IProdOrder prodOrderExclude, out string foundOrderType, out string foundProdOrdID)
        {
			...
			foreach (AMProdItemSplit split in SelectFrom<AMProdItemSplit>
		...
		[Obsolete(PX.Objects.Common.InternalMessages.MethodIsObsoleteAndWillBeRemoved2022R2)]
        public static void FreeUnusedPreassignedLotSerial(PXGraph graph, AMProdItem prodItem)
        {
			throw new NotImplementedException();
        }
    }
