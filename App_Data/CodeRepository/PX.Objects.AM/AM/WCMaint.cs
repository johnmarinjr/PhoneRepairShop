...
namespace PX.Objects.AM
{
	...
	public class WCMaint : PXGraph<WCMaint, AMWC>
	{
        ...
        public PXSelectJoin<AMShift, InnerJoin<EPShiftCode, On<AMShift.shiftCD, Equal<EPShiftCode.shiftCD>>>,
        ...
        protected virtual void InsertDefaultShiftRow(AMWC row)
        {
            ...
            var firstShift = (EPShiftCode)PXSelect<EPShiftCode, Where<EPShiftCode.isManufacturingShift, Equal<True>>, OrderBy<Asc<EPShiftCode.shiftCD>>>.SelectWindowed(this, 0, 1);

            if (firstShift?.ShiftID == null)
            {
                return;
            }
        ...
        protected virtual void _(Events.FieldSelecting<EPShiftCode, EPShiftCodeExt.diffType> e)
		{
            if (e.Row == null)
			{
                return;
            ...
            (decimal? _, string diffType) = ShiftMaint.GetShiftDiffAndType(this, e.Row);
            e.ReturnValue = diffType;
        }

        protected virtual void _(Events.FieldSelecting<EPShiftCode, EPShiftCodeExt.shftDiff> e)
        {
            if (e.Row == null)
            {
                return;
            ...
            (decimal? shftDiff, string _) = ShiftMaint.GetShiftDiffAndType(this, e.Row);
            e.ReturnValue = shftDiff;
        }
