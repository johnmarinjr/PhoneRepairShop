...
namespace PX.Objects.AM
{
    public class APSMaintenanceProcess : PXGraph<APSMaintenanceProcess>
    {
		...
		protected virtual void _(Events.CacheAttached<AMAPSMaintenanceSetup.workCenterCalendarProcessLastRunByID> e) { }

        [PXDBCreatedByID(DisplayName = "Last Run By")]
		protected virtual void _(Events.CacheAttached<AMAPSMaintenanceSetup.blockSizeSyncProcessLastRunByID> e) { }

        [PXDBCreatedByID(DisplayName = "Last Run By")]
		protected virtual void _(Events.CacheAttached<AMAPSMaintenanceSetup.historyCleanupProcessLastRunByID> e) { }

        [PXDBCreatedByID(DisplayName = "Last Run By")]
		protected virtual void _(Events.CacheAttached<AMAPSMaintenanceSetup.workCalendarProcessLastRunByID> e) { }
