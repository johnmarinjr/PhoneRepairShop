...
namespace PX.Objects.AM
{
    ...
    public class CreateProductionOrdersProcess : PXGraph<CreateProductionOrdersProcess>
    {
		...
		/// a select of <see cref="INItemPlan"/> Join <see cref="INPlanType"/> Join <see cref="InventoryItem"/> Join <see cref="INUnit"/> Left Join <see cref="INItemSite"/> <br/>
		...
		/// in the <see cref="ProductionOrdersCreateFilter"/>: <br/>
		/// 1. <see cref="ProductionOrdersCreateFilter.ownerID"/> is null or <see cref="ProductionOrdersCreateFilter.ownerID"/> = <see cref="InventoryItem.productManagerID"/> <br/>
		/// 2. <see cref="ProductionOrdersCreateFilter.workGroupID"/> is null or <see cref="ProductionOrdersCreateFilter.workGroupID"/> = <see cref="InventoryItem.productWorkgroupID"/><br/>
		/// 3. <see cref="ProductionOrdersCreateFilter.myWorkGroup"/> = false or <see cref="InventoryItem.productWorkgroupID"/> = InMember&lt;<see cref="ProductionOrdersCreateFilter.currentOwnerID"/>&gt;<br/>
		/// 4. <see cref="InventoryItem.productWorkgroupID"/> is null or <see cref="InventoryItem.productWorkgroupID"/> = Owened&lt;<see cref="ProductionOrdersCreateFilter.currentOwnerID"/>&gt;<br/>
        /// </summary>
        public class ProductionOrdersCreateFilterProjectionAttribute : PX.TM.OwnedFilter.ProjectionAttribute
        {
            ...
            typeof(Select2<,,>),
				...
				InnerJoin<INSite, On<INSite.siteID, Equal<INItemPlan.siteID>>,
