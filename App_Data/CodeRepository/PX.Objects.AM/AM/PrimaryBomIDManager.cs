...
namespace PX.Objects.AM
{
    ...
    public class PrimaryBomIDManager : IDManagerBase
    {
		...
		public string GetItemSitePrimary(int? inventoryID, int? siteID, int? subItemID, bool useDefault)
        {
            return GetItemSitePrimary(GetINItemSite(inventoryID, siteID), subItemID, useDefault);
        }
