...
namespace PX.Objects.AM
{
        ...
        And<AMClockTranSplit.lineNbr, Equal<Current<AMClockTran.lineNbr>>>>>
    {
     ...
     : base(graph)
        ...
        public virtual IStatus AvailabilityFetchTranUom(PXCache sender, AMClockTran Row, bool ExcludeCurrent)
        {
        ...
        public override void Availability_FieldSelecting(PXCache sender, PXFieldSelectingEventArgs e)
        {
            ...
            if (!PXLongOperation.Exists(sender.Graph.UID))
            {
                IStatus availability = AvailabilityFetchTranUom(sender, (AMClockTran)e.Row, !(e.Row != null && (((AMClockTran)e.Row).Released == true)));
