...
#pragma warning restore PX1073
        ...
        public PXInitializeState<AMConfiguration> initializeState;
        ...
        [PXButton]
        [PXUIField(DisplayName = "Set as Default Configuration", MapViewRights = PXCacheRights.Select, MapEnableRights = PXCacheRights.Update)]
        ...
        {
            var context = config.GetScreenConfigurationContext<ConfigurationMaint, AMConfiguration>();
            ...
            context.AddScreenConfigurationFor(screen =>
            {
                return screen
                    ...
                    .WithActions(actions =>
                    {
                        actions.Add(g => g.TestConfiguration, c => c.WithCategory(customOtherCategory));
                        actions.Add(g => g.SetAsDefaultForItem, c => c.WithCategory(customOtherCategory));
                        actions.Add(g => g.CopyConfiguration, c => c.WithCategory(customOtherCategory));
                        actions.Add(g => g.SetActiveConfiguration, c => c.WithCategory(customOtherCategory));
                    });
            });
        }
