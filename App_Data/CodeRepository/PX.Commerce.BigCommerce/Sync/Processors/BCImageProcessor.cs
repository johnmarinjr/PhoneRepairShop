...
namespace PX.Commerce.BigCommerce
{
	...
	public class BCImageProcessor : BCProcessorBulkBase<BCImageProcessor, BCImageEntityBucket, MappedStockItem>, IProcessor
	{
		...
		public override List<BCImageEntityBucket> GetBucketsImport(List<BCSyncStatus> ids)
		{
			throw new NotImplementedException();
		}
		#endregion
				...
				try
				{
					...
					if (localObj.TemplateItemID?.Value == null)//for product
					{
						...
						if (!existingImages.TryGetValue(localObj.ExternalInventoryID, out files))
						{
							...
							try
							{
								productImages = productImageDataProvider.GetAll(localObj.ExternalInventoryID)?.ToList();
							}
		...
		public override List<BCImageEntityBucket> GetBucketsExport(List<BCSyncStatus> ids)
		{
