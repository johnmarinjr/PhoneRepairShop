...
namespace PX.Commerce.BigCommerce
{
		...
		where TPrimaryMapped : class, IMappedEntity, new()
	{
		...
		protected virtual CustomerAddressData MapLocationExport(MappedLocation addressObj)
		{
			...
			{
				var stateValue = helper.GetSubstituteExternByLocal(BCSubstitute.GetValue(Operation.ConnectorType, BCSubstitute.State), addressImpl.State.Value, addressImpl.State.Value);
