...
namespace PX.Commerce.BigCommerce.API.REST
{
	...
	[CommerceDescription(BigCommerceCaptions.Product, FieldFilterStatus.Filterable, FieldMappingStatus.ImportAndExport)]
    public class ProductData : BCAPIEntity
	{
		...
		{
			get => PreorderReleaseDate.TDToString(format: "yyyy'-'MM'-'dd'T'HH':'mm':'sszzz");
			set => PreorderReleaseDate = value.ToDate();
		}
		...
		public List<ProductsCustomFieldData> CustomFieldsData { get; set; }
	...
	[CommerceDescription(BigCommerceCaptions.ProductQuantityData, FieldFilterStatus.Filterable, FieldMappingStatus.ImportAndExport)]
