...
namespace PX.Data
{
	public partial class PXSearchableAttribute : PXEventSubscriberAttribute
	{
		...
		protected class UserRecordsUpdater
		{
			...
			public void UpdateUserRecordsCachedContentOnRowPersisted(PXGraph screenGraph, PXRowPersistedEventArgs e, Guid noteID, 
																	 IRecordCachedContentBuilder contentBuilder, ILogger logger)
			{
				...
				string content = e.Operation.Command() != PXDBOperation.Delete
					? RebuildCachedContentOfUserRecords(screenGraph, noteID, entity, entityType, contentBuilder, logger)
					: string.Empty;
			...
			private string RebuildCachedContentOfUserRecords(PXGraph screenGraph, Guid noteID, IBqlTable entity, Type entityType,
															 IRecordCachedContentBuilder contentBuilder, ILogger logger)
			{
				...
				if (!cachedRecordContents.TryGetValue(entityKey, out string content))
				{
										...
										transactionID, entityType.FullName, noteID))
					{
						...
						content = contentBuilder.BuildCachedContent(screenGraph, entity);
