    ...
    public class RSSVRepairPriceMaint : PXGraph<RSSVRepairPriceMaint, RSSVRepairPrice>
    {
        ...
        public SelectFrom<RSSVRepairItem>.
            Where<RSSVRepairItem.serviceID.
                ...
                And<RSSVRepairItem.deviceID.
                    IsEqual<RSSVRepairPrice.deviceID.FromCurrent>>>.View RepairItems;
        #endregion

        //Update the price and repair item type when the inventory ID of the repair item is updated.
        ...
        protected void _(Events.FieldDefaulting<RSSVRepairItem, RSSVRepairItem.basePrice> e)
        {
            ...
            if (row.InventoryID != null)
            {
                ...
                InventoryItemCurySettings curySettings = InventoryItemCurySettings.PK.Find(this, item.InventoryID, Accessinfo.BaseCuryID ?? "USD");
        ...
        //Update the IsDefault field of other records with the same repair item type when the IsDefault field is updated.
        protected void _(Events.RowUpdated<RSSVRepairItem> e)
        {
            ...
            //Use LINQ to select the repair items with the same repair item type as in the updated row.
            var repairItems = RepairItems.Select().Where(item => item.GetItem<RSSVRepairItem>().RepairItemType == row.RepairItemType);
