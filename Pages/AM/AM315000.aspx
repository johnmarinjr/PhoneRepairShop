...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" BorderStyle="NotSet" PrimaryView="header" TypeName="PX.Objects.AM.ClockEntry">
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Name="AMClockItemLineSplittingExtension_GenerateNumbers" Visible="False"/>
            <px:PXDSCallbackCommand CommitChanges="True" Name="AMClockItemLineSplittingExtension_ShowSplits" Visible="True" />  
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="header" Caption="Document Summary"
        ...
        <Template>
            ...
            <px:PXSelector ID="edShift" runat="server" DataField="ShiftCD" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="764px" Caption="Line Details" DesignView="Content" CaptionVisible="True"
        Key="AMClockItemLineSplittingExtension_lsselect" AutoCallBack-Command="Refresh" AutoCallBack-Enabled="True" AutoCallBack-Target="optform" Height="500px">
        <px:PXFormView ID="optform" runat="server" Width="100%" CaptionVisible="False" DataMember="AMClockItemLineSplittingExtension_LotSerOptions" DataSourceID="ds"
            ...
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" Text="Generate" Height="20px" CommandName="AMClockItemLineSplittingExtension_GenerateNumbers" CommandSourceID="ds">
                </px:PXButton>
            </Template>
        </px:PXFormView>
