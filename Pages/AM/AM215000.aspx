...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" Width="100%" Caption="ECO" DataMember="Documents" DataSourceID="ds" 
        ...
        <Template>
            ...
            <px:PXTextEdit ID="edRevisionID" runat="server" DataField="RevisionID" CommitChanges="True" AutoRefresh="True" />
            <px:PXSelector ID="edBOMID" runat="server" DataField="BOMID" AllowEdit="True" CommitChanges="True" />
                            ...
                            <Levels>
                                <px:PXGridLevel DataMember="BomOperRecords" >
                                    <RowTemplate>
                                        ...
                                        <px:PXCheckBox ID="edOperControlPoint" runat="server" DataField="ControlPoint" />
                                    </RowTemplate>
                                    <Columns>
