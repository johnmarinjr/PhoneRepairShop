...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource  EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AM.VendorShipmentEntry" PrimaryView="Document">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="AMVendorShipmentLineSplittingExtension_GenerateNumbers" />
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="AMVendorShipmentLineSplittingExtension_ShowSplits" DependOnGrid="grid" />
            <px:PXDSCallbackCommand Name="AddProductionOrders" Visible="False" />
            <px:PXDSCallbackCommand Name="AddShipLines" Visible="False" />
            <px:PXDSCallbackCommand Name="AddShipLinesClose" Visible="False" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
            ...
            <px:PXTabItem Text="Details">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="height: 250px;" Width="100%" SkinID="DetailsInTab" StatusField="Availability" 
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="AMVendorShipmentLineSplittingExtension_ShowSplits" CommandSourceID="ds" DependOnGrid="grid" />
                                <px:PXToolBarButton DependOnGrid="gridOperations" >
                                    <AutoCallBack Command="AddProductionOrders" Target="ds" />
                                </px:PXToolBarButton>
...
<%--					<px:PXPanel runat="server" Caption="Service Management" RenderStyle="Fieldset">
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 500px;" Width="764px" Caption="Line Details" CaptionVisible="True"
        Key="AMVendorShipmentLineSplittingExtension_lsselect" AutoCallBack-Command="Refresh" AutoCallBack-Enabled="True" AutoCallBack-Target="optform">
        <px:PXFormView ID="optform" runat="server" Width="100%" CaptionVisible="False" DataMember="AMVendorShipmentLineSplittingExtension_LotSerOptions" DataSourceID="ds" SkinID="Transparent">
            <Parameters>
            ...
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" Text="Generate" Height="20px" CommandName="AMVendorShipmentLineSplittingExtension_GenerateNumbers" CommandSourceID="ds"></px:PXButton>
            </Template>
        </px:PXFormView>
    ...
    <px:PXSmartPanel runat="server" Height="360px" TabIndex="9999" Width="1200px" ID="edPanelShipLineCreate" LoadOnDemand="True" CaptionVisible="True" CloseButtonDialogResult="Abort"
            Caption="Production Order Lookup" Key="ShipmentProdOrders" AutoCallBack-Command="Refresh" AutoCallBack-Target="ShipLinesProdGrid" CallBackMode-CommitChanges="True" > 
        <px:PXGrid ID="ShipLinesProdGrid" runat="server" Height="360px" Width="100%" DataSourceID="ds" AutoAdjustColumns="true" SyncPosition="True" SkinID="Details" > 
            <Levels>
                <px:PXGridLevel DataMember="ShipmentProdOrders" DataKeyNames="OrderType,ProdOrdID,OperationID" > 
                    <RowTemplate>
						<px:PXCheckBox runat="server" DataField="Selected" ID="LinkGridCheckSelect"  CommitChanges="true" />
						<px:PXSelector runat="server" ID="ProdLookupOrderType" DataField="AMProdItem__OrderType" AllowEdit="true"/>
						<px:PXSelector runat="server" ID="ProdLookupProdNbr" DataField="AMProdItem__ProdOrdID" AllowEdit="true" />
                        <px:PXTextEdit runat="server" ID="ProdLookupOperationCD" Datafield="OperationCD" />
                        <px:PXSegmentMask  ID="ProdLookupInventoryID" runat="server" DataField="AMProdItem__InventoryID" AllowEdit="true" />
                        <px:PXSegmentMask ID="ProdLookupSubItemID" runat="server" DataField="AMProdItem__SubItemID" />
                        <px:PXSegmentMask  ID="ProdLookupSiteID" runat="server" DataField="AMProdItem__SiteID" AllowEdit="true" />
					    <px:PXTextEdit runat="server" ID="ProdLookupUOM" DataField="AMProdItem__UOM" />
                        <px:PXTextEdit runat="server" ID="ProdLookupDescr" DataField="AMProdItem__Descr" />
                        <px:PXNumberEdit ID="ProdLookupOPQtytoProd" runat="server" DataField="QtytoProd" />
                        <px:PXNumberEdit ID="ProdLookupOPShippedQuantity" runat="server" DataField="ShippedQuantity" />
                        <px:PXNumberEdit ID="ProdLookupOPShipRemainingQty" runat="server" DataField="ShipRemainingQty" />
                    </RowTemplate>
					<Columns>
						<px:PXGridColumn DataField="Selected" Type="CheckBox" TextAlign="Center" AutoCallBack="True" AllowCheckAll="true" />
						<px:PXGridColumn DataField="AMProdItem__OrderType" Width="70px" />
						<px:PXGridColumn DataField="AMProdItem__ProdOrdID" Width="130px" />
                        <px:PXGridColumn DataField="OperationCD" Width="90px" />
                        <px:PXGridColumn DataField="AMProdItem__InventoryID" Width="130px" />
						<px:PXGridColumn DataField="AMProdItem__SubItemID" Width="65px" />
                        <px:PXGridColumn DataField="AMProdItem__SiteID" Width="130px" />
						<px:PXGridColumn DataField="AMProdItem__UOM" Width="80px" />
                        <px:PXGridColumn DataField="AMProdItem__Descr" Width="130px" />
                        <px:PXGridColumn DataField="QtytoProd" Width="130px" />
                        <px:PXGridColumn DataField="ShippedQuantity" Width="130px" />
                        <px:PXGridColumn DataField="ShipRemainingQty" Width="130px" />
                    </Columns>
        ...
        <px:PXPanel ID="PanelAddShipmentinesButtons" runat="server" SkinID="Buttons">
            <px:PXButton ID="btnAddShipLines" runat="server" CommandName="AddShipLines" CommandSourceID="ds" Text="Add" />
            <px:PXButton ID="btnAddAndCloseShipLines" runat="server" CommandName="AddShipLinesClose" CommandSourceID="ds" Text="Add & Close" DialogResult="OK" />
            <px:PXButton ID="btnCancelLink" runat="server" DialogResult="Abort" Text="Cancel" />
        </px:PXPanel>
    </px:PXSmartPanel>
</asp:Content>
