		...
		<Items>
			<px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXCheckBox ID="edPreassignLotSerial" runat="server" DataField="PreassignLotSerial" CommitChanges="True" />
                    <px:PXDropDown ID="edParentLotSerialRequired" runat="server" DataField="ParentLotSerialRequired" />
                </Template>
			</px:PXTabItem>
