...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" BorderStyle="NotSet" PrimaryView="batch" TypeName="PX.Objects.AM.LaborEntry" HeaderDescriptionField="TranDesc">
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Name="LineSplittingExtension_GenerateNumbers" Visible="False"/>
            <px:PXDSCallbackCommand CommitChanges="True" Name="LineSplittingExtension_ShowSplits" Visible="False" DependOnGrid="grid"/>
    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" SyncPosition="True" >
        <Levels>
            <px:PXGridLevel DataMember="transactions" DataKeyNames="DocType,BatNbr,LineNbr">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="ShiftCD" AutoCallBack="True" />
		...
		<ActionBar ActionsText="False">
		    <CustomItems>
                ...
                <px:PXToolBarButton Text="Late Assignment" Key="cmdLA" CommandName="lateAssignmentEntry" CommandSourceID="ds" DependOnGrid="grid" />
            </CustomItems>
		</ActionBar>
	</px:PXGrid>
