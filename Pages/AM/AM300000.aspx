...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
		...
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="LineSplittingExtension_GenerateNumbers" CommitChanges="True" Visible="False" />
            <px:PXDSCallbackCommand Name="LineSplittingExtension_ShowSplits" CommitChanges="True" Visible="False" DependOnGrid="grid" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
		...
		<Levels>
			<px:PXGridLevel DataMember="transactions" DataKeyNames="DocType,BatNbr,LineNbr">
                <RowTemplate>
                    ...
                    <px:PXSelector ID="edParentLotSerial" runat="server" DataField="ParentLotSerialNbr" CommitChanges="true" NullText="<SPLIT>" AutoRefresh="True"/>
                </RowTemplate>
                <Columns>
                    ...
                    <px:PXGridColumn DataField="ParentLotSerialNbr" NullText="&lt;SPLIT&gt;"/>
                </Columns>
			</px:PXGridLevel>
		</Levels>
		...
		<ActionBar ActionsText="False">
            <CustomItems>
		        <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LineSplittingExtension_ShowSplits" CommandSourceID="ds" DependOnGrid="grid" />
            </CustomItems>
		</ActionBar>
	</px:pxgrid>
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="764px" Caption="Line Details" DesignView="Content" CaptionVisible="True"
        Key="LineSplittingExtension_lsselect" AutoCallBack-Command="Refresh" AutoCallBack-Enabled="True" AutoCallBack-Target="optform" Height="500px">

        <px:PXFormView ID="optform" runat="server" Width="100%" CaptionVisible="False" DataMember="LineSplittingExtension_LotSerOptions" DataSourceID="ds"
            ...
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" Text="Generate" Height="20px" CommandName="LineSplittingExtension_GenerateNumbers" CommandSourceID="ds">
                </px:PXButton>
            </Template>
        </px:PXFormView>
            ...
            <Levels>
                <px:PXGridLevel DataMember="splits">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="ExpireDate" Width="90px" />
                        <px:PXGridColumn DataField="ParentLotSerialNbr" />
                    </Columns>
                    <RowTemplate>
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" />
                        ...
                        <px:PXSelector ID="edParentLotSerSplit" runat="server" DataField="ParentLotSerialNbr" CommitChanges="true"  />
                    </RowTemplate>
                    <Layout ColumnsMenu="False" />
                </px:PXGridLevel>
            </Levels>
