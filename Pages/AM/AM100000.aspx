...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" 
        ...
        <Template>
            ...
            <px:PXLayoutRule runat="server" GroupCaption="Consolidation" StartGroup="True"/>
            <px:PXCheckBox ID="edUseDaysSupplytoConsolidateOrders" CommitChanges="True" runat="server" DataField="UseDaysSupplytoConsolidateOrders"/>
            <px:PXCheckBox ID="edUseLongTermConsolidationBucket" CommitChanges="True" runat="server" DataField="UseLongTermConsolidationBucket"/>
            <px:PXNumberEdit ID="edConsolidateAfterDays" runat="server" DataField="ConsolidateAfterDays" />
            <px:PXNumberEdit ID="edBucketDays" runat="server" DataField="BucketDays" />
        </Template>
	</px:PXFormView>
</asp:Content>
