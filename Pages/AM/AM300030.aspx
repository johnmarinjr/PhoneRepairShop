<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AM300030.aspx.cs"
    Inherits="Page_AM300030" Title="Scan Materials" %>
...
<asp:content id="cont1" contentplaceholderid="phDS" runat="Server">
    ...
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AM.ScanMaterial+Host" PrimaryView="HeaderView">
        <CallbackCommands>
			<px:PXDSCallbackCommand Name="AMMaterialLineSplittingExtension_GenerateNumbers" Visible="false" />
			<px:PXDSCallbackCommand Name="AMMaterialLineSplittingExtension_ShowSplits" Visible="false" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:content>
