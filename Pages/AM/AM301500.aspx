...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" BorderStyle="NotSet" PrimaryView="Document" TypeName="PX.Objects.AM.DisassemblyEntry" HeaderDescriptionField="Description">
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="AMDisassembleMaterialTranLineSplittingExtension_GenerateNumbers" />
		    <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="AMDisassembleMaterialTranLineSplittingExtension_ShowSplits" DependOnGrid="gridMaterial" />
		    <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="AMDisassembleMasterTranLineSplittingExtension_GenerateNumbers" />
		    <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="AMDisassembleMasterTranLineSplittingExtension_ShowSplits" />
...
<px:PXTab ID="tab" runat="server" Width="100%" >
    <Items>
            ...
            <Template>
                <px:PXGrid ID="gridMaterial" runat="server" DataSourceID="ds" SkinID="DetailsInTab" Width="100%" SyncPosition="True" 
                    ...
                    <Levels>
                        <px:PXGridLevel DataMember="MaterialTransactionRecords" DataKeyNames="DocType,BatNbr,LineNbr">
                            <RowTemplate>
                                ...
                                <px:PXTextEdit ID="edParentLotSerialNbr" runat="server" DataField="ParentLotSerialNbr" />
                            ...
                            <Columns>
                                ...
                                <px:PXGridColumn DataField="ParentLotSerialNbr" Width="180px" AutoCallBack="true" />
		            ...
		            <ActionBar ActionsText="False">
		                <CustomItems>
		                    <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="AMDisassembleMaterialTranLineSplittingExtension_ShowSplits" CommandSourceID="ds" DependOnGrid="gridMaterial" />
        ...
        <px:PXTabItem Text="Line Details">
            <Template>
                <px:PXFormView ID="lsoptform" runat="server" Width="100%" DataMember="AMDisassembleMasterTranLineSplittingExtension_LotSerOptions"
                    ...
                    <Template>
                        ...
                        <px:PXButton ID="btnGenerate2" runat="server" Text="Generate" CommandName="AMDisassembleMasterTranLineSplittingExtension_GenerateNumbers"
                            CommandSourceID="ds" />
                    </Template>
                </px:PXFormView>
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 360px;"
        Width="764px" Caption="Material Line Details" DesignView="Content" CaptionVisible="True" Key="AMDisassembleMaterialTranLineSplittingExtension_lsselect" AutoCallBack-Command="Refresh"
        AutoCallBack-Enabled="True" AutoCallBack-Target="optform">
        <px:PXFormView ID="optform" runat="server" Width="100%" CaptionVisible="False" DataMember="AMDisassembleMaterialTranLineSplittingExtension_LotSerOptions"
            DataSourceID="ds" SkinID="Transparent">
            <Parameters>
            ...
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" Text="Generate" Height="20px" CommandName="AMDisassembleMaterialTranLineSplittingExtension_GenerateNumbers"
                    CommandSourceID="ds">
                </px:PXButton>
            </Template>
        </px:PXFormView>
