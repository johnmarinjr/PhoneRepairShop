...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:pxdatasource ID="ds" runat="server" Visible="True" BorderStyle="NotSet" PrimaryView="ProdMaintRecords" TypeName="PX.Objects.AM.ProdMaint">
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Name="MatlLineSplittingExtension_ShowSplits" Visible="False" />
		...
		<Items>
			<px:PXTabItem Text="General" >
                <Template>
                    ...
                    <px:PXCheckBox runat="server" DataField="PreassignLotSerial" ID="edPreassignLotSerial" CommitChanges="True" />
                    <px:PXDropdown runat="server" DataField="ParentLotSerialRequired" ID="edParentLotSerialRequired" CommitChanges="True" />
                </Template>
			</px:PXTabItem>
            ...
            <Template>
                <px:PXFormView ID="lsoptform" runat="server" Width="100%" DataMember="ItemLineSplittingExtension_LotSerOptions"
                    ...
                    <Template>
                        ...
                        <px:PXButton ID="btnGenerate2" runat="server" Text="Generate" CommandName="ItemLineSplittingExtension_GenerateNumbers"
                            CommandSourceID="ds" />
                    </Template>
                </px:PXFormView>
                    ...
                    <Levels>
                        <px:PXGridLevel DataMember="splits" DataKeyNames="OrderType,ProdOrdID,SplitLineNbr">
                            ...
                            <Columns>
                                ...
                                <px:PXGridColumn DataField="LotSerialNbr" AllowShowHide="Server" Width="198px" CommitChanges="true"/>
                                ...
                                <px:PXGridColumn AllowNull="False" DataField="QtyComplete" TextAlign="Right" Width="90px" />
                                <px:PXGridColumn AllowNull="False" DataField="QtyScrapped" TextAlign="Right" Width="90px" />
                                <px:PXGridColumn AllowNull="False" DataField="QtyRemaining" TextAlign="Right" Width="90px" />
