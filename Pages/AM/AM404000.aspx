...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AM.MRPDetail" PrimaryView="invlookup" BorderStyle="NotSet" >
		<CallbackCommands>
            <px:PXDSCallbackCommand Visible="false" Name="AMRPPlan$RefNbr$Link" DependOnGrid="grid" CommitChanges="True" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
		...
		<Levels>
			<px:PXGridLevel DataMember="MRPRecs" >
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="RefNbr" RenderEditorText="True" LinkCommand="AMRPPlan$RefNbr$Link" Width="175px" />
