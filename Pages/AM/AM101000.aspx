            ...
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXPanel ID="pnlDataEntrySettings" runat="server" Caption="Data Entry Settings" RenderStyle="Fieldset">
                        ...
                        <px:PXCheckBox ID="edRequireECRBeforeECO" runat="server" DataField="RequireECRBeforeECO"/>
                    </px:PXPanel>
                    ...
                    <px:PXPanel ID="PXPanel2" runat="server" Caption="Work Center Defaults" RenderStyle="Fieldset">
