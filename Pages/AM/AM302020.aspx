<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AM302020.aspx.cs"
    Inherits="Page_AM302020" Title="Scan Move" %>
...
<asp:content id="cont1" contentplaceholderid="phDS" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ActionCallback(callbackContext) {
            ...
            if ((callbackContext.info.name.startsWith("scan") || callbackContext.info.name == "ElapsedTime") && callbackContext.control.longRunInProcess == null && edInfoMessageSoundFile != null) {
    ...
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AM.ScanLabor+Host" PrimaryView="HeaderView">
        <CallbackCommands>
			<px:PXDSCallbackCommand Name="LineSplittingExtension_GenerateNumbers" Visible="false" />
			<px:PXDSCallbackCommand Name="LineSplittingExtension_ShowSplits" Visible="false" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:content>
                    ...
                    <px:PXGrid ID="gridPicked" runat="server" DataSourceID="ds" SyncPosition="true" Width="100%" SkinID="DetailsInTab">
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                <Columns>
                                    <px:PXGridColumn DataField="LaborType" Width="90px" />
                                    <px:PXGridColumn DataField="LaborCodeID" Width="90px" />
                                    ...
                                    <px:PXGridColumn DataField="EmployeeID" Width="90px" />
                                    <px:PXGridColumn DataField="ShiftCD" />
                                    <px:PXGridColumn DataField="LaborTime" Width="90px" />
                                </Columns>
                                <RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" />
                                    <px:PXSegmentMask ID="edOperationID" runat="server" DataField="OperationID" AutoRefresh="True" />
