...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" 
        ...
        <CallbackCommands>
            <px:PXDSCallbackCommand CommitChanges="True" Name="AMClockTranLineSplittingExtension_GenerateNumbers" Visible="False"/>
            <px:PXDSCallbackCommand CommitChanges="True" Name="AMClockTranLineSplittingExtension_ShowSplits" Visible="True" />   
        </CallbackCommands>
	</px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
		...
		<Levels>
			<px:PXGridLevel  DataMember="UnapprovedTrans" DataKeyNames="EmployeeID, LineNbr">
			    <RowTemplate>
                    ...
                    <px:PXSelector ID="edShiftCD" runat="server" DataField="ShiftCD" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="764px" Caption="Line Details" DesignView="Content" CaptionVisible="True"
        Key="AMClockTranLineSplittingExtension_lsselect" AutoCallBack-Command="Refresh" AutoCallBack-Enabled="True" AutoCallBack-Target="optform" Height="500px">
        <px:PXFormView ID="optform" runat="server" Width="100%" CaptionVisible="False" DataMember="AMClockTranLineSplittingExtension_LotSerOptions" DataSourceID="ds"
            ...
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" Text="Generate" Height="20px" CommandName="AMClockTranLineSplittingExtension_GenerateNumbers" CommandSourceID="ds">
                </px:PXButton>
            </Template>
        </px:PXFormView>
