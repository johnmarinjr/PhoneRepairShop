...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" runat="server" PrimaryView="ExceptRecs" TypeName="PX.Objects.AM.MRPExcept" Visible="True" BorderStyle="NotSet" >
		<CallbackCommands>
            <px:PXDSCallbackCommand Visible="false" Name="AMRPExceptions$RefNbr$Link" DependOnGrid="grid" CommitChanges="True" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
		...
		<Levels>
			<px:PXGridLevel DataMember="ExceptRecs">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="RefNbr" RenderEditorText="True" LinkCommand="AMRPExceptions$RefNbr$Link" Width="175px" />
