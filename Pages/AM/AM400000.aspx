...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" Width="100%" runat="server" PrimaryView="Detailrecs" TypeName="PX.Objects.AM.MRPDisplay" Visible="True" BorderStyle="NotSet" >
        <CallbackCommands>
            <px:PXDSCallbackCommand Visible="false" Name="AMRPDetail$RefNbr$Link" DependOnGrid="grid" CommitChanges="True" />
            <px:PXDSCallbackCommand Visible="false" Name="AMRPDetail$ParentRefNbr$Link" DependOnGrid="grid" CommitChanges="True" />
            <px:PXDSCallbackCommand Visible="false" Name="AMRPDetail$ProductRefNbr$Link" DependOnGrid="grid" CommitChanges="True" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    <px:PXFormView runat="server" ID="form" DataMember="MRPDisplayFilters" DefaultControlID="ds" Width="100%">
    <Template>
      <px:PXLayoutRule runat="server" ID="PXLayoutRule11" StartColumn="True" LabelsWidth="M"/>
      <px:PXTextEdit runat="server" ID="edRefNbr" DataField="RefNbr" CommitChanges="True" />
      <px:PXLayoutRule runat="server" ID="PXLayoutRule18" StartColumn="True" LabelsWidth="M"/>
      <px:PXTextEdit runat="server" ID="edParentRefNbr" DataField="ParentRefNbr" CommitChanges="True"/>
      <px:PXLayoutRule runat="server" ID="PXLayoutRule19" StartColumn="True" LabelsWidth="M"/>
      <px:PXTextEdit runat="server" ID="edProductRefNbr" DataField="ProductRefNbr" CommitChanges="True"/></Template></px:PXFormView>
    ...
    <Levels>
        <px:PXGridLevel DataMember="Detailrecs" >
            <RowTemplate>
                ...
                <px:PXTextEdit ID="edPreferredVendorID_Vendor_AcctName" runat="server" DataField="Vendor__AcctName"/>
            ...
            <Columns>
                ...
                <px:PXGridColumn DataField="Vendor__AcctName" Width="120px"/>
                ...
                <px:PXGridColumn DataField="RefNbr" RenderEditorText="True" LinkCommand="AMRPDetail$RefNbr$Link" Width="175px" />
                <px:PXGridColumn DataField="ParentRefNbr" RenderEditorText="True" LinkCommand="AMRPDetail$ParentRefNbr$Link" Width="175px" />
                <px:PXGridColumn DataField="ProductRefNbr" RenderEditorText="True" LinkCommand="AMRPDetail$ProductRefNbr$Link" Width="175px" />
