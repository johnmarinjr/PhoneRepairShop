		...
		<Items>
					...
					<px:PXGrid ID="detgrid2" runat="server" Height="300px" Style="z-index: 100" Width="100%" SkinID="DetailsInTab"
						...
						<Levels>
							<px:PXGridLevel DataMember="APPost">
								...
								<Columns>
									<px:PXGridColumn DataField="APRegister__BranchID" RenderEditorText="True" />
									<px:PXGridColumn DataField="BatchNbr" LinkCommand="ViewCurrentBatch" />
									<px:PXGridColumn DataField="SourceDocType" Type="DropDownList" />
									...
									<px:PXGridColumn DataField="CuryAmt" TextAlign="Right" />
									<px:PXGridColumn DataField="CuryPPDAmt" TextAlign="Right" />
									<px:PXGridColumn DataField="CuryWhTaxAmt" TextAlign="Right" />
									<px:PXGridColumn DataField="FinPeriodID" />
									<px:PXGridColumn DataField="ApplicationDate" />
									...
									<px:PXGridColumn DataField="APRegister__DocDesc" />
									<px:PXGridColumn DataField="APRegister__CuryID" />
									<px:PXGridColumn DataField="APRegister__FinPeriodID" />
									<px:PXGridColumn DataField="APInvoice__InvoiceNbr" />
									<px:PXGridColumn DataField="APAdjust2__TaxInvoiceNbr" />
									<px:PXGridColumn DataField="APInvoice__SuppliedByVendorID" DisplayMode="Hint"/>
									<px:PXGridColumn DataField="APAdjust2__PendingPPD" TextAlign="Center" Type="CheckBox" />
									<px:PXGridColumn DataField="APAdjust2__PPDDebitAdjRefNbr" LinkCommand="ViewPPDDebitAdj"  />
                                    <px:PXGridColumn DataField="APAdjust2__HasExpiredComplianceDocuments" Type="CheckBox" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" MinHeight="150" />
			...
			<px:PXTabItem Text="Remittance">
				<Template>
					...
					<px:PXCheckBox CommitChanges="True" ID="chkPrintCheck" runat="server" DataField="PrintCheck" Size="M" />
					<px:PXSelector ID="edbatchPaymentRefNbr" runat="server" DataField="BatchPaymentRefNbr" Enabled="False" AllowEdit="True" />
				</Template>
			</px:PXTabItem>
