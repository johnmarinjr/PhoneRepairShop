...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AP.APScheduleMaint"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Document_Detail">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowUpdate="False" DataField="RefNbr" LinkCommand="ViewDocument" AutoCallBack="true" />
                                    <px:PXGridColumn DataField="VendorID" AllowUpdate="False" />
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="CuryOrigDocAmt" TextAlign="Right" AllowUpdate="False" MatrixMode="True" />
                                    <px:PXGridColumn DataField="CuryID" AllowUpdate="False" />
                    ...
                    <px:PXGrid ID="grid2" runat="server" Height="400px" Width="100%"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Document_History">
                                ...
                                <Columns>
                                    <px:PXGridColumn AllowUpdate="False" DataField="DocType" Type="DropDownList" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="RefNbr" LinkCommand="ViewGenDocument" />
                                    <px:PXGridColumn DataField="VendorID" AllowUpdate="False" />
                                    <px:PXGridColumn DataField="VendorID_Vendor_acctName" />
                                    ...
                                    <px:PXGridColumn AllowUpdate="False" DataField="FinPeriodID" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryOrigDocAmt" TextAlign="Right" AllowUpdate="False" MatrixMode="True" />
                                    <px:PXGridColumn DataField="CuryID" AllowUpdate="False" MatrixMode="True" />
                                    <px:PXGridColumn AllowNull="False" DataField="DocDesc" AllowUpdate="False" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
