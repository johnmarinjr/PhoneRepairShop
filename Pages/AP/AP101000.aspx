		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXCheckBox SuppressLabel="True" ID="chkReclassifyInvoices" runat="server" DataField="ReclassifyInvoices" AlignLeft="True" Size="Empty" CommitChanges="true" />
					...
					<px:PXLayoutRule runat="server" />
					<px:PXLayoutRule runat='server' ControlSize="M" LabelsWidth="XM" StartColumn="True" />
					...
					<px:PXDropDown ID="edIntercompanyExpenseAccountDefault" runat="server" DataField="IntercompanyExpenseAccountDefault" />
			...
			<px:PXTabItem Text="1099 Settings">
				<Template>
					<px:PXFormView ID="DiscountParameters" runat="server" DataMember="Setup" RenderStyle="Simple" SkinID="Transparent">
                        <Template>
							<px:PXLayoutRule runat="server" StartRow="true" LabelsWidth="SM" ControlSize="XM" />					
							<px:PXDropDown ID="edPrintDirectSalesOn" runat="server" DataField="PrintDirectSalesOn" AllowEdit="True" />					
						</Template>
					</px:PXFormView>
					<px:PXGrid ID="grid" runat="server" Height="400" Width="100%" Style="z-index: 100" AllowSearch="true" DataSourceID="ds"
