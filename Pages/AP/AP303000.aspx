...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="494px" Style="z-index: 100" Width="100%" DataMember="CurrentVendor" MarkRequired="Dynamic" >
		...
		<Items>
			...
			<px:PXTabItem Text="General" RepaintOnDemand="false">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Vendor Properties" StartGroup="True" />
						...
						<px:PXCheckBox runat="server" ID="chkBoxT5018" DataField="VendorT5018" CommitChanges="True" />
						<px:PXDropDown runat="server" ID="edBoxT5018" DataField="BoxT5018" CommitChanges="True" />
						<px:PXMaskEdit runat="server" ID="edSIN" DataField="SocialInsNum" CommitChanges="True" />
						<px:PXTextEdit runat="server" ID="edBusinessNum" DataField="BusinessNum" CommitChanges="True" />
			...
			<px:PXTabItem Text="Balances" LoadOnDemand="True" RepaintOnDemand="false">
				<Template>
					<px:PXGrid ID="PXGrid1" runat="server" Height="300px" Width="100%" SkinID="DetailsInTab" DataSourceID="ds">
						<Levels>
							<px:PXGridLevel DataMember="VendorBalanceByBaseCurrency">
								<Columns>
									<px:PXGridColumn DataField="BaseCuryID" />
									<px:PXGridColumn DataField="Balance" />
									<px:PXGridColumn DataField="DepositsBalance" />
								...
								<RowTemplate>
									...
									<px:PXNumberEdit ID="edDepositsBalance" runat="server" DataField="DepositsBalance" />
			...
			<px:PXTabItem Text="Tax Agency" BindingContext="tab" VisibleExp="DataControls[&quot;chkTaxAgency&quot;].Value = 1">
				<Template>
