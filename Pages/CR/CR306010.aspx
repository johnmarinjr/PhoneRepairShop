...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" UDFTypeField="Type" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Activities"
		...
		FilesIndicator="True" DefaultControlID="edSubject" Width="100%" AllowCollapse="true">
				<Template>
					<px:PXPanel ID="PXPanel1" runat="server" RenderStyle="Simple" ContentLayout-OuterSpacing="Around">
						...
						<px:PXSelector ID="edShiftID" runat="server" DataField="TimeActivity.ShiftID" AutoRefresh="true"/>
