...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <px:PXDataSource EnableAttributes="true" UDFTypeField="ClassID" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.CR.BusinessAccountMaint"
        ...
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ViewMergingDuplicate" Visible="false" />
            <px:PXDSCallbackCommand Name="ViewLinkingDuplicate" Visible="false" />
    ...
    <px:PXTab ID="tab" runat="server" DataSourceID="ds" Height="500px" Width="100%" DataMember="CurrentBAccount">
        <Items>
                            ...
                            <Template>
                                <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="CRM" StartColumn="True" ControlSize="XM" LabelsWidth="M" />
                                    ...
                                    <px:PXSegmentMask ID="edParentBAccountID" runat="server" DataField="ParentBAccountID" 
                                        AllowEdit="True" FilterByAllFields="True" TextMode="Search" DisplayMode="Hint" CommitChanges="true" AutoRefresh="True" />
            ...
            <px:PXTabItem Text="Duplicates" BindingContext="DefContact" VisibleExp="DataControls[&quot;edDuplicateFound&quot;].Value == true" LoadOnDemand="True">
                <Template>
					<px:PXGrid ID="PXGridDuplicates" runat="server" DataSourceID="ds" SkinID="Inquire" Width="100%" Height="200px" MatrixMode="True" SyncPosition="True" 
						...
						<ActionBar>
							<CustomItems>
								<px:PXToolBarButton Text="Merge" Key="cmdMerge" DependOnGrid="PXGridDuplicates" StateColumn="CanBeMerged">
						...
						<Levels>
							<px:PXGridLevel DataMember="DuplicatesForMerging">
								<Columns>
									<px:PXGridColumn DataField="DuplicateContact__BAccountID" TextAlign="Left" LinkCommand="ViewMergingDuplicate" />
									<px:PXGridColumn DataField="BAccountR__AcctName" TextAlign="Left" Width="160px"/>
									<px:PXGridColumn DataField="BAccountR__Status" TextAlign="Left" Width="160px"/>
									<px:PXGridColumn DataField="DuplicateContact__Email" />
									<px:PXGridColumn DataField="Phone1" />
									<px:PXGridColumn DataField="BAccountR__OwnerID" />
