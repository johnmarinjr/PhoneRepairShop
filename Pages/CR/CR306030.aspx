...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Events"
		TypeName="PX.Objects.EP.EPEventMaint" EnableAttributes="true" UDFTypeField="Type">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
			...
			<px:PXTabItem Text="Details">
				...
				<Template>
					<px:PXPanel ID="PXPanel1" runat="server" RenderStyle="Simple" ContentLayout-OuterSpacing="Around">
						...
						<px:PXDropDown CommitChanges="True" ID="edTimeZone" runat="server" DataField="TimeZone" />
						...
						<px:PXDateTimeEdit CommitChanges="True" ID="edStartDate_Time" runat="server" DataField="StartDate_Time"
							TimeMode="true" SuppressLabel="True" Width="134" />
						...
						<px:PXCheckBox CommitChanges="True" ID="chkAllDay" runat="server" Checked="True"
							DataField="AllDay" ControlSize="L"/>
						<px:PXDropDown ID="edShowAsID" runat="server" DataField="ShowAsID" />
						...
						<px:PXDropDown CommitChanges="True" ID="edRemindAt" runat="server" DataField="Reminder.RemindAt" />
						...
						<px:PXTextEdit ID="edRefNoteID" runat="server" DataField="RefNoteID" Visible="false" />
			...
			<px:PXTabItem Text="Attendees">
				<Template>
					<px:PXGrid ID="grdAttendees" runat="server" DataSourceID="ds" Width="100%" ActionsPosition="Top"
						...
						AdjustPageSize="Auto" SkinID="Details" MatrixMode="true" SyncPosition="true">
						<Levels>
							<px:PXGridLevel DataMember="Attendees">
								<RowTemplate>
									<px:PXSelector ID="edContactID" runat="server" DataField="ContactID" DisplayMode="Text">
										<GridProperties FastFilterFields="DisplayName,FullName,EMail" />
									</px:PXSelector>
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="ContactID" AutoCallBack="true" DisplayMode="Text" LinkCommand="Attendees_Contact__contactID_ViewDetails"/>
									<px:PXGridColumn DataField="Email" AutoCallBack="true" />
									<px:PXGridColumn DataField="Comment" />
									<px:PXGridColumn DataField="IsOptional" Type="CheckBox" />
	...
	<px:PXSmartPanel ID="sendCardDlg" runat="server" Height="86px" Width="281px" Caption="Send vCard by Email"
