        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                <RowTemplate>
                    ...
                    <px:PXTimeSpan runat="server" DataField="EPEquipmentTimeCardSpentTotals__SetupTime" ID="PXTimeSpan1" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
                    <px:PXTimeSpan runat="server" DataField="EPEquipmentTimeCardSpentTotals__RunTime" ID="PXTimeSpan2" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
                    <px:PXTimeSpan runat="server" DataField="EPEquipmentTimeCardSpentTotals__SuspendTime" ID="PXTimeSpan3" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
                    <px:PXTimeSpan runat="server" DataField="EPEquipmentTimeCardSpentTotals__TimeTotalCalc" ID="PXTimeSpan7" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
                    <px:PXTimeSpan runat="server" DataField="EPEquipmentTimeCardBillableTotals__SetupTime" ID="PXTimeSpan4" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
                    <px:PXTimeSpan runat="server" DataField="EPEquipmentTimeCardBillableTotals__RunTime" ID="PXTimeSpan5" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
                    <px:PXTimeSpan runat="server" DataField="EPEquipmentTimeCardBillableTotals__SuspendTime" ID="PXTimeSpan6" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
                    <px:PXTimeSpan runat="server" DataField="EPEquipmentTimeCardBillableTotals__TimeTotalCalc" ID="PXTimeSpan8" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
                </RowTemplate>
                <Columns>
