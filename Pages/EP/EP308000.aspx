...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True"
        ...
        <Template>
            ...
            <px:PXTimeSpan runat="server" DataField="TimeSetupCalc" ID="SetupTime" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
            <px:PXTimeSpan ID="BillableTime" runat="server" DataField="TimeBillableSetupCalc" Enabled="False" Size="XS" LabelWidth="55" SummaryMode="true" />
            
            <px:PXLayoutRule ID="PXLayoutRule2" runat="server" GroupCaption="Run" StartColumn="True" StartGroup="True" />
            <px:PXTimeSpan runat="server" DataField="TimeRunCalc" ID="PXTimeSpan13" Enabled="False" Size="XS" LabelWidth="55" SuppressLabel="true" SummaryMode="true" />
            <px:PXTimeSpan ID="PXTimeSpan14" runat="server" DataField="TimeBillableRunCalc" Enabled="False" Size="XS" LabelWidth="55" SuppressLabel="true" SummaryMode="true" />
            
            <px:PXLayoutRule ID="PXLayoutRule3" runat="server" GroupCaption="Suspend" StartColumn="True" StartGroup="True" />
            <px:PXTimeSpan runat="server" DataField="TimeSuspendCalc" ID="PXTimeSpan15" Enabled="False" Size="XS" LabelWidth="55" SuppressLabel="true" SummaryMode="true" />
            <px:PXTimeSpan ID="PXTimeSpan16" runat="server" DataField="TimeBillableSuspendCalc" Enabled="False" Size="XS" LabelWidth="55" SuppressLabel="true" SummaryMode="true" />
            
            <px:PXLayoutRule ID="PXLayoutRule5" runat="server" GroupCaption="Total" StartColumn="True" StartGroup="True" />
            <px:PXTimeSpan runat="server" DataField="TimeTotalCalc" ID="PXTimeSpan17" Enabled="False" Size="XS" LabelWidth="55" SuppressLabel="true" SummaryMode="true" />
            <px:PXTimeSpan ID="PXTimeSpan18" runat="server" DataField="TimeBillableTotalCalc" Enabled="False" Size="XS" LabelWidth="55" SuppressLabel="true" SummaryMode="true" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Summary">
                                <RowTemplate>
                                    ...
                                    <px:PXTimeSpan ID="PXTimeSpan7" runat="server" DataField="TimeSpent" SummaryMode="true" />
                                </RowTemplate>
                                <Columns>
