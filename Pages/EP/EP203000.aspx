        ...
        <Items>
            <px:PXTabItem Text="General Info">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" />
                    <px:PXTextEdit ID="edBaseCuryID" runat="server" DataField="BaseCuryID" Enabled="False" />
                    <px:PXSegmentMask ID="edLabourItemID" runat="server" DataField="LabourItemID" />
                    <px:PXSelector ID="edShiftID" runat="server" DataField="ShiftID" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="EmployeePositions">
                                <Columns>
									...
									<px:PXGridColumn DataField="SettlementPaycheckRefNoteID" Width="100px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                    ...
                    <px:PXGrid runat="server" ID="gridCorpCards" DataSourceID="ds" SkinID="DetailsInTab" Height="400px" Width="100%">
                        <Levels>
                            <px:PXGridLevel DataMember="EmployeeCorpCards">
                                ...
                                <RowTemplate>
                                    <px:PXSelector runat="server" ID="edCorpCardID" DataField="CorpCardID" AutoRefresh="True"/>
                                </RowTemplate>
                            </px:PXGridLevel>
                        </Levels>
