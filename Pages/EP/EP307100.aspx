						...
						<Levels>
							<px:PXGridLevel DataMember="TimeActivities">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="TimeSpent" CommitChanges="true" RenderEditorText="True" />
									<px:PXGridColumn DataField="IsBillable" Type="CheckBox" CommitChanges="true" />
									<px:PXGridColumn DataField="TimeBillable" CommitChanges="true" RenderEditorText="True"/>
					...
					<px:PXGrid ID="gridWorkgroupMembers" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="Details" AutoAdjustColumns="true" SyncPosition="true">
						<Levels>
							<px:PXGridLevel DataMember="WorkgroupTimeSummary">
								<RowTemplate>
									<px:PXTimeSpan DataField="TotalRegularTime" ID="edTotalRegularTime" runat="server" SummaryMode="true" />
									<px:PXTimeSpan DataField="TotalBillableTime" ID="edTotalBillableTime2" runat="server" SummaryMode="true" /> 
									<px:PXTimeSpan DataField="TotalOvertime" ID="edTotalOvertime" runat="server" SummaryMode="true" />
									<px:PXTimeSpan DataField="TotalBillableOvertime" ID="edTotalBillableOvertime" runat="server" SummaryMode="true" />
								</RowTemplate>
								<Columns>
									...
									<px:PXGridColumn DataField="TotalRegularTime" RenderEditorText="True" />
									<px:PXGridColumn DataField="TotalBillableTime" RenderEditorText="True" />
									<px:PXGridColumn DataField="TotalOvertime" RenderEditorText="True"  />
									<px:PXGridColumn DataField="TotalBillableOvertime" RenderEditorText="True"  />
					...
					<Levels>
						<px:PXGridLevel DataMember="BulkEntryTimeActivities">
							<RowTemplate>
								...
								<px:PXSelector DataField="Date" ID="edBulkDate" runat="server" AutoRefresh="true" />
							...
							<Columns>
								...
								<px:PXGridColumn DataField="ServiceID" />
								<px:PXGridColumn DataField="TimeSpent" CommitChanges="true" RenderEditorText="True" />
								<px:PXGridColumn DataField="IsBillable" CommitChanges="true"  Type="CheckBox" />
								<px:PXGridColumn DataField="TimeBillable" CommitChanges="true" RenderEditorText="True" />
