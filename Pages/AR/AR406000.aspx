...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" DefaultControlID="edPaymentMethodID" TabIndex="2100">
		<Template>
			...
			<px:PXDropDown CommitChanges="True" ID="edCardType" runat="server" DataField="CardType" />
			...
			<px:PXSelector CommitChanges="True" ID="edDescr" runat="server" AutoRefresh="True" DataField="Descr"/>
