...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" DefaultControlID="edCustomerClassID">
        <Template>
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" GroupCaption="Recalculate" />
            <px:PXCheckBox ID="edRecalcDocumentBalances" runat="server" DataField="RecalcDocumentBalances" CommitChanges="true" AlignLeft="True" />
            <px:PXCheckBox ID="edRecalcCustomerBalancesReleased" runat="server" DataField="RecalcCustomerBalancesReleased" CommitChanges="true" AlignLeft="True" />
            <px:PXCheckBox ID="edRecalcCustomerBalancesUnreleased" runat="server" DataField="RecalcCustomerBalancesUnreleased" CommitChanges="true" Size="XXL" AlignLeft="True" />
        </Template>
    </px:PXFormView>
</asp:Content>
