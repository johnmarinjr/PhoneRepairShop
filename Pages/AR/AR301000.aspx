...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="300px" Style="z-index: 100;" Width="100%" TabIndex="200" DataMember="CurrentDocument">
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								<Columns>
									...
									<px:PXGridColumn DataField="Qty" TextAlign="Right" AutoCallBack="True" CommitChanges="true"/>
									<px:PXGridColumn DataField="BaseQty" TextAlign="Right" />
									<px:PXGridColumn DataField="UOM" AutoCallBack="True" CommitChanges="true"/>
			...
			<px:PXTabItem Text="Approvals" BindingContext="form" LoadOnDemand="false">
				<Template>
			...
			<px:PXTabItem Text="Applications" LoadOnDemand="true" RepaintOnDemand="false">
				<Template>
						...
						<Levels>
							<px:PXGridLevel DataMember="Adjustments">
								<RowTemplate>
									...
									<px:PXSelector CommitChanges="True" ID="edAdjgRefNbr" runat="server" DataField="AdjgRefNbr" AutoRefresh="true" >
										<Parameters>
											<px:PXControlParam ControlID="form" Name="ARInvoice.customerID" PropertyName="DataControls[&quot;edCustomerID&quot;].Value" />
											<px:PXControlParam ControlID="detgrid" Name="ARAdjust2.adjgDocType" PropertyName="DataValues[&quot;AdjgDocType&quot;]" />
										</Parameters>
									</px:PXSelector>
					...
					<px:PXGrid ID="detgrid2" runat="server" Width="100%" SkinID="DetailsInTab" Height="300px" TabIndex="700" FilesIndicator="True"
						...
						<Levels>
							<px:PXGridLevel DataMember="Adjustments_1">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
									<px:PXDropDown ID="edDisplayDocType" runat="server" DataField="DisplayDocType" />
									<px:PXSelector CommitChanges="True" ID="edDisplayRefNbr" runat="server" DataField="DisplayRefNbr" AutoRefresh="true">
										<Parameters>
											<px:PXControlParam ControlID="form" Name="ARInvoice.customerID" PropertyName="DataControls[&quot;edCustomerID&quot;].Value" />
											<px:PXControlParam ControlID="detgrid2" Name="ARAdjust.displayDocType" PropertyName="DataValues[&quot;DisplayDocType&quot;]" />
										</Parameters>
									</px:PXSelector>
									<px:PXNumberEdit CommitChanges="True" ID="edCuryAdjgAmt3" runat="server" DataField="DisplayCuryAmt" />
									<px:PXDateTimeEdit ID="edARInvoice__DocDate3" runat="server" DataField="DisplayDocDate" Enabled="False" />
									<px:PXNumberEdit ID="edCuryDocBal3" runat="server" DataField="CuryDocBal" Enabled="False" />
									<px:PXSelector ID="edARInvoice__CuryID3" runat="server" DataField="DisplayCuryID" />
									<px:PXSelector ID="edARInvoice__FinPeriodID3" runat="server" DataField="DisplayFinPeriodID" Enabled="False" />
									<px:PXDropDown ID="edARInvoice__Status3" runat="server" DataField="DisplayStatus" Enabled="False" />
									<px:PXTextEdit ID="edARInvoice__DocDesc3" runat="server" DataField="DisplayDocDesc" />
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="DisplayBranchID" RenderEditorText="True" />
									<px:PXGridColumn DataField="DisplayDocType" RenderEditorText="True"/>
									<px:PXGridColumn DataField="DisplayRefNbr" AutoCallBack="True" LinkCommand="ViewInvoice" />
