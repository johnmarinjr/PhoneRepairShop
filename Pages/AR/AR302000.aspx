...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="DocType" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AR.ARPaymentEntry" PrimaryView="Document">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ViewExternalAsaction" DependOnGrid="grdCCProcTran" Visible="False" />
    ...
    <px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%"
        ...
        <Template>
            ...
            <pxa:PXCurrencyRate DataField="CuryID" ID="edCury" runat="server"
                RateTypeView="CurrencyInfo" DataMember="_Currency_"
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Height="300px" Style="z-index: 100;" Width="100%" TabIndex="200">
        <Items>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Adjustments" >
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="AdjdRefNbr" AutoCallBack="True" LinkCommand="ViewDocumentToApply" PopupCommand="Refresh" />
            ...
            <px:PXTabItem Text="Sales Orders" RepaintOnDemand="false" >
                <Template>                     
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="SOAdjustments">
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="edCuryAdjgTransferredToChildrenAmt" runat="server" DataField="CuryAdjgTransferredToChildrenAmt" />
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="CuryAdjgTransferredToChildrenAmt" TextAlign="Right" />
            ...
            <px:PXTabItem Text="Service Orders" RepaintOnDemand="false" VisibleExp="DataControls[&quot;chkServiceManagement&quot;].Value == 1" BindingContext="form">
                <Template>
           ...
           <px:PXTabItem Text="Application History" RepaintOnDemand="false" >
                <Template>
                    <px:PXGrid ID="detgrid2" runat="server" Style="z-index: 100;" Width="100%" Height="300px" SkinID="DetailsInTab" 
                        AdjustPageSize="Auto" AllowPaging="True" NoteIndicator="true" FilesIndicator="true"
                               NoteField="ARAdjust2__NoteText" FilesField="ARAdjust2__NoteFiles">
                        <Levels>
                            <px:PXGridLevel DataMember="ARPost">
                                <Mode AllowAddNew="False" AllowDelete="False" AllowUpdate="False" AllowFormEdit="False" />
                                <Columns>
									<px:PXGridColumn DataField="ARRegisterAlias__BranchID" RenderEditorText="True" />
                                    <px:PXGridColumn DataField="BatchNbr" AllowUpdate="False" LinkCommand="ViewCurrentBatch" />
                                    <px:PXGridColumn DataField="SourceDocType" RenderEditorText="True" />
                                    <px:PXGridColumn DataField="SourceRefNbr" LinkCommand="ViewApplicationDocument" />
                                    ...
                                    <px:PXGridColumn DataField="ARRegisterAlias__CustomerID" TextAlign="Right" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryAmt" TextAlign="Right" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryPPDAmt" TextAlign="Right" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryWOAmt" TextAlign="Right" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="ApplicationDate" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="FinPeriodID" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="ARRegisterAlias__DocDate" />
                                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ARRegisterAlias__DueDate" />
                                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ARInvoice__DiscDate" />
                                    <px:PXGridColumn DataField="CuryBalanceAmt" TextAlign="Right" />
                                    <px:PXGridColumn DataField="CuryDiscBalanceAmt" TextAlign="Right" />
                                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ARRegisterAlias__DocDesc" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="ARRegisterAlias__CuryID" />
                                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ARRegisterAlias__FinPeriodID" />
                                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ARInvoice__InvoiceNbr" />
                                    <px:PXGridColumn DataField="ARAdjust2__PendingPPD" TextAlign="Center" Type="CheckBox" />
                                    <px:PXGridColumn DataField="ARAdjust2__PPDCrMemoRefNbr" LinkCommand="ViewPPDCrMemo" />
                                    <px:PXGridColumn DataField="ARAdjust2__TaxInvoiceNbr" />
                                    <px:PXGridColumn DataField="ARAdjust2__HasExpiredComplianceDocuments" Type="CheckBox" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
                ...
                <Template>
                    <px:PXFormView ID="form2" runat="server" Style="z-index: 100" Width="100%" DataMember="CurrentDocument" CaptionVisible="False" SkinID="Transparent">
                        <Template>
                            ...
                            <px:PXSelector ID="edDepositNbr" runat="server" DataField="DepositNbr" Enabled="False" AllowEdit="True" />
            ...
            <px:PXTabItem Text="Card Processing" BindingContext="form" RepaintOnDemand="false">
                <Template>
