		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXDropDown ID="edIntercompanySalesAccountDefault" runat="server" DataField="IntercompanySalesAccountDefault" />
					...
					<px:PXDropDown ID="edPrepareStatements" CommitChanges="True" runat="server" DataField="PrepareStatements" />
			...
			<px:PXTabItem Text="Dunning">
				<Template>
					...
					<px:PXSegmentMask CommitChanges="True" ID="edDunningFeeInventoryID" runat="server" DataField="DunningFeeInventoryID" AutoRefresh="True" />
								...
								<Levels>
									<px:PXGridLevel DataMember="Recipients" DataKeyNames="RecipientID">
										<Columns>
											...
											<px:PXGridColumn DataField="Format" RenderEditorText="True" Width="65px" AutoCallBack="True">
											</px:PXGridColumn>
