<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AR305500.aspx.cs" Inherits="Page_AR305500" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Header" TypeName="PX.Objects.CA.CABankTransactionsImportPayments">
        <CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100"
        Width="100%" Height="150px" SkinID="Details" TabIndex="5700">
        ...
        <Levels>
            <px:PXGridLevel DataKeyNames="CashAccountID,TranID" DataMember="Details">
                <RowTemplate>
                    ...
                    <px:PXCheckBox ID="edFullProcessed" runat="server" DataField="FullProcessed" Text="Create Doc.">
                    </px:PXCheckBox>
                    <px:PXCheckBox ID="edFullDocumentMatched" runat="server" DataField="FullDocumentMatched" Text="Matched">
                    </px:PXCheckBox>
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="FullDocumentMatched" Width="60px" TextAlign="Center" Type="CheckBox">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="FullProcessed" Width="60px" TextAlign="Center" Type="CheckBox">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="Hidden" Width="60px" TextAlign="Center" Type="CheckBox">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="Splitted" Width="60px" TextAlign="Center" Type="CheckBox">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="CuryDisplayDebitAmt" Width="100px" TextAlign="Right">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CuryDisplayCreditAmt" TextAlign="Right" Width="100px">
                    </px:PXGridColumn>
