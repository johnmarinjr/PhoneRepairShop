		...
		<Levels>
			<px:PXGridLevel DataMember="PaymentTrans">
				<Columns>
					...
					<px:PXGridColumn DataField="ARPayment__PaymentMethodID" LinkCommand="viewPaymentMethod" />
					<px:PXGridColumn DataField="ExternalTransaction__CardType" />
					<px:PXGridColumn DataField="ExternalTransaction__ProcCenterCardTypeCode" />
					...
					<px:PXGridColumn DataField="TranStatus" Width="90px"/>
					<px:PXGridColumn  DataField="RefTranNbr" TextAlign="Right" Width="90px"/>
