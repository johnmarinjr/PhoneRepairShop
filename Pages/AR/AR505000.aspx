...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" DefaultControlID="edWOType" MarkRequired="Dynamic">
		...
		<Levels>
			<px:PXGridLevel DataMember="ARDocumentList">
				<Columns>
					...
					<px:PXGridColumn DataField="CuryOrigDocAmt" TextAlign="Right" AllowShowHide="Server" />					
