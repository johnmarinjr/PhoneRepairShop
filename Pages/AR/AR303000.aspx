					...
					<px:PXFormView ID="DefLocation" runat="server" DataMember="DefLocation" SkinID="Transparent" Width="100%">
						<Template>
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Other Settings" />
								...
								<px:PXCheckBox ID="chkSuggestRelatedItems" runat="server" DataField="CurrentCustomer.SuggestRelatedItems" />
							<%-- column 2 --%>
									...
									<Levels>
										<px:PXGridLevel DataMember="Carriers">
											<RowTemplate>
												...
												<px:PXMaskEdit ID="PXMaskEdit4" runat="server" DataField="PostalCode" />
												<px:PXSelector ID="edCarrierPluginID"  runat="server" DataField="CarrierPluginID" AutoRefresh="True"  />
											</RowTemplate>
											<Columns>
