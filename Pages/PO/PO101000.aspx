		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXCheckBox SuppressLabel="True" ID="chkRequireProjectDropShipControlTotal" runat="server" DataField="RequireProjectDropShipControlTotal" />
				...
				<Template>
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="ReceivePutAwaySetup" DefaultControlID="edShowReceivingTab" RenderStyle="Simple">
						<Template>
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Receiving Settings" />
