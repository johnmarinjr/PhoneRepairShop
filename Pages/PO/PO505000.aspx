        ...
        <Levels>
            <px:PXGridLevel DataMember="FixedDemand">
                <RowTemplate>
                    ...
                    <px:PXSegmentMask ID="edPOSiteID" runat="server" DataField="POSiteID" AllowEdit="true" AutoRefresh="true" />
                    <px:PXSegmentMask ID="edSourceSiteID" runat="server" DataField="SourceSiteID" AllowEdit="true" AutoRefresh="true" />
