...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="ReceiptType" runat="server" Visible="True" TypeName="PX.Objects.PO.POReceiptEntry" PrimaryView="Document" BorderStyle="NotSet" Width="100%">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="POReceiptLineSplittingExtension_GenerateNumbers" />
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="POReceiptLineSplittingExtension_ShowSplits" DependOnGrid="grid" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Document Summary"
        ...
        <Template>
            ...
            <px:PXSegmentMask CommitChanges="True" ID="edSiteID" runat="server" DataField="SiteID" AllowAddNew="True" AllowEdit="True" AutoRefresh="true">
                <GridProperties>
                    <Layout ColumnsMenu="False" />
                </GridProperties>
            </px:PXSegmentMask>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Height="353px" Style="z-index: 100;" Width="100%" DataMember="CurrentDocument" DataSourceID="ds">
        ...
        <Items>
            <px:PXTabItem Text="Details">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; left: 0px; top: 0px; height: 455px;" Width="100%"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask CommitChanges="True" ID="edCostCodeID" runat="server" AutoRefresh="True" DataField="CostCodeID" />
                                </RowTemplate>
                            </px:PXGridLevel>
                        </Levels>
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="POReceiptLineSplittingExtension_ShowSplits" CommandSourceID="ds" DependOnGrid="grid" />
			...
			<px:PXTabItem Text="Billing" BindingContext="form" RepaintOnDemand="false">
                <Template>
					<px:PXFormView ID="formBaseCurrencyMessage" runat="server" DataMember="apDocs" DataSourceID="ds" Style="z-index: 100" Width="100%">
						<Template>
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108;" Width="764px" Height="500px" Caption="Line Details" CaptionVisible="True"
        Key="POReceiptLineSplittingExtension_lsselect" AutoCallBack-Command="Refresh" AutoCallBack-Enabled="True" AutoCallBack-Target="optform">
        <px:PXFormView ID="optform" runat="server" Width="100%" CaptionVisible="False" DataMember="POReceiptLineSplittingExtension_LotSerOptions" DataSourceID="ds"
            SkinID="Transparent">
            <Parameters>
                <px:PXSyncGridParam ControlID="grid" />
            </Parameters>
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" Text="Generate" Height="20px" CommandName="POReceiptLineSplittingExtension_GenerateNumbers"
                    CommandSourceID="ds">
                </px:PXButton>
            </Template>
        </px:PXFormView>
    ...
    <px:PXSmartPanel ID="PanelAddPOLine" runat="server" Height="396px" Style="z-index: 108;" Width="960px"
    ...
    <px:PXSmartPanel ID="panelAddReceiptLineReturn" runat="server" Style="z-index: 108; height: 396px;" Width="960px" Caption="Add Receipt Line"
        ...
        <px:PXFormView ID="frmReceiptReturnLineFilter" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="returnFilter"
            ...
            <Template>
                ...
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
                <px:PXSelector CommitChanges="True" ID="edReceiptNbr" runat="server" DataField="ReceiptNbr" AutoRefresh="true" />
                <px:PXSegmentMask CommitChanges="True" ID="edInventoryID" runat="server" DataField="InventoryID" AutoRefresh="true" />
            </Template>
        </px:PXFormView>
            ...
            <Levels>
                <px:PXGridLevel DataMember="openTransfers">
                    <Columns>
						...
						<px:PXGridColumn DataField="SOOrder__OrderDesc" />
                    </Columns>
                </px:PXGridLevel>
            </Levels>
        </px:PXGrid>
