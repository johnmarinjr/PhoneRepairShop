...
<asp:content id="cont1" contentplaceholderid="phDS" runat="Server">
    ...
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.PO.WMS.ReceivePutAway+Host" PrimaryView="HeaderView">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="POReceiptLineSplittingExtension_GenerateNumbers" Visible="False" />
            <px:PXDSCallbackCommand Name="POReceiptLineSplittingExtension_ShowSplits" Visible="False" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:content>
