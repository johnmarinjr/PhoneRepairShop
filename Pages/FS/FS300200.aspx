...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
  ...
  <px:PXSmartPanel ID="PXLogActionStartFilter" Key="LogActionStartFilter" runat="server" Caption="Perform Action" CaptionVisible="True" AutoCallBack-Target="LogActionStartFilter" AutoCallBack-Command="Refresh" Overflow="Hidden" Width="600px" AutoReload="True" AutoRepaint="True">
    <px:PXFormView ID="PXLogActionStartFilterForm" runat="server"  TabIndex="1600" SkinID="Transparent"
        DataMember="LogActionStartFilter" DataSourceID="ds">
        <Template>
    ...
    <px:PXGrid ID="PXLogStartActionStaffLinesGrid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" SkinID="Inquire" TabIndex="900"
      ...
      <Levels>
          <px:PXGridLevel DataMember="LogActionStaffDistinctRecords" DataKeyNames="DocID, BAccountID">
            <RowTemplate>
                <px:PXSelector ID="edBAccountIDDB1" runat="server" DataField="BAccountID"
                    CommitChanges="True">
                </px:PXSelector>
            </RowTemplate>
            <Columns>
    ...
    <px:PXPanel ID="pnlCloseButtonStaffLines" runat="server" SkinID="Buttons">
        <px:PXButton ID="startBtnStaffLines" runat="server" DialogResult="OK" Text="OK" />
        <px:PXButton ID="cancelBtnStaffLines" runat="server" DialogResult="Cancel" Text="Cancel"/>
    </px:PXPanel>
  </px:PXSmartPanel>
  <px:PXSmartPanel ID="PXLogActionSmartPanel" Key="LogActionPCRFilter" runat="server" Caption="Perform Action" CaptionVisible="True" AutoCallBack-Target="LogActionPCRFilter" AutoCallBack-Command="Refresh" Overflow="Hidden" Width="600px" AutoReload="True" AutoRepaint="True">
      <px:PXFormView ID="PXLogActionForm" runat="server"  TabIndex="1600" SkinID="Transparent"
          DataMember="LogActionPCRFilter" DataSourceID="ds">
          <Template>
              <px:PXLayoutRule runat="server" StartRow="True" StartColumn="True" ControlSize="XM" LabelsWidth="S" />
              <px:PXDropDown ID="edActionLog" runat="server" DataField="Action" CommitChanges="True"/>
              <px:PXDropDown ID="edTypeLog" runat="server" DataField="Type" CommitChanges="True"/>
      ...
      <px:PXGrid ID="PXLogActionGrid" runat="server" DataSourceID="ds"
          ...
          <Levels>
              <px:PXGridLevel DataMember="LogActionLogRecords" DataKeyNames="LineRef">
                  <RowTemplate>
                    <px:PXSelector ID="edBAccountIDDB2" runat="server" DataField="BAccountID"
                        CommitChanges="True">
                    </px:PXSelector>
                    <px:PXSelector ID="edInventoryIDDB1" runat="server" DataField="InventoryID"
                        CommitChanges="True">
                    </px:PXSelector>
                  </RowTemplate>
                  <Columns>
  ...
  <px:PXSmartPanel ID="PXServicesBasedActionSmartPanel" Key="LogActionStartServiceFilter" runat="server" Caption="Perform Action" CaptionVisible="True" AutoCallBack-Target="LogActionStartServiceFilter" AutoCallBack-Command="Refresh" Overflow="Hidden" Width="600px" AutoReload="True" AutoRepaint="True">
    <px:PXFormView ID="PXServicesBasedActionForm" runat="server"  TabIndex="1600" SkinID="Transparent"
        DataMember="LogActionStartServiceFilter" DataSourceID="ds">
        <Template>
            <px:PXLayoutRule runat="server" StartRow="True" StartColumn="True" ControlSize="XM" LabelsWidth="S" />
            <px:PXDropDown ID="edServicesBasedActionLog" runat="server" DataField="Action" CommitChanges="True"/>
            <px:PXDropDown ID="edServicesBasedTypeLog" runat="server" DataField="Type" CommitChanges="True"/>
            <px:PXCheckBox ID="edServicesBasedMeLogAction" runat="server" CommitChanges="True" DataField="Me" />
            <px:PXLayoutRule runat="server" Merge="True" ControlSize="SM" />
            <px:PXDateTimeEdit ID="edServicesBasedLogDateTime_Date" runat="server" CommitChanges="True" DataField="LogDateTime_Date" />
            <px:PXDateTimeEdit ID="edServicesBasedLogDateTime_Time" runat="server" CommitChanges="True" DataField="LogDateTime_Time" TimeMode="True" SuppressLabel="True" />
            <px:PXLayoutRule runat="server" EndGroup="True" />
            <px:PXSelector ID="edServicesBasedDetailsLineRef" runat="server" DataSourceID="ds" DataField="DetLineRef" CommitChanges="True" AutoRefresh="True"/>
        </Template>
    </px:PXFormView>
    <px:PXGrid ID="PXServicesBasedOnGrid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" SkinID="Inquire" TabIndex="900"
      ...
      <Levels>
          <px:PXGridLevel DataMember="ServicesLogAction" DataKeyNames="AppointmentID,AppDetID,SODetID">
              <RowTemplate>
                <px:PXSelector ID="edInventoryIDDB2" runat="server" DataField="InventoryID"
                        CommitChanges="True">
                </px:PXSelector>
              </RowTemplate>
              <Columns>
    ...
    <px:PXPanel ID="pnlCloseButtonServicesBased" runat="server" SkinID="Buttons">
        <px:PXButton ID="startBtnServicesBased" runat="server" DialogResult="OK" Text="OK" />
        <px:PXButton ID="cancelBtnServicesBased" runat="server" DialogResult="Cancel" Text="Cancel"/>
    </px:PXPanel>
  </px:PXSmartPanel>
  <px:PXSmartPanel ID="PXtaffLinesActionSmartPanel" Key="LogActionStartStaffFilter" runat="server" Caption="Perform Action" CaptionVisible="True" AutoCallBack-Target="LogActionStartStaffFilter" AutoCallBack-Command="Refresh" Overflow="Hidden" Width="600px" AutoReload="True" AutoRepaint="True">
    <px:PXFormView ID="PXtaffLinesActionForm" runat="server"  TabIndex="1600" SkinID="Transparent"
        DataMember="LogActionStartStaffFilter" DataSourceID="ds">
        <Template>
            <px:PXLayoutRule runat="server" StartRow="True" StartColumn="True" ControlSize="XM" LabelsWidth="S" />
            <px:PXDropDown ID="edActionLog" runat="server" DataField="Action" CommitChanges="True"/>
            <px:PXDropDown ID="edTypeLog" runat="server" DataField="Type" CommitChanges="True"/>
    ...
    <px:PXGrid ID="PXLogStaffLinesGrid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" SkinID="Inquire" TabIndex="900"
      ...
      <Levels>
          <px:PXGridLevel DataMember="LogActionStaffRecords" DataKeyNames="AppointmentID,LineNbr">
              <RowTemplate>
                <px:PXSelector ID="edBAccountIDDB3" runat="server" DataField="BAccountID"
                    CommitChanges="True">
                </px:PXSelector>
                <px:PXSelector ID="edInventoryIDDB3" runat="server" DataField="InventoryID"
                        CommitChanges="True">
                </px:PXSelector>
              </RowTemplate>
              <Columns>
    ...
    <px:PXPanel ID="pnlCloseButtontaffLines" runat="server" SkinID="Buttons">
        <px:PXButton ID="startBtntaffLines" runat="server" DialogResult="OK" Text="OK" />
        <px:PXButton ID="cancelBtntaffLines" runat="server" DialogResult="Cancel" Text="Cancel"/>
    </px:PXPanel>
  </px:PXSmartPanel>
  <%--/ Log Action SmartPanel --%>
    ...
    <px:PXFormView ID="mainForm" runat="server" DataSourceID="ds" Style="z-index: 100" BPEventsIndicator="True" FilesIndicator="True" ActivityIndicator="True" NoteIndicator="True" Width="100%" DataMember="AppointmentRecords" TabIndex="100" MarkRequired="Dynamic">
        <Template>
            ...
            <px:PXPanel ID="edThirdColumn" runat="server" RenderStyle="Simple">
              ...
              <px:PXNumberEdit ID="edProfitPercent" runat="server" DataField="ProfitPercent" AllowNull="True" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <script type="text/javascript">
        ...
        function UpdateItemSiteCell(n, c) {
            ...
            var eCell = activeRow.getCell("EstimatedDuration");
    ...
    <Items>
      <px:PXTabItem Text="Settings">
        ...
        <Template>
          <px:PXGrid ID="PXGridDetails" runat="server" DataSourceID="ds" SkinID="Details" StatusField="Availability" TabIndex="1700" Height="100%" Width="100%" SyncPosition="True">
            <Levels>
            ...
            <ActionBar ActionsText="False" PagerVisible="False">
              <CustomItems>
                ...
                <px:PXToolBarButton Text="Serials" Key="cmdLS" CommandName="FSAppointmentLineSplittingExtension_ShowSplits" CommandSourceID="ds" DependOnGrid="PXGridDetails">
                    <AutoCallBack>
                        <Behavior CommitChanges="True" PostData="Page" />
                    </AutoCallBack>
                </px:PXToolBarButton>
                        ...
                        <Levels>
                            <px:PXGridLevel
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edFSAppointmentServiceEmployee__InventoryID" runat="server" DataField="FSAppointmentServiceEmployee__InventoryID" Enabled="False" AutoRefresh="True" AllowEdit="True">
                                    </px:PXSegmentMask>
      ...
      <px:PXTabItem Text="Totals">
          <Template>
              ...
              <px:PXNumberEdit ID="edTotalsTabCuryTaxTotal" runat="server" DataField="CuryTaxTotal" Enabled="False" Size="Empty" />
              <px:PXNumberEdit ID="edTotalsTabCuryDocTotal" runat="server" DataField="CuryDocTotal" Enabled="False" Size="Empty" />
          ...
          <px:PXFormView ID="ServiceOrderTotalsTab" runat="server" DataMember="ServiceOrderRelated" RenderStyle="Simple">
            <Template>
              ...
              <px:PXNumberEdit ID="edCuryEffectiveBillableDocTotal" runat="server" DataField="CuryEffectiveBillableDocTotal" Enabled="False" Size="Empty" />
            </Template>
          </px:PXFormView>  
          <px:PXLayoutRule runat="server" StartColumn="True"/>
      ...
      <px:PXTabItem Text="Billing Documents" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False" VisibleExp="DataControls[&quot;edShowInvoicesTab&quot;].Value == true">
            <Template>
                <px:PXGrid ID="PXGridInvoiceRecords" runat="server" DataSourceID="ds" SkinID="Inquire" TabIndex="2100" Height="100%" Width="100%" SyncPosition="True">
                    <Levels>
      ...
      <px:PXTabItem Text="Other" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False" >
            <Template>
  ...
  <%-- LotSerial Numbers --%>
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="90%" Height="360px" Caption="Lot/Serial Nbrs" CaptionVisible="True" Key="FSAppointmentLineSplittingExtension_lsselect" AutoCallBack-Command="Refresh" AutoCallBack-Target="PXGridLotSer" DesignView="Content" >
