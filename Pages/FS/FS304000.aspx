                    ...
                    <Levels>
                        <px:PXGridLevel DataMember="VehicleRecords" DataKeyNames="RefNbr">
                            <RowTemplate>
                                ...
                                <px:PXCheckBox ID="edFSMemUnassignedVehicle" runat="server" DataField="MemUnassignedVehicle"></px:PXCheckBox>
                            </RowTemplate>
                            <Columns>
                                <px:PXGridColumn DataField="RefNbr"></px:PXGridColumn>
                                <px:PXGridColumn DataField="Description" TextAlign="Left"></px:PXGridColumn>
                                <px:PXGridColumn DataField="MemUnassignedVehicle" TextAlign="Center" Type="CheckBox"></px:PXGridColumn>
                            </Columns>
                        </px:PXGridLevel>
                    </Levels>
                    <AutoSize Container="Window" Enabled="True" MinHeight="150" />
