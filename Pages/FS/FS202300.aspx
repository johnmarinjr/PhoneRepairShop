                ...
                <Items>
                    <px:PXTabItem Text="General">
                        <Template>
                            ...
                            <px:PXCheckBox ID="edCompleteSrvOrdWhenSrvDone" runat="server" CommitChanges="True" DataField="CompleteSrvOrdWhenSrvDone" Size="XM">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCloseSrvOrdWhenSrvDone" runat="server" CommitChanges="True" DataField="CloseSrvOrdWhenSrvDone" Size="XM">
                            </px:PXCheckBox>
                            ...
                            <px:PXCheckBox ID="edCopyNotesToInvoice" runat="server" DataField="CopyNotesToInvoice" Size="XM">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyAttachmentsToInvoice" runat="server" DataField="CopyAttachmentsToInvoice" Size="XM">
                            </px:PXCheckBox>
                    ...
                    <px:PXTabItem Text="Quick Processing" VisibleExp="DataControls[&quot;chkShowQuickProcessTab&quot;].Value == 1" BindingContext="form" RepaintOnDemand="False">
                        <Template>
