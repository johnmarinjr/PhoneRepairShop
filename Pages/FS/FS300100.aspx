    ...
    <px:PXFormView ID="mainForm" runat="server" DataSourceID="ds" Width="100%" Caption="Service Order" MarkRequired="Dynamic" BPEventsIndicator="True" FilesIndicator="True" NoteIndicator="True" ActivityIndicator="True" DataMember="ServiceOrderRecords" TabIndex="100" DefaultControlID="edCustomerID">
        <Template>
            ...
            <px:PXPanel ID="edThirdColumn" runat="server" RenderStyle="Simple">
                ...
                <px:PXNumberEdit ID="edCuryEffectiveBillableDocTotal" runat="server" DataField="CuryEffectiveBillableDocTotal">
                </px:PXNumberEdit>
                <px:PXNumberEdit ID="edCuryEffectiveCostTotal" runat="server" DataField="CuryEffectiveCostTotal" />
                ...
                <px:PXCheckBox ID="edAppointmentsNeeded" runat="server" DataField="AppointmentsNeeded" Text="Appointments Needed">
                </px:PXCheckBox>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <px:PXTab ID="tab" runat="server" Height="300px" Style="z-index: 100;" Width="100%" TabIndex="200" DataSourceID="ds" MarkRequired="Dynamic" DataMember="CurrentServiceOrder">
        <Items>
                    ...
                    <px:PXGrid ID="PXGridDetails" runat="server" DataSourceID="ds" TabIndex="-12436" SkinID="Details" StatusField="Availability"
                        ...
                        <ActionBar ActionsText="False" PagerVisible="False">
                            <CustomItems>
                                ...
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="FSServiceOrderLineSplittingExtension_ShowSplits" CommandSourceID="ds" DependOnGrid="PXGridDetails">
                                    <AutoCallBack>
                                        <Behavior CommitChanges="True" PostData="Page" />
                                    </AutoCallBack>
                                </px:PXToolBarButton>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ServiceOrderAppointments">
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="edApptCompletedBillableTotal" runat="server" DataField="AppCompletedBillableTotal" />
                                    <px:PXNumberEdit ID="edApptCuryCostTotal" runat="server" DataField="CuryCostTotal" />
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="RefNbr">
                                    </px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="AppCompletedBillableTotal" TextAlign="Right" />
                                    <px:PXGridColumn DataField="CuryCostTotal" TextAlign="Right" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ServiceOrderEmployees">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edFSSODetEmployee__InventoryID" runat="server" DataField="FSSODetEmployee__InventoryID" Enabled="False" AutoRefresh="True" AllowEdit="True">
                                    </px:PXSegmentMask>
            ...
            <px:PXTabItem Text="Related Documents" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False">
                <Template>
            ...
            <px:PXTabItem Text="Totals">
                <Template>
                    <px:PXFormView ID="formG" runat="server" DataSourceID="ds" Style="z-index: 100; left: 18px; top: 36px;" Width="100%" DataMember="CurrentServiceOrder" CaptionVisible="False" SkinID="Transparent">
                        <Template>
                            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="S" GroupCaption="Service Order Totals" />
                            <px:PXMaskEdit ID="edEstimatedDurationTotal" runat="server" DataField="EstimatedDurationTotal" Enabled="False" TextAlign="Right"/>
                            <px:PXNumberEdit ID="edCuryEstimatedOrderTotal" runat="server" DataField="CuryEstimatedOrderTotal" Enabled="False" />
                            <px:PXNumberEdit ID="edCuryBillableOrderTotal" runat="server" Enabled="False" DataField="CuryBillableOrderTotal" />
                            ...
                            <px:PXNumberEdit ID="edTotalsTabCuryTaxTotal" runat="server" DataField="CuryTaxTotal" Enabled="False" />
                            <px:PXNumberEdit ID="edCuryDocTotal" runat="server" DataField="CuryDocTotal" Enabled="False" />
                            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="S" GroupCaption="Appointment Totals" />
                            <px:PXMaskEdit ID="edApptDurationTotal" runat="server" DataField="ApptDurationTotal" Enabled="False" TextAlign="Right" />
                            <px:PXNumberEdit ID="edCuryApptOrderTotal" runat="server" DataField="CuryApptOrderTotal" Enabled="False" />
                            <px:PXNumberEdit ID="edCuryAppointmentTaxTotal" runat="server" DataField="CuryAppointmentTaxTotal" Enabled="False" />
                            <px:PXNumberEdit ID="edCuryAppointmentDocTotal" runat="server" DataField="CuryAppointmentDocTotal" Enabled="False" />
                            <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="S" GroupCaption="Billable Total" />
                            <px:PXDropDown ID="edTotalsTabBillingBy" runat="server" AllowEdit="False" DataField="BillingBy" AlignRight="True" />
                            <px:PXNumberEdit ID="edCuryEffectiveBillableLineTotal" runat="server" DataField="CuryEffectiveBillableLineTotal" Enabled="False" />
                            <px:PXNumberEdit ID="edCuryEffectiveBillableTaxTotal" runat="server" DataField="CuryEffectiveBillableTaxTotal" Enabled="False" />
                            <px:PXNumberEdit ID="edCuryShortLabelEffectiveBillableDocTotal" runat="server" DataField="CuryShortLabelEffectiveBillableDocTotal" Enabled="False" />
                            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="S" GroupCaption="Prepayment Totals" />
                            <px:PXNumberEdit ID="edSOPrepaymentReceivedT" runat="server" DataField="SOPrepaymentReceived" Enabled="False" />
                            <px:PXNumberEdit ID="edSOPrepaymentAppliedT" runat="server" DataField="SOPrepaymentApplied" Enabled="False" />
                            <px:PXNumberEdit ID="edSOPrepaymentRemainingT" runat="server" DataField="SOPrepaymentRemaining" Enabled="False" />
                            <px:PXNumberEdit ID="edSOCuryUnpaidBalanaceT" runat="server" DataField="SOCuryUnpaidBalanace" Enabled="False" />
                            <px:PXNumberEdit ID="edSOCuryBillableUnpaidBalanaceT" runat="server" DataField="SOCuryBillableUnpaidBalanace" Enabled="False" />
                        </Template>
                    </px:PXFormView>
                </Template>
            </px:PXTabItem>
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="90%" Height="360px" Caption="Line Details" CaptionVisible="True" Key="FSServiceOrderLineSplittingExtension_lsselect"
        AutoCallBack-Command="Refresh" AutoCallBack-Target="optform" DesignView="Content" TabIndex="3200">
        <px:PXFormView ID="optform" runat="server" CaptionVisible="False" DataMember="FSServiceOrderLineSplittingExtension_LotSerOptions" DataSourceID="ds" SkinID="Transparent"
            ...
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" CommandName="FSServiceOrderLineSplittingExtension_GenerateNumbers" CommandSourceID="ds" Height="20px"
                    Text="Generate" />
            </Template>
            <Parameters>
