...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="ServiceContractRecords" 
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXSmartPanel
        ...
        <px:PXFormView ID="PXFormActivateDate" runat="server" DataSourceID="ds" Style="z-index: 150" Width="100%" Height="40px" DataMember="ActivationContractFilter" TabIndex="700" SkinID="Transparent">
            <Template>
    ...
    <%-- Copy Contract --%>
    <px:PXSmartPanel
        ID="PXSmartPanelCopyContract"
        runat="server"
        Caption="Copy"
        CaptionVisible="True"
        Key="CopyContractFilter"
        AutoCallBack-Command="Refresh"
        ShowAfterLoad="True"
        Width="400px"
        Height="110px"
        ...
        AllowResize="False">
        <px:PXLayoutRule runat="server" StartColumn="True"></px:PXLayoutRule>
        <px:PXFormView ID="PXFormCopyDate" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="40px" DataMember="CopyContractFilter" TabIndex="700" SkinID="Transparent">
            <Template>
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M"></px:PXLayoutRule>
                <px:PXDateTimeEdit ID="edStartDate" runat="server" DataField="StartDate" CommitChanges="True"></px:PXDateTimeEdit>
                <px:PXLabel Height="10px" runat="server"></px:PXLabel>
            </Template>
        </px:PXFormView>
        <px:PXPanel ID="PXPanelCopyContractButtons" runat="server" SkinID="Buttons">
            <px:PXButton ID="okCopyContractButton" runat="server" DialogResult="OK" Text="OK" CommandSourceID="ds" />
            <px:PXButton ID="cancelCopyContractButton" runat="server" DialogResult="Cancel" Text="Cancel" CommandSourceID="ds" />
        </px:PXPanel>
    </px:PXSmartPanel>
    <%--/ Copy Contract --%>
    ...
    <%-- Forecast Report --%>
    <px:PXSmartPanel
        ID="PXSmartPanelForecast"
        runat="server"
        Caption="Contract Quote"
        CaptionVisible="True"
        Key="ForecastFilter"
        AutoCallBack-Enabled="True"
        AutoCallBack-Command="Refresh"
        AutoCallBack-Target="PXFormForecastContract"
        Width="400px"
        Height="150px"
        LoadOnDemand="True"
        TabIndex="8500"
        AllowResize="False">
        <px:PXLayoutRule runat="server" StartColumn="True"></px:PXLayoutRule>
        <px:PXFormView ID="PXFormForecastContract" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="80px" DataMember="ForecastFilter" TabIndex="700" SkinID="Transparent">
            <Template>
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M"></px:PXLayoutRule>
                <px:PXDateTimeEdit ID="edForecastStartDate" runat="server" DataField="StartDate" CommitChanges="True" />
                <px:PXDateTimeEdit ID="edForecastEndDate" runat="server" DataField="EndDate" CommitChanges="True" />
            </Template>
        </px:PXFormView>
        <px:PXPanel ID="PXPanelForecastButtons" runat="server" SkinID="Buttons">
            <px:PXButton ID="okForecastButton" runat="server" DialogResult="OK" Text="OK" CommandSourceID="ds" />
            <px:PXButton ID="cancelForecastButton" runat="server" DialogResult="Cancel" Text="Cancel" CommandSourceID="ds" />
        </px:PXPanel>
    </px:PXSmartPanel>
    <%--/ Forecast Report --%>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="100%" DataSourceID="ds" 
        ...
        <Items>
                ...
                <Template>
                    ...
                    <px:PXFormView runat="server" Caption="Location"
                        ...
                        <Template>
                            ...
                            <px:PXNumberEdit ID="edDuration" runat="server" Size="XXS" DataField="Duration" CommitChanges="True">
                            </px:PXNumberEdit>
                            <px:PXDropDown ID="edDurationType" runat="server" DataField="DurationType" SuppressLabel="True" Size="M" Width="194" CommitChanges="True">
                            </px:PXDropDown>
                            <px:PXLayoutRule runat="server" EndGroup="True" ></px:PXLayoutRule>
                            <px:PXDateTimeEdit ID="edRenewalDate" runat="server" DataField="RenewalDate" CommitChanges="True">
                            </px:PXDateTimeEdit>
                            ...
                            <px:PXLayoutRule runat="server" StartColumn="True" GroupCaption="Billing Type Settings" StartGroup="True" LabelsWidth="SM" ControlSize="XM">
                            </px:PXLayoutRule>
                            ...
                            <px:PXLayoutRule runat="server" GroupCaption="Default Values" StartGroup="True" LabelsWidth="SM" ControlSize="XM" />
                            ...
                            <px:PXSegmentMask ID="edDfltCostCodeID" runat="server" DataField="DfltCostCodeID" AllowEdit = "True" AutoRefresh="True" CommitChanges="True" />
                        </Template>
                    </px:PXFormView>
                </Template>
            </px:PXTabItem>
            ...
            <px:PXTabItem Text="History" LoadOnDemand="True" RepaintOnDemand="False" BindingContext="form">
                <Template>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ContractHistoryItems">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="OrigServiceContractRefNbr" />
                                    <px:PXGridColumn DataField="OrigScheduleRefNbr" />
                                </Columns>
                                <RowTemplate>
                                    ...
                                    <px:PXSelector runat="server" ID="edCH_OrigServiceContractRefNbr" DataField="OrigServiceContractRefNbr" AllowEdit="True"/>
                                    <px:PXSelector runat="server" ID="edCH_OrigScheduleRefNbr" DataField="OrigScheduleRefNbr" AllowEdit="True"/>
                                </RowTemplate>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="200" />
