...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" PageLoadBehavior="InsertRecord" 
    ...
    <px:PXSmartPanel
            ...
            <Levels>
                <px:PXGridLevel 
                    ...
                    <RowTemplate>
                        ...
                        <px:PXSegmentMask runat="server" ID="smInventoryID" DataField="InventoryID" AutoRefresh="true" AllowEdit="true"> 
                        </px:PXSegmentMask>
        ...
        Width="100%" DataMember="ReplaceComponentInfo" TabIndex="29900" DefaultControlID="edComponentID"
            ...
            <Template>
                ...
                <px:PXSegmentMask runat="server" ID="rInventoryID" DataField="InventoryID" AutoRefresh="true" CommitChanges="true"> 
                </px:PXSegmentMask>
                        ...
                        <Levels>
                            <px:PXGridLevel 
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask runat="server" ID="edInventoryID" DataField="InventoryID" AutoRefresh="true" AllowEdit="true"> 
                                    </px:PXSegmentMask>
