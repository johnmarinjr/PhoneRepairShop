...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Invoice Summary"
		...
		<Template>
			...
			<pxa:PXCurrencyRate DataField="CuryID" ID="edCury" runat="server" DataSourceID="ds" RateTypeView="CurrencyInfo" DataMember="_Currency_" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions" DataKeyNames="RefNbr,LineNbr">
								...
								<RowTemplate>
									...
									<px:PXSelector ID="edBlanketNbr" runat="server" DataField="BlanketNbr" AllowEdit="true" />
					...
					<px:PXGrid ID="detgrid2" runat="server" Width="100%" SkinID="DetailsInTab" Height="300px" FilesIndicator="True" NoteIndicator="True" SyncPosition="True" Caption="Application Credit Memo"  CaptionVisible="False">
						<Levels>
							<px:PXGridLevel DataMember="Adjustments_1">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
									<px:PXDropDown ID="edAdjdDocType3" runat="server" DataField="DisplayDocType" Enabled="False" />
									<px:PXSelector CommitChanges="True" ID="edAdjdRefNbr3" runat="server" DataField="DisplayRefNbr" AutoRefresh="true">
										<Parameters>
											<px:PXControlParam ControlID="form" Name="ARInvoice.customerID" PropertyName="DataControls[&quot;edCustomerID&quot;].Value" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="DisplayStatus" Type="DropDownList" />
									<px:PXGridColumn DataField="DisplayProcStatus" Type="DropDownList" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" MinHeight="150" />
						<ActionBar DefaultAction="ViewInvoice">
							<CustomItems>
								<px:PXToolBarButton>
	...
	<!--#include file="~\Pages\Includes\AddRelatedItemsPanel.inc"-->
