...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
        ...
        <Items>
            <px:PXTabItem Text="Details">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="height: 250px;" Width="100%" SkinID="DetailsInTab" StatusField="Availability" SyncPosition="true" Height="372px" TabIndex="-7372">
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="SOShipmentLineSplittingExtension_ShowSplits" CommandSourceID="ds" DependOnGrid="grid" />
            ...
            <px:PXTabItem Text="Shipping">
                <Template>
                    ...
                    <px:PXPanel RenderStyle="Fieldset" ID="PXPanel2" runat="server" Caption="Shipping Information">
                        <px:PXFormView ID="formF" runat="server" CaptionVisible="False" DataMember="CurrentDocument" DataSourceID="ds" AllowCollapse="false">
                            <Template>
								...
								<px:PXDropDown runat="server" ID="edTermsOfSale" DataField="TermsOfSale" />
								<px:PXTextEdit runat="server" ID="edDHLBillingRef" DataField="DHLBillingRef" />
                    ...
                    <px:PXFormView runat="server" ID="gridSM" SkinID="Transparent" Caption="Service Management" DataMember="CurrentDocument" DataSourceID="ds" RenderStyle="Fieldset">
                        <Template>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Packages">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="TrackUrl" Type="HyperLink"/>
									...
									<px:PXGridColumn DataField="EELPFC" Width="140" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 500px;" Width="764px" Caption="Line Details" CaptionVisible="True"
        Key="SOShipmentLineSplittingExtension_lsselect" AutoCallBack-Command="Refresh" AutoCallBack-Enabled="True" AutoCallBack-Target="optform">
        <px:PXFormView ID="optform" runat="server" Width="100%" CaptionVisible="False" DataMember="SOShipmentLineSplittingExtension_LotSerOptions" DataSourceID="ds" SkinID="Transparent">
            <Parameters>
            ...
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" Text="Generate" Height="20px" CommandName="SOShipmentLineSplittingExtension_GenerateNumbers" CommandSourceID="ds"></px:PXButton>
            </Template>
        </px:PXFormView>
    ...
    <px:PXSmartPanel ID="PanelPickList" runat="server" Caption="Pick List" CaptionVisible="True" Key="PickListEntries" LoadOnDemand="True" AutoReload="True" AutoRepaint="True">
        ...
        <px:PXPanel ID="PXPanelPickListButtons" runat="server" SkinID="Buttons">
            <px:PXButton ID="PXButtonDeletePickList" runat="server" DialogResult="Cancel" CommandName="DeletePickList" CommandSourceID="ds" SyncVisible="false" />
