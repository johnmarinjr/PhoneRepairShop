    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Order Summary"
        ...
        <Template>
            ...
            <px:PXSegmentMask CommitChanges="True" ID="edCustomerLocationID" runat="server" AutoRefresh="True"
                DataField="CustomerLocationID" DataSourceID="ds" AllowEdit="true" />
            ...
            <px:PXCheckBox runat="server" DataField="ShowDiscountsTab" ID="chkShowDiscountsTab" />
            <px:PXCheckBox runat="server" DataField="ShowShipmentsTab" ID="chkShowShipmentsTab" />
            <px:PXCheckBox runat="server" DataField="ShowOrdersTab" ID="chkShowOrdersTab" />
        </Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <px:PXTab ID="tab" runat="server" Height="540px" Style="z-index: 100;" Width="100%">
        <Items>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="FOBPoint" />
                                    <px:PXGridColumn DataField="ShipTermsID" />
            ...
            <px:PXTabItem Text="Shipments" VisibleExp="DataControls[&quot;chkShowShipmentsTab&quot;].Value == 1" BindingContext="form">
                <Template>
    ...
    <px:PXSmartPanel ID="PanelAddSiteStatus" runat="server" Key="sitestatus" LoadOnDemand="true" Width="1100px" Height="500px"
        ...
        <px:PXFormView ID="formSitesStatus" runat="server" CaptionVisible="False" DataMember="sitestatusfilter" DataSourceID="ds"
            ...
            <Template>
                ...
                <px:PXGroupBox CommitChanges="True" RenderStyle="Simple" ID="gpMode" runat="server" Caption="Selected Mode"
                    DataField="Mode" Width="279px" Height="25px">
                    <Template>
                        ...
                        <px:PXDateTimeEdit CommitChanges="True" ID="edHistoryDate" runat="server" DataField="HistoryDate" SuppressLabel="true" />
                    </Template>
                </px:PXGroupBox>
                
                <px:PXPanel runat="server" Height="50px" RenderStyle="Simple" ID="pnlOnlyAvailable" >
                ...
                <px:PXSegmentMask CommitChanges="True" ID="edCustomerLocationIDApply" runat="server" AutoRefresh="True"
