        ...
        <Items>
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXPanel ID="pnlRelatedItemSettings" runat="server" Caption="Related Item Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" />
                        <px:PXCheckBox ID="chkShowOnlyAvailableRelatedItems" runat="server" DataField="ShowOnlyAvailableRelatedItems" />
                    </px:PXPanel>
                </Template>
            </px:PXTabItem>
