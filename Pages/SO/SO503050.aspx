...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" DefaultControlID="edAction">
        <Template>
            ...
            <px:PXSelector ID="edShipVia" runat="server" DataField="ShipVia" CommitChanges="True" AutoRefresh="True" />
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XS" GroupCaption="Process Parameters" />
            ...
            <px:PXLayoutRule runat="server" Merge="True" LabelsWidth="SM" ControlSize="S" />
            <px:PXCheckBox ID="chkSendToQueue" runat="server" DataField="SendToQueue" CommitChanges="True" AlignLeft="true" />
            <px:PXCheckBox ID="chkPrintPickLists" runat="server" DataField="PrintPickLists" CommitChanges="True" AlignLeft="true" />
            <px:PXLayoutRule runat="server" EndGroup="True" />
            <px:PXCheckBox ID="chkAutomaticShipmentConfirmation" runat="server" DataField="AutomaticShipmentConfirmation" CommitChanges="True" AlignLeft="true" />
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="S" GroupCaption="Device Hub" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Width="100%" AllowPaging="true" AllowSearch="true" AdjustPageSize="Auto" 
    ...
    <px:PXSmartPanel ID="LocationListDialog" runat="server" Caption="Location List" CaptionVisible="True" Key="selectedLocations" LoadOnDemand="True" AutoRepaint="True">
