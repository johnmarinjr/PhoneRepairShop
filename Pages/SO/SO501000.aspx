...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" DefaultControlID="edAction">
        ...
        <Template>
            ...
            <px:PXDateTimeEdit CommitChanges="True" ID="edSchedOrderDate" runat="server" DataField="SchedOrderDate" />
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
        ...
        <Levels>
            <px:PXGridLevel DataMember="Orders">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="MinSchedOrderDate" />
                    <px:PXGridColumn AllowUpdate="False" DataField="ExpireDate" />
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="TermsID" />
