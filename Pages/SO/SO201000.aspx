        ...
        <Items>
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXCheckBox SuppressLabel="True" ID="chkAllowRefundBeforeReturn" runat="server" DataField="AllowRefundBeforeReturn" />
					...
					<px:PXCheckBox SuppressLabel="True" ID="chkCopyLineNotesToChildOrder" runat="server" DataField="CopyLineNotesToChildOrder" />
                    <px:PXCheckBox SuppressLabel="True" ID="chkCopyLineFilesToChildOrder" runat="server" DataField="CopyLineFilesToChildOrder" />
                    ...
                    <px:PXCheckBox SuppressLabel="True" ID="chkEncryptAndPseudonymizePII" runat="server" DataField="EncryptAndPseudonymizePII" />
                    ...
                    <px:PXCheckBox SuppressLabel="True" ID="chkValidateCCRefundsOrigTransactions" runat="server" DataField="ValidateCCRefundsOrigTransactions" />
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Child Order Settings" />
                    <px:PXSelector ID="edDfltChildOrderType" runat="server" DataField="DfltChildOrderType" />
                    <px:PXCheckBox ID="chkUseCuryRateFromBL" runat="server" DataField="UseCuryRateFromBL" />
	        ...
	        <px:PXTabItem Text="Quick Processing" VisibleExp="DataControls[&quot;chkAllowQuickProcess&quot;].Value == 1" BindingContext="hiddenForm" RepaintOnDemand="False">
		        <Template>
