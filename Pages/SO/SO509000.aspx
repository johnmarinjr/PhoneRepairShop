...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" DataMember="Filter" Width="100%" Caption="Selection"
        ...
        <Template>
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
            <px:PXSegmentMask CommitChanges="True" ID="edSourceSiteID" runat="server" DataField="SourceSiteID" AutoRefresh="true" />
        ...
        <Levels>
            <px:PXGridLevel DataMember="FixedDemand">
                <RowTemplate>
                    ...
                    <px:PXSegmentMask ID="edSourceSiteID" runat="server" DataField="SourceSiteID" AutoRefresh="true" />
