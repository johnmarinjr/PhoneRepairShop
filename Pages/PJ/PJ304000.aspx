    ...
    <px:PXTab ID="tab" runat="server" Width="100%">
        ...
        <Items>
            ...
            <px:PXTabItem Text="Change Requests" BindingContext="form" RepaintOnDemand="false">
                <Template>
                    <px:PXGrid ID="gridChangeRequests" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" NoteIndicator="false" FilesIndicator="false" SyncPosition="True">
                        <AutoSize Container="Window" Enabled="True" MinHeight="150"/>
                        <Levels>
            ...
            <px:PXTabItem Text="Change Orders" BindingContext="form" RepaintOnDemand="false">
                <Template>
                    <px:PXGrid ID="gridChangeOrders" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" NoteIndicator="false" FilesIndicator="false" SyncPosition="True">
                        <AutoSize Container="Window" Enabled="True" MinHeight="150"/>
                        <Levels>
            ...
            <px:PXTabItem Text="Subcontractors" BindingContext="form" RepaintOnDemand="false">
                <Template>
                    <px:PXGrid ID="gridSubcontractors" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" NoteIndicator="True" FilesIndicator="true" SyncPosition="True">
                        <AutoSize Container="Window" Enabled="True" MinHeight="150" />
                        <Mode InitNewRow="True" />
                        <Levels>
            ...
            <px:PXTabItem Text="Photo Logs" BindingContext="form" RepaintOnDemand="false">
                <Template>
                    <px:PXSplitContainer runat="server" SplitterPosition="1100" Orientation="Vertical" Height="100%" Width="100%">
                        <AutoSize Enabled="True" Container="Window" MinHeight="300" />
                        <Template1>
            ...
            <px:PXTabItem Text="Employee Expenses" RepaintOnDemand="False" BindingContext="form" >
                <Template>
                    <px:PXGrid FilesIndicator="False" NoteIndicator="False" DataSourceID="ds" Width="100%" SkinID="Details" runat="server" ID="gridEmployeeExpenses" SyncPosition="True">
                        <AutoSize Container="Window" Enabled="True" MinHeight="150"/>
                        <Levels>
            ...
            <px:PXTabItem Text="Approvals" BindingContext="form" RepaintOnDemand="false">
                ...
                <px:PXTabItem BindingContext="form" RepaintOnDemand="False" Text="History" >
                    <Template>
                        <px:PXGrid Width="100%" runat="server" ID="gridHistory" DataSourceID="ds" SkinID ="Inquire" FilesIndicator="false" SyncPosition="True">
                            <AutoSize Container="Window" Enabled="True" MinHeight="150" />
                            <Levels>
