...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="PayrollEmployee" TypeName="PX.Objects.PR.PREmployeePayrollSettingsMaint">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ViewAvailablePTOPaidHours" Visible="False" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXLayoutRule runat="server" LabelsWidth="0" />
					<px:PXLayoutRule runat="server" Merge="True" LabelsWidth="0" />
					<px:PXCheckBox ID="chkUsePayrollProjectWorkLocation" runat="server" DataField="UsePayrollProjectWorkLocation" CommitChanges="True" />
                    <px:PXCheckBox ID="chkUsePayrollProjectWorkLocationUseDflt" runat="server" DataField="UsePayrollProjectWorkLocationUseDflt" CommitChanges="True" />
					<px:PXLayoutRule runat="server" />
					...
					<px:PXLayoutRule runat="server" Merge="True" />
					<px:PXSelector ID="edWorkCodeID" runat="server" TabIndex="105" DataField="WorkCodeID" />
                    ...
                    <px:PXLayoutRule runat="server" Merge="True" />
                    <px:PXCheckBox ID="chkExemptFromCertifiedReporting" runat="server" DataField="ExemptFromCertifiedReporting" TabIndex="115" Width="200" CommitChanges="True" />
			...
			<px:PXTabItem Text="Employment History">
				<Template>
					...
					<px:PXGrid runat="server" ID="gridPositions" SkinID="DetailsInTab" DataSourceID="ds" Width="100%" AdjustPageSize="Auto" SyncPosition="True">
						<Levels>
							<px:PXGridLevel DataMember="EmployeePositions" >
								<Columns>
									...
									<px:PXGridColumn DataField="SettlementPaycheckRefNoteID" Width="100px" LinkCommand="ViewPayCheck"/>
								</Columns>
							</px:PXGridLevel>
						</Levels>
						...
						<Levels>
							<px:PXGridLevel DataMember="EmployeeAttributes">
								<Columns>
									...
									<px:PXGridColumn DataField="UsedForTaxCalculation" TextAlign="Center" Type="CheckBox" />
			...
			<px:PXTabItem Text="Paid Time Off">
				<Template>
					<px:PXFormView ID="fEmployeePTOBanks" runat="server" DataMember="CurrentPayrollEmployee">
						<Template>
							<px:PXLayoutRule runat="server" StartRow="true" ControlSize="XXS" LabelsWidth="1px" />
						...
						<Levels>
							<px:PXGridLevel DataMember="PTOBanks">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="StartDate" CommitChanges="true" />
									<px:PXGridColumn DataField="AccrualMethod" CommitChanges="true" />
									...
									<px:PXGridColumn DataField="DisbursingType" />
									...
									<px:PXGridColumn DataField="CreateFinancialTransaction" Visible="False" AllowShowHide="False" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<ActionBar>
							...
							<CustomItems>
								...
								<px:PXToolBarButton CommandSourceID="ds" DependOnGrid="grdPTOBanks" CommandName="ViewAvailablePTOPaidHours" StateColumn="CreateFinancialTransaction" />
							</CustomItems>
						</ActionBar>
	...
	<px:PXSmartPanel runat="server" ID="pnlViewAvailablePTOPaidHours" Caption="View Available PTO Paid Hours" CaptionVisible="true" LoadOnDemand="true"
		Key="PTOPaidHoursPopupFilter" Width="600px" Height="250px">
		<px:PXFormView ID="formPTOPaidHoursPopupFilter" runat="server" DataMember="PTOPaidHoursPopupFilter" DataSourceID="ds" Width="100%" SkinID="Transparent">
			<Template>
				<px:PXLayoutRule runat="server" StartRow="true" LabelsWidth="M" ControlSize="M" />
				<px:PXSelector ID="edBankID" runat="server" DataField="BankID" />
				<px:PXDateTimeEdit ID="edEffectiveDate" runat="server" DataField="EffectiveDate" CommitChanges="true" />
				<px:PXDropDown ID="edDisbursingType" runat="server" DataField="DisbursingType" CommitChanges="true" />
				<px:PXNumberEdit ID="edPTOPayRate" runat="server" DataField="PayRate" CommitChanges="true" />
				<px:PXNumberEdit ID="edAvailablePaidHours" runat="server" DataField="AvailablePaidHours" CommitChanges="true" />
			</Template>
			<AutoSize Enabled="true" />
		</px:PXFormView>
		<px:PXPanel ID="pnlPTOPaidHoursPopupFilterButtons" runat="server" SkinID="Buttons">
			<px:PXButton ID="btnPTOPaidHoursPopupFilterOK" runat="server" DialogResult="OK" Text="OK" />
		</px:PXPanel>
	</px:PXSmartPanel>
