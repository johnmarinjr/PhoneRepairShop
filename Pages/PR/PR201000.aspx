...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%"
		...
		<Template>
			...
			<px:PXNumberEdit ID="edFinPeriods" runat="server" DataField="FinPeriods" />
			<px:PXCheckBox ID="edOverrideFinPeriods" runat="server" DataField="OverrideFinPeriods" CommitChanges="true" />
		</Template>
	</px:PXFormView>
</asp:Content>
