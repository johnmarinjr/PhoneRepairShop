		...
		<Items>
			<px:PXTabItem Text="Payroll">
				<Template>
                    ...
                    <px:PXCheckBox ID="chkExemptFromCertifiedReporting" runat="server" DataField="ExemptFromCertifiedReporting" Style="margin-bottom: 30px" />
					<px:PXLayoutRule runat="server" GroupCaption="Work Locations" />
					...
					<px:PXCheckBox ID="chkUsePayrollProjectWorkLocation" runat="server" DataField="UsePayrollProjectWorkLocation" />
				</Template>
			</px:PXTabItem>
