...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="EarningTypes" TabIndex="2100">
		<Template>
			...
			<px:PXCheckBox runat="server" ID="edPublicHoliday" DataField="PublicHoliday" />
		</Template>
	</px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="EarningSettings">
		<Items>
			<px:PXTabItem Text="US Tax and Reporting">
				<Template>
					<px:PXFormView ID="frmUSTaxReportingForm" runat="server" DataSourceID="ds" Width="100%" DataMember="EarningSettings">
						<Template>
							<px:PXLayoutRule runat="server" StartRow="True" ControlSize="L" LabelsWidth="SM" />
							<px:PXSelector ID="edWageTypeCD" runat="server" DataField="WageTypeCD" AutoRefresh="True" CommitChanges="true" />
							<px:PXSelector ID="edReportType" runat="server" DataField="ReportType" CommitChanges="True" />
							<px:PXDropDown ID="edIncludeType" runat="server" DataField="IncludeType" CommitChanges="True" />
						</Template>
					</px:PXFormView>
					<px:PXGrid ID="grdTaxDetailsUS" runat="server" DataSourceID="ds" TabIndex="8700" SkinID="DetailsInTab" Style="left: 0px; top: 0px" Width="100%">
						<Levels>
							<px:PXGridLevel DataMember="EarningTypeTaxesUS">
								<Columns>
									<px:PXGridColumn DataField="TaxID" CommitChanges="True" />
									<px:PXGridColumn DataField="TaxID_Description" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
			...
			<px:PXTabItem Text="CAN Tax and Reporting">
				<Template>
					<px:PXFormView ID="frmCANTaxReportingForm" runat="server" DataSourceID="ds" Width="100%" DataMember="EarningSettings">
						<Template>
							<px:PXLayoutRule runat="server" StartRow="True" ControlSize="L" LabelsWidth="SM" />
							<px:PXSelector ID="edWageTypeCDCAN" runat="server" DataField="WageTypeCDCAN" AutoRefresh="True" CommitChanges="true" />
							<px:PXSelector ID="edReportTypeCAN" runat="server" DataField="ReportTypeCAN" CommitChanges="True" />
							<px:PXCheckBox ID="edIsSupplementalCAN" runat="server" DataField="IsSupplementalCAN" />
						</Template>
					</px:PXFormView>
					<px:PXGrid ID="grdTaxDetailsCAN" runat="server" DataSourceID="ds" SkinID="Inquire" Style="left: 0px; top: 0px" Width="100%">
						<Levels>
							<px:PXGridLevel DataMember="EarningTypeTaxesCAN">
								<Columns>
									<px:PXGridColumn DataField="TaxID" />
									<px:PXGridColumn DataField="TaxID_Description" />
									<px:PXGridColumn DataField="Taxability" Width="200px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" />
			...
			<px:PXTabItem Text="Project Settings">
				<Template>
					<px:PXLayoutRule runat="server" StartRow="True" ControlSize="L" LabelsWidth="SM" />
			...
			<px:PXTabItem Text="GL Accounts">
				<Template>
					...
					<px:PXSelector ID="edPTOExpenseAcctID" runat="server" DataField="PTOExpenseAcctID" />
