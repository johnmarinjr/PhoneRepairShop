		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXSelector ID="edROENumberingCD" runat="server" AllowEdit="True" DataField="ROENumberingCD" />
					...
					<px:PXDropDown ID="edEarningsAlternateAcctDefault" runat="server" AllowNull="False" DataField="EarningsAlternateAcctDefault" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" />

					<px:PXLayoutRule runat="server" Merge="True" />
					<px:PXSegmentMask ID="edEarningsSubMask" runat="server" DataField="EarningsSubMask" CommitChanges="true" />
					<px:PXSegmentMask ID="edEarningsAlternateSubMask" runat="server" DataField="EarningsAlternateSubMask" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" />
					...
					<px:PXDropDown ID="edBenefitExpenseAlternateAcctDefault" runat="server" AllowNull="False" DataField="BenefitExpenseAlternateAcctDefault" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" />

					<px:PXLayoutRule runat="server" Merge="True" />
					<px:PXSegmentMask ID="edBenefitExpenseSubMask" runat="server" DataField="BenefitExpenseSubMask" CommitChanges="true" />
					<px:PXSegmentMask ID="edBenefitExpenseAlternateSubMask" runat="server" DataField="BenefitExpenseAlternateSubMask" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" />
					...
					<px:PXDropDown ID="edTaxExpenseAlternateAcctDefault" runat="server" AllowNull="False" DataField="TaxExpenseAlternateAcctDefault" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" />

					<px:PXLayoutRule runat="server" Merge="True" />
					<px:PXSegmentMask ID="edTaxExpenseSubMask" runat="server" DataField="TaxExpenseSubMask" CommitChanges="true" />
					<px:PXSegmentMask ID="edTaxExpenseAlternateSubMask" runat="server" DataField="TaxExpenseAlternateSubMask" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" />
					...
					<px:PXLayoutRule runat="server" Merge="True" />
					<px:PXDropDown ID="edPTOExpenseAcctDefault" runat="server" AllowNull="False" DataField="PTOExpenseAcctDefault" CommitChanges="true" />
					<px:PXDropDown ID="edPTOExpenseAlternateAcctDefault" runat="server" AllowNull="False" DataField="PTOExpenseAlternateAcctDefault" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" />

					<px:PXLayoutRule runat="server" Merge="True" />
					<px:PXSegmentMask ID="edPTOExpenseSubMask" runat="server" DataField="PTOExpenseSubMask" CommitChanges="true" />
					<px:PXSegmentMask ID="edPTOExpenseAlternateSubMask" runat="server" DataField="PTOExpenseAlternateSubMask" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" />

					<px:PXDropDown ID="edPTOLiabilityAcctDefault" runat="server" AllowNull="False" DataField="PTOLiabilityAcctDefault" />
					<px:PXSegmentMask ID="edPTOLiabilitySubMask" runat="server" DataField="PTOLiabilitySubMask" />
					<px:PXDropDown ID="edPTOAssetAcctDefault" runat="server" AllowNull="False" DataField="PTOAssetAcctDefault" />
					<px:PXSegmentMask ID="edPTOAssetSubMask" runat="server" DataField="PTOAssetSubMask" />
					<px:PXDropDown ID="edProjectCostAssignment" runat="server" AllowNull="False" DataField="ProjectCostAssignment" CommitChanges="true" />
					<px:PXDropDown ID="edTimePostingOption" runat="server" DataField="TimePostingOption" CommitChanges="true" />
