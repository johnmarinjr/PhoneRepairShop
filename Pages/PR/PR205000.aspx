		...
		<Levels>
			<px:PXGridLevel DataMember="PayGroup">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="PTOLiabilityAcctID" />
					<px:PXGridColumn DataField="PTOLiabilitySubID" />
					<px:PXGridColumn DataField="PTOAssetAcctID" />
					<px:PXGridColumn DataField="PTOAssetSubID" />
