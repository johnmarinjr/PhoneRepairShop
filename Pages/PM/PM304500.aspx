			...
			<px:PXTabItem Text="Addresses">
				<Template>
					...
					<px:PXFormView ID="edQuote_Contact" runat="server" DataMember="Quote_Contact" DataSourceID="ds" RenderStyle="Simple">
						<Template>
							<px:PXLayoutRule runat="server" GroupCaption="Bill-to Contact" StartGroup="True" />
					...
					<px:PXFormView ID="formA" runat="server" DataMember="Shipping_Address" DataSourceID="ds" RenderStyle="Simple">
                        <Template>
							<px:PXLayoutRule runat="server" StartGroup="True" ControlSize="XM" LabelsWidth="SM" GroupCaption="Project Address" />
