        ...
        <Template2>
            <px:PXFormView ID="formRules" runat="server" DataSourceID="ds" DataMember="BillingRule" Width="100%">
                <Template>
                    ...
                    <px:PXSegmentMask ID="edAccountGroupID" runat="server" DataField="AccountGroupID" CommitChanges="true" />

                    <px:PXLayoutRule ID="PXLayoutRule6" runat="server" Merge="True" ControlSize="SM" />
                    <px:PXSelector ID="edRateTypeID" runat="server" DataField="RateTypeID" CommitChanges="true"/>
                    <px:PXDropDown ID="edNoRateOption" runat="server" DataField="NoRateOption" CommitChanges="true" />
                    ...
                    <pxa:PMFormulaEditor ID="edInvoiceFormula" runat="server" DataSourceID="ds" DataField="InvoiceFormula" CommitChanges="true" />
                    <pxa:PMFormulaEditor ID="edQtyFormula" runat="server" DataSourceID="ds" DataField="QtyFormula" Parameters="@Rate,@Price" CommitChanges="true"/>
                    <pxa:PMFormulaEditor ID="edAmountFormula" runat="server" DataSourceID="ds" DataField="AmountFormula" Parameters="@Rate,@Price" CommitChanges="true" />
                    <pxa:PMFormulaEditor ID="edDescriptionFormula" runat="server" DataSourceID="ds" DataField="DescriptionFormula" Parameters="@Rate,@Price" CommitChanges="true"/>

                    <px:PXLayoutRule ID="PXLayoutRule12" runat="server" Merge="True" ControlSize="SM" />
                    <px:PXDropDown ID="edBranchSource" runat="server" DataField="BranchSource" CommitChanges="true"/>
                    <px:PXDropDown ID="edBranchSourceBudget" runat="server" DataField="BranchSourceBudget" CommitChanges="true"/>
                    <px:PXSegmentMask ID="edBranchID" runat="server" DataField="TargetBranchID" CommitChanges="true"/>
                    ...
                    <px:PXSegmentMask ID="edSubMask" runat="server" DataField="SubMask" DataMember="_PMBILL_Segments_" CommitChanges="true"/>
                    <px:PXSegmentMask ID="edSubMaskBudget" runat="server" DataField="SubMaskBudget" DataMember="_PMBILLBUDGET_Segments_" CommitChanges="true"/>
                    ...
                    <px:PXCheckBox ID="PXCheckBox2" runat="server" DataField="CopyNotes" Size="L" CommitChanges="true"/>
                    <px:PXCheckBox ID="PXCheckBox3" runat="server" DataField="IncludeZeroAmount" CommitChanges="true"/>
					<px:PXCheckBox ID="PXCheckBox4" runat="server" DataField="IncludeZeroAmountAndQty" CommitChanges="true"/>

                    <px:PXLayoutRule ID="PXLayoutRule22" runat="server" Merge="True" ControlSize="SM" />
                    <px:PXCheckBox ID="PXCheckBox5" runat="server" DataField="IncludeNonBillable" Size="L" CommitChanges="true" />
                    ...
                    <px:PXCheckBox ID="PXCheckBox1" runat="server" DataField="GroupByDate" Size="S" CommitChanges="true" />
                    <px:PXCheckBox ID="PXCheckBox6" runat="server" DataField="GroupByEmployee" Size="S" CommitChanges="true" />
                    <px:PXCheckBox ID="PXCheckBox7" runat="server" DataField="GroupByVendor" Size="S" CommitChanges="true" />
                    <px:PXCheckBox ID="PXCheckBox8" runat="server" DataField="GroupByItem" Size="S" CommitChanges="true" />
                </Template>
                <CallbackCommands>
