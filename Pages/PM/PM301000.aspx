...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" EnableAttributes="true" Visible="True" Width="100%" TypeName="PX.Objects.PM.ProjectEntry" PrimaryView="Project" BorderStyle="NotSet">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="LoadFromTemplate" Visible="False" CommitChanges="True" PostData="Page" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Project" Caption="Project Summary" FilesIndicator="True"
        ...
        <Template>
            ...
            <pxa:PXCurrencyRate ID="edCury" DataField="CuryID" runat="server" DataSourceID="ds" RateTypeView="CurrencyInfo" DataMember="_Currency_" />
        ...
        <Items>
            <px:PXTabItem Text="Summary">
                <Template>
                    ...
                    <px:PXSelector ID="edCuryID" runat="server" DataField="CuryIDCopy" Size="S" CommitChanges="True" />
                    ...
                    <px:PXSelector ID="edBaseCuryID" runat="server" DataField="BaseCuryID" Size="S" CommitChanges="True" />
                    ...
                    <px:PXDropDown ID="edAccountingMode" runat="server" AllowNull="False" DataField="AccountingMode" />
                    ...
                    <px:PXSelector ID="edPayrollWorkLocationID" runat="server" DataField="PayrollWorkLocationID" AllowEdit="True" CommitChanges="True" />
                    ...
                    <px:PXSelector ID="edDefaultBranchID" runat="server" DataField="DefaultBranchID" CommitChanges="True" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Tasks" DataKeyNames="ProjectID,TaskCD">
                                ...
                                <Columns>
									...
									<px:PXGridColumn DataField="PTOExpenseAcctID" />
									<px:PXGridColumn DataField="PTOExpenseSubID" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="RevenueBudget">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="QtyToInvoice" TextAlign="Right" CommitChanges="true" />
                                    ...
                                    <px:PXGridColumn DataField="ProgressBillingBase" CommitChanges="true"/>
                                </Columns>
                                <RowTemplate>
            ...
            <px:PXTabItem Text="Balances" LoadOnDemand="true">
                <Template>
                    <px:PXGrid runat="server" ID="ProjectBalanceGrid" Width="100%" DataSourceID="ds" Height="100%" SkinID="DetailsInTab" AdjustPageSize="Auto" AllowPaging="False" AllowSearch="False"
                        AllowFilter="False" OnRowDataBound="ProjectBalanceGrid_RowDataBound" SyncPosition="True">
                        <Levels>
        ...
        <Template>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Activities">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="TimeActivityOwner" LinkCommand="OpenActivityOwner" DisplayMode="Text" />
            ...
            <px:PXTabItem Text="Addresses">
                <Template>
                    ...
                    <px:PXFormView ID="Tax_Settings" runat="server" Caption="TAX SETTINGS" DataMember="ProjectProperties" RenderStyle="Fieldset">
                        <Template>
                            <px:PXLayoutRule ID="SiteTaxSettingsLayoutRule" runat="server" ControlSize="XM" LabelsWidth="SM" StartColumn="True" />
					        <px:PXSelector ID="edCostTaxZoneID" runat="server" DataField="CostTaxZoneID" AutoRefresh="True" CommitChanges="True"/>
					        <px:PXSelector ID="edRevenueTaxZoneID" runat="server" DataField="RevenueTaxZoneID" AutoRefresh="True" CommitChanges="True"/>
                        </Template>
                    </px:PXFormView>
            ...
            <px:PXTabItem Text="Defaults">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Drop-Ship Purchases" />
                    <px:PXDropDown ID="edDropshipExpenseAccountSource" runat="server" DataField="DropshipExpenseAccountSource" />
                    <px:PXSegmentMask ID="edDropshipExpenseSubMask" runat="server" DataField="DropshipExpenseSubMask" />
                    <px:PXDropDown ID="edDropshipReceiptProcessing" runat="server" DataField="DropshipReceiptProcessing" CommitChanges="true" />
                    <px:PXDropDown ID="edDropshipExpenseRecording" runat="server" DataField="DropshipExpenseRecording" CommitChanges="true" />
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Payroll Values" />
					...
					<px:PXSegmentMask ID="edPTOExpenseAcctID" runat="server" DataField="PTOExpenseAcctID" />
					<px:PXSegmentMask ID="edPTOExpenseSubID" runat="server" DataField="PTOExpenseSubID" />
...
<asp:Content ID="Dialogs" ContentPlaceHolderID="phDialogs" runat="Server">
    ...
    <px:PXSmartPanel ID="LoadFromTemplatePanel" runat="server" Style="z-index: 108; position: absolute; left: 27px; top: 99px;" Caption="Warning"
        CaptionVisible="True" LoadOnDemand="true" ShowAfterLoad="true" Key="LoadFromTemplateDialog" AutoCallBack-Enabled="true" AutoCallBack-Target="formLoadfromTemplate"
        CallBackMode-CommitChanges="True" CallBackMode-PostData="Page" AcceptButtonID="PXButton5" CancelButtonID="PXButton4" >
        <px:PXFormView ID="formLoadfromTemplate" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Settings" CaptionVisible="False" SkinID="Transparent"
            DataMember="LoadFromTemplateDialog">
            <Template>
                <px:PXLayoutRule runat="server" StartColumn="True" />
				
                <px:PXLabel DataField="Message" ID="PXTextEdit1" runat="server" Text="Creation of the project based on the selected template may take a significant amount of time. Do you want to proceed?" 
					Width="300px" Height="60px"/>
            </Template>
        </px:PXFormView>
        <div style="padding: 5px; text-align: center;">
            <px:PXButton ID="PXButton5" runat="server" DialogResult="Cancel" Text="Proceed" CommandName="LoadFromTemplate" CommandSourceID="ds" />
