        ...
        <Levels>
            <px:PXGridLevel DataMember="Transactions">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="BAccountID" Label="Customer/Vendor" LinkCommand ="ViewCustomer" DisplayMode="Hint"/>
                    <px:PXGridColumn DataField="ResourceID" Label="Resource" />
                    <px:PXGridColumn DataField="BAccount__AcctName" Label="Employee Name" />
                    ...
                    <px:PXGridColumn DataField="OffsetAccountGroupID" Label="GL Account-Account Group" />
