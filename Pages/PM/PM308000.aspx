...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="511px" DataSourceID="ds" DataMember="DocumentSettings" >
        ...
        <Items>
            ...
            <px:PXTabItem Text="Cost Budget" BindingContext="VisibilityForm" VisibleExp="DataControls[&quot;chkIsCostVisible&quot;].Value == true">
                <Template>
            ...
            <px:PXTabItem Text="Commitments" BindingContext="VisibilityForm" VisibleExp="DataControls[&quot;chkIsDetailsVisible&quot;].Value == true">
                <Template>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Details">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="POOrderType" Type="DropDownList" CommitChanges="True" />
            ...
            <px:PXTabItem Text="Approvals" LoadOnDemand="True">
                <Template>
