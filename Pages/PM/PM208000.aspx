    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="511px" DataSourceID="ds" DataMember="ProjectProperties">
        <Items>
            <px:PXTabItem Text="Summary">
                <Template>
                   ...
                   <px:PXSelector ID="edTermsID" runat="server" DataField="TermsID" />
                    ...
                    <px:PXCheckBox ID="chkVisibleInGL" runat="server" DataField="VisibleInGL" CommitChanges="True" />
                    <px:PXCheckBox ID="chkVisibleInAP" runat="server" DataField="VisibleInAP" CommitChanges="True" />
                    <px:PXCheckBox ID="chkVisibleInAR" runat="server" DataField="VisibleInAR" CommitChanges="True" />
                    <px:PXCheckBox ID="chkVisibleInSO" runat="server" DataField="VisibleInSO" CommitChanges="True" />
                    <px:PXCheckBox ID="chkVisibleInPO" runat="server" DataField="VisibleInPO" CommitChanges="True" />
                    <px:PXLayoutRule ID="PXLayoutRule5" runat="server" />
                    <px:PXLayoutRule ID="PXLayoutRule4" runat="server" Merge="True" />                   
                    <px:PXCheckBox ID="chkVisibleInIN" runat="server" DataField="VisibleInIN" CommitChanges="True" />
                    <px:PXCheckBox ID="chkVisibleInCA" runat="server" DataField="VisibleInCA" CommitChanges="True" />
                    <px:PXCheckBox ID="chkVisibleInCR" runat="server" DataField="VisibleInCR" CommitChanges="True" />
					<px:PXCheckBox runat="server" ID="chkVisibleInPROD" DataField="VisibleInPROD" CommitChanges="True" />
                    <px:PXLayoutRule ID="PXLayoutRule8" runat="server" />
                    <px:PXLayoutRule ID="PXLayoutRule9" runat="server" Merge="True" />
                    <px:PXCheckBox ID="chkVisibleInTA" runat="server" DataField="VisibleInTA" CommitChanges="True" />
                    <px:PXCheckBox ID="chkVisibleInEA" runat="server" DataField="VisibleInEA" CommitChanges="True" />
            ...
            <px:PXTabItem Text="Tasks">
                <Template>
                    <px:PXGrid runat="server" ID="TaskGrid" Width="100%" DataSourceID="ds" Height="100%" SkinID="DetailsInTab" SyncPosition="True">
                        <Levels>
                            <px:PXGridLevel DataMember="Tasks" DataKeyNames="ProjectID,TaskCD">
                                <RowTemplate>
                                    ...
                                    <px:PXDropDown Size="m" ID="edProgressBillingBase" runat="server" DataField="ProgressBillingBase" />
            ...
            <px:PXTabItem Text="Defaults">
                <Template>
                    ...
                    <px:PXSegmentMask ID="edDefaultAccrualSubID" runat="server" DataField="DefaultAccrualSubID" CommitChanges="True" />
                    <px:PXSelector ID="edApprover" runat="server" DataField="ApproverID" CommitChanges="True" />
