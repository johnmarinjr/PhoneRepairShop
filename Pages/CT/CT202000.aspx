        ...
        <Items>
            <px:PXTabItem Text="Summary">
                <Template>
                    ...
                    <px:PXNumberEdit ID="edDuration"  AllowNull="False" runat="server" DataField="Duration" Size="XXS" CommitChanges="true" />
                    <px:PXDropDown ID="edDurationType" runat="server" DataField="DurationType" SuppressLabel="true" Size="M"  Width="194" AllowNull="false" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" />
                    <px:PXCheckBox runat="server" ID="chkRefundable" DataField="Refundable" CommitChanges="true" />
                    <px:PXLayoutRule runat="server" Merge="true" />
                    <px:PXNumberEdit ID="edRefundPeriod" runat="server" DataField="RefundPeriod" Size="XXS" CommitChanges="true" />
