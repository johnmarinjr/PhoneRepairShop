					...
					<px:PXGrid runat="server" ID="UnbilledGrid" Height="100%" Width="100%" DataSourceID="ds"
						...
						<Levels>
							<px:PXGridLevel DataKeyNames="TranID" DataMember="UnBilled">
								...
								<Columns>
									<px:PXGridColumn DataField="BranchID" Label="Branch" Width="130px" />
									<px:PXGridColumn DataField="InventoryID" Label="Inventory ID" Width="120px" AutoCallBack="true" />
									<px:PXGridColumn DataField="Description" Label="Description"  Width="230px"/>
					...
					<px:PXGrid runat="server" ID="BilledGrid" Width="100%" DataSourceID="ds"
						...
						<Levels>
							<px:PXGridLevel DataMember="Billed">
								...
								<Columns>
									<px:PXGridColumn DataField="BranchID" Label="Branch" Width="130px" />
									<px:PXGridColumn DataField="InventoryID" Label="Inventory ID" Width="110px" />
									<px:PXGridColumn DataField="Description" Label="Description" Width="230px" />
									<px:PXGridColumn DataField="UOM" Label="UOM" Width="108px" />
