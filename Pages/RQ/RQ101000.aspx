        ...
        <Items>
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Requisition Order Settings" LabelsWidth="M" ControlSize="SM" />
                    <px:PXSelector ID="edQTOrderType" runat="server" DataField="QTOrderType" AllowEdit="true" />
                    <px:PXSelector ID="edSOOrderType" runat="server" DataField="SOOrderType" AllowEdit="true" />
                    <px:PXLayoutRule runat="server" StartGroup="True" LabelsWidth="SM" ControlSize="M" />
                    ...
                    <px:PXSelector ID="edDefaultReqClassID" runat="server" DataField="DefaultReqClassID" Text="DEFAULT" AllowEdit="True" />
                </Template>
            </px:PXTabItem>
