...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Selection" DataMember="Filter"
        TabIndex="1100" DefaultControlID="edClassID" MarkRequired="Dynamic">
        <Template>
            ...
            <px:PXBranchSelector CommitChanges="True" ID="CompanyBranchSelector" runat="server" DataField="OrgBAccountID" InitialExpandLevel="0" />
            ...
            <px:PXDropDown CommitChanges="True" runat="server" DataField="ReceiptType" ID="edReceiptType" />
            <px:PXSelector CommitChanges="True" runat="server" DataField="ReceiptNbr" ID="edReceiptNbr" DataSourceID="ds" AutoRefresh="True" />
