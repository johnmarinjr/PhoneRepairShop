...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Height="600px" Width="100%" Style="z-index: 100" DataSourceID="ds" DataMember="CurrentAsset"
        ...
        <Items>
                ...
                <Template>
                    ...
                    <px:PXFormView ID="formAssetDetails3" runat="server" DataSourceID="ds" DataMember="AssetDetails" RenderStyle="Simple">
                        <Template>
                            ...
                            <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="S" StartRow="True"/>
                    ...
                    <px:PXFormView ID="formAssetLocation" runat="server" DataSourceID="ds" DataMember="AssetLocation" RenderStyle="Simple">
                        <Template>
                            ...
                            <px:PXSegmentMask CommitChanges="True" ID="edLocationID" runat="server" DataField="LocationID" AllowEdit="True" DataSourceID="ds" AutoRefresh="True">
			...
			<px:PXTabItem Text="Depreciation" RepaintOnDemand="false">
                <Template>
            ...
            <px:PXTabItem Text="Transactions" Visible="True" LoadOnDemand="False" RepaintOnDemand="False">
                <Template>
            ...
            <px:PXTabItem Text="Locations" RepaintOnDemand="false">
                <Template>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="DsplAdditions">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="OpenQty" Label="Open Quantity" TextAlign="Right" Width="100px" AllowUpdate="False"  AllowSort = "False" AllowFilter ="False"/>
                                    <px:PXGridColumn DataField="OpenAmt" Label="Open Amount" TextAlign="Right" Width="100px" AllowUpdate="False"  AllowSort = "False" AllowFilter ="False"/>
                                    <px:PXGridColumn AllowUpdate="False" AutoCallBack="True" DataField="GLTranQty" Label="Quantity" AllowSort = "False" AllowFilter ="False" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn AllowUpdate="False" AutoCallBack="True" DataField="UnitCost" Label="Unit Cost" AllowSort = "False" AllowFilter ="False" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn AllowUpdate="False" AutoCallBack="True" DataField="GLTranAmt" Label="Amount" AllowSort = "False" AllowFilter ="False" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="FAAccrualTran__GLTranDate" Label="Transaction Date" AllowSort = "False" AllowFilter ="False" Width="90px" />
