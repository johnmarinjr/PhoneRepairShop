				...
				<Levels>
					<px:PXGridLevel DataMember="GLTransactions">
						...
						<Columns>
							...
							<px:PXGridColumn AllowUpdate="False" DataField="OpenAmt" TextAlign="Right" AllowFilter="false"/>
				...
				<Levels>
					<px:PXGridLevel DataMember="FATransactions">
						...
						<Columns>
							...
							<px:PXGridColumn DataField="AssetCD" AutoCallBack="True"/>
							<px:PXGridColumn DataField="BranchID" DisplayFormat="&gt;AAAAAA" AutoCallBack="True"/>
							<px:PXGridColumn DataField="ClassID" AutoCallBack="True" />
							...
							<px:PXGridColumn DataField="ReceiptDate" AutoCallBack="True" />
