...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
		Width="100%" Caption="Options" DataMember="Filter"  MarkRequired="Dynamic">
		<Template>
			...
			<px:PXDropDown CommitChanges="True" ID="edActionBeforeDisposal" runat="server" AllowNull="False" DataField="ActionBeforeDisposal" SelectedIndex="-1" />
