...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.FA.TransactionEntry" PrimaryView="Document" HeaderDescriptionField="Origin">
        <CallbackCommands>
            <px:PXDSCallbackCommand CommitChanges="True" Name="Release" PopupCheckSave="false" />
            <px:PXDSCallbackCommand CommitChanges="True" Name="Action" PopupCheckSave="false" />
        ...
        <Levels>
            <px:PXGridLevel DataMember="Trans">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="SrcBranchID" />
