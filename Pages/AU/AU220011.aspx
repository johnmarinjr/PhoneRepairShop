<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="AU220011.aspx.cs" Inherits="Page_AU220011"
	 %>

<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXLabel runat="server" Text="Mobile Workspaces" class="projectLink transparent border-box" />
	<pxa:AUDataSource ID="ds" runat="server" Width="100%" TypeName="PX.SM.ProjectMobileSiteMapWorkspaceMaintenance" PrimaryView="Items" Visible="true">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    ...
    <px:PXSmartPanel runat="server"
                     ID="FilterSelectWorkspaces"
                     Width="700px"
                     Height="400px"
                     CaptionVisible="True"
		             Caption="Add Workspace"
                     ShowMaximizeButton="True"
                     Key="ViewSelectWorkspaces"
                     ShowAfterLoad="True"
                     AutoRepaint="True">
        <px:PXGrid runat="server" 
                   ...
                   NoteIndicator="False">
		    <Levels>
				<px:PXGridLevel DataMember="ViewSelectWorkspaces" >
					<Columns>
					    <px:PXGridColumn runat="server" DataField="Selected" Type="CheckBox" AllowCheckAll="True" Width="100px"/>
                        <px:PXGridColumn runat="server" DataField="Name"/>
					    <px:PXGridColumn runat="server" DataField="DisplayName"/>
                        <px:PXGridColumn runat="server" DataField="Icon"/>
                        <px:PXGridColumn runat="server" DataField="IsActive" Type="CheckBox" Width="100px" />
					</Columns>
				</px:PXGridLevel>
			</Levels>
		    <AutoSize Enabled="True"/>
