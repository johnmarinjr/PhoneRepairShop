...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <pxa:AUDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.SM.AUWorkflowEventHandlersMaint"
        ...
        <CallbackCommands>
            <px:PXDSCallbackCommand CommitChanges="True" Name="actionViewChanges" Visible="False" RepaintControls="All" DependOnGrid="gridHandlers" StateColumn="ViewChangesAvailable"/>
