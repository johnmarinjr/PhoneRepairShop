...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <pxa:AUDataSource ID="ds" runat="server" Visible="True" TypeName="PX.SM.AUWorkflowMaint"
                            ...
                            <Template>
                                <px:PXFormView ID="FormState" runat="server"
                                    ...
                                    <Template>
                                        ...
                                        <px:PXSelector ID="edSkipStateConditionID" runat="server" CommitChanges="True"
                                            AllowNull="True" DataField="SkipConditionID" AutoGenerateColumns="False" DisplayMode="Text"
                                            AutoRefresh="True">
                                            <GridProperties>
                                                <Columns>
                                        ...
                                        <px:PXTextEdit runat="server" ID="PXNextStateTextEdit" DataField="DisplayNextState"></px:PXTextEdit>
                                    </Template>
                                </px:PXFormView>
                                <px:PXTab runat="server" ID="tab" Width="100%" RepaintOnDemand="false">
                                    <AutoSize Enabled="True"></AutoSize>
                                    <Items>
                                        ...
                                        <px:PXTabItem Text="Fields to Update on Entry" RepaintOnDemand="false">
                                            <Template>
                                                <px:PXGrid runat="server" ID="gridOnEnterFields" CaptionVisible="True" AutoAdjustColumns="True" Width="100%"
                                                    ...
                                                    <ActionBar ActionsVisible="True">
                                                        ...
                                                        <CustomItems>
                                                            <px:PXToolBarButton DisplayStyle="Image" ImageKey="ArrowUp" Visible="true" Tooltip="Move Up">
                                                                <ActionBar />
                                                                <AutoCallBack Command="onEnterFieldMoveUp" Target="ds" />
                                                            </px:PXToolBarButton>
                                                            <px:PXToolBarButton DisplayStyle="Image" ImageKey="ArrowDown" Visible="True" Tooltip="Move Down">
                                                                <ActionBar />
                                                                <AutoCallBack Command="onEnterFieldMoveDown" Target="ds" />
                                                            </px:PXToolBarButton>
                                                        </CustomItems>
                                                    </ActionBar>
                                                    <Levels>
                                                        <px:PXGridLevel DataMember="OnEnterStateFieldsPerState" SortOrder="OnEnterStateFieldLineNbr">
                                                            <Mode InitNewRow="True" AllowRowSelect="true" />
                                                            <RowTemplate>
                                                                <pxa:PXFormulaCombo ID="edOEFPSValue" runat="server" DataField="Value" EditButton="True"
                                        ...
                                        <px:PXTabItem Text="Fields to Update on Exit" RepaintOnDemand="false">
                                            <Template>
                                                <px:PXGrid runat="server" ID="gridOnLeaveFields" CaptionVisible="True" AutoAdjustColumns="True" Width="100%"
                                                    MatrixMode="True" SyncPosition="True" SkinID="DetailsInTab" OnEditorsCreated="grd_EditorsCreated_RelativeDates" SyncPositionWithGraph="True">
                                                    <AutoCallBack Enabled="True" Command="refreshAll" Target="ds" SuppressOnReload="True" FromUIOnly="True"></AutoCallBack>
                                                    <AutoSize Enabled="True" MinHeight="150" />
                                                    <ActionBar ActionsVisible="True">
                                                        ...
                                                        <CustomItems>
                                                            <px:PXToolBarButton DisplayStyle="Image" ImageKey="ArrowUp" Visible="true" Tooltip="Move Up">
                                                                <ActionBar />
                                                                <AutoCallBack Command="onLeaveFieldMoveUp" Target="ds" />
                                                            </px:PXToolBarButton>
                                                            <px:PXToolBarButton DisplayStyle="Image" ImageKey="ArrowDown" Visible="True" Tooltip="Move Down">
                                                                <ActionBar />
                                                                <AutoCallBack Command="onLeaveFieldMoveDown" Target="ds" />
                                                            </px:PXToolBarButton>
                                                        </CustomItems>
                                                    </ActionBar>
                                                    <Levels>
                                                        <px:PXGridLevel DataMember="OnLeaveStateFieldsPerState" SortOrder="OnLeaveStateFieldLineNbr">
                                                            <Mode InitNewRow="True" AllowRowSelect="true" />
                                                            <RowTemplate>
                                                                <pxa:PXFormulaCombo ID="edOLFPSValue" runat="server" DataField="Value" EditButton="True"
                                                                    FieldsAutoRefresh="True" FieldsRootAutoRefresh="true" LastNodeName="Fields and Parameters"
                                                                    IsInternalVisible="false" IsExternalVisible="false" OnRootFieldsNeeded="edValue_RootFieldsNeeded"
                                                                    SkinID="GI">
                                                                    <Parameters>
                            ...
                            <Template>
                                <px:PXFormView ID="FormTransition" runat="server"
                                    ...
                                    <Template>
                                        ...
                                        <px:PXTextEdit runat="server" ID="edNextStateDisplay" DataField="DisplayNextState"></px:PXTextEdit>
                                        <px:PXLayoutRule ID="PXLayoutRule3" runat="server" LabelsWidth="SM" ControlSize="M" StartColumn="True"></px:PXLayoutRule>
...
<asp:Content ID="Dialogs" ContentPlaceHolderID="phDialogs" runat="server">
    <px:PXSmartPanel ID="PanelAddPredefinedState" runat="server"
        ...
        <px:PXFormView ID="FormAddPredefinedState" runat="server"
            ...
            <Template>
                ...
                <px:PXDropDown ID="AddPredefinedStateParentID" runat="server" DataField="ParentStateID"></px:PXDropDown>
    ...
    <px:PXSmartPanel ID="PXSmartPanelAddState" runat="server"
        ...
        <px:PXFormView ID="PXFormView1" runat="server"
            ...
            <Template>
                ...
                <px:PXDropDown ID="AddStateParentID" runat="server" DataField="ParentStateID"></px:PXDropDown>
    ...
    <px:PXSmartPanel ID="PanelChangeParentState" runat="server"
        Caption="Change Parent State"
        CaptionVisible="True"
        AutoReload="True" ClientEvents-AfterHide="OnProgressClosed" 
        LoadOnDemand="True" ShowAfterLoad="True" AutoRepaint="True"
        Key="ChangeWorkflowStateParent">
        <px:PXLayoutRule ID="PXLayoutRule12" runat="server" StartRow="True" />
        <px:PXFormView ID="PXFormView6" runat="server"
            SkinID="Transparent"
            DataMember="ChangeWorkflowStateParent"
            DataSourceID="ds"
            AutoRepaint="True">
            <Template>
                <px:PXLayoutRule ID="PXLayoutRule1" runat="server" ControlSize="M"></px:PXLayoutRule>
                <px:PXTextEdit runat="server" ID="edSIdentifier2" DataField="CurrentState"></px:PXTextEdit>
                <px:PXDropDown ID="ChangeWorkflowStateParentID" runat="server" DataField="ParentStateID"></px:PXDropDown>
            </Template>
        </px:PXFormView>
        <px:PXPanel ID="PXPanel5" runat="server" SkinID="Buttons">
            <px:PXButton ID="PXButton9" runat="server"
                CausesValidation="False"
                Text="OK"
                DialogResult="OK" />
            <px:PXButton ID="PXButton10" runat="server"
                CausesValidation="False" DialogResult="Cancel" Text="Cancel" />
        </px:PXPanel>
    </px:PXSmartPanel>
                        ...
                        <px:PXGrid runat="server" ID="gridOnEnterFields" CaptionVisible="True" AutoAdjustColumns="True" Width="100%"
                            ...
                            <Levels>
                                <px:PXGridLevel DataMember="OnEnterStateFieldsPerState" SortOrder="OnEnterStateFieldLineNbr">
                                    <Mode InitNewRow="True" AllowRowSelect="true" />
                                    <RowTemplate>
                                        <pxa:PXFormulaCombo ID="edSPOEFPSValue" runat="server" DataField="Value" EditButton="True"
                                            FieldsAutoRefresh="True" FieldsRootAutoRefresh="true" LastNodeName="Fields and Parameters"
                                            IsInternalVisible="false" IsExternalVisible="false" OnRootFieldsNeeded="edValue_RootFieldsNeeded"
                                            SkinID="GI">
                                            <Parameters>
                        ...
                        <px:PXGrid runat="server" ID="gridOnLeaveFields" CaptionVisible="True" AutoAdjustColumns="True" Width="100%"
                            ...
                            <Levels>
                                <px:PXGridLevel DataMember="OnLeaveStateFieldsPerState" SortOrder="OnLeaveStateFieldLineNbr">
                                    <Mode InitNewRow="True" AllowRowSelect="true" />
                                    <RowTemplate>
                                        <pxa:PXFormulaCombo ID="edSPOLFPSValue" runat="server" DataField="Value" EditButton="True"
                                            FieldsAutoRefresh="True" FieldsRootAutoRefresh="true" LastNodeName="Fields and Parameters"
                                            IsInternalVisible="false" IsExternalVisible="false" OnRootFieldsNeeded="edValue_RootFieldsNeeded"
                                            SkinID="GI">
                                            <Parameters>
