...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<pxa:AUDataSource ID="ds" runat="server" TypeName="PX.SM.ProjectMobileSiteMapMaintenance" PrimaryView="Items" Visible="true">
		<CallbackCommands>
            <px:PXDSCallbackCommand Name="actionClearCurrentCompany" RepaintControls="None" RepaintControlsIDs="ds" SelectControlsIDs="grid" Visible="false" />
            <px:PXDSCallbackCommand Name="actionClearAllCompanies" RepaintControls="None" RepaintControlsIDs="ds" SelectControlsIDs="grid" Visible="false" />
		</CallbackCommands>
	</pxa:AUDataSource>
</asp:Content>
