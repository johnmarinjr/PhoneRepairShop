		...
		<Levels>
            <px:PXGridLevel DataMember="GLTranForReclass">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="NewProjectID"  CommitChanges="True"/>
					<px:PXGridColumn DataField="NewTaskID"  CommitChanges="True"/>
					<px:PXGridColumn DataField="NewCostCodeID"  CommitChanges="True"/>
    ...
    <px:PXSmartPanel ID="pnlLoadOpts" runat="server" Style="z-index: 108;" Caption="Load Transactions" CaptionVisible="True" Key="LoadOptionsView" AutoReload="true" LoadOnDemand="true">
		<px:PXFormView ID="loform" runat="server" Style="z-index: 100;" DataMember="LoadOptionsView" CaptionVisible="False" DefaultControlID="edBranch" SkinID="Transparent"  DataSourceID="ds">
			...
			<Template>
                ...
                <px:PXSelector ID="edReferenceID" runat="server" DataField="ReferenceID" CommitChanges="True" AutoRefresh="True"/>

				<px:PXSelector ID="edProjectID" runat="server" DataField="ProjectID"  CommitChanges="True"/>
				<px:PXSelector ID="edFromTaskID" runat="server" DataField="FromTaskID"  CommitChanges="True" AutoRefresh="true"/>
				<px:PXSelector ID="edToTaskID" runat="server" DataField="ToTaskID"  CommitChanges="True" AutoRefresh="true"/>
				<px:PXSelector ID="edFromCostCodeID" runat="server" DataField="FromCostCodeID"  CommitChanges="True"/>
				<px:PXSelector ID="edToCostCodeID" runat="server" DataField="ToCostCodeID"  CommitChanges="True"/>
     ...
     <px:PXSmartPanel ID="pnlRepalceOpt" runat="server" Style="z-index: 108;" Caption="Find and Replace" CaptionVisible="True" Key="ReplaceOptionsView" AutoReload="true" LoadOnDemand="true">
		<px:PXFormView ID="roform" runat="server" Style="z-index: 100;" DataMember="ReplaceOptionsView" CaptionVisible="False" DefaultControlID="edOldBranchID" SkinID="Transparent">
			...
			<Template>
                ...
                <px:PXSegmentMask ID="edWithBranchID" runat="server" DataField="WithBranchID" CommitChanges="True" />
				...
				<px:PXSelector ID="edWithProjectID" runat="server" DataField="WithProjectID"  CommitChanges="True"/>
				<px:PXSelector ID="edWithTaskID" runat="server" DataField="WithTaskID"  CommitChanges="True" AutoRefresh="true"/>
				<px:PXSelector ID="edWithCostCodeID" runat="server" DataField="WithCostCodeID"  CommitChanges="True"/>
                ...
                <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="M" GroupCaption="REPLACE WITH" StartGroup="True" StartColumn="true"/>
				<px:PXSegmentMask ID="edNewBranchID" runat="server" DataField="NewBranchID" CommitChanges="True" AutoRefresh="True" />
				...
				<px:PXSelector ID="edNewProjectID" runat="server" DataField="NewProjectID"  CommitChanges="True"/>
				<px:PXSelector ID="edNewTaskID" runat="server" DataField="NewTaskID"  CommitChanges="True" AutoRefresh="true"/>
				<px:PXSelector ID="edNewCostCodeID" runat="server" DataField="NewCostCodeID"  CommitChanges="True"/>
                <px:PXDateTimeEdit ID="edNewDate" runat="server" DataField="NewDate" CommitChanges="True"/>
				<px:PXLabel ID="lbSpace" runat="server" />
