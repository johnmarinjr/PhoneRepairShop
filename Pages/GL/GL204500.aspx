		...
		<Items>
			<px:PXTabItem Text="Allocation">
				<Template>
					...
					<px:PXSelector CommitChanges="True" ID="edAllocLedgerID" runat="server" DataField="AllocLedgerID" AutoRefresh="true"/>
					<px:PXSelector ID="edSourceLedgerID" runat="server" DataField="SourceLedgerID" AutoRefresh="True" CommitChanges="True">
						<Parameters>
					...
					<px:PXSelector ID="edBasisLederID" runat="server" DataField="BasisLederID" CommitChanges="true"/>
					<px:PXCheckBox ID="chkAllocateSeparately" runat="server" DataField="AllocateSeparately" CommitChanges="true"/>
						...
						<Levels>
							<px:PXGridLevel DataMember="Source">
								<RowTemplate>
									...
									<px:PXSegmentMask CommitChanges="True" ID="edBranchID" runat="server" DataField="BranchID" AutoRefresh="true"/></RowTemplate>
								<Columns>
			...
			<px:PXTabItem Text="Destination Accounts">
				<Template>
					<px:PXGrid ID="grDest" runat="server"  Height="300px" Width="100%" MarkRequired="Dynamic"
						SkinID="DetailsInTab">
						<Levels>
							<px:PXGridLevel DataMember="Destination">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="S" />
									<px:PXSegmentMask ID="edAccountCD2" runat="server" DataField="AccountCD" SelectMode="Segment"
										Wildcard="?" CommitChanges="true"/>
									<px:PXSegmentMask ID="edSubCD2" runat="server" DataField="SubCD" SelectMode="Segment"
										Wildcard="?"/>
									...
									<px:PXSegmentMask CommitChanges="True" ID="edBasisBranchID" runat="server" DataField="BasisBranchID" AutoRefresh="true"/>
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="BranchID" AutoCallBack="True" />
									<px:PXGridColumn DataField="AccountCD" AutoCallBack="True"/>
									<px:PXGridColumn DataField="SubCD" AutoCallBack="True"/>
