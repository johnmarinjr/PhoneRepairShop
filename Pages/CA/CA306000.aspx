...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="TranFilter" TypeName="PX.Objects.CA.CABankTransactionsMaint">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="Split" Visible="false" DependOnGrid="grid1" />
            ...
            <px:PXDSCallbackCommand Visible="False" Name="viewTaxDetails" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
        ...
        <Template1>
            ...
            <px:PXGrid ID="grid1" runat="server" DataSourceID="ds" Style="z-index: 100; border-right: 1px solid #BBBBBB;"
                ...
                <AutoCallBack Target="PXGrid1" Command="Refresh" ActiveBehavior="true">
                    <Behavior RepaintControls="None" RepaintControlsIDs="form,grid1,gridAdjustments,gridCASplits,PXGrid1,gridDetailMatches4,gridExpenseReceiptDetailMatches,frmMatchToPayments,frmCreateDocumentInv,frmCreateDocument,tab2" />
                </AutoCallBack>
                <ActionBar ActionsVisible="true" DefaultAction="ViewDetailsDoc" PagerVisible="False" ActionsText="False">
                    ...
                    <CustomItems>
                        ...
                        <px:PXToolBarButton Text="Split" Key="cmdLS" CommandName="Split" CommandSourceID="ds" DependOnGrid="grid1">
                            <ActionBar GroupIndex="1" Order="5" />
                        </px:PXToolBarButton>
                    </CustomItems>
                </ActionBar>
                <Levels>
                    <px:PXGridLevel DataKeyNames="CashAccountID,TranID" DataMember="Details" >
                        ...
                        <Columns>
                            ...
                            <px:PXGridColumn DataField="CuryDebitAmt" TextAlign="Right" CommitChanges="true">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="CuryCreditAmt" TextAlign="Right" CommitChanges="true"> 
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="CuryOrigDebitAmt" TextAlign="Right">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="CuryOrigCreditAmt" TextAlign="Right"> 
                            </px:PXGridColumn>
            ...
            <px:PXTab ID="tab2" runat="server" Width="100%" Style="background-color: #ffffff;" 
                ...
                <Items>
                    <px:PXTabItem Text="Match to Payments" RepaintOnDemand="False" BindingContext="form">
                        <Template>
                            <px:PXFormView ID="frmMatchToPayments" runat="server" DataSourceID="ds" DataMember="DetailsForPaymentMatching" Style="z-index: 100"
                                Width="100%" CaptionVisible="false" FilesIndicator="false" 
                                NoteIndicator="false" SkinID="Preview" >
                                <CallbackCommands>
                                    <Save RepaintControls="None" RepaintControlsIDs="grid1,PXGrid1,frmCreateDocument,frmCreateDocumentInv" />
                                </CallbackCommands>
                                <Template>
                                    <px:PXLayoutRule ID="PXLayoutRule26" runat="server" LabelsWidth="sm" ControlSize="m" StartRow="true" />
                                    <px:PXCheckBox ID="edMultipleMatchingToPayments" runat="server" DataField="MultipleMatchingToPayments" CommitChanges="true" AlignLeft="true"/>
                                    <px:PXCheckBox ID="edMatchReceiptsAndDisbursements" runat="server" DataField="MatchReceiptsAndDisbursements" CommitChanges="true" AlignLeft="true"/>
                                    <px:PXLayoutRule ID="PXLayoutRule29" runat="server" LabelsWidth="sm" StartColumn="true" />                                    
                                    <px:PXNumberEdit ID="edCuryTotalAmtCopy1" runat="server" DataField="CuryTotalAmtDisplay" Enabled="false" />
                                    <px:PXNumberEdit ID="edCuryApplAmtMatch1" runat="server" DataField="CuryApplAmtMatchToPayment" Enabled="false" />
                                    <px:PXNumberEdit ID="edCuryUnappliedBalMatch1" runat="server" DataField="CuryUnappliedBalMatchToPayment" Enabled="false" />
                                </Template>
                            </px:PXFormView>
                            <px:PXGrid ID="PXGrid1" runat="server" DataSourceID="ds" Style="z-index: 100"
                                Height="100%" Width="100%" SkinID="Details" TabIndex="300" 
                                FilesIndicator="False" NoteIndicator="False" FeedbackMode="ForceDataEntry" AllowFilter="True" AllowSearch="true" FastFilterFields="OrigRefNbr,ExtRefNbr,ReferenceID,ReferenceID_description,TranDesc">
                                <Mode InitNewRow="True" />
                                <CallbackCommands>
                                    <Save RepaintControls="None" RepaintControlsIDs="grid1,frmCreateDocument,frmMatchToPayments,frmCreateDocumentInv" />
                                </CallbackCommands>
                                <Parameters>
                                ...
                                <ActionBar Position="TopAndBottom" DefaultAction="ViewDetailsDoc" PagerVisible="False">
                                    <Actions>
                                        ...
                                        <ExportExcel Enabled="False" MenuVisible="False" />
                                        <FilterBar GroupIndex="3" Order="1" Enabled="True" ToolBarVisible="Top"/>
                                    </Actions>
                                </ActionBar>
                                <Levels>
                                    <px:PXGridLevel DataMember="DetailMatchesCA" DataKeyNames="TranID">
                                        ...
                                        <Columns>
                                            ...
                                            <px:PXGridColumn DataField="CuryTranAmtCalc" TextAlign="Right" />
                    ...
                    <px:PXTabItem Text="Match to Invoices" RepaintOnDemand="False" BindingContext="form">
                        <Template>
                            <px:PXFormView ID="frmCreateDocumentInv" runat="server" DataSourceID="ds" DataMember="DetailsForInvoiceApplication" Style="z-index: 100"
                                ...
                                NoteIndicator="false" SkinID="Preview" >
                                <CallbackCommands>
                                    <Save RepaintControls="None" RepaintControlsIDs="grid1,gridDetailMatches4,frmCreateDocument,frmMatchToPayments" />
                                </CallbackCommands>
                                <Template>
                                    <px:PXLayoutRule ID="PXLayoutRule26" runat="server" LabelsWidth="sm" ControlSize="m" StartRow="true" />
                                    ...
                                    <px:PXSelector ID="edPMInstanceID" runat="server" DataField="PMInstanceIDCopy" CommitChanges="true"
                                        Size="SM" />
                                    <px:PXSelector ID="edChargeTypeID" runat="server" DataField="ChargeTypeID" CommitChanges="true"
                                        Size="M" />
                                    <px:PXLayoutRule ID="PXLayoutRule29" runat="server" LabelsWidth="sm" StartColumn="true" />
                                    <px:PXNumberEdit ID="edCuryTotalAmtCopy" runat="server" DataField="CuryTotalAmtCopy" Enabled="false" />
                                    <px:PXNumberEdit ID="edCuryApplAmtMatchToInvoice" runat="server" DataField="CuryApplAmtMatchToInvoice" Enabled="false" />
                                    <px:PXNumberEdit ID="edCuryChargeAmt" runat="server" DataField="CuryChargeAmt" CommitChanges="true" />
                                    <px:PXNumberEdit ID="edCuryChargeTaxAmt" runat="server" DataField="CuryChargeTaxAmt" Enabled="false" />
                                    <px:PXNumberEdit ID="edCuryUnappliedBalMatchToInvoice" runat="server" DataField="CuryUnappliedBalMatchToInvoice" Enabled="false" />
                                </Template>
                            </px:PXFormView>
                            <px:PXGrid ID="gridDetailMatches4" runat="server" Width="100%" DataSourceID="ds"
                                SkinID="Details" Caption="Matching Invoices" FilesIndicator="false" FeedbackMode="ForceDataEntry" FastFilterFields="OrigRefNbr,ExtRefNbr,ReferenceID,ReferenceName,TranDesc">
                                <CallbackCommands>
                                    <Save RepaintControls="None" RepaintControlsIDs="grid1,frmCreateDocumentInv,frmCreateDocument,frmMatchToPayments" />
                                </CallbackCommands>
                        ...
                        <Template>
                            <px:PXFormView ID="frmCreateDocument" runat="server" DataSourceID="ds" DataMember="DetailsForPaymentCreation" Style="z-index: 100"
                                ...
                                <Template>
                                    ...
                                    <px:PXSelector runat="server" DataField="RuleID" ID="edRuleID" AllowEdit="true" Enabled="false" TextField="Description" />

                                    <px:PXDropDown ID="edOrigModule" runat="server" DataField="OrigModule"
                                        CommitChanges="true" />
                                    <px:PXDateTimeEdit CommitChanges="True" ID="edMatchingPaymentDate" runat="server" DataField="MatchingPaymentDate" />
                                    <px:PXSelector CommitChanges="True" ID="edMatchingFinPeriodID" runat="server" DataField="MatchingFinPeriodID" AutoRefresh="True" Size="S"/>
                                    ...
                                    <px:PXLayoutRule ID="PXLayoutRule121" runat="server" LabelsWidth="sm" ControlSize="m"  ColumnSpan="3" />
                                    ...
                                    <px:PXLayoutRule ID="PXLayoutRule28" runat="server" LabelsWidth="sm" StartColumn="true" />
                                        ...
                                        <px:PXLayoutRule runat="server" Merge="true" StartColumn="true" SuppressLabel="true"/>
                                        <px:PXLabel runat="server" Text="" Size="xxxs" />
                                        <px:PXButton ID="btnUnapplyRule" runat="server" CommandName="UnapplyRule" CommandSourceID="ds" SyncVisibility="true" CallbackUpdatable="true" DependOnGrid="grid1" StateColumn="RuleApplied" AlignLeft="true" />
                                        <px:PXButton ID="btnCreateRule" runat="server" CommandName="CreateRule" CommandSourceID="ds" SyncVisibility="true" CallbackUpdatable="true" DependOnGrid="grid1" StateColumn="ApplyRuleEnabled" AlignLeft="true" />
                                    <px:PXLayoutRule runat="server" />
                                    <px:PXNumberEdit ID="edCuryDetailsWithTaxesTotal" runat="server" DataField="CuryDetailsWithTaxesTotal" Enabled="false" />
                                    ...
                                    <px:PXNumberEdit ID="edCuryTaxTotal" runat="server" DataField="CuryTaxTotal" Enabled="false">
                                        <LinkCommand Target="ds" Command="viewTaxDetails" />
                                    </px:PXNumberEdit>
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="Adjustments">
                                        <RowTemplate>
                                            ...
                                            <px:PXNumberEdit ID="edCuryAdjgAmt" runat="server" AutoRefresh="True" CommitChanges="True" DataField="CuryAdjgAmt" />
                                            ...
                                            <px:PXNumberEdit ID="edCuryAdjgWOAmt" runat="server" DataField="CuryAdjgWOAmt" Enabled="False" />
                                            <px:PXSelector ID="edWriteOffReasonCode" runat="server" AutoRefresh="True"  DataField="WriteOffReasonCode"/>
                                        </RowTemplate>
                                        <Columns>
                                            ...
                                            <px:PXGridColumn AllowNull="False" DataField="CuryAdjgWOAmt" AutoCallBack="True" TextAlign="Right" CommitChanges="true" />
                                            <px:PXGridColumn AllowNull="False" DataField="WriteOffReasonCode" AutoCallBack="True" />
                            ...
                            <px:PXGrid ID="gridCASplits" runat="server" AutoAdjustColumns="True" Caption="CA Splits" DataSourceID="ds" FilesIndicator="False" NoteIndicator="False" SkinID="Details" SyncPosition="true" Width="100%">
                                ...
                                <Levels>
                                    <px:PXGridLevel DataKeyNames="BankTranID,BankTranType,LineNbr" DataMember="TranSplit">
                                        <RowTemplate>
                                            ...
                                            <px:PXNumberEdit ID="edCuryTranAmt" runat="server" DataField="CuryTranAmt" CommitChanges="true"/>
                                ...
                                <CallbackCommands>
                                    <InitRow RepaintControlsIDs="DetailsForPaymentCreation" RepaintControls="All"/>
                                </CallbackCommands>
                                <AutoSize Enabled="True" MinHeight="150" />
                            </px:PXGrid>
                        </Template>
    ...
    <px:PXSmartPanel ID="pnlMatchSettings" runat="server" Style="z-index: 108;" Key="matchSettings"
        Caption="Transaction Matching Settings" CaptionVisible="True" LoadOnDemand="false"
        ShowAfterLoad="true" AutoCallBack-Command="Refresh"
        AutoCallBack-Target="tabMatchSettings" DesignView="Content" Height="609px" Width="630px">
        <px:PXTab ID="tabMatchSettings" runat="server" DataSourceID="ds" DataMember="cashAccount" Width="100%">
            <AutoSize Enabled="True" />
            <Items>
                <px:PXTabItem Text="Matching Settings">
                    <Template>
                        ...
                        <px:PXLayoutRule runat="server" LabelsWidth="L" ControlSize="XS" StartGroup="True" GroupCaption="Invoice Matching"/>
				        ...
				        <px:PXLayoutRule runat="server" LabelsWidth="L" ControlSize="XS" StartGroup="True" SuppressLabel="True" GroupCaption="Other Matching Settings"/>
                        <px:PXCheckBox ID="chkskipVoided" runat="server" DataField="SkipVoided" SuppressLabel="True"/>
                ...
                <px:PXTabItem Text="Relevance Calculation">
                    <Template>
                        <px:PXLayoutRule ID="PXLayoutRule19" runat="server" LabelsWidth="L" StartGroup="True" GroupCaption="Payment and Expense Receipt Relevance" />
                        ...
                        <px:PXLayoutRule runat="server" StartGroup="True" LabelsWidth="L" GroupCaption="Invoice Relevance"/>
                        <px:PXPanel runat="server" Border="none" RenderStyle="Simple" ID="pnlInvoiceRelativeWeights" RenderSimple="True">
                            ...
                            <px:PXNumberEdit ID="edInvoiceRefNbrComparePercent" DataField="InvoiceRefNbrComparePercent" runat="server" Enabled="False" Size="XS" />
                            <px:PXNumberEdit ID="edInvoiceDateComparePercent" DataField="InvoiceDateComparePercent" runat="server" Enabled="False" Size="XS" />
                            <px:PXNumberEdit ID="edInvoicePayeeComparePercent" DataField="InvoicePayeeComparePercent" runat="server" Enabled="False" Size="XS" />
                        </px:PXPanel>
    ...
    <px:PXSmartPanel ID="pnlCreateRule" runat="server" Key="RuleCreation"
     ...
     <px:PXSmartPanel ID="PXTaxPanel" runat="server" Key="TaxTrans" Caption="Tax Details" CaptionVisible="True" AcceptButtonID="Ok"  AutoRepaint="true" AutoReload="true" Width="764px" Height="360px">
        <px:PXFormView runat="server" ID="PXTaxFormView1" DataMember="CurrentCABankTran" SkinID="Transparent" DefaultControlID="edRuleName">
            <Template>
                <px:PXLayoutRule ID="PXLayoutRule4" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
         ...
         <px:PXGrid runat="server" ID="PXTaxGrid" SkinID="Details" Width="100%" AdjustPageSize="Auto" NoteIndicator="false" FilesIndicator="false">
            <AutoSize Enabled="true" />
            <Levels>
                <px:PXGridLevel DataMember="TaxTrans">
                    <Columns>
        ...
        <px:PXFormView ID="loform" runat="server" Style="z-index: 100;" DataMember="loadOpts" CaptionVisible="False" DefaultControlID="edFromDate" SkinID="Transparent">
            ...
            <Template>
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="180px" ColumnWidth="380" ControlSize="S" />
					<px:PXBranchSelector ID="BranchSelector1" runat="server" CommitChanges="True" DataField="OrgBAccountID" InitialExpandLevel="0" TabIndex="1" Width="200px" />
