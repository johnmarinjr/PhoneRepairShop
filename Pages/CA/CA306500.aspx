...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Header" TypeName="PX.Objects.CA.CABankTransactionsImport">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ProcessTransactions" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        <Template>
            ...
            <px:PXTextEdit ID="edTranType" runat="server" DataField="TranType" >
            </px:PXTextEdit>
        ...
        <Levels>
            <px:PXGridLevel DataKeyNames="CashAccountID,TranID" DataMember="Details">
                <RowTemplate>
                    ...
                    <px:PXSelector runat="server" DataField="RuleID" AllowEdit="true" ID="edRuleID" TextField="Description">
                    </px:PXSelector>
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="RuleID" Width="100px" TextField="RuleID_CABankTranRule_Description">
                    </px:PXGridColumn>
