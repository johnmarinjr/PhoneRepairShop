...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        <Levels>
            <px:PXGridLevel DataKeyNames="TranID, CATranID" DataMember="Result">
                <RowTemplate>
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="RuleID" TextField="RuleID_CABankTranRule_Description"/>
                    <px:PXGridColumn DataField="MatchedModule" />
                    <px:PXGridColumn DataField="PayeeLocationID" />
                    <px:PXGridColumn DataField="CuryMatchedDebitAmt" TextAlign="Right"/>
                    <px:PXGridColumn DataField="CuryMatchedCreditAmt" TextAlign="Right"/>
