    ...
    <px:PXSmartPanel ID="AddFilterPanel" Key="AddFilter" runat="server" Caption="Quick Transaction" CaptionVisible="True" AutoCallBack-Target="AddFilter" AutoCallBack-Command="Refresh"
        ...
        <px:PXPanel ID="PXPanel1" runat="server" SkinID="Buttons">
            ...
            <px:PXButton ID="Release" runat="server" Text="Release" DialogResult="Yes" SyncVisible="false">
				<AutoCallBack Command="ReleaseTransaction" Target="ds" />
			</px:PXButton>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" ActionsPosition="Top" Caption="Cash Transactions" AllowPaging="true" AdjustPageSize="Auto" SkinID="Details" SyncPosition="true">
        <CallbackCommands>
        ...
        <Levels>
            <px:PXGridLevel DataMember="CATranListRecords">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="BatchPaymentRefNbr" LinkCommand="ViewBatchPayment"/>
                    ...
                    <px:PXGridColumn DataField="BAccountR__AcctCD" />
