...
<asp:Content ID="Content1" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="PXFormView1" runat="server" Width="100%" Caption="Company Summary" DataMember="BAccount" NoteIndicator="True" FilesIndicator="True" DefaultControlID="edAcctCD">
		<Template>
			...
			<px:PXCheckBox ID="chkUseForAnomalyService" runat="server" DataField="OrganizationView.UseForAnomalyService" CommitChanges="true" AlignLeft="True" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="522px" Width="100%" DataMember="CurrentBAccount" DataSourceID="ds">
		<Items>
				...
				<Template>
					...
					<px:PXFormView ID="DefAddress" runat="server" Caption="Main Address" DataMember="DefAddress" RenderStyle="Fieldset" DataSourceID="ds" SyncPosition="true">
						<Template>
							...
							<px:PXFormView ID="formCarrierFacility" runat="server" DataMember="OrganizationView" RenderStyle="Simple" DataSourceID="ds">
								<Template>
									<px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" />
									<px:PXTextEdit runat="server" ID="edCarrierFacility" DataField="CarrierFacility" />
								</Template>
							</px:PXFormView>
					...
					<px:PXTextEdit CommitChanges="True" ID="TaxRegistrationID" runat="server" DataField="TaxRegistrationID" ></px:PXTextEdit>
					<%-- Start of lines used in localization for GB --%>
					<px:PXSelector runat="server" ID="MTDApplication" DataField="MTDApplicationID" AutoRefresh="True" />
					<%-- End of lines used in localization for GB --%>
				    ...
				    <px:PXCheckBox CommitChanges="True" ID="edFileTaxesByBranches" runat="server" DataField="OrganizationView.FileTaxesByBranches" ></px:PXCheckBox>
			...
			<%-- Start of lines used in localization for CA --%>
			<px:PXTabItem Text="Taxes">
				<Template>
					<px:PXGrid runat="server" ID="grdTaxes" SkinID="Details" Width="100%" DataSourceID="ds" Height="300px">
						<Levels>
							<px:PXGridLevel DataMember="Taxes">
								<Columns>
									<px:PXGridColumn DataField="TaxID" Width="120" CommitChanges="True" />
									<px:PXGridColumn DataField="TaxID_Tax_descr" Width="200" />
									<px:PXGridColumn DataField="TaxRegistrationNumber" Width="200" /></Columns>
								<RowTemplate>
									<px:PXSelector runat="server" ID="edTaxID" DataField="TaxID" CommitChanges="True" />
								</RowTemplate>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" MinHeight="150" />
			...
			<%-- End of lines used in localization for CA --%>
					...
					<px:PXGrid ID="grid" runat="server" Height="150px" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" SyncPosition="True">
						...
						<Levels>
							<px:PXGridLevel DataMember="Groups">
								...
								<RowTemplate>
									<px:PXSelector runat="server" ID="edGroupID" DataField="GroupID" AutoRefresh="true" />
								</RowTemplate>
