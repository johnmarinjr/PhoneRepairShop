...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="522px" Width="100%" DataMember="CurrentBAccount" DataSourceID="ds">
		<Items>
				...
				<Template>
					...
					<px:PXFormView ID="DefAddress" runat="server" Caption="Main Address" DataMember="DefAddress" RenderStyle="Fieldset" DataSourceID="ds" SyncPosition="true" TabIndex="20">
						<Template>
							...
							<px:PXFormView ID="formCarrierFacility" runat="server" DataMember="CurrentBAccount" RenderStyle="Simple" DataSourceID="ds" TabIndex="25">
								<Template>
					...
					<px:PXTextEdit CommitChanges="True" ID="TaxRegistrationID" runat="server" DataField="TaxRegistrationID" TabIndex="60"></px:PXTextEdit>
					<%-- Start of lines used in localization for GB --%>
					<px:PXSelector runat="server" ID="MTDApplication" DataField="MTDApplicationID" AutoRefresh="True" TabIndex="65" />
					<%-- End of lines used in localization for GB --%>
					<px:PXTextEdit ID="edCRAPayrollAccountNumber" runat="server" DataField="CRAPayrollAccountNumber" TabIndex="70"/>
					<px:PXFormView ID="PXFormViewLocation" runat="server" DataMember="DefLocation" RenderStyle="Simple" DataSourceID="ds" TabIndex="80">
						<Template>
			...
			<px:PXTabItem Text="Taxes" BindingContext="Organization" RepaintOnDemand="False">
				<Template>
					<px:PXGrid runat="server" ID="grdTaxes" SkinID="Details" Width="100%" DataSourceID="ds">
						<Levels>
							<px:PXGridLevel DataMember="Taxes">
								...
								<RowTemplate>
									<px:PXSelector runat="server" DataField="TaxID" CommitChanges="True" DataSourceID="ds" ID="edTaxID" />
								</RowTemplate>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" MinHeight="150" />
