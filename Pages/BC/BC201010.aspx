...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Bindings" TypeName="PX.Commerce.Shopify.BCShopifyStoreMaint">
	</px:PXDataSource>
</asp:Content>
				...
				<Template>
					...
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBindingShopify" runat="server" ID="frmCurrentBindingShopify1">
						<Template>
							...
							<px:PXTextEdit runat="server" ID="edShopifyAccessToken" DataField="ShopifyAccessToken" CommitChanges="True"></px:PXTextEdit>
					...
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBindingShopify" runat="server" ID="frmCurrentBindingShopify2">
						<Template>
							...
							<px:PXTextEdit runat="server" CommitChanges="true" ID="txShopifyDefaultCurrency" DataField="CurrentStore.DefaultStoreCurrency"></px:PXTextEdit>
							...
							<px:PXTextEdit runat="server" ID="edShopifyApiVersion" DataField="ShopifyApiVersion"></px:PXTextEdit>
						</Template>
					</px:PXFormView>
