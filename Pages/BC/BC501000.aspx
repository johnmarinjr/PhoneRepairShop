...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
  <px:PXGrid AutoAdjustColumns="True" ID="grid" runat="server" MatrixMode="True" DataSourceID="ds" Width="100%" Height="" SkinID="PrimaryInquire"  SyncPosition="true" AllowAutoHide="false">
    <Levels>
      <px:PXGridLevel DataMember="Entities">
          ...
          <px:PXGridColumn LinkCommand="NavigatePrepared" DataField="PreparedRecords" Width="70" CommitChanges="True" ></px:PXGridColumn>
          <px:PXGridColumn LinkCommand="NavigateProcessed" DataField="ProcessedRecords" Width="70" CommitChanges="True" ></px:PXGridColumn>
