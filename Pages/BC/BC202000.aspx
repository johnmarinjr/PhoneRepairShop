						...
						<Levels>
							<px:PXGridLevel DataMember="ImportMappings">
								<RowTemplate>
									...
									<pxa:PXFormulaCombo ID="edImportSourceField" runat="server" DataField="Value" EditButton="True" IsInternalVisible="false" FieldsAutoRefresh="True" 
										OnInternalFieldsNeeded="edImportSourceField_InternalFieldsNeeded" OnExternalFieldsNeeded="edImportSourceField_ExternalFieldsNeeded"
										IsSubstitutionKeysVisible="True" OnSubstitutionKeysNeeded="edImportSourceField_SubstitutionKeysNeeded">
									</pxa:PXFormulaCombo>
								</RowTemplate>
								<Columns>
					...
					<px:PXGrid ID="gridExportMapping" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" AllowFilter="true" SyncPosition="true" KeepPosition="true" MatrixMode="true">
						...
						<Levels>
							<px:PXGridLevel DataMember="ExportMappings">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM"></px:PXLayoutRule>
									<pxa:PXFormulaCombo ID="edExportSourceField" runat="server" DataField="Value" EditButton="True" IsExternalVisible="false" FieldsAutoRefresh="True" 
										OnInternalFieldsNeeded="edExportSourceField_InternalFieldsNeeded" OnExternalFieldsNeeded="edExportSourceField_ExternalFieldsNeeded"
										IsSubstitutionKeysVisible="True" OnSubstitutionKeysNeeded="edExportSourceField_SubstitutionKeysNeeded">
									</pxa:PXFormulaCombo>
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="SortOrder" TextAlign="Center" Width="54px" AllowDragDrop="true" ></px:PXGridColumn>
