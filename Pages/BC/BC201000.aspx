...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Bindings" TypeName="PX.Commerce.BigCommerce.BCBigCommerceStoreMaint">
	</px:PXDataSource>
</asp:Content>
	...
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="CurrentStore">
		<Items>
			<px:PXTabItem Text="Connection Settings">
				<Template>
					...
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBindingBigCommerce" runat="server" ID="PXFormView2">
						<Template>
							<px:PXLayoutRule StartColumn="True" ControlSize="L" LabelsWidth="SM" runat="server" ID="PXLayoutRule1" StartRow="True"></px:PXLayoutRule>
							<px:PXTextEdit runat="server" CommitChanges="true" ID="edBigCommerceDefaultCurrency" DataField="CurrentStore.DefaultStoreCurrency"></px:PXTextEdit>
			...
			<px:PXTabItem Text="Order Settings">
				<Template>
					...
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBinding" runat="server" ID="frmCurrentBinding1">
						<Template>
							<px:PXLayoutRule StartColumn="True" LabelsWidth="M" ControlSize="M" runat="server" ID="PXLayoutRule1" StartRow="True"></px:PXLayoutRule>
							<px:PXSegmentMask runat="server" ID="edBranchID" DataField="BranchID" CommitChanges="True" AutoRefresh="true" AllowEdit="True"></px:PXSegmentMask>
						</Template>
					</px:PXFormView>	
					...
					<px:PXSelector AllowEdit="True" runat="server" ID="edGiftWrapItem" DataField="GiftWrappingItemID"></px:PXSelector>
			...
			<px:PXTabItem Text="Payment Settings">
				<Template>
					<px:PXGrid SyncPosition="true" runat="server" ID="PaymentsMethods"  MatrixMode="True" SkinID="Details" Width="100%">
						<AutoSize Enabled="True" Container="Window"></AutoSize>
						<Levels>
							<px:PXGridLevel DataMember="PaymentMethods">
								<Columns>
									...
									<px:PXGridColumn CommitChanges="True" DataField="StoreCurrency" Width="140"></px:PXGridColumn>
								...
								<RowTemplate>
									...
									<px:PXSelector AutoRefresh="True" runat="server" ID="edProcessingCenterID" DataField="ProcessingCenterID"></px:PXSelector>
								</RowTemplate>
							</px:PXGridLevel>
						</Levels>
