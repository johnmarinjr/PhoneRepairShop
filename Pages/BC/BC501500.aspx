...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	<px:PXGrid SyncPosition="True" AdjustPageSize="Auto" runat="server" ID="grid" Height="150px" SkinID="PrimaryInquire" MatrixMode="True" Width="100%" AllowAutoHide="false" DataSourceID="ds">
		...
		<Levels>
			<px:PXGridLevel DataMember="Statuses">
				<Columns >
				  ...
				  <px:PXGridColumn DataField="LocalID" Width="200"></px:PXGridColumn>
