...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Deferral Schedule" DataMember="Schedule"
		...
		<Template>
			...
			<px:PXSelector runat="server" DataField="BaseCuryID" ID="edBaseCuryID" CommitChanges="true" AutoRefresh="True" DataSourceID="ds" TextAlign="Right" />
			...
			<px:PXLayoutRule runat="server" ControlSize="S" LabelsWidth="S" StartColumn="False"/>
			<px:PXSelector runat="server" DataField="BaseCuryIDASC606" ID="edBaseCuryIDASC606" CommitChanges="true" DataSourceID="ds" TextAlign="Right" />
		</Template>
	</px:PXFormView>
</asp:Content>
						...
						<Levels>
							<px:PXGridLevel DataMember="ReallocationPool" >
								<Columns>
									...
									<px:PXGridColumn DataField="DRScheduleDetail__DiscountPercent" />
