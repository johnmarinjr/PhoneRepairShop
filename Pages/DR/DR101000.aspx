...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="DRSetupRecord" AllowCollapse="False" DefaultControlID="edScheduleNumberingID" TabIndex="100">
		<Template>
			...
			<px:PXSelector CommitChanges="True" ID="edSuspenseAccountID" runat="server" DataField="SuspenseAccountID" />
			<px:PXSelector CommitChanges="True" ID="edSuspenseSubID" runat="server" DataField="SuspenseSubID" AutoRefresh="True" />
