...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="TXSetupRecord" Caption="Tax Preferences" AllowCollapse="False" DefaultControlID="edTaxRoundingGainAcctID" TabIndex="100">
		<Template>
			...
			<px:PXSelector ID="edTaxAdjustNumberingID" runat="server" DataField="TaxAdjustmentNumberingID" AllowEdit="True" />
			<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Rounding Settings" StartColumn="False" />
