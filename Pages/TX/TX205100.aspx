...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" AutoCallBack="True" Visible="True" Width="100%" TypeName="PX.Objects.TX.TaxReportMaint" PrimaryView="Report">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="Report"  Caption="Tax Agency Settings" NoteIndicator="False" FilesIndicator="False">
		<Template>
			<px:PXLayoutRule runat="server" StartColumn="True" ControlSize="XM" LabelsWidth="SM" />
			<px:PXSegmentMask CommitChanges="True" ID="edBAccountID" runat="server" DataField="VendorID" AllowEdit="True" />
			<px:PXSelector CommitChanges="True" ID="edRevVersionID" runat="server" DataField="RevisionID" Size="S" AutoRefresh="true" InputMask="9999"/>
			<px:PXDateTimeEdit CommitChanges="True" ID="cldrValidFromID" runat="server" DataField="ValidFrom" AllowEdit="True"/>
