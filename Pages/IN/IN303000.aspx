...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INAdjustmentEntry" PrimaryView="adjustment" HeaderDescriptionField="TranDesc">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="LineSplittingExtension_ShowSplits" />
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="LineSplittingExtension_GenerateNumbers" DependOnGrid="grid" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
            ...
            <px:PXTabItem Text="Details">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="250px" Style="z-index: 100; left: 0px; top: 0px;" Width="100%"
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Split" Key="cmdSplit">
                                    <AutoCallBack Command="Split" Target="ds">
