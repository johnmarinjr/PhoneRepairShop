...
<asp:content id="cont1" contentplaceholderid="phDS" runat="Server">
    ...
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.WMS.InventoryItemLookup+Host" PrimaryView="HeaderView">
        <CallbackCommands>
        </CallbackCommands>
    </px:PXDataSource>
</asp:content>
                    ...
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="144px" Style="z-index: 100; left: 0px; top: 0px;" Width="100%"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ISERecords">
                                <Columns>
                                    <px:PXGridColumn DataField="LocationID" AllowShowHide="Server" AllowNull="True" NullText="<UNASSIGNED>"/>
