...
public partial class Page_IN204025 : PX.Web.UI.PXPage
{
	...
	{
		var log = (PX.BarcodeProcessing.ScanLog)PXResult.UnwrapMain(e.Row.DataItem);
		if (log == null) return;

		if (log.MessageType == PX.BarcodeProcessing.ScanMessageTypes.Error)
		{
			e.Row.Style.CssClass = PickCss.Overpick;
		}
		else if (log.MessageType == PX.BarcodeProcessing.ScanMessageTypes.Warning)
		{
