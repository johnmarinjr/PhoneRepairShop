        ...
        <Items>
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXFormView ID="CurySettingsFormDefaultSite" runat="server" SkinID="Inside" RenderStyle="Simple" DataSourceID="ds" DataMember="itemclasscurysettings" CaptionVisible="false">
                        <Template>
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="MRP Consolidation" ControlSize="XM" LabelsWidth="S" />
                    <px:PXNumberEdit runat="server" ID="edAMDaysSupply" DataField="AMDaysSupply" />
                </Template>
            </px:PXTabItem>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="replenishment">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ReplenishmentSourceSiteID" DisplayFormat="&gt;AAAAAAAAAA" Width="140px" CommitChanges="true" />
            ...
            <px:PXTabItem Text="Restriction Groups">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" AdjustPageSize="Auto"
                        AllowSearch="True" SkinID="Details" BorderWidth="0px" SyncPosition="true">
                        <ActionBar>
                            <Actions>
                ...
                <Template>
                    ...
                    <px:PXPanel ID="PXPanelsdf" runat="server" RenderSimple="True" RenderStyle="Fieldset">
                        ...
                        <px:PXGrid ID="PXGridIdGenerationRules" runat="server" DataSourceID="ds" Height="150px" Width="650px" SkinID="Details"
                            StatusField="Sample" Caption="Inventory ID Segment Settings" CaptionVisible="true" SyncPosition="true">
                        ...
                        <px:PXGrid ID="PXGridDescriptionGenerationRules" runat="server" DataSourceID="ds" Height="150px" Width="650px" SkinID="Details"
                            StatusField="Sample" Caption="Description Segment Settings" CaptionVisible="true" SyncPosition="true">
