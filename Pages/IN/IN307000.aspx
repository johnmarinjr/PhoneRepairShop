...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.KitAssemblyEntry" PrimaryView="Document" UDFTypeField="DocType" EnableAttributes="true" HeaderDescriptionField="TranTranDesc">
        <CallbackCommands>
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="INComponentLineSplittingExtension_GenerateNumbers" />
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="INComponentLineSplittingExtension_ShowSplits" DependOnGrid="componentsGrid" />
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="INKitLineSplittingExtension_GenerateNumbers" />
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="INKitLineSplittingExtension_ShowSplits" DependOnGrid="componentsGrid" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="DocumentProperties">
        ...
        <Items>
            <px:PXTabItem Text="Stock Components">
                <Template>
                    <px:PXGrid runat="server" ID="componentsGrid" DataSourceID="ds" SkinID="DetailsInTab" Width="100%" 
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="INComponentLineSplittingExtension_ShowSplits" CommandSourceID="ds" DependOnGrid="componentsGrid">
                                </px:PXToolBarButton>
                            </CustomItems>
                        </ActionBar>
                        <Levels>
            ...
            <px:PXTabItem Text="Kit Line Details">
                <Template>
                    <px:PXFormView ID="lsoptform" runat="server" Width="100%" DataMember="INKitLineSplittingExtension_LotSerOptions"
                        ...
                        <Template>
                            ...
                            <px:PXButton ID="btnGenerate2" runat="server" Text="Generate" CommandName="INKitLineSplittingExtension_GenerateNumbers"
                                CommandSourceID="ds" />
                        </Template>
                    </px:PXFormView>
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 500px;"
        Width="764px" Caption="Line Details" DesignView="Content" CaptionVisible="True" Key="INComponentLineSplittingExtension_lsselect" AutoCallBack-Command="Refresh"
        AutoCallBack-Enabled="True" AutoCallBack-Target="optform">
        <px:PXFormView ID="optform" runat="server" Width="100%" CaptionVisible="False" DataMember="INComponentLineSplittingExtension_LotSerOptions"
            DataSourceID="ds" SkinID="Transparent">
            <Parameters>
            ...
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" Text="Generate" Height="20px" CommandName="INComponentLineSplittingExtension_GenerateNumbers"
                    CommandSourceID="ds">
                </px:PXButton>
            </Template>
        </px:PXFormView>
