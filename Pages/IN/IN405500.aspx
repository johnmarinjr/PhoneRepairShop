...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INDeadStockEnq" PrimaryView="Filter" PageLoadBehavior="PopulateSavedValues">
        <CallbackCommands>
		</CallbackCommands>
	</px:PXDataSource>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" DataMember="Filter" Width="100%" Height="100px">
        <Template>
			...
			<px:PXSegmentMask runat="server" ID="selInventoryID" DataField="InventoryID" CommitChanges="True" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="PrimaryInquire" CaptionVisible="false" AdjustPageSize="Auto">
        <Levels>
