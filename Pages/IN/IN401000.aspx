            ...
            <px:PXGridLevel DataMember="ISERecords">
                <Columns>
                    ...
                    <px:PXGridColumn AllowNull="False" DataField="QtyInTransitToSO" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProductionSupplyPrepared" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProductionSupply" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProdFixedProdOrdersPrepared" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProdFixedProdOrders" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyPOFixedProductionPrepared" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyPOFixedProductionOrders" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProdFixedSalesOrdersPrepared" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProdFixedSalesOrders" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProductionDemandPrepared" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProductionDemand" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProductionAllocated" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProdFixedProduction" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtyProdFixedPurchase" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
					<px:PXGridColumn AllowNull="False" DataField="QtySOFixedProduction" DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right"
                        Width="100px" />
