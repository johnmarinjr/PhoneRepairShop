...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INTransferEntry" PrimaryView="transfer" HeaderDescriptionField="TranDesc">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="LineSplittingExtension_GenerateNumbers" />
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="LineSplittingExtension_ShowSplits" DependOnGrid="grid" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ToLocationID" DisplayFormat="&gt;AAAAAAAAAA" AutoCallBack="true"/>
                                    <px:PXGridColumn DataField="ToProjectID" AutoCallBack="true" />
                                    <px:PXGridColumn DataField="ToTaskID" AutoCallBack="true" />
                                    <px:PXGridColumn DataField="ToCostCodeID" AutoCallBack="true" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 500px;"
        Width="764px" Caption="Line Details" DesignView="Hidden" CaptionVisible="True" Key="LineSplittingExtension_lsselect" AutoCallBack-Command="Refresh"
