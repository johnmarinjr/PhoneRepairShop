        ...
        <Items>
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXFormView ID="CurySettingsFormDefaultSite" runat="server" SkinID="Inside" RenderStyle="Fieldset" DataSourceID="ds" DataMember="CurySettings_InventoryItem" CaptionVisible="false">
                        <Template>
                            <px:PXLayoutRule runat="server" StartGroup="True" LabelsWidth="SM" ControlSize="XM" />
                            <px:PXSegmentMask ID="edDfltSiteID" runat="server" DataField="DfltSiteID" CommitChanges="true" />
                         </Template>
                    </px:PXFormView>
                    ...
                    <px:PXFormView ID="curySettingsForm2" runat="server" SkinID="Inside" RenderStyle="simple" DataSourceID="ds" DataMember="CurySettings_InventoryItem" CaptionVisible="false">
                        <Template>
                            ...
                            <px:PXTextEdit ID="edPendingStdCostLabel" runat="server" 
                                           Style="background-color: transparent; border-width:0px; padding-left:0px; margin-right:-2px; color:#5c5c5c"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Components">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="AmtOptionASC606" Width="81px" CommitChanges="true" />
            ...
            <px:PXTabItem Text="GL Accounts">
                <Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Payroll Values" />
					...
					<px:PXSegmentMask ID="edPTOExpenseAcctID" runat="server" DataField="PTOExpenseAcctID" CommitChanges="true" />
                    <px:PXSegmentMask CommitChanges="True" ID="edPTOExpenseSubID" runat="server" DataField="PTOExpenseSubID" AutoRefresh="true" />
                </Template>
            </px:PXTabItem>
