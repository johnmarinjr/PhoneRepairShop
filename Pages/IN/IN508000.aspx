        ...
        <Levels>
            <px:PXGridLevel DataMember="Records">
                <RowTemplate>
                    ...
                    <px:PXSegmentMask ID="edReplenishmentSourceSiteID" runat="server" DataField="ReplenishmentSourceSiteID" Enabled="False" AutoRefresh="true" />
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="ReplenishmentSourceSiteID" AllowUpdate="False" DisplayFormat="&gt;AAAAAAAAAA" Label="Source Warehouse" CommitChanges="true" />
                    <px:PXGridColumn AllowUpdate="False" DataField="PreferredVendorID" DisplayFormat="&gt;AAAAAA" AutoCallBack="true" CommitChanges="true" />
