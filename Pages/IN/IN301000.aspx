				...
				<px:PXTabItem Text="Details">
					<Template>
						<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; left: 0px; top: 0px; height: 250px;"
							...
							<ActionBar>
								<CustomItems>
									<px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LineSplittingExtension_ShowSplits" CommandSourceID="ds"
										DependOnGrid="grid" />
							...
							<Levels>
								<px:PXGridLevel DataMember="transactions">
									<RowTemplate>
										...
										<px:PXSegmentMask CommitChanges="True" Height="19px" ID="edBranchID" runat="server" DataField="BranchID" AutoRefresh="true" />
									</RowTemplate>
									<Columns>
										...
										<px:PXGridColumn DataField="POReceiptType" Visible="False" />
