...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="server">
            <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="100%" Style="z-index: 100;" Width="100%" ActionsPosition="Top"
                AdjustPageSize="Auto" AllowPaging="True" SkinID="Inquire" FastFilterFields="Name" SyncPosition="true">
                <Levels>
                ...
                <ActionBar DefaultAction="viewRevisions" PagerVisible="False">
                    ...
                    <CustomItems>
                        <px:PXToolBarButton Text="Get file" CollectParams="BeforeNavigate" Tooltip="Download selected file to your computer." DependOnGrid="grid">
                            <AutoCallBack Command="getFile" Target="ds" />
                        </px:PXToolBarButton>
                        <px:PXToolBarButton Text="Get link" CollectParams="BeforeNavigate" Tooltip="Get link to the attached file." DependOnGrid="grid">
                            <AutoCallBack Command="getFileLink" Target="ds" />
                        </px:PXToolBarButton>
                        <px:PXToolBarButton Text="Delete file" CollectParams="BeforeNavigate" Tooltip="Delete selected file." DependOnGrid="grid">
                            <AutoCallBack Command="deleteFile" Target="ds" />
                        </px:PXToolBarButton>
                        <px:PXToolBarButton Text="Add Link" CollectParams="BeforeNavigate" Tooltip="Add Link" DependOnGrid="grid">
                            <AutoCallBack Command="addLink" Target="ds" />
                        </px:PXToolBarButton>
                        <px:PXToolBarButton Text="Add Link" CollectParams="BeforeNavigate" Tooltip="Add Link & Close" DependOnGrid="grid">
