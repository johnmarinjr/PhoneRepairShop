...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Caption="General Settings"
		...
		<Template>
			...
			<px:PXSelector ID="edAddressLookupPluginID" runat="server" DataField="AddressLookupPluginID" AllowEdit="true" />
			...
			<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Table Settings" />
			<px:PXDropDown ID="edGridFastFilterCondition" runat="server" DataField="GridFastFilterCondition" 
				Size="XL" > </px:PXDropDown>
