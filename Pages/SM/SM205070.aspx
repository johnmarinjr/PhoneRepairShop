...
<asp:Content ID="Content2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXFormView runat="server"
		ID="form"
		Width="100%"
		DataMember="Filter" CaptionVisible="False" AllowCollapse="true">
		<Template>
			...
			<px:PXLayoutRule runat="server" StartColumn="true" />
			<px:PXPanel runat="server" ID="PXPanel3" Caption="Exception Logging" RenderStyle="Fieldset" Width="400px">
				...
				<px:PXGrid runat="server" ID="grid" SkinID="Details" Width="100%" Height="400px"
					...
					<ActionBar PagerVisible="False" DefaultAction="buttonSql">
						<CustomItems>
							...
							<px:PXToolBarButton Text="PIN/UNPIN" Key="PinRows" DependOnGrid="grid">
			...
			<Template>
				<px:PXGrid runat="server" ID="GridExceptionsLog" Width="100%" Height="400px" SyncPosition="True" 
					...
					<ActionBar PagerVisible="False" DefaultAction="buttonExceptionDetails">
						<CustomItems>
							<px:PXToolBarButton Text="View Exception Details" Key="buttonExceptionDetails" DependOnGrid="GridExceptionsLog">
