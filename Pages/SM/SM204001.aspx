...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Caption="General Settings"
		...
		<Template>
            ...
            <px:PXCheckBox ID="lblSuspendEmailProcessing" runat="server" DataField="SuspendEmailProcessing" CommitChanges="true" />
			<px:PXCheckBox ID="chkSendUserEmailsImmediately" runat="server" DataField="SendUserEmailsImmediately" SuppressLabel="True" Size="Empty" CommitChanges="true" />
