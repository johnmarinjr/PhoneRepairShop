<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="SM207025.aspx.cs" Inherits="Page_SM207025"
	Title="Untitled Page" %>
...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Mappings"
		TypeName="PX.Api.SYExportMaint">
		<CallbackCommands>
			<px:PXDSCallbackCommand Name="fillSource" Visible="False" />
			<px:PXDSCallbackCommand Name="fillDestination" Visible="False" />
			<px:PXDSCallbackCommand DependOnGrid="gridMapping" Name="rowUp" Visible="False" CommitChanges="true" />
			<px:PXDSCallbackCommand DependOnGrid="gridMapping" Name="rowDown" Visible="False" CommitChanges="true" />
			<px:PXDSCallbackCommand DependOnGrid="gridMapping" Name="rowInsert" Visible="False" CommitChanges="true" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXSmartPanel ID="pnlInsertFrom" runat="server" CaptionVisible="True" Caption="Choose scenario to insert steps from"
		ForeColor="Black" Style="position: static" Height="100px" Width="380px" Key="InsertFromFilter"
		DesignView="Content">
		<px:PXFormView ID="frmInsertFrom" runat="server" SkinID="Transparent" DataMember="InsertFromFilter"
			DataSourceID="ds" Width="342px">
			<Template>
				<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="M" />
				<px:PXSelector CommitChanges="True" ID="edMappingID" runat="server" 
	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
            ...
            <px:PXCheckBox runat="server" Checked="True" DataField="IsActive" CommitChanges="True" ID="chkIsActive" AlignLeft="True"/>
            ...
            <px:PXDropDown runat="server" DataField="RepeatingData" ID="PXDropDown1" AllowNull="False" />
            <px:PXCheckBox runat="server" DataField="IsExportOnlyMappingFields" ID="edIsExportOnlyMappingFields" />
						...
						<ActionBar>
							...
							<CustomItems>
							    ...
							    <pxa:PXGridCombo ListItems="Show All Commands,Hide Service Commands" ParameterName="whatToShow"
									AutoCallback="True" DataMember="WhatToShowFilter" DataField="WhatToShow" Width="150px" />
								<px:PXToolBarButton CommandName="rowUp" CommandSourceID="ds" Text="Row Up" Tooltip="Move Row Up">
									<Images Normal="main@ArrowUp" />
								</px:PXToolBarButton>
								<px:PXToolBarButton CommandName="rowDown" CommandSourceID="ds" Text="Row Down" Tooltip="Move Row Down">
						...
						<Levels>
							<px:PXGridLevel DataMember="FieldMappings">
								...
								<RowTemplate>
									...
									<pxa:PXFormulaCombo ID="edMapFieldName" runat="server" DataField="FieldName" EditButton="True"
										FieldsAutoRefresh="True" OnExternalFieldsNeeded="edValue_ExternalFieldsNeeded"
										OnInternalFieldsNeeded="edValue_InternalFieldsNeeded" IsSubstitutionKeysVisible="True"
                                        OnSubstitutionKeysNeeded="edValue_SubstitutionKeysNeeded" />
								</RowTemplate>
								<Columns>
									...
									<px:PXGridColumn DataField="FieldName" Width="150px" AutoCallBack="true" EditorID="edMapFieldName" />
									<px:PXGridColumn AllowNull="False" DataField="NeedCommit" TextAlign="Center" Type="CheckBox"
										Width="60px" CommitChanges="True" />
									<px:PXGridColumn DataField="Value" EditorID="edValue" RenderEditorText="True" />
					...
					<px:PXGrid ID="gridConditions" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
						...
						<Levels>
							<px:PXGridLevel DataMember="MatchingConditions">
								<Mode InitNewRow="True" />
								<RowTemplate>
									<%--<pxa:PXFormulaCombo ID="edCondFieldName" runat="server" DataField="FieldName" EditButton="True"
										FieldsAutoRefresh="True" OnExternalFieldsNeeded="edValue_ExternalFieldsNeeded"
										OnInternalFieldsNeeded="edValue_InternalFieldsNeeded" />--%>
								</RowTemplate>
								<Columns>
									<px:PXGridColumn AllowNull="False" DataField="IsActive" TextAlign="Center" Type="CheckBox"
										Width="60px" />
