		...
		<Items>
			...
			<Template>
				<px:PXGrid ID="gridActions" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
						Width="100%" AdjustPageSize="Auto" BorderWidth="0px" AllowSearch="True" SkinID="Details"
						MatrixMode="true" SyncPosition="true">
					<ActionBar>
						<CustomItems>
							<px:PXToolBarButton Text="Fill with Values" DependOnGrid="gridActions">
							...
							<px:PXToolBarButton Text="Reorder Actions" DependOnGrid="gridActions">
							    <AutoCallBack Enabled="True" Target="ds" Command="ReOrderMenu" />
							</px:PXToolBarButton>
							<px:PXToolBarButton Text="Flow" DependOnGrid="gridActions">
			...
			<Template>
				<px:PXGrid ID="gridFields" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
					...
					<ActionBar>
						<CustomItems>
							<px:PXToolBarButton Text="Combo Box Values" DependOnGrid="gridFields">
							    <AutoCallBack Target="ds" Command="ComboValues" />
							</px:PXToolBarButton>
							<px:PXToolBarButton Text="Reload Combo Box Values" DependOnGrid="gridFields">
