...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="formSchedule" runat="server" DataSourceID="ds" Style="z-index: 100"
		...
		<Template>
			...
			<px:PXCheckBox SuppressLabel="True" ID="chkShowEventsTabExpr" runat="server" DataField="ShowEventsTabExpr" />
		</Template>
		<Parameters>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Height="300px" Style="z-index: 100" Width="100%"
		...
		<Items>
			...
			<px:PXTabItem Text="Events" BindingContext="formSchedule" VisibleExp="DataControls[&quot;chkShowEventsTabExpr&quot;].Value=1">
				<Template>
                    <px:PXGrid ID="grdEvents" runat="server" DataSourceID="ds" Width="100%" SkinID="Details"
						AutoAdjustColumns="True" AllowPaging="False" SyncPosition="True">
						<Levels>
							<px:PXGridLevel DataMember="BPEvents">
								<Columns>
