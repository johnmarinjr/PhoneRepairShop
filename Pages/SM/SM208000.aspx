					...
					<px:PXGrid ID="grdTables" runat="server" DataSourceID="ds" Height="150px" SkinID="DetailsInTab"
						...
						<Levels>
							<px:PXGridLevel  DataMember="Tables">
								...
								<Columns>
									<px:PXGridColumn DataField="Name" Width="250px" LinkCommand="NavigateToDacSchemaBrowser" />
							...
							<px:PXGridLevel  DataMember="Wheres">
								...
								<Columns>
									...
									<px:PXGridColumn AllowNull="False" DataField="Condition" RenderEditorText="True"
										Width="120px" AllowSort="False" CommitChanges="true" />
									...
									<px:PXGridColumn DataField="Value1" Width="150px" Key="value1" AllowSort="False" MatrixMode="true" AllowStrings="True" DisplayMode="Value" CommitChanges="true"/>
									<px:PXGridColumn DataField="Value2" Width="150px" Key="value2" AllowSort="False" MatrixMode="true" AllowStrings="True" Visible="False" DisplayMode="Value" CommitChanges="true"/>
