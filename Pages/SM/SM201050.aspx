			...
			<px:PXTabItem Text="Email accounts">
				<Template>
					<px:PXGrid ID="gridEMail" BorderWidth="0px" runat="server" DataSourceID="ds" Height="150px"
						Style="z-index: 100" Width="100%" AllowPaging="True" AdjustPageSize="Auto" ActionsPosition="Top"
						AllowSearch="True" EditPageUrl="~/Pages/SM/SM204002.aspx" SkinID="Details" FastFilterFields="EmailAccountId,LoginName">
						<Levels>
							<px:PXGridLevel DataMember="Account">
								<Mode AllowAddNew="True" AllowDelete="False" />
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" />
									<px:PXSelector ID="edEmailAccountId" runat="server" DataField="EmailAccountId" TextMode="Search" DisplayMode="Text" AutoRefresh="True" FilterByAllFields="True" />
									<px:PXTextEdit ID="edAccountName" runat="server" DataField="Description" />
								...
								<Columns>
									<px:PXGridColumn DataField="EmailAccountId" Width="150px"  AutoCallBack="True"/>
						...
						<EditPageParams>
							<px:PXControlParam ControlID="gridEMail" Name="EmailAccountId" PropertyName="DataValues[&quot;EmailAccountId&quot;]"
								Type="String" />
						</EditPageParams>
						<ActionBar>
							<Actions>
