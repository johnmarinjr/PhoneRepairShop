...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    <px:PXTab ID="tab" runat="server" Height="540px" Style="z-index: 100;" Width="100%" DataSourceID="ds" DataMember="CurrentEvent">
        ...
        <Items>
            ...
            <px:PXTabItem Text="Fields to Track" BindingContext="formBPEvent" VisibleExp="DataControls[&quot;edType&quot;].Value == 0" Visible="false">
                <Template>
                    <px:PXFormView ID="formFields" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="CurrentEvent">
                        <Template>
                            <px:PXCheckBox runat="server" DataField="TrackAllFields" ID="trackAllFields" CommitChanges="true" Width="200" />
                        </Template>
                    </px:PXFormView>
                    <px:PXGrid ID="gridFields" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px"
                        AutoAdjustColumns="True" AutoRefresh="True" MatrixMode="True" SkinID="DetailsInTab">
                        <Mode InitNewRow="True" AllowRowSelect="True" />
                        <ActionBar>
                            <Actions>
                                <AddNew Tooltip="Add a field to use its previous value for configuration of a subscriber" />
                            </Actions>
                        </ActionBar>
                        <Levels>
                            <px:PXGridLevel DataMember="TrackingFields">
                                <Columns>
