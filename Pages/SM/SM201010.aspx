...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<pxa:DynamicDataSource ID="ds" runat="server" Visible="True" PrimaryView="UserList" 
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="SendLoginLink" CommitChanges="True" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" 
		...
		<Template>
			...
			<px:PXCheckBox ID="edForbidLoginWithPassword" runat="server" DataField="ForbidLoginWithPassword" CommitChanges="True"/>
			...
			<px:PXCheckBox ID="edOverrideWithOidcRoles" runat="server" DataField="OverrideLocalRolesWithOidcProviderRoles" CommitChanges="True"/>
