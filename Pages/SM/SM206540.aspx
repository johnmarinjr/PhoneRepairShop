        ...
        <Levels>
            <px:PXGridLevel DataMember="Scanners">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="PaperSourceComboValues" CommitChanges="true" />
                    <px:PXGridColumn DataField="PixelTypeComboValues" CommitChanges="true" />
                    <px:PXGridColumn DataField="ResolutionComboValues" CommitChanges="true" />
                    <px:PXGridColumn DataField="FileTypeComboValues" CommitChanges="true" />
