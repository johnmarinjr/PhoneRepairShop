...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
		Width="100%" AdjustPageSize="Auto" AllowSearch="True" SkinID="Details" Caption="Screens" SyncPosition="true">
		<ActionBar>
		</ActionBar>
		<Levels>
		...
		<ActionBar>
			<CustomItems>
				<px:PXToolBarButton Text="View Screen" Key="cmdViewScreen" DependOnGrid="grid">
