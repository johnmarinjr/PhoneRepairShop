...
<asp:Content ID="Content1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Visible="False" PrimaryView="Filter"
        ...
        <Items>
            <px:PXTabItem Text="RUNNING PROCESSES" Visible="True">
                <Template>
                    ...
                    <px:PXGrid runat="server" ID="grid" Width="100%" Height="100%" DataSourceID="ds" AutoGenerateColumns="Recreate" SkinID="Details" Caption="Operations" SyncPosition="true">
                                ...
                                <ActionBar PagerVisible="False" DefaultAction="buttonStop">
                                    ...
                                    <CustomItems>
                                        <px:PXToolBarButton Text="ABORT" Key="buttonStop" DependOnGrid="grid">
                                            <AutoCallBack Target="ds" Command="actionStop"></AutoCallBack>
                                        </px:PXToolBarButton>
                                        <px:PXToolBarButton Text="VIEW SCREEN" Key="buttonShow" DependOnGrid="grid">
                    ...
                    <px:PXGrid runat="server" ID="ActiveUsersGrid" Width="100%" Height="100%" DataSourceID="ds" AutoGenerateColumns="None" 
                               SkinID="Details" Caption="Active Users" SyncPosition="True">
                                ...
                                <ActionBar PagerVisible="False" DefaultAction="buttonViewUser">
                                    ...
                                    <CustomItems>
                                        <px:PXToolBarButton Text="VIEW USER" Key="buttonViewUser" DependOnGrid="ActiveUsersGrid">
				    ...
				    <px:PXGrid runat="server" ID="gridProfiler" SkinID="Details" Width="100%" Height="800px"
					    ...
					    <ActionBar PagerVisible="False" DefaultAction="buttonSql">
						    <CustomItems>
							    ...
							    <px:PXToolBarButton Text="Open URL" Key="ViewScreen" DependOnGrid="gridProfiler">
