	...
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="Tables" OnDataBound="form_DataBound">
		<Template>
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="L" />
		        ...
		        <px:PXSelector ID="edFilterID" runat="server" DataField="FilterID" AutoRefresh="true" DisplayMode="Text" AllowNull="False" />
						...
						<tr>
							<td style="width: 50%;padding: 0px">
								<table style="width:100%;height:100px" cellspacing="0" cellpadding="0">
									<tr>
										<td style="height: 50%">
											<px:PXGrid ID="gridInact" runat="server" SkinID="Details" Width="100%" DataSourceID="ds" Height="150px" FilesIndicator="False" NoteIndicator="False"
									...
									<tr>
										<td style="height: 50%">
										    <px:PXGrid ID="gridYDim" runat="server" SkinID="Details" Width="100%" DataSourceID="ds" Height="150px" FilesIndicator="False" NoteIndicator="False"
							...
							<td style="width: 50%;padding: 0px">
								<table style="width:100%;height:100px" cellspacing="0" cellpadding="0">
									<tr>
										<td style="height: 50%">
											<px:PXGrid ID="gridXDim" runat="server" SkinID="Details" Width="100%" DataSourceID="ds" Height="150px" FilesIndicator="False" NoteIndicator="False"
									...
									<tr>
										<td style="height: 50%">
											<px:PXGrid ID="gridFacts" runat="server" SkinID="Details" Width="100%" DataSourceID="ds" Height="150px" FilesIndicator="False" NoteIndicator="False"
