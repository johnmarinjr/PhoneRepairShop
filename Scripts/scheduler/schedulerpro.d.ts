...
declare module '@bryntum/schedulerpro' {
    ...
    export class GlobalEvents {
        ...
        static trigger(eventName: string, param?: object): boolean|Promise<any>;
    ...
    export class ProjectModelMixin {
        assignmentStore: SchedulerAssignmentStore|AssignmentStore
        changes: object
        dependencyStore: SchedulerDependencyStore|DependencyStore
        eventStore: SchedulerEventStore|EventStore
        inlineData: object
        json: string
        resourceStore: SchedulerResourceStore|ResourceStore
        resourceTimeRangeStore: ResourceTimeRangeStore
        stm: StateTrackingManager
        timeRangeStore: Store
    ...
    type SchedulerProTagConfig = {
        faPath: string
        stylesheet: string
    }

    export class SchedulerProTag extends TimelineBaseTag {
        constructor(config?: Partial<SchedulerProTagConfig>);
    }
    ...
    export class CalendarModel extends Model implements PartOfProject {
        ...
        addInterval(interval: CalendarIntervalModel|object|Partial<CalendarIntervalModelConfig>): CalendarIntervalModel[];
        addIntervals(intervals: CalendarIntervalModel[]|object[]|Partial<CalendarIntervalModelConfig>[]): CalendarIntervalModel[];
    ...
    type ProjectModelConfig = {
        ...
        autoSyncTimeout: number
        calendar: CalendarModel
        calendarManagerStoreClass: CalendarManagerStore|object|Partial<CalendarManagerStoreConfig>
