...
public partial class MasterPages_Login : System.Web.UI.MasterPage
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		{
			lblCopy.Style.Add("cursor", "pointer");
			lblCopy.Text += " +";
			this.lblCstProjects.Visible = true;
			this.lblCstProjects.Text = "<ul><li>" + PXMessages.LocalizeNoPrefix(cstProjects.Replace(",", "</li><li>")) + "</li></ul>";
		}
		this.lblCustomizationDlgTopTitle.Text = PXMessages.LocalizeNoPrefix(Msg.CustomizationDetailsLabel);
		this.CorrectCssUrl();
	}
