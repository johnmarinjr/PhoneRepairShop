...
<asp:Content ID="Content3" ContentPlaceHolderID="phUser" Runat="Server">
	...
	<script type="text/javascript">
		...
		var trialMessage = '<%=PX.Data.PXLocalizer.Localize(PX.AscxControlsMessages.LoginScreen.TrialPopupMessage)%>';
		var trialTitle = '<%=PX.Data.PXLocalizer.Localize(PX.AscxControlsMessages.LoginScreen.TrialPopupTitle)%>';
		var agreeBtnLabel = '<%=PX.Data.PXLocalizer.Localize(PX.AscxControlsMessages.LoginScreen.TrialPopupAgreeButtonLabel)%>';
		var disagreeBtnLabel = '<%=PX.Data.PXLocalizer.Localize(PX.AscxControlsMessages.LoginScreen.TrialPopupDisagreeButtonLabel)%>';
...
<asp:Content ID="extLogins" ContentPlaceHolderID="phExt" Runat="Server">
	...
	<asp:LinkButton runat="server" ID="btnLoginGoogle" class="extlogin_wide_button" OnClick="btnLoginOAuth_Click" OnClientClick="return wrapClick(this, 'isRealOAuth', realFlagContainer, function() {return true}, true)" CommandName="Google" Visible="false"
		Text="<img src='../Icons/loginGoogle_new.png' alt='logo' /><span>Google</span>"/>	
	<asp:LinkButton runat="server" ID="btnLoginMicrosoft" class="extlogin_wide_button" OnClick="btnLoginOAuth_Click" OnClientClick="return wrapClick(this, 'isRealOAuth', realFlagContainer, function() {return true}, true)" CommandName="MicrosoftAccount" Visible="false" 
