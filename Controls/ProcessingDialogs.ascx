...
<%--                    <CustomItems>
    ...
    <script type="text/javascript">
        ...
        function selectFilter(a, b) {
            ...
            var filter = "00000000-0000-0000-0000-000000000000";
            if (key === "Errors")
                filter = "00000000-0000-0000-0000-000000000010";
            if (key === "Processed")
                filter = "00000000-0000-0000-0000-000000000020";
            if (key === "Remains")
                filter = "00000000-0000-0000-0000-000000000030";
            if (key === "Warnings")
                filter = "00000000-0000-0000-0000-000000000040";
        ...
        function BeforeShowProgress() {
			...
			if (tb.getButton('ElapsedTime')) tb.getButton('ElapsedTime').element.classList.add('progressButton');
            if (tb.getButton('LongRun')) tb.getButton('LongRun').element.classList.add('progressButton');
            var lr = px_alls['LongRun'];
			if(lr && lr.element) lr.element.classList.add('progressButton');
            px_alls["gridDetails"].setVisible(false);
        ...
        function OnProgressClosed() {
			var tb = px_alls['ToolBar'];
			if (tb.getButton('ElapsedTime')) tb.getButton('ElapsedTime').element.classList.remove('progressButton');
			if (tb.getButton('LongRun')) tb.getButton('LongRun').element.classList.remove('progressButton');

			var lr = px_alls['LongRun'];
            if (lr && lr.element) {
                lr.setVisible(false);
                lr.element.classList.remove('progressButton');
            }
        ...
        function SetButton(dest, btnName, editor,title, style, addStyle) {
            ...
            var filter = null;
            if (ExpandFilter === "00000000-0000-0000-0000-000000000000")
                filter = "Total";
            if (ExpandFilter === "00000000-0000-0000-0000-000000000010")
                filter = "Errors";
            if (ExpandFilter === "00000000-0000-0000-0000-000000000020")
                filter = "Processed";
            if (ExpandFilter === "00000000-0000-0000-0000-000000000030")
                filter = "Remains";
            if (ExpandFilter === "00000000-0000-0000-0000-000000000040")
                filter = "Warnings";
